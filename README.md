【导读】：[awesome-go](https://github.com/avelino/awesome-Go) ⭐ 185,442 | 🐛 229 | 🌐 Go | 📅 2026-09-24 就是 `avelino` 发起维护的 Go 资源列表，内容包括：音频和音乐库、命令行工具、服务端应用、流处理、持续集成、数据库、机器学习、NLP、物联网、中间件、文本处理、安全、机器人技术等。
...
* [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,973 | 🐛 20 | 🌐 Go | 📅 2026-09-23 :  可用于在多个平台上播放音频的底层库
...
* [malgo](https://github.com/gen2brain/malgo) ⭐ 428 | 🐛 9 | 🌐 C | 📅 2026-08-18 :`go`语言开发的迷你音频库。
* [id3v2](https://github.com/bogem/id3v2) ⭐ 370 | 🐛 24 | 🌐 Go | 📅 2023-10-28 :`go`语言开发的`ID3`编码和解码库,具有快速和稳定的特性。
* [flac](https://github.com/mewkiz/flac) ⭐ 362 | 🐛 9 | 🌐 Go | 📅 2026-08-19 :  原生`Go`语言编写的FLAC数据流编码与解码器。
...
* [mix](https://github.com/go-mix/mix) ⭐ 181 | 🐛 7 | 🌐 Go | 📅 2026-01-21 :   针对音乐类应用程序的基于序列的`Go`原生音频混音器。
...
* [minimp3](https://github.com/tosone/minimp3) ⭐ 134 | 🐛 3 | 🌐 C | 📅 2025-07-09 :  轻量级`MP3`解码库。
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 20,404 | 🐛 39 | 🌐 Go | 📅 2026-09-11 : 支持`ACL`、`RBAC`、`ABAC`等访问控制模型的授权与认证库。
* [jwt-go](https://github.com/dgrijalva/jwt-go) ⚠️ Archived :   -`JSON Web Tokens`（JWT）的Golang实现。
* [goth](https://github.com/markbates/goth) ⭐ 6,608 | 🐛 146 | 🌐 Go | 📅 2026-02-11 :   以简单、干净、常用的方式来使用`OAuth`和`OAuth2`。支持多种身份认证。
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,899 | 🐛 62 | 🌐 Go | 📅 2026-09-08 :  继承自`goauth2`。实现了JWT,Google APIs,GCE,GAE的通用`OAuth 2.0`授权包。
...
* [scs](https://github.com/alexedwards/scs) ⭐ 2,620 | 🐛 22 | 🌐 Go | 📅 2025-11-20 : `HTTP`服务器的会话管理器。
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) ⭐ 2,149 | 🐛 29 | 🌐 Go | 📅 2025-12-09 :  不需要其他依赖的、符合规范的、用`Golang` 编写的`OAuth2` 服务器。
* [gologin](https://github.com/dghubble/gologin) ⭐ 1,960 | 🐛 2 | 🌐 Go | 📅 2026-09-21 :  适用于OAuth1和OAuth2多身份登录认证的实现方案
...
* [gorbac](https://github.com/mikespook/gorbac) ⭐ 1,676 | 🐛 4 | 🌐 Go | 📅 2026-07-21 :   Golang中一个轻量级的基于角色的访问控制`（RBAC）`实现。
...
* [permissions2](https://github.com/xyproto/permissions2) ⭐ 509 | 🐛 0 | 🌐 Go | 📅 2026-09-03 :  用于跟踪用户、登录状态和权限的库,依赖安全`cookies`和`bcrypt`。
* [jwt](https://github.com/pascaldekloe/jwt) ⭐ 361 | 🐛 0 | 🌐 Go | 📅 2023-04-29 :  轻量级`JSON`网络令牌（`JWT`）库。
* [jeff](https://github.com/abraithwaite/jeff) ⭐ 271 | 🐛 2 | 🌐 Go | 📅 2025-01-23 :  简单、灵活、安全、习惯性的`Web`会话管理,支持可插拔的后端。
* [jwt-auth](https://github.com/adam-hanna/jwt-auth) ⭐ 238 | 🐛 4 | 🌐 Go | 📅 2021-08-01 :  用于`Golang http`服务器的`JWT`中间件,有许多配置选项。
* [httpauth](https://github.com/goji/httpauth) ⭐ 222 | 🐛 5 | 🌐 Go | 📅 2021-09-28 : `HTTP`认证中间件
...
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) ⭐ 6,407 | 🐛 174 | 🌐 Go | 📅 2024-08-14 :  简单干净的`Telegram`机器人客户端。
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,634 | 🐛 66 | 🌐 Go | 📅 2026-06-16 :  用`Go`编写的`Telegram`机器人框架。
* [olivia](https://github.com/olivia-ai/olivia) ⚠️ Archived :  一个用人工神经网络构建的聊天机器人。
* [Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot) ⭐ 1,164 | 🐛 7 | 🌐 Go | 📅 2025-11-20 :` golang`实现的基于控制台的加密货币交易所交易机器人库
...
* [go-twitch-irc](https://github.com/gempir/go-twitch-irc) ⭐ 403 | 🐛 8 | 🌐 Go | 📅 2026-03-11 :  用于编写`twitch.tv`聊天机器人的库。
...
* [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) ⭐ 98 | 🐛 8 | 🌐 Go | 📅 2026-09-09 :  根据语音频道成员是否出现来管理临时角色的机器人。
...
* [micha](https://github.com/onrik/micha) ⭐ 35 | 🐛 0 | 🌐 Go | 📅 2026-03-19 :  封装`Telegram`机器人api的`Go`库。
...
* [cobra](https://github.com/spf13/cobra) ⭐ 44,647 | 🐛 450 | 🌐 Go | 📅 2026-07-11 :   一个现代化的命令行。
* [urfave/cli](https://github.com/urfave/cli) ⭐ 24,249 | 🐛 71 | 🌐 Go | 📅 2026-09-24 :   简单、快速、有趣的、用于构建 Go 语言命令行程序的软件包。
* [kingpin](https://github.com/alecthomas/kingpin) ⭐ 3,568 | 🐛 29 | 🌐 Go | 📅 2026-09-14 :  支持子命令的命令行和标志位解析器。
* [Dnote](https://github.com/dnote/dnote) ⭐ 3,085 | 🐛 41 | 🌐 Go | 📅 2026-07-25 :  支持多设备同步的命令行笔记工具。
* [pflag](https://github.com/spf13/pflag) ⭐ 2,771 | 🐛 139 | 🌐 Go | 📅 2026-09-21 :  Go flag软件包的替代品, 实现了`POSIX/GNU`风格的`flags`.
* [go-flags](https://github.com/jessevdk/go-flags) ⭐ 2,694 | 🐛 69 | 🌐 Go | 📅 2024-07-26 : `  GO`命令行选项解析器。
* [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,281 | 🐛 38 | 🌐 Go | 📅 2025-12-27 :  `Go`中基于结构体的参数解析。
* [mitchellh/cli](https://github.com/mitchellh/cli) ⚠️ Archived :  用于实现命令行交互的 `Go `语言库
* [ops](https://github.com/nanovms/ops) ⭐ 1,519 | 🐛 143 | 🌐 Go | 📅 2026-09-22 : `Unikernel `编辑器和生成器
...
* [argparse](https://github.com/akamensky/argparse) ⭐ 639 | 🐛 10 | 🌐 Go | 📅 2022-10-31 :   受`Python`的`argparse`模块启发的命令行参数解析器。
* [1build](https://github.com/gopinath-langote/1build) ⭐ 251 | 🐛 30 | 🌐 Go | 📅 2026-05-11 :  管理项目专用命令的命令行工具。
* [wmenu](https://github.com/dixonwille/wmenu) ⭐ 230 | 🐛 3 | 🌐 Go | 📅 2024-11-25 :  为命令行程序提供简单的菜单结构选项来提供给用户来进行选择
...
* [hiboot cli](https://github.com/hidevopsio/hiboot/tree/master/pkg/app/cli) ⭐ 180 | 🐛 2 | 🌐 Go | 📅 2026-06-08 :  具有自动配置和依赖注入功能的 cli 应用程序框架。
...
* [job](https://github.com/liujianping/job) ⭐ 151 | 🐛 1 | 🌐 Shell | 📅 2020-06-30 :  将你的短期命令转化为长期作业。
* [cmdr](https://github.com/hedzr/cmdr) ⭐ 142 | 🐛 0 | 🌐 Go | 📅 2026-09-17 :  一个`POSIX/GNU`风格,类似于`getopt`的命令行UI的Go库。
...
* [ukautz/clif](https://github.com/ukautz/clif) ⭐ 127 | 🐛 3 | 🌐 Go | 📅 2019-02-18 :   一个小型命令行程序开发框架
...
* [strumt](https://github.com/antham/strumt) ⭐ 63 | 🐛 0 | 🌐 Go | 📅 2026-08-22 :  用于创建提示链的库。
...
* [termui](https://github.com/gizak/termui) ⭐ 13,589 | 🐛 106 | 🌐 Go | 📅 2025-07-10 :   基于 `termbox-go` 的 `Go` 终端仪表盘,灵感来源于[blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,775 | 🐛 97 | 🌐 JavaScript | 📅 2026-05-01 。
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,612 | 🐛 59 | 🌐 Go | 📅 2025-05-01 :  极简的控制台用户界面创建库.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,542 | 🐛 87 | 🌐 Go | 📅 2026-07-11 :  在每个平台上美化控制台输出的库,有许多可组合的组件。
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,503 | 🐛 114 | 🌐 Go | 📅 2025-08-12 :   受 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,586 | 🐛 722 | 🌐 Python | 📅 2026-07-26  的启发，用于构建强大的交互式提示符的go语言库
* [termbox-go](https://github.com/nsf/termbox-go) ⭐ 4,789 | 🐛 50 | 🌐 Go | 📅 2026-08-23 :   Termbox是一个用于创建跨平台文本界面的库。
* [progressbar](https://github.com/schollz/progressbar) ⭐ 4,706 | 🐛 15 | 🌐 Go | 📅 2026-09-19 :   适用于各种操作系统的,线程安全进度条管理库。
* [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 3,094 | 🐛 5 | 🌐 Go | 📅 2026-06-21 :   没有其他依赖的可以在命令行应用中制作轻量级的`ASCII`行图┈┈╭╯的go语言工具包
* [termdash](https://github.com/mum4k/termdash) ⭐ 3,038 | 🐛 49 | 🌐 Go | 📅 2026-09-14 :   基于 `termbox-go `的 `Go` 终端仪表盘,灵感来自 [termui](https://github.com/gizak/termui) ⭐ 13,589 | 🐛 106 | 🌐 Go | 📅 2025-07-10 。
* [mpb](https://github.com/vbauerster/mpb) ⭐ 2,512 | 🐛 15 | 🌐 Go | 📅 2026-09-21 :  为命令行提供多个进度条的工具
* [uiprogress](https://github.com/gosuri/uiprogress) ⭐ 2,139 | 🐛 30 | 🌐 Go | 📅 2024-02-29 ：用于渲染进度条的库
...
* [aurora](https://github.com/logrusorgru/aurora) ⭐ 1,496 | 🐛 2 | 🌐 Go | 📅 2025-01-07 :   `ANSI` 终端颜色,支持 `fmt.Printf/Sprintf`
* [go-isatty](https://github.com/mattn/go-isatty) ⭐ 926 | 🐛 1 | 🌐 Go | 📅 2026-07-23 :   `go`语言版本的`isatty`
* [go-colorable](https://github.com/mattn/go-colorable) ⭐ 817 | 🐛 7 | 🌐 Go | 📅 2026-05-29 : `Windows`上使用的可以输出彩色文本的库
* [uitable](https://github.com/gosuri/uitable) ⭐ 741 | 🐛 7 | 🌐 Go | 📅 2022-10-18 :  用于改善命令行中，表格数据可读性的库
* [gommon/color](https://github.com/labstack/gommon/tree/master/color) ⭐ 597 | 🐛 15 | 🌐 Go | 📅 2026-07-23 ：多样的命令行文本
* [simpletable](https://github.com/alexeyco/simpletable) ⭐ 553 | 🐛 5 | 🌐 Go | 📅 2021-04-23 :   在终端中用`Go`实现简单的表格。
* [chalk](https://github.com/ttacon/chalk) ⭐ 471 | 🐛 2 | 🌐 Go | 📅 2019-08-28 :  符合直觉的用于美化命令行输出的库
* [yacspin](https://github.com/theckman/yacspin) ⭐ 456 | 🐛 6 | 🌐 Go | 📅 2022-01-03 : 用于终端的`CLi Spinner` 工具包。
* [tabby](https://github.com/cheynewallace/tabby) ⭐ 372 | 🐛 3 | 🌐 Go | 📅 2020-12-23 :   超级简单的`Golang`表格的库。
...
* [table](https://github.com/tomlazar/table) ⭐ 51 | 🐛 1 | 🌐 Go | 📅 2023-05-19 :  基于终端颜色的表格库。
...
* [viper](https://github.com/spf13/viper) ⭐ 30,468 | 🐛 136 | 🌐 Go | 📅 2026-01-12 :`Go`语言配置工具
* [godotenv](https://github.com/joho/godotenv) ⭐ 10,640 | 🐛 85 | 🌐 Go | 📅 2026-08-04 : 把 `Ruby`的 `dotenv `库移植到 `Go `（从 `.env `中加载环境变量）。
* [env](https://github.com/caarlos0/env) ⭐ 6,320 | 🐛 35 | 🌐 Go | 📅 2026-09-04 :   解析环境变量为` Go` 语言结构体
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,468 | 🐛 62 | 🌐 Go | 📅 2025-06-28 :  用于管理环境变量配置数据的` Go` 库。
* [koanf](https://github.com/knadh/koanf) ⭐ 4,208 | 🐛 6 | 🌐 Go | 📅 2026-09-24 :  轻量级、可扩展的库,用于读取Go应用程序中的配置。内置支持`JSON、TOML、YAML、env`、命令行。
* [ini](https://github.com/go-ini/ini) ⭐ 3,543 | 🐛 98 | 🌐 Go | 📅 2026-09-05 :  用于读写INI 文件的库
* [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 2,165 | 🐛 55 | 🌐 Go | 📅 2025-09-15 :   简约的配置读取器(从文件、`ENV`以及任何你想要的地方读取)。
* [konfig](https://github.com/lalamove/konfig) ⭐ 645 | 🐛 5 | 🌐 Go | 📅 2020-10-28 :  为分布式处理时代的`Go`提供可组合、可观察和可执行的配置处理。
* [aconfig](https://github.com/cristalhq/aconfig) ⭐ 643 | 🐛 19 | 🌐 Go | 📅 2025-11-28 :   简单、有用的配置加载器。
* [gookit/config](https://github.com/gookit/config) ⭐ 586 | 🐛 5 | 🌐 Go | 📅 2026-09-07 :  应用程序配置管理(`load,get,set`),支持`JSON、YAML、TOML、INI、HCL`
...
* [hjson](https://github.com/hjson/hjson-go) ⭐ 357 | 🐛 7 | 🌐 Go | 📅 2026-09-06 :  便于程序员使用和阅读的配置文件格式。具有更加轻松的语法,更少的错误和更多的注释
...
* [harvester](https://github.com/beatlabs/harvester) ⭐ 135 | 🐛 4 | 🌐 Go | 📅 2026-09-11 :   `Harvester,`一个易于使用的静态和动态配置包,支持 `envars` 和 `Consul` 集成。
...
* [envh](https://github.com/antham/envh) ⭐ 101 | 🐛 2 | 🌐 Go | 📅 2026-08-31 :  管理环境变量的助手
* [configuro](https://github.com/sherifabdlnaby/configuro) ⭐ 92 | 🐛 1 | 🌐 Go | 📅 2026-07-11 :  来自`ENV`和`Files`的意见性配置加载和验证框架,专注于`12-Factor`兼容应用程序。
* [hocon](https://github.com/gurkankaymak/hocon) ⭐ 91 | 🐛 1 | 🌐 Go | 📅 2026-09-23 :  用于使用`HOCON`(一种人类友好的JSON超集)格式的配置库,支持环境变量、引用其他值、注释和多文件等功能。
...
* [go-aws-ssm](https://github.com/PaddleHQ/go-aws-ssm) ⭐ 66 | 🐛 3 | 🌐 Go | 📅 2026-09-23 :   从` AWS System Manager - Parameter Store` 获取参数的` Go` 包。
...
* [mini](https://github.com/sasbury/mini) ⭐ 36 | 🐛 1 | 🌐 Go | 📅 2018-12-26 :  用于解析类 `ini ` 文件的库
...
* [drone](https://github.com/drone/drone) ⭐ 38,433 | 🐛 113 | 🌐 Go | 📅 2026-09-24 : ` Drone` 是一个基于` Docker`的持续集成平台,使用 `Go `语言编写
* [CDS](https://github.com/ovh/cds) ⭐ 4,845 | 🐛 162 | 🌐 Go | 📅 2026-09-24 :  企业级`CI/CD`和`DevOps`自动化开源平台。
...
* [gomason](https://github.com/nikogura/gomason) ⭐ 69 | 🐛 4 | 🌐 Go | 📅 2026-02-10 :  从一个干净的工作空间测试、构建、签署和发布你的`go`二进制文件
...
* [gods](https://github.com/emirpasic/gods) ⭐ 17,462 | 🐛 73 | 🌐 Go | 📅 2025-03-12 :` Go`语言数据结构、容器、集合、列表、栈、键值对、 `BidiMaps`、树、`HashSet`等
* [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,962 | 🐛 30 | 🌐 Go | 📅 2026-07-31:一组有用的、高性能的、线程安全的数据结构
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,757 | 🐛 13 | 🌐 Go | 📅 2026-09-19 :  线程安全和非线程安全的高性能集合
...
* [gocache](https://github.com/eko/gocache) ⭐ 2,885 | 🐛 4 | 🌐 Go | 📅 2026-09-13 :   完整的`Go`缓存库,支持多个存储（内存、`memcache、redis......`）。
* [willf/bloom](https://github.com/willf/bloom) ⭐ 2,815 | 🐛 19 | 🌐 Go | 📅 2026-07-10 :   实现了布隆过滤器的库
* [boomfilters](https://github.com/tylertreat/BoomFilters) ⭐ 1,647 | 🐛 13 | 🌐 Go | 📅 2025-11-17 ： 概率统计数据结构,用于处理大量连续的数据。
* [bitset](https://github.com/willf/bitset) ⭐ 1,512 | 🐛 1 | 🌐 Go | 📅 2026-09-03 :  实现了 `bitset `的 `Go `语言包.
* [ttlcache](https://github.com/ReneKroon/ttlcache) ⭐ 1,284 | 🐛 16 | 🌐 Go | 📅 2026-09-14 : 基于过期时间的内存字符串缓存接口。
* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) ⭐ 1,234 | 🐛 15 | 🌐 Go | 📅 2024-07-15 : `Cuckoo`过滤器：一个用go语言实现的计数布隆过滤器的替代品
* [gostl](https://github.com/liyue201/gostl) ⭐ 1,142 | 🐛 7 | 🌐 Go | 📅 2025-08-28 :  数据结构和算法库,旨在提供类似于` C++ STL` 的功能。
* [hyperloglog](https://github.com/axiomhq/hyperloglog) ⭐ 1,050 | 🐛 4 | 🌐 Go | 📅 2026-09-14 : `HyperLogLog` 的go语言实现
...
* [deque](https://github.com/gammazero/deque) ⭐ 786 | 🐛 6 | 🌐 Go | 📅 2026-07-02 :  快速的环形缓冲区` deque`（双端队列）。
* [go-edlib](https://github.com/hbollon/go-edlib) ⭐ 606 | 🐛 1 | 🌐 Go | 📅 2026-02-05 :  与 Unicode 兼容的 Go 字符串比较和编辑距离算法库（`Levenshtein、LCS、Hamming、Damerau levenshtein、Jaro-Winkler` 等）。
* [merkletree](https://github.com/cbergoon/merkletree) ⭐ 542 | 🐛 0 | 🌐 Go | 📅 2026-08-14 :  实现了梅克尔树,提供了一种高效、安全的数据结构内容验证方法
* [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 478 | 🐛 2 | 🌐 Go | 📅 2026-09-03 : 在Go中计算`levenshtein`距离的实现。
* [goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) ⭐ 434 | 🐛 5 | 🌐 Go | 📅 2023-05-12 :  并发`FIFO`队列。
* [go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) ⭐ 413 | 🐛 0 | 🌐 Go | 📅 2025-11-21 :   `Go `语言实现的自适应基数树
* [go-geoindex](https://github.com/hailocab/go-geoindex) ⭐ 360 | 🐛 2 | 🌐 Go | 📅 2018-02-20 :  基于内存存储的地理索引
* [skiplist](https://github.com/MauriceGit/skiplist) ⭐ 296 | 🐛 5 | 🌐 Go | 📅 2023-01-31 :  非常快的`Go Skipipllist`实现。
...
* [iter](https://github.com/disksing/iter) ⭐ 197 | 🐛 0 | 🌐 Go | 📅 2026-07-30 :  `C++ STL`迭代器和算法的Go实现。
* [bit](https://github.com/yourbasic/bit) ⭐ 168 | 🐛 1 | 🌐 Go | 📅 2022-12-29 : `Go`语言集合数据结构。提供了额外的位操作功能
* [bloom](https://github.com/zhenjl/bloom) ⭐ 147 | 🐛 1 | 🌐 Go | 📅 2018-04-16 : `Go `语言实现的布隆过滤器（`bloom filter`）
* [ring](https://github.com/TheTannerRyan/ring) ⭐ 146 | 🐛 0 | 🌐 Go | 📅 2026-09-13 :  高性能、线程安全的 `bloom `过滤器的 Go 实现。
...
* [levenshtein](https://github.com/agext/levenshtein) ⭐ 93 | 🐛 1 | 🌐 Go | 📅 2020-10-15 :  编辑距离（`levenshtein distance`）和相似性度量计算库
...
* [skiplist](https://github.com/gansidui/skiplist) ⭐ 84 | 🐛 0 | 🌐 Go | 📅 2014-11-21 :  在 `Go `中实现的` Skiplist`。
...
* [goset](https://github.com/zoumo/goset) ⭐ 52 | 🐛 0 | 🌐 Go | 📅 2020-12-11 : `Go`集合实现。
...
* [typ](https://github.com/gurukami/typ) ⭐ 46 | 🐛 0 | 🌐 Go | 📅 2021-10-15 :  空类型安全的基础类型转换器和从复杂结构中取值的开发库。
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,210 | 🐛 911 | 🌐 Go | 📅 2026-09-24 :  监控系统及时间序列数据库
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,586 | 🐛 7,172 | 🌐 Go | 📅 2026-09-24 : ` TiDB` 是一个分布式的` SQL` 数据库。受到了` Google F1`的启发
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,496 | 🐛 8,343 | 🌐 Go | 📅 2026-09-24 :  可扩展的、一致的事务型数据库
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 31,757 | 🐛 2,174 | 🌐 Rust | 📅 2026-09-24 :  用于度量、事件和实时分析的可扩展数据存储。
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,808 | 🐛 100 | 🌐 Go | 📅 2026-09-24 :  可扩展的、分布式的、低延时、高吞吐的图数据库
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,767 | 🐛 792 | 🌐 Go | 📅 2026-09-24 :  快速、资源高效、可扩展的开源时间序列数据库。可作为`Prometheus`的长期远程存储。支持`PromQL`。
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 17,764 | 🐛 75 | 🌐 Go | 📅 2026-09-24 :  基于 `SQLite `的轻量级的、分布式的关系型数据库
* [badger](https://github.com/dgraph-io/badger) ⭐ 15,771 | 🐛 68 | 🌐 Go | 📅 2026-09-23 : `Go`中的快速键值存储库。
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,337 | 🐛 46 | 🌐 Go | 📅 2024-11-29 :  `Groupcache`是一个缓存及缓存填充库,在很多情况下用于替代 `memcached`.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,751 | 🐛 32 | 🌐 Go | 📅 2026-09-15 :  `Go`的嵌入式键值数据库。
* [immudb](https://github.com/codenotary/immudb) ⭐ 9,037 | 🐛 113 | 🌐 Go | 📅 2026-09-10 :  `immudb `是一个轻量级、高速的不可变数据库,适用于用`Go`编写的系统和应用程序。
* [go-cache](https://github.com/pmylund/go-cache) ⭐ 8,842 | 🐛 80 | 🌐 Go | 📅 2023-11-20 :   基于内存存储的缓存,适用于分布式部署的应用
* [BigCache](https://github.com/allegro/bigcache) ⭐ 8,163 | 🐛 94 | 🌐 Go | 📅 2026-09-21 :  为GB量级数据设计的高效键/值缓存
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,322 | 🐛 111 | 🌐 Go | 📅 2024-05-14 :  `Go`中[LevelDB](https://github.com/google/leveldb) ⭐ 39,446 | 🐛 410 | 🌐 C++ | 📅 2026-03-11键/值数据库的实现
* [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,888 | 🐛 8 | 🌐 Go | 📅 2026-02-10 : 一个基于 LSM+WAL 的内嵌 k-v数据库，支持多种数据结构，如字符串、列表、哈希表、集合、有序集合
* [buntdb](https://github.com/tidwall/buntdb) ⭐ 4,870 | 🐛 32 | 🌐 Go | 📅 2026-05-19 :  快速,可嵌入的,内存键值数据库,可定义索引及 `spatial`
* [ledisdb](https://github.com/siddontang/ledisdb) ⭐ 4,115 | 🐛 1 | 🌐 Go | 📅 2023-10-22 :  `Ledisdb `是一个高性能 `NoSQL` 数据库,类似 `Redis`
* [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,580 | 🐛 50 | 🌐 Go | 📅 2026-09-18 :  `Nutsdb`是一个用纯`Go`编写的简单、快速、可嵌入、持久化的键/值存储。它支持完全可序列化的事务和许多数据结构,如列表、集合、排序集合。
* [GCache](https://github.com/bluele/gcache) ⭐ 2,732 | 🐛 30 | 🌐 Go | 📅 2024-03-01 :  支持缓存过期、 `LFU、 LRU `和 `ARC `的缓存库
...
* [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) ⭐ 1,529 | 🐛 36 | 🌐 Go | 📅 2023-02-25 :  `CovenantSQL`是一个区块链上的SQL数据库。
* [Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,487 | 🐛 4 | 🌐 Go | 📅 2026-07-28 :  为符合`GDPR`和`CCPA`而构建的个人身份信息`PII`存储服务。
* [diskv](https://github.com/peterbourgon/diskv) ⭐ 1,455 | 🐛 10 | 🌐 Go | 📅 2021-11-10 :   具有 `disk-backed` 功能的持久化键值存储
* [pogreb](https://github.com/akrylysov/pogreb) ⭐ 1,350 | 🐛 15 | 🌐 Go | 📅 2026-04-06 :  嵌入式键值存储,适用于重读工作负载。
* [eliasdb](https://github.com/krotik/eliasdb) ⭐ 1,036 | 🐛 14 | 🌐 Go | 📅 2026-08-25 :  无依赖、事物型图数据库,支持 `REST API`、短语搜索以及类` SQL` 的查询语言
...
* [Kivik](https://github.com/go-kivik/kivik) ⭐ 345 | 🐛 36 | 🌐 Go | 📅 2026-09-22 :  `Kivik`为`CouchDB、PouchDB`和类似的数据库提供了一个通用的`Go`和`GopherJS`客户端库。
* [Vasto](https://github.com/chrislusf/vasto) ⭐ 262 | 🐛 4 | 🌐 Go | 📅 2019-03-07 :   一个分布式高性能键值存储。在磁盘上。最终一致。HA。能够在不中断服务的情况下增长或收缩。
...
* [unitdb](https://github.com/unit-io/unitdb) ⭐ 124 | 🐛 2 | 🌐 Go | 📅 2026-09-24 :  用于物联网、实时消息应用的快速时序数据库。
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,941 | 🐛 496 | 🌐 Go | 📅 2026-09-09 :   数据库迁移。命令行及 `Go `语言库
* [goose](https://github.com/pressly/goose) ⭐ 11,496 | 🐛 133 | 🌐 Go | 📅 2026-09-24 :   数据库迁移工具。你可以通过编写增量 `SQL `或 `Go` 语言脚本来管理你的数据库
* [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,417 | 🐛 98 | 🌐 Go | 📅 2026-07-14 :  数据库迁移工具,允许利用 `Go-bindata` 将数据库迁移嵌入应用程序
* [soda](https://github.com/gobuffalo/pop/tree/master/soda) ⭐ 1,526 | 🐛 93 | 🌐 Go | 📅 2026-09-16 : 数据库迁移、创建、 ORM等等,用于`MySQL, PostgreSQL,`以及 `SQLite`.
* [skeema](https://github.com/skeema/skeema) ⭐ 1,379 | 🐛 15 | 🌐 Go | 📅 2026-09-22 :  `MySQL`的纯SQL模式管理系统,支持`sharding`和外部在线模式变更工具
* [gormigrate](https://github.com/go-gormigrate/gormigrate) ⭐ 1,175 | 🐛 17 | 🌐 Go | 📅 2026-09-15 :   数据库模式迁移帮助工具,用于` Gorm ORM.`
* [migrator](https://github.com/lopezator/migrator) ⭐ 178 | 🐛 11 | 🌐 Go | 📅 2024-03-14 :  简单的`Go`数据库迁移库。
...
* [schema](https://github.com/adlio/schema) ⭐ 44 | 🐛 1 | 🌐 Go | 📅 2026-09-17 :   在你的Go二进制文件中嵌入数据库/sql兼容数据库的模式迁移库。
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,353 | 🐛 1,130 | 🌐 Go | 📅 2026-09-24 :  `vitess` 提供了能够使大型 `web `服务 `MySQL` 数据库的扩展变得更加容易的服务器及工具
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,514 | 🐛 56 | 🌐 Go | 📅 2026-07-26 :  基于 `Web` 的 `PostgreSQL` 数据库浏览工具
* [kingshard](https://github.com/flike/kingshard) ⭐ 6,399 | 🐛 160 | 🌐 Go | 📅 2026-06-05 :  `kingshard`是一个`Go`语言编写的高性能 `MySQL `数据库代理
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived : ` MySQL`复制拓扑管理器及可视化工具
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,970 | 🐛 156 | 🌐 Go | 📅 2026-09-24 :   用于处理` MySQL` 协议及复制的`Go`语言工具集
* [pREST](https://github.com/nuveo/prest) ⭐ 4,618 | 🐛 155 | 🌐 Go | 📅 2026-09-18 :  为 `PostgreSQL `数据库提供 `RESTful API`
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) ⭐ 4,144 | 🐛 219 | 🌐 Go | 📅 2023-10-22 :  将你的 `MySQL` 数据自动同步到` Elasticsearch`
* [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1,486 | 🐛 90 | 🌐 Go | 📅 2026-04-15 : ` HTTP`代理的`ClickHouse`数据库。
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,402 | 🐛 1 | 🌐 Go | 📅 2026-09-22 : `PostgreSQL` 的高级调度。
...
* [dbbench](https://github.com/sj14/dbbench) ⭐ 118 | 🐛 9 | 🌐 Go | 📅 2026-09-19 :  数据库基准测试工具,支持多个数据库和脚本。
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,985 | 🐛 97 | 🌐 Go | 📅 2024-04-24 :  一个帮助你构建 `SQL` 查询的库
* [xo](https://github.com/knq/xo) ⭐ 3,899 | 🐛 70 | 🌐 Go | 📅 2026-09-08 :  基于已知的数据库表或自定义查询生成地道的`Go`语言代码,支持 `PostgreSQL, MySQL, SQLite, Oracle`, 以及 `Microsoft SQL Server`.
* [jet](https://github.com/go-jet/jet) ⭐ 3,805 | 🐛 45 | 🌐 Go | 📅 2026-08-31 :  在`Go`中编写类型安全的`SQL`查询框架,能够轻松地将数据库查询结果转换为所需的任意对象结构。
* [goqu](https://github.com/doug-martin/goqu) ⭐ 2,677 | 🐛 146 | 🌐 Go | 📅 2024-05-22 :  地道的 `SQL` 语句创建器和查询库
* [gendry](https://github.com/didi/gendry) ⚠️ Archived :  非侵入式`SQL`构建器和强大的数据绑定器。
* [Dotsql](https://github.com/gchaincl/dotsql) ⭐ 739 | 🐛 8 | 🌐 Go | 📅 2023-11-24 :  `Go`语言库,帮助你将 `sql` 文件保存在一个地方并且方便的取用
* [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) ⭐ 672 | 🐛 2 | 🌐 Go | 📅 2026-09-03 :  强大的数据检索方法以及与`DB`无关的查询构建能力。
* [sqlingo](https://github.com/lqs/sqlingo) ⭐ 455 | 🐛 5 | 🌐 Go | 📅 2026-04-01 :  在` Go` 中构建 `SQL` 的轻量级 `DSL`。
...
* [sq](https://github.com/bokwoon95/go-structured-query) ⭐ 200 | 🐛 2 | 🌐 Go | 📅 2023-01-15 :  适用于`Go`的类型安全`SQL`构建器和结构映射器。
...
* 关系型数据库
  * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 15,286 | 🐛 59 | 🌐 Go | 📅 2026-09-19 :  Go 语言 `MySQL`驱动
  * [pgx](https://github.com/jackc/pgx) ⭐ 14,270 | 🐛 220 | 🌐 Go | 📅 2026-09-17 :  `PostgreSQL` 驱动,支持比 `database/sql `更多的特性
  * [pq](https://github.com/lib/pq) ⭐ 9,961 | 🐛 52 | 🌐 Go | 📅 2026-08-20 :  用于`database/sql`的`Pure Go Postgres`驱动。
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,242 | 🐛 149 | 🌐 C | 📅 2026-09-20 :  Go 语言的 `SQLite3 `驱动
  ...
  * [firebirdsql](https://github.com/nakagami/firebirdsql) ⭐ 267 | 🐛 2 | 🌐 Go | 📅 2026-09-17 :  `Firebird RDBMS SQL `驱动
...
* NoSQL数据库
  * [redis](https://github.com/go-redis/redis) ⭐ 22,248 | 🐛 83 | 🌐 Go | 📅 2026-09-24 :  兼容R`edis`协议的 `TCP` 服务器/服务.
  * [redigo](https://github.com/gomodule/redigo) ⭐ 9,853 | 🐛 25 | 🌐 Go | 📅 2025-11-02 : ` RediGo`是 `Redis` 数据库的`Go` 语言客户端.
  * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,540 | 🐛 19 | 🌐 Go | 📅 2026-09-23 :   `Go`语言的官方`MongoDB`驱动。
  * [mgo](https://github.com/globalsign/mgo) ⭐ 1,961 | 🐛 64 | 🌐 Go | 📅 2021-10-29 :`  MonGoDB` 驱动,通过简单的 `API` 现了丰富的、经过测试的特性,这些 API 遵循 Go 语言的习惯
  * [gomemcache](https://github.com/bradfitz/gomemcache/) ⭐ 1,887 | 🐛 49 | 🌐 Go | 📅 2026-07-12 :  `Go`编程语言的`memcache`客户端库。
  * [gorethink](https://github.com/dancannon/gorethink) ⭐ 1,647 | 🐛 27 | 🌐 Go | 📅 2025-10-24 :  `RethinkDB`的Go语言驱动。
  * [qmgo](https://github.com/qiniu/qmgo) ⭐ 1,357 | 🐛 52 | 🌐 Go | 📅 2026-06-20 :  Go的`MongoDB`驱动。它基于官方的`MongoDB`驱动,但和Mgo一样更容易使用。
  * [mgm](https://github.com/kamva/mgm) ⭐ 765 | 🐛 18 | 🌐 Go | 📅 2026-08-03 :  用于 `Go` 的基于` MongoDB` 模型的` ODM`（基于官方 MongoDB 驱动程序）
  * [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) ⭐ 461 | 🐛 46 | 🌐 Go | 📅 2026-09-24 :   `Go`语言的`Aerospike`客户端。
  ...
  * [gocb](https://github.com/couchbase/gocb) ⭐ 376 | 🐛 2 | 🌐 Go | 📅 2026-09-24 :  `Couchbase Go`官方SDK。
  * [go-rejson](https://github.com/nitishm/go-rejson) ⭐ 339 | 🐛 17 | 🌐 Go | 📅 2024-01-17 : `Redislabs` 的 `ReJSON `模块的 `Golang` 客户端,使用 `Redigo golang `客户端。在`redis`中轻松地将结构体作为`JSON`对象进行存储和操作。
...
* 搜索引擎和文本数据库
  * [bleve](https://github.com/blevesearch/bleve) ⭐ 11,231 | 🐛 296 | 🌐 Go | 📅 2026-09-24 :  现代文本索引库
  * [elastic](https://github.com/olivere/elastic) ⭐ 7,443 | 🐛 116 | 🌐 Go | 📅 2024-08-08 :  ` Go` 语言的 `Elasticsearch `客户端
  * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 6,069 | 🐛 30 | 🌐 Go | 📅 2026-09-18 : Go的官方`Elasticsearch`客户端。
  * [riot](https://github.com/go-ego/riot) ⭐ 6,050 | 🐛 0 | 🌐 Go | 📅 2026-09-21 :  `Go`开源,分布式,简单高效的搜索引擎。
...
* 多个后端:
  * [cayley](https://github.com/google/cayley) ⭐ 15,069 | 🐛 93 | 🌐 Go | 📅 2026-08-27 :  支持多个后端的图形数据库。
...
* [now](https://github.com/jinzhu/now) ⭐ 4,701 | 🐛 19 | 🌐 Go | 📅 2026-02-02 :  `Now` 是一个 `Go` 语言的时间工具集
* [dateparse](https://github.com/araddon/dateparse) ⭐ 2,142 | 🐛 63 | 🌐 Go | 📅 2023-12-30 :  在不知道格式的情况下解析日期。
* [carbon](https://github.com/uniplaces/carbon) ⭐ 780 | 🐛 1 | 🌐 Go | 📅 2024-01-17 :  简单的时间扩展程序,有很多有用的方法,是`PHP Carbon`库的接口
* [durafmt](https://github.com/hako/durafmt) ⭐ 511 | 🐛 13 | 🌐 Go | 📅 2021-06-08 :  持续时间格式化
* [go-persian-calendar](https://github.com/yaa110/go-persian-calendar) ⭐ 244 | 🐛 4 | 🌐 Go | 📅 2025-09-28 : - 太阳历
...
* [iso8601](https://github.com/relvacode/iso8601) ⭐ 170 | 🐛 1 | 🌐 Go | 📅 2026-08-17 :  有效地解析`ISO8601`日期时间,而无需使用`regex`。
* [date](https://github.com/rickb777/date) ⭐ 142 | 🐛 0 | 🌐 Go | 📅 2026-09-07 :  增强了Time的功能,用于处理日期、日期范围、时间跨度、时间段和日期时间。
...
* [raft](https://github.com/coreos/etcd/tree/master/raft) ⭐ 52,310 | 🐛 351 | 🌐 Go | 📅 2026-09-24 : ` Raft`共识协议的 `Go` 实现,由 `CoreOS` 提供。
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,424 | 🐛 60 | 🌐 Go | 📅 2024-07-19 :   为服务工具吧,支持服务发现、负载均衡 、可插拔传输以及请求追踪等
* [go-micro](https://github.com/micro/go-micro) ⭐ 23,078 | 🐛 5 | 🌐 Go | 📅 2026-09-24 :   一个分布式系统开发框架。
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 23,074 | 🐛 136 | 🌐 Go | 📅 2026-09-24 : ` gRPC`的Go语言实现。基于`HTTP/2的RPC`。
* [NATS](https://github.com/nats-io/gnatsd) ⭐ 20,765 | 🐛 454 | 🌐 Go | 📅 2026-09-24 :  轻量级、高性能微服务系统,用于微服务、物联网以及云
* [raft](https://github.com/hashicorp/raft) ⭐ 9,136 | 🐛 57 | 🌐 Go | 📅 2026-09-22 :  `Raft` 共识协议的 `Golang `实现,由 `HashiCorp`.开发。
* [rpcx](https://github.com/smallnest/rpcx) ⭐ 8,317 | 🐛 4 | 🌐 Go | 📅 2026-09-03 :   `rpcx`是一个类似阿里巴巴` Dubbo` 和微博` Motan` 的分布式的`RPC`服务框架
* [KrakenD](https://github.com/devopsfaith/krakend) ⭐ 6,799 | 🐛 12 | 🌐 Go | 📅 2026-09-21 :  带有中间件的,高性能`API`网关框架
* [torrent](https://github.com/anacrolix/torrent) ⭐ 6,116 | 🐛 73 | 🌐 Go | 📅 2026-09-24 :   `BitTorrent` 客户端
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,864 | 🐛 20 | 🌐 Go | 📅 2026-09-24 : 使用`Tendermint` 一致性及区块链协议的高性能的中间件,用于将任何语言编写的状态机转换为一个拜占庭容错状态机,
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,329 | 🐛 65 | 🌐 Go | 📅 2025-07-23 :  `Go`中一个功能完整且高性能的多组`Raft`库。
...
* [gleam](https://github.com/chrislusf/gleam) ⭐ 3,566 | 🐛 38 | 🌐 Go | 📅 2026-09-18 :   快速、可扩展的分布式` map/reduce` 系统,使用纯` Go` 语言和` Luajit` 编写,融合了 Go 语言的高并发能力和 Luajit 的高性能,可以独立或分布式部署运行。
* [glow](https://github.com/chrislusf/glow) ⭐ 3,216 | 🐛 15 | 🌐 Go | 📅 2018-11-02 :   易于使用的可扩展的分布式大数据处理、`Map-Reduce、DAG`执行,全部用纯Go编写。
* [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,802 | 🐛 45 | 🌐 Go | 📅 2026-09-09 :  用于`NATS`的轻量级、容错消息流。
* [redis-lock](https://github.com/bsm/redislock) ⭐ 1,767 | 🐛 3 | 🌐 Go | 📅 2026-06-27 :  使用Redis实现的简化的分布式锁。
* [hprose](https://github.com/hprose/hprose-golang) ⭐ 1,256 | 🐛 5 | 🌐 Go | 📅 2024-02-18 :  非常新颖的RPC库,现在支持25种以上的语言。
* [rain](https://github.com/cenkalti/rain) ⭐ 1,146 | 🐛 3 | 🌐 Go | 📅 2026-09-21 :   `BitTorrent`客户端和库。
* [arpc](https://github.com/lesismal/arpc) ⭐ 1,091 | 🐛 2 | 🌐 Go | 📅 2026-09-19 :  更有效的网络通信,支持双向呼叫、通知、广播。
* [ringpop-go](https://github.com/uber/ringpop-go) ⭐ 881 | 🐛 29 | 🌐 Go | 📅 2025-10-16 :   为`Go`应用提供可扩展、容错的应用层分片。
...
* [go-sundheit](https://github.com/AppsFlyer/go-sundheit) ⭐ 561 | 🐛 7 | 🌐 Go | 📅 2026-07-14 :  为 `golang `服务定义异步服务健康检查提供支持的库。
* [digota](https://github.com/digota/digota) ⭐ 524 | 🐛 12 | 🌐 Go | 📅 2021-02-14 grpc电子商务微服务。
* [go-jump](https://github.com/dgryski/go-jump) ⭐ 388 | 🐛 1 | 🌐 Go | 📅 2021-10-18 :  `Google "Jump" `一致性哈希函数的接口
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 387 | 🐛 0 | 🌐 Go | 📅 2023-07-09 :  在 `HTTP `服务之间进行无主` p2p` 自动发现和 RPC通信(使用 [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 11,004 | 🐛 385 | 🌐 C++ | 📅 2026-07-26)ß
...
* [dot](https://github.com/dotchain/dot/) ⭐ 89 | 🐛 0 | 🌐 Go | 📅 2019-09-30 ： 使用操作转换/OT的分布式同步库。
* [celeriac](https://github.com/svcavallar/celeriac.v1) ⭐ 76 | 🐛 0 | 🌐 Go | 📅 2024-07-17 :  利用 `Go` 语言对`Celery`的` worker`ß任务事件进行交互和监控的库
* [flowgraph](https://github.com/vectaport/flowgraph) ⭐ 67 | 🐛 5 | 🌐 Go | 📅 2026-08-08 :  基于流的编程包实现的MPI 风格的读取,发送协同层；
...
* [GoDNS](https://github.com/timothyye/godns) ⭐ 1,779 | 🐛 12 | 🌐 Go | 📅 2026-09-16 : 用Go编写的动态`DNS`客户端工具,支持`DNSPod`和`HE.net`。
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 16,167 | 🐛 257 | 🌐 Go | 📅 2024-02-13 :  `Email` 及 `SMTP` 测试工具,具有 web 及 API 接口
...
* [go-imap](https://github.com/emersion/go-imap) ⭐ 2,350 | 🐛 78 | 🌐 Go | 📅 2026-09-17 :  ` IMAP` 库,用于客户端和服务器
* [SendGrid](https://github.com/sendgrid/sendgrid-go) ⭐ 1,061 | 🐛 33 | 🌐 Go | 📅 2026-06-25 : `SendGrid`的 Go 语言库,用于发送电子邮件
* [mailgun-go](https://github.com/mailgun/mailgun-go) ⭐ 744 | 🐛 3 | 🌐 Go | 📅 2026-09-07 :  使用`Mailgun API`发送邮件的Go库。
* [go-simple-mail](https://github.com/xhit/go-simple-mail) ⭐ 699 | 🐛 16 | 🌐 Go | 📅 2026-09-17 :  `go`语言实现的基于简单`smtp`协议的邮件发送库
* [go-message](https://github.com/emersion/go-message) ⭐ 459 | 🐛 31 | 🌐 Go | 📅 2025-02-16 :  用于互联网消息格式和邮件的库
...
* [go-premailer](https://github.com/vanng822/go-premailer) ⭐ 207 | 🐛 1 | 🌐 Go | 📅 2026-09-02 : 在`Go`中为`HTML`邮件提供在线样式。
...
* [smtp](https://github.com/mailhog/smtp) ⭐ 76 | 🐛 7 | 🌐 Go | 📅 2021-10-20 :   `SMTP` 服务器协议状态机
...
* [expr](https://github.com/antonmedv/expr) ⭐ 8,029 | 🐛 95 | 🌐 Go | 📅 2026-07-07 :  ` Go` 的表达式评估引擎，具有快速、非图灵完备、动态类型化、静态类型化的特性。
* [goja](https://github.com/dop251/goja) ⭐ 7,112 | 🐛 33 | 🌐 Go | 📅 2026-09-23 :  在 Go 中实现 `ECMAScript 5.1(+)` 。
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,982 | 🐛 105 | 🌐 Go | 📅 2026-04-01 :  ` Go` 语言编写的 `Lua 5.1` 虚拟机和编译器
* [tengo](https://github.com/d5/tengo) ⭐ 3,841 | 🐛 91 | 🌐 Go | 📅 2026-04-29 : `Go`的字节码编译脚本语言。
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,453 | 🐛 50 | 🌐 Go | 📅 2026-09-23 :  `Lua 5.2`虚拟机的纯 Go 语言接口
* [anko](https://github.com/mattn/anko) ⭐ 1,584 | 🐛 20 | 🌐 Go | 📅 2026-07-10 :   `Go `语言编写的解释器
...
* [gval](https://github.com/PaesslerAG/gval) ⭐ 815 | 🐛 25 | 🌐 Go | 📅 2026-09-13 :  Go编写的高度可定制的表达式语言。
...
* [binder](https://github.com/alexeyco/binder) ⭐ 80 | 🐛 2 | 🌐 Go | 📅 2022-07-07 :  基于[gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,982 | 🐛 105 | 🌐 Go | 📅 2026-04-01的go语言Lua 接口,
...
* [cel-go](https://github.com/google/cel-go) ⭐ 0 | 🐛 1 | 🌐 Go | 📅 2026-09-10 :  快速、可移植、非图灵完全表达式评估和渐进分型。
...
* [go-multierror](https://github.com/hashicorp/go-multierror) ⭐ 2,588 | 🐛 30 | 🌐 Go | 📅 2026-07-06 : 用于将错误列表表示为单个错误的包
...
* [tracerr](https://github.com/ztrue/tracerr) ⭐ 1,122 | 🐛 4 | 🌐 Go | 📅 2026-04-02 ： 带有堆栈跟踪和源片段的`Golang`错误处理包。
* [errlog](https://github.com/snwfdhmp/errlog) ⭐ 458 | 🐛 0 | 🌐 Go | 📅 2023-06-27 : 用于确定错误的责任源代码（以及其他一些快速调试功能，可以嵌入到任何的日志服务中。
* [emperror](https://github.com/emperror/emperror) ⭐ 388 | 🐛 6 | 🌐 Go | 📅 2020-10-04 : ` Go`库和应用程序的错误处理工具和最佳实践。
* [errors](https://github.com/emperror/errors) ⭐ 204 | 🐛 12 | 🌐 Go | 📅 2022-06-20 :  标准库错误包和` github.com/pkg/errors` 的替代包。提供各种错误处理单元。
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 8,852 | 🐛 102 | 🌐 Go | 📅 2026-09-20 :   PDF 处理器。
* [afero](https://github.com/spf13/afero) ⭐ 6,705 | 🐛 140 | 🌐 Go | 📅 2026-09-11 : ` go`语言编写的对文件系统进行抽象的系统框架
* [notify](https://github.com/rjeczalik/notify) ⭐ 937 | 🐛 46 | 🌐 Go | 📅 2026-06-01 : 类似 `os/signal`的文件系统提示库,具有简单的 API.
* [copy](https://github.com/otiai10/copy) ⭐ 772 | 🐛 24 | 🌐 Go | 📅 2025-01-05 :  递归复制目录。
* [afs](https://github.com/viant/afs) ⭐ 403 | 🐛 7 | 🌐 Go | 📅 2026-09-14 :  适用于 `Go` 的抽象文件存储。
* [vfs](https://github.com/C2FO/vfs) ⭐ 371 | 🐛 9 | 🌐 Go | 📅 2026-09-22 :  适用于 `Go` 的多个文件系统类型,如 `os、S3 `和 `GCS`的可插拔、可扩展的文件系统功能库。
* [go-exiftool](https://github.com/barasher/go-exiftool) ⭐ 299 | 🐛 11 | 🌐 Go | 📅 2025-08-03 :  为`ExifTool`提供绑定服务,`ExifTool`是一个著名的库,用于从文件（图片、PDF、office...）中提取尽可能多的元数据
...
* [skywalker](https://github.com/dixonwille/skywalker) ⭐ 101 | 🐛 1 | 🌐 Go | 📅 2021-08-31 :  允许你简单方便的并发浏览文件系统
* [opc](https://github.com/qmuntal/opc) ⭐ 80 | 🐛 1 | 🌐 Go | 📅 2023-12-01 :   为`Go`加载`Open Packaging Conventions (OPC)`文件
* [baraka](https://github.com/xis/baraka) ⭐ 65 | 🐛 4 | 🌐 Go | 📅 2022-09-30 :   用于轻松处理 `http `文件上传的库。
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 7,484 | 🐛 156 | 🌐 Go | 📅 2026-08-19 :  支持任意精度的十进制数的go包
* [go-money](https://github.com/rhymond/go-money) ⭐ 1,912 | 🐛 29 | 🌐 Go | 📅 2026-04-29 :   `Fowler's Money`模式的实现。
* [accounting](https://github.com/leekchan/accounting) ⭐ 909 | 🐛 14 | 🌐 Go | 📅 2022-07-28 :  `Go`语言金钱及货币格式
* [techan](https://github.com/sdcoffey/techan) ⭐ 908 | 🐛 17 | 🌐 Go | 📅 2026-09-04 :   具有高级市场分析和交易策略的技术分析库。
* [currency](https://github.com/bojanz/currency) ⭐ 643 | 🐛 3 | 🌐 Go | 📅 2026-09-06 :  处理货币金额,提供货币信息和格式。
* [orderbook](https://github.com/i25959341/orderbook) ⭐ 558 | 🐛 5 | 🌐 Go | 📅 2025-04-04 :  `Golang`中的限价订单簿的匹配引擎。
* [go-finance](https://github.com/alpeb/go-finance) ⭐ 194 | 🐛 1 | 🌐 Go | 📅 2021-12-02 :   用于货币时间价值（年金）、现金流、利率转换、债券和折旧计算的金融函数库。
...
* [vat](https://github.com/dannyvankooten/vat) ⭐ 120 | 🐛 4 | 🌐 Go | 📅 2023-11-07 :   VAT 验证及欧洲增值税率工具
...
* [nosurf](https://github.com/justinas/nosurf) ⭐ 1,752 | 🐛 17 | 🌐 Go | 📅 2025-05-13 :  `CSRF` 防御中间件
* [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,212 | 🐛 38 | 🌐 Go | 📅 2025-04-14 : 为 `Go` 语言 `web` 应用提供 `CSRF` 防御
* [form](https://github.com/go-playground/form) ⭐ 931 | 🐛 14 | 🌐 Go | 📅 2026-09-20 :  解码 `url `中的数据到 `Go` 语言变量中以及将 `Go `语言变量编码进 `url` 。
* [binding](https://github.com/mholt/binding) ⚠️ Archived :  将来自`net/HTTP`请求的表单、`JSON` 数据绑定到结构体
* [conform](https://github.com/leebenson/conform) ⭐ 323 | 🐛 5 | 🌐 Go | 📅 2025-07-15 :  检查用户输入并基于结构标签来清理数据
* [formam](https://github.com/monoculum/formam) ⭐ 191 | 🐛 3 | 🌐 Go | 📅 2022-11-06 :  将表单数据解码到结构体
* [forms](https://github.com/albrow/forms) ⭐ 141 | 🐛 2 | 🌐 Go | 📅 2022-12-16 :  框架无关的表单/JSON数据解析验证库,支持多部分表单及文件
* [qs](https://github.com/sonh/qs) ⭐ 82 | 🐛 0 | 🌐 Go | 📅 2026-06-06 :  用于将结构体编码为 `URL` 查询参数的` Go` 模块
...
* [go-underscore](https://github.com/tobyhede/go-underscore) ⭐ 1,297 | 🐛 4 | 🌐 Go | 📅 2023-02-28 :  `Go`函数式集合工具。
* [fpGo](https://github.com/TeaEntityLab/fpGo) ⭐ 355 | 🐛 0 | 🌐 Go | 📅 2026-09-23 :   `Golang`中的单项式函数式编程功能
...
* [Ebiten](https://github.com/hajimehoshi/ebiten) ⭐ 13,508 | 🐛 293 | 🌐 Go | 📅 2026-09-24 :  `Go` 语言编写的简单的 `2D` 游戏库
...
* [nano](https://github.com/lonng/nano) ⭐ 3,227 | 🐛 32 | 🌐 Go | 📅 2026-02-26 :  基于`golang`的轻量级、设施、高性能的游戏服务器框架。
* [g3n](https://github.com/g3n/engine) ⭐ 3,117 | 🐛 38 | 🌐 Go | 📅 2026-08-01 :  `Go 3D`游戏引擎。
* [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,830 | 🐛 69 | 🌐 Go | 📅 2026-09-14 :  可扩展的游戏服务器框架,支持集群,并通过`C SDK`为`iOS、Android、Unity`等提供客户端库。
* [goworld](https://github.com/xiaonanln/goworld) ⭐ 2,718 | 🐛 27 | 🌐 Go | 📅 2025-11-14 :  可扩展的游戏服务器引擎。
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,538 | 🐛 8 | 🌐 C | 📅 2026-08-15 :   raylib的 Go 语言接口,简单、易用的用于学习游戏编程的库
* [go-sdl2](https://github.com/veandco/go-sdl2) ⭐ 2,327 | 🐛 88 | 🌐 C | 📅 2025-02-20 :  [Simple DirectMedia Layer](https://www.libsdl.org/) 的 `Go`封装。
* [engo](https://github.com/EngoEngine/engo) ⭐ 1,822 | 🐛 54 | 🌐 Go | 📅 2026-03-30 :  `EnGo`是一个开源的`2D`游戏引擎,遵循实体-组件-系统范式
* [Oak](https://github.com/oakmound/oak) ⭐ 1,669 | 🐛 14 | 🌐 Go | 📅 2026-08-10 :  `go`游戏引擎。
* [termloop](https://github.com/JoelOtter/termloop) ⭐ 1,473 | 🐛 6 | 🌐 Go | 📅 2024-07-29 :  终端游戏引擎,基于 `Termbox`
...
* [go3d](https://github.com/ungerik/go3d) ⭐ 342 | 🐛 0 | 🌐 Go | 📅 2025-10-20 :  专注性能的 `2D/3D` 数学库
* [tile](https://github.com/kelindar/tile) ⭐ 226 | 🐛 2 | 🌐 Go | 📅 2025-08-17 : 面向数据和缓存友好的 `2D` 网格库 (`TileMap`)。
* [prototype](https://github.com/gonutz/prototype) ⭐ 109 | 🐛 2 | 🌐 C | 📅 2025-08-05 :   跨平台（`Windows/Linux/Mac`）库,可利用最小的API创建桌面游戏。
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) ⭐ 3,780 | 🐛 5 | 🌐 Go | 📅 2026-09-20 :  类似`.NET LINQ`的`Go`查询方法。
* [jennifer](https://github.com/dave/jennifer) ⭐ 3,630 | 🐛 19 | 🌐 Go | 📅 2024-09-08 :   不适用模板生成任意 `Go` 语言代码
* [gen](https://github.com/clipperhouse/gen) ⭐ 1,424 | 🐛 32 | 🌐 Go | 📅 2023-10-31 :  代码生成工具,用于提供类似泛型的功能
* [GoWrap](https://github.com/hexdigest/gowrap) ⭐ 1,339 | 🐛 21 | 🌐 Go | 📅 2026-09-02 :  使用简单的模板为 `Go `接口生成装饰器。
* [goderive](https://github.com/awalterschulze/goderive) ⭐ 1,262 | 🐛 19 | 🌐 Go | 📅 2026-08-24 :  从输入类型导出函数。
* [go-enum](https://github.com/abice/go-enum) ⭐ 961 | 🐛 24 | 🌐 Go | 📅 2026-09-21 :   从代码注释中生成`enums`代码。
* [interfaces](https://github.com/rjeczalik/interfaces) ⭐ 431 | 🐛 15 | 🌐 Go | 📅 2025-06-03 :  命令行工具,用于生成接口定义
* [pkgreflect](https://github.com/ungerik/pkgreflect) ⭐ 103 | 🐛 0 | 🌐 Go | 📅 2017-09-05 :  用于包作用域反射的 `Go `语言预处理器
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,733 | 🐛 163 | 🌐 Go | 📅 2026-09-02 :  具有空间索引和实时地理围栏的地理位置数据库。
* [S2 geometry](https://github.com/golang/geo) ⭐ 1,854 | 🐛 37 | 🌐 Go | 📅 2026-09-21 :  `Go`中的`S2`几何库。
* [llgo](https://github.com/go-llvm/llgo) ⚠️ Archived :  基于 `LLVM` 的` Go` 语言编译器
* [mbtileserver](https://github.com/consbio/mbtileserver) ⭐ 791 | 🐛 22 | 🌐 Go | 📅 2025-05-21 :  简单的基于`Go`的服务器,用于存储`mbtiles`格式的地理信息。
* [osm](https://github.com/paulmach/osm) ⭐ 468 | 🐛 12 | 🌐 Go | 📅 2026-09-09 :   用于读取、写入和处理`OpenStreetMap`数据和API的库。
* [tardisgo](https://github.com/tardisgo/tardisgo) ⭐ 430 | 🐛 5 | 🌐 Go | 📅 2016-11-19 : G`olang`转换为 `Haxe` 进而转换为 `CPP/CSharp/Java/JavaScript `的编译器.
* [c4go](https://github.com/Konstantin8105/c4go) ⭐ 376 | 🐛 27 | 🌐 C | 📅 2024-09-19 :   将`C`代码转换为`go`代码。
* [WGS84](https://github.com/wroge/wgs84) ⭐ 142 | 🐛 1 | 🌐 Go | 📅 2026-09-03 :  坐标转换和变换的库（`ETRS89, OSGB36, NAD83, RGF93, Web Mercator, UTM`）。
* [geocache](https://github.com/melihmucuk/geocache) ⭐ 141 | 🐛 0 | 🌐 Go | 📅 2016-06-21 :  内存缓存,适用于基于地理位置的应用。
* [geoserver](https://github.com/hishamkaram/geoserver) ⭐ 94 | 🐛 1 | 🌐 Go | 📅 2026-09-21 :  用于通过`GeoServer REST API`操纵`GeoServer`实例的Go包。
* [pbf](https://github.com/maguro/pbf) ⭐ 56 | 🐛 2 | 🌐 Go | 📅 2026-09-25 : ` OpenStreetMap PBF golang`编码器/解码器。
* [gismanager](https://github.com/hishamkaram/gismanager) ⭐ 54 | 🐛 3 | 🌐 Go | 📅 2026-07-27 :   将你的GIS数据（矢量数据）发布到`PostGIS`和`Geoserver`的库。
...
* [ants](https://github.com/panjf2000/ants) ⭐ 14,511 | 🐛 0 | 🌐 Go | 📅 2026-09-19 : 高性能和低消耗的`goroutine`池。
* [tunny](https://github.com/Jeffail/tunny) ⭐ 4,027 | 🐛 8 | 🌐 Go | 📅 2023-03-09 :  `Go `语言协程池
* [goworker](https://github.com/benmanns/goworker) ⭐ 2,848 | 🐛 34 | 🌐 Go | 📅 2025-04-15 :  `Goworker `是一个基于 Go 语言的后台worker
* [pond](https://github.com/alitto/pond) ⭐ 2,196 | 🐛 6 | 🌐 Go | 📅 2026-06-22 :   在 `Go` 中编写的最小化和高性能的 `goroutine `工作池。
* [workerpool](https://github.com/gammazero/workerpool) ⭐ 1,458 | 🐛 4 | 🌐 Go | 📅 2026-08-21 :   用于限制任务执行的并发性的`goroutine`缓冲池。
* [grpool](https://github.com/ivpusic/grpool) ⭐ 733 | 🐛 5 | 🌐 Go | 📅 2019-01-27 :  轻量级`Goroutine`池。
* [pool](https://github.com/go-playground/pool) ⭐ 722 | 🐛 4 | 🌐 Go | 📅 2021-06-28 :  便于goroutine处理和取消的有限的消费者`goroutine`池或无限的`goroutine`池,
* [gowp](https://github.com/xxjwxc/gowp) ⭐ 515 | 🐛 3 | 🌐 Go | 📅 2024-09-29 :  - gowp 是限制并发量的`goroutine`池。
* [async](https://github.com/reugn/async) ⭐ 315 | 🐛 0 | 🌐 Go | 📅 2026-01-23 :  `Go `的另一个同步库（`Future, Promise, Locks`）。
...
* [gollback](https://github.com/vardius/gollback) ⭐ 122 | 🐛 1 | 🌐 Go | 📅 2023-02-16 :   异步简单函数工具,用于管理闭包和回调的执行
...
* [semaphore](https://github.com/kamilsk/semaphore) ⭐ 102 | 🐛 6 | 🌐 Go | 📅 2026-07-22 :  基于管道和上下文的加锁/解锁操作。
* [worker-pool](https://github.com/vardius/worker-pool) ⭐ 93 | 🐛 0 | 🌐 Go | 📅 2021-01-17 :  `Go`简单的异步`worker`池。
* [gpool](https://github.com/Sherifabdlnaby/gpool) ⭐ 90 | 🐛 0 | 🌐 Go | 📅 2026-07-11 :   管理一个可调整大小的上下文感知的`goroutine`池,并以这种方式来约束并发量。
...
* [kyoo](https://github.com/dirkaholic/kyoo) ⭐ 50 | 🐛 0 | 🌐 Go | 📅 2026-03-09 :  提供了一个无限的作业队列和并发的工作池。
* [go-waitgroup](https://github.com/pieterclaerhout/go-waitgroup) ⭐ 49 | 🐛 0 | 🌐 Go | 📅 2026-08-25 :  - 类似 `sync.WaitGroup `的错误处理和并发控制。
* [parallel-fn](https://github.com/rafaeljesus/parallel-fn) ⭐ 37 | 🐛 0 | 🌐 Go | 📅 2018-01-01 :  并行执行函数。
* [go-trylock](https://github.com/subchen/go-trylock) ⭐ 36 | 🐛 1 | 🌐 Go | 📅 2021-05-07 :  支持 `Golang` 的读写锁的 `TryLock`.
* [channelify](https://github.com/ddelizia/channelify) ⭐ 34 | 🐛 0 | 🌐 Go | 📅 2026-09-20 :  将你的函数转化为返回管道,以实现简单而强大的并行处理。
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 28,709 | 🐛 740 | 🌐 Go | 📅 2026-09-23 :   基于`Material Design`为`Go`设计的跨平台本地GUI。支持 Linux, macOS, Windows, BSD, iOS\` 和 Android.
* [webview](https://github.com/zserge/webview) ⭐ 14,246 | 🐛 216 | 🌐 C++ | 📅 2026-03-09 :   支持双向`JavaScript`绑定的跨平台 webview 窗口库（`Windows，macOS，Linux`）。
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,820 | 🐛 5 | 🌐 Go | 📅 2026-09-22 :   跨平台`GUI`自动化工具，可以控制鼠标、键盘及其他设备
...
* [app](https://github.com/murlokswarm/app) ⭐ 8,963 | 🐛 53 | 🌐 Go | 📅 2026-08-12 :  使用`Go, HTML` 和 `CSS` 进行应用程序开发的库， 支持` MacOS, Windows`。
* [ui](https://github.com/andlabs/ui) ⭐ 8,361 | 🐛 127 | 🌐 Go | 📅 2022-05-19 :  跨平台的原生 GUI 库
* [walk](https://github.com/lxn/walk) ⭐ 7,106 | 🐛 345 | 🌐 Go | 📅 2024-01-21 :  `windows `应用程序开发工具包
* [go-astilectron](https://github.com/asticode/go-astilectron) ⚠️ Archived :  使用`GO`和`HTML/JS/CSS`（由Electron提供支持）构建跨平台GUI应用程序
* [systray](https://github.com/getlantern/systray) ⭐ 3,732 | 🐛 114 | 🌐 Go | 📅 2024-07-03 :  跨平台的` Go` 语言库,用于在桌面提醒区域放置按钮及菜单
* [go-sciter](https://github.com/sciter-sdk/go-sciter) ⭐ 2,617 | 🐛 98 | 🌐 C++ | 📅 2023-05-13 :   `Sciter` 的` Go` 语言接口，支持现代 GUI 程序开发的、嵌入式 HTML/CSS/脚本引擎。具有跨平台特性。
* [gotk3](https://github.com/gotk3/gotk3) ⭐ 2,214 | 🐛 122 | 🌐 Go | 📅 2025-11-24 : `GTK3`的Go语言接口
* [gosx-notifier](https://github.com/deckarep/gosx-notifier) ⭐ 590 | 🐛 11 | 🌐 Go | 📅 2020-02-27 :   `OSX` 桌面提醒库
* [gowd](https://github.com/dtylman/gowd) ⭐ 435 | 🐛 6 | 🌐 Go | 📅 2023-02-24 :  使用`Go, HTML, CSS `和` NW.js` 语言进行快速、简单的桌面UI开发。具有跨平台特性
...
* 请参考 [go-hardware](https://github.com/rakyll/go-hardware) ⭐ 1,389 | 🐛 3 | 🌐 Go | 📅 2019-07-31

***

## Images 图像处理

* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,504 | 🐛 356 | 🌐 Go | 📅 2026-05-28 : 使用` OpenCV 3.3+` 的计算机视觉的 `Go` 包。
* [imaginary](https://github.com/h2non/imaginary) ⭐ 6,080 | 🐛 135 | 🌐 Go | 📅 2025-11-08 :  快速且简单的 `HTTP `微服务,用于图像缩放
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,762 | 🐛 35 | 🌐 Go | 📅 2023-09-21 :  简单的`Go`图像处理包。
* [gg](https://github.com/fogleman/gg) ⭐ 4,795 | 🐛 97 | 🌐 Go | 📅 2023-12-14 :  使用`Go`编写的 `2D `渲染程序
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,214 | 🐛 19 | 🌐 Go | 📅 2026-09-07 :  汇集了使用 `Go `语言编写的图像处理算法
* [ln](https://github.com/fogleman/ln) ⭐ 3,378 | 🐛 12 | 🌐 Go | 📅 2019-07-19 : ` 3D` 图线艺术渲染
...
* [picfit](https://github.com/thoas/picfit) ⭐ 2,342 | 🐛 12 | 🌐 Go | 📅 2026-09-02 :  一个使用 `Go `语言编写的图片缩放服务器
...
* [smartcrop](https://github.com/muesli/smartcrop) ⭐ 1,856 | 🐛 9 | 🌐 Go | 📅 2023-07-06 :   - 为任意图片进行剪裁的工具
* [canvas](https://github.com/tdewolff/canvas) ⭐ 1,841 | 🐛 26 | 🌐 Go | 📅 2026-09-23 :  将矢量图形转换成 `PDF、SVG `或光栅化图像。
* [gift](https://github.com/disintegration/gift) ⭐ 1,797 | 🐛 9 | 🌐 Go | 📅 2023-09-20 :    图像处理过滤器包
* [go-opencv](https://github.com/lazywei/go-opencv) ⭐ 1,324 | 🐛 43 | 🌐 Go | 📅 2023-03-30 :  `OpenCV` 的 `Go `语言接口
* [geopattern](https://github.com/pravj/geopattern) ⭐ 1,287 | 🐛 3 | 🌐 Go | 📅 2019-01-08 :  从字符串创建优美的图样
...
* [gltf](https://github.com/qmuntal/gltf) ⭐ 287 | 🐛 3 | 🌐 Go | 📅 2026-08-19 :  高效且强大的`glTF 2.0`读取器、写入器和验证器。
* [mergi](https://github.com/noelyahan/mergi) ⭐ 244 | 🐛 2 | 🌐 Go | 📅 2024-11-05 :   用于图像处理的工具和` Go` 库（合并、裁剪、调整大小、水印、动画）。
...
* [cameron](https://github.com/aofei/cameron) ⭐ 132 | 🐛 0 | 🌐 Go | 📅 2026-07-24 :  `Go`的头像生成器。
...
* [mpo](https://github.com/donatj/mpo) ⭐ 27 | 🐛 4 | 🌐 Go | 📅 2026-09-11 :  ` MPO 3D` 照片解码与转换工具.

## 物联网(IOT)

* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,475 | 🐛 100 | 🌐 Go | 📅 2026-01-07 : ` Gobot` 是一个用于机器人,物理计算以及物联网的库
* [flogo](https://github.com/tibcosoftware/flogo) ⭐ 2,490 | 🐛 128 | 🌐 CSS | 📅 2024-04-24 :` FloGo`是一个用于物联网 `Edge App `及集成的开源框架
* [gatt](https://github.com/paypal/gatt) ⭐ 1,166 | 🐛 49 | 🌐 Go | 📅 2022-08-17 :  `Gatt`是一个用于创建低功耗蓝牙外设的库
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 7,169 | 🐛 9 | 🌐 Go | 📅 2026-09-01 : 简单流畅的`Go`作业调度。这是·`jasonlvhit/gocron`·\`的一个积极维护的fork.
...
* [gron](https://github.com/roylee0704/gron) ⭐ 1,033 | 🐛 9 | 🌐 Go | 📅 2023-05-05 :   使用简单的 `Go API` 定义基于时间的任务,`Gron `的调度器将相应地运行它们。
* [jobs](https://github.com/albrow/jobs) ⚠️ Archived :  持久而灵活的后台作业库。
* [scheduler](https://github.com/carlescere/scheduler) ⭐ 467 | 🐛 6 | 🌐 Go | 📅 2022-06-23 : `  Cronjobs`调度系统。
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,560 | 🐛 102 | 🌐 Go | 📅 2026-08-28 :  用一行代码获取`JSON`值。
* [gojson](https://github.com/ChimeraCoder/gojson) ⭐ 2,687 | 🐛 41 | 🌐 Go | 📅 2021-07-30 :  从示例 `JSON `自动生成 `Go`结构体定义的库。
* [kazaam](https://github.com/Qntfy/kazaam) ⭐ 294 | 🐛 23 | 🌐 Go | 📅 2022-06-06 :   转换任意`json`文档的的`API`库。
...
* [logrus](https://github.com/sirupsen/logrus) ⭐ 25,753 | 🐛 47 | 🌐 Go | 📅 2026-08-25 : `Go`的结构化日志记录器。
* [zap](https://github.com/uber-go/zap) ⭐ 24,660 | 🐛 193 | 🌐 Go | 📅 2026-09-16 :  快速的、结构化的、分级的日志库
* [zerolog](https://github.com/rs/zerolog) ⭐ 12,507 | 🐛 150 | 🌐 Go | 📅 2026-09-08 :  零内存分配 的`JSON `日志库.
* [spew](https://github.com/davecgh/go-spew) ⭐ 6,425 | 🐛 70 | 🌐 Go | 📅 2024-04-06 :  - 为 `Go `语言的数据结构实现了一个整洁的打印功能,有助于调试
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,471 | 🐛 101 | 🌐 Go | 📅 2024-08-05 :  简单的循环日志工具。
* [glog](https://github.com/golang/glog) ⭐ 3,598 | 🐛 3 | 🌐 Go | 📅 2025-04-29 :  `Go`的分级日志
* [tail](https://github.com/hpcloud/tail) ⭐ 2,782 | 🐛 79 | 🌐 Go | 📅 2022-10-25 :  这个 `Go `语言软件包力争模拟 `BSD tail `的功能
...
* [phuslu/log](https://github.com/phuslu/log) ⭐ 873 | 🐛 12 | 🌐 Go | 📅 2026-09-24 :  - 结构化日志系统。
* [httpretty](https://github.com/henvic/httpretty) ⭐ 457 | 🐛 3 | 🌐 Go | 📅 2026-08-10 :  将常规的 `HTTP` 请求漂亮地打印在终端上用于调试（类似于 `http.DumpRequest`）。
...
* [logutils](https://github.com/hashicorp/logutils) ⭐ 371 | 🐛 4 | 🌐 Go | 📅 2026-05-11 :  对 `Go `语言标准日志工具进行了扩展,使其更好用
...
* [logur](https://github.com/logur/logur) ⚠️ Archived :  日志记录接口和日志记录最佳实践的整合,它对诸多知名库如[logrus](https://github.com/sirupsen/logrus) ⭐ 25,753 | 🐛 47 | 🌐 Go | 📅 2026-08-25、[go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,424 | 🐛 60 | 🌐 Go | 📅 2024-07-19、[zap](https://github.com/uber-go/zap) ⭐ 24,660 | 🐛 193 | 🌐 Go | 📅 2026-09-16 ， [zerolog](https://github.com/rs/zerolog) ⭐ 12,507 | 🐛 150 | 🌐 Go | 📅 2026-09-08等的功能进行了集成
...
* [ozzo-log](https://github.com/go-ozzo/ozzo-log) ⭐ 123 | 🐛 9 | 🌐 Go | 📅 2026-08-25 :   高性能日志库,支持日志分级、分类及过滤。可以将过滤后的信息发送到不同的目的地(例如： 控制台、网络、邮箱).
* [log-voyage](https://github.com/firstrow/logvoyage) ⭐ 94 | 🐛 10 | 🌐 Go | 📅 2017-05-24 :用`golang`编写的全功能日志库。
...
* [go-log](https://github.com/siddontang/go-log) ⭐ 40 | 🐛 3 | 🌐 Go | 📅 2019-02-21 :  日志库支持级别和多处理程序。
...
* [logrusly](https://github.com/sebest/logrusly) ⭐ 29 | 🐛 3 | 🌐 Go | 📅 2021-07-27 :  [logrus](https://github.com/sirupsen/logrus) ⭐ 25,753 | 🐛 47 | 🌐 Go | 📅 2026-08-25插件,用于将错误发送到[Loggly](https://www.loggly.com/)
...
* [kemba](https://github.com/clok/kemba) ⭐ 18 | 🐛 9 | 🌐 Go | 📅 2026-09-24 :  受[debug](https://github.com/visionmedia/debug) ⭐ 11,456 | 🐛 99 | 🌐 JavaScript | 📅 2026-04-01 启发的小型调试日志工具,非常适合CLI工具和应用程序。
...
* [go-log](https://github.com/pieterclaerhout/go-log) ⭐ 11 | 🐛 0 | 🌐 Go | 📅 2026-08-24 :  一个包含`rack traces`、对象转储和可选时间戳的日志库。
* [logdump](https://github.com/ewwwwwqm/logdump) ⭐ 11 | 🐛 0 | 🌐 Go | 📅 2018-04-02 :  用于多级日志记录的软件包。
* [log](https://github.com/aerogo/log) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2019-10-26 :   `O(1)`复杂度的日志系统,允许你将一个日志连接到多个输出(例如 `stdout`、文件和一个 `TCP` 连接)。
* [xlog](https://github.com/xfxdev/xlog) ⭐ 8 | 🐛 1 | 🌐 Go | 📅 2019-01-15 :  插件架构以及灵活的日志系统,具有日志等级控制,多日志目标以及自定义日志格式功能
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,930 | 🐛 126 | 🌐 Go | 📅 2024-08-12 :  基于图的计算库,类似于 `Theano`。提供了一些原型用于构建各种个样的机器学习和神经网络算法
...
* [goml](https://github.com/cdipaolo/goml) ⭐ 1,615 | 🐛 4 | 🌐 Go | 📅 2022-07-15 :  即时`go`语言机器学习库
...
* [bayesian](https://github.com/jbrukh/bayesian) ⭐ 815 | 🐛 0 | 🌐 Go | 📅 2025-12-07 :  贝叶斯分类器
* [ocrserver](https://github.com/otiai10/ocrserver) ⭐ 770 | 🐛 4 | 🌐 Go | 📅 2021-08-05 :   简单的`OCR API`服务器,很容易被`Docker`和`Heroku`部署。
* [CloudForest](https://github.com/ryanbressler/CloudForest) ⭐ 748 | 🐛 34 | 🌐 Go | 📅 2022-02-05 :  纯 `Go `语言编写的快速、灵活、多线程决策树
* [gobrain](https://github.com/goml/gobrain) ⭐ 569 | 🐛 1 | 🌐 Go | 📅 2020-12-12 :  用`go`语言编写的神经网络。
* [go-deep](https://github.com/patrikeh/go-deep) ⭐ 555 | 🐛 2 | 🌐 Go | 📅 2024-07-11 :  用`Go`编写的功能丰富的神经网络库。
* [regommend](https://github.com/muesli/regommend) ⭐ 312 | 🐛 0 | 🌐 Go | 📅 2019-08-07 :   推荐系统及协同过滤引擎
* [Goptuna](https://github.com/c-bata/goptuna) ⭐ 280 | 🐛 19 | 🌐 Go | 📅 2025-08-12 :  用`Go`编写的黑盒函数的贝叶斯优化框架。一切都将被优化。
* [goga](https://github.com/tomcraven/goga) ⭐ 224 | 🐛 2 | 🌐 Go | 📅 2022-04-13 :  `Go` 语言遗传算法库
...
* [go-fann](https://github.com/white-pony/go-fann) ⭐ 120 | 🐛 2 | 🌐 Go | 📅 2015-02-03 :   快速人工神经网络库`(FANN)`的 `Go` 语言借口.
...
* [libsvm](https://github.com/datastream/libsvm) ⭐ 73 | 🐛 1 | 🌐 Go | 📅 2016-05-09 :  `libsvm`的` Go` 语言版本,基于 `LIBSVM 3.14.`
...
* [godist](https://github.com/e-dard/godist) ⭐ 44 | 🐛 0 | 🌐 Go | 📅 2015-05-11 :   各种概率分布以及相关方法库。
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 13,734 | 🐛 292 | 🌐 Go | 📅 2026-06-22 :   建立在 `Redis` 之上，为 `Go` 提供的简单、可靠、高效的分布式任务队列,。
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,518 | 🐛 49 | 🌐 Go | 📅 2026-09-24 :  用于 `Apache Kafka `的库
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10,794 | 🐛 23 | 🌐 Go | 📅 2026-09-24 :  实时消息服务器
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,779 | 🐛 68 | 🌐 Go | 📅 2026-07-25  通知推送服务器,使用 [APNs2](https://github.com/sideshow/apns2) ⭐ 3,189 | 🐛 32 | 🌐 Go | 📅 2025-07-22 和 [GCM](https://github.com/google/go-gcm) ⚠️ Archived 。
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,767 | 🐛 337 | 🌐 Go | 📅 2026-09-24 : 在一系列协议之间建立消息流`go`代码库
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,972 | 🐛 248 | 🌐 Go | 📅 2025-11-15 :  异步任务队列,基于分布式消息处理
* [NATS Go Client](https://github.com/nats-io/nats) ⭐ 6,758 | 🐛 168 | 🌐 Go | 📅 2026-09-24 :   原生的 `oplog/replication `系统,用于 `REST APIs`场景
* [go-socket.io](https://github.com/googollee/go-socket.io) ⚠️ ArchivedGo 语言的 `socket.io`库 ,一个实时应用框架.
* [Mercure](https://github.com/dunglas/mercure) ⭐ 5,331 | 🐛 23 | 🌐 Go | 📅 2026-09-24 :   使用`Mercure`协议（建立在`Server-Sent Events`之上）来调度服务器发送的更新的代码库。
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 5,168 | 🐛 276 | 🌐 Go | 📅 2026-09-24   是`Confluent`为`Apache Kafka`和`Confluent Platform`开发的`Golang`客户端。
* [melody](https://github.com/olahol/melody) ⭐ 4,083 | 🐛 14 | 🌐 Go | 📅 2025-10-28 :  用于处理`websocket`会话的简约框架,包括广播和自动`ping/pong`处理。
* [APNs2](https://github.com/sideshow/apns2) ⭐ 3,189 | 🐛 32 | 🌐 Go | 📅 2025-07-22 :   `go`语言实现的基于`HTTP/2`苹果推送通知提供服务，可以向`iOS`、`tvOS`、`Safari`和`OSX`应用程序发送推送通知
* [go-nsq](https://github.com/nsqio/go-nsq) ⭐ 2,658 | 🐛 28 | 🌐 Go | 📅 2025-07-23 :   `NSQ `官方 `Go` 语言库
* [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster) ⭐ 2,069 | 🐛 5 | 🌐 Go | 📅 2017-06-07 :  Gopush-cluster 是一个`Go`语言实现的支持集群的`comet`服务（支持` websocket`和`tcp`协议）
* [EventBus](https://github.com/asaskevich/EventBus) ⭐ 1,985 | 🐛 29 | 🌐 Go | 📅 2024-06-19 :   轻量级事件库,支持异步
* [Beaver](https://github.com/Clivern/Beaver) ⭐ 1,583 | 🐛 17 | 🌐 Go | 📅 2026-09-02 :  实时消息服务器,用于在网络和移动应用中构建可扩展的应用内通知、多人游戏、聊天应用。
* [Uniqush-Push](https://github.com/uniqush/uniqush-push) ⭐ 1,561 | 🐛 6 | 🌐 Go | 📅 2026-09-23 :  基于 `Redis` 的统一推服务,用于服务器端向移动客户端推送消息
* [mangos](https://github.com/go-mangos/mangos) ⚠️ Archived :   纯 `Go `语言实现的 `Nanomsg ("Scalable Protocols")`
* [zmq4](https://github.com/pebbe/zmq4) ⭐ 1,264 | 🐛 58 | 🌐 Go | 📅 2025-07-06 :  `ZeroMQ version 4`的 `GO `语言接口。也有适用于[version 3](https://github.com/pebbe/zmq3) ⭐ 132 | 🐛 1 | 🌐 Go | 📅 2025-05-11 及 [version 2](https://github.com/pebbe/zmq2) ⭐ 19 | 🐛 1 | 🌐 Go | 📅 2025-05-11 的
* [dbus](https://github.com/godbus/dbus) ⭐ 1,198 | 🐛 54 | 🌐 Go | 📅 2026-09-24 : ` D-Bus`的 `Go` 语言接口
...
* [rabtap](https://github.com/jandelgado/rabtap) ⭐ 289 | 🐛 5 | 🌐 Go | 📅 2026-09-18 :  -` RabbitMQ` 瑞士军刀 `cli `应用。
* [messagebus](https://github.com/vardius/message-bus) ⭐ 284 | 🐛 3 | 🌐 JavaScript | 📅 2021-01-14 :  ` messagebus`是一个Go简单的异步消息系统,用于事件源、`CQRS、DDD`等场景
...
* [hub](https://github.com/leandro-lugaresi/hub) ⭐ 149 | 🐛 0 | 🌐 Go | 📅 2026-07-17 :   用于 `Go` 应用程序的消息/事件汇聚,使用发布/订阅模式,支持像 `rabbitMQ` 的使用模式。
* [redisqueue](https://github.com/robinjoseph08/redisqueue) ⭐ 138 | 🐛 7 | 🌐 Go | 📅 2024-03-08 :   `redisqueue` 提供了一个使用 `Redis `流的队列，可以用于生产者和消费者模式。
* [oplog](https://github.com/dailymotion/oplog) ⭐ 111 | 🐛 3 | 🌐 Go | 📅 2024-09-27 : 用于 `REST API`场景的通用oplog/copy系统。
...
* [nsq-event-bus](https://github.com/rafaeljesus/nsq-event-bus) ⭐ 80 | 🐛 2 | 🌐 Go | 📅 2018-02-15 :  针对 `NSQ 的topic`和`channel`进行了简单的封装
...
* [event](https://github.com/agoalofalife/event) ⭐ 61 | 🐛 0 | 🌐 Go | 📅 2018-02-19 :  观察者模式的`go`语言实现
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,937 | 🐛 7 | 🌐 Go | 📅 2026-09-21 :  用于创建和处理`Office Word (.docx)、Excel (.xlsx)`和`Powerpoint (.pptx)`文档的纯`go`库。

### EXCEL

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) ⭐ 20,938 | 🐛 148 | 🌐 Go | 📅 2026-09-23 :  用于读写 `Microsoft Excel™ (XLSX)` 文件的 `Golang `库
...
* [fx](https://github.com/uber-go/fx) ⭐ 7,689 | 🐛 80 | 🌐 Go | 📅 2025-12-27 :  基于 `Go `的依赖注入应用框架（建立在 `dig` 的基础上）。
* [dig](https://github.com/uber-go/dig) ⭐ 4,502 | 🐛 35 | 🌐 Go | 📅 2025-05-13 :  基于反射的`Go`依赖注入工具包。
...
* [dingo](https://github.com/i-love-flamingo/dingo) ⭐ 189 | 🐛 15 | 🌐 Go | 📅 2026-09-24 :  基于 `Guice` 的 `Go` 依赖注入工具包。
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 56,628 | 🐛 94 | 🌐 Makefile | 📅 2026-04-28 :  -` Go` 生态系统中常见的历史和新兴项目布局模式集。
...
* [xstrings](https://github.com/huandu/xstrings) ⭐ 1,413 | 🐛 0 | 🌐 Go | 📅 2026-09-20 :  从其他语言移植过来的字符串函数集合。
* [gobeam/Stringy](https://github.com/gobeam/Stringy) ⭐ 249 | 🐛 1 | 🌐 Go | 📅 2025-05-19 :  字符串操作库,用于将字符串转换为驼峰、小驼峰等格式
* [strutil](https://github.com/ozgio/strutil) ⭐ 206 | 🐛 2 | 🌐 Go | 📅 2025-05-21 :   字符串实用工具。
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 12,152 | 🐛 391 | 🌐 Go | 📅 2026-09-24 :  自动化的服务健康仪表板。
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,927 | 🐛 212 | 🌐 Go | 📅 2026-09-22 :  跨平台库,用于检索进程和系统利用率（`CPU`、内存、磁盘等）。
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 5,390 | 🐛 7 | 🌐 Go | 📅 2026-09-19 :   用`go`编写的随机数据生成器。
...
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 2,152 | 🐛 10 | 🌐 Go | 📅 2026-09-13 :  快速将整个` org/users` 仓库克隆到一个目录中 - 支持` GitHub、GitLab` 和 `Bitbucket`。
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,678 | 🐛 81 | 🌐 Go | 📅 2026-07-01 :  提供轻松访问各种消息服务的通知库,如`slack, mattermost, gotify`和`smtp`等。
* [gosms](https://github.com/haxpax/gosms) ⭐ 1,467 | 🐛 5 | 🌐 Go | 📅 2021-02-05 :  你本地的`SMS `网关,可以用来发送 `SMS`
* [stateless](https://github.com/qmuntal/stateless) ⭐ 1,382 | 🐛 23 | 🌐 Go | 📅 2026-02-10 :  用于创建状态机的库
* [llvm](https://github.com/llir/llvm) ⭐ 1,278 | 🐛 18 | 🌐 Go | 📅 2024-12-06 :  - 用于在纯`Go`中与`LLVM IR`交互的库。
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) ⭐ 1,240 | 🐛 4 | 🌐 Go | 📅 2023-05-30 : `Golang` 的通用对象池。
* [shortid](https://github.com/teris-io/shortid) ⭐ 958 | 🐛 4 | 🌐 Go | 📅 2022-06-17 :  分布式生成超短的、唯一的、非序列的、URL友好的ID。
* [banner](https://github.com/dimiro1/banner) ⭐ 463 | 🐛 0 | 🌐 Go | 📅 2021-01-04 :   在你的`Go`应用程序中添加漂亮的横幅。
* [health](https://github.com/dimiro1/health) ⭐ 449 | 🐛 9 | 🌐 Go | 📅 2023-11-18 :  简单易用、可扩展的服务健康检查库
* [gountries](https://github.com/pariz/gountries) ⭐ 435 | 🐛 22 | 🌐 Go | 📅 2026-04-27 :  一个用来展示国家及其行政区划数据的库
* [lk](https://github.com/hyperboloide/lk) ⭐ 423 | 🐛 0 | 🌐 Go | 📅 2025-12-20 :  简单的 \`golang 授权库。
* [conv](https://github.com/cstockton/go-conv) ⭐ 380 | 🐛 1 | 🌐 Go | 📅 2021-08-23 :  包`conv`提供了跨`Go`类型的快速和直观的转换。
* [ffmt](https://github.com/go-ffmt/ffmt) ⭐ 317 | 🐛 2 | 🌐 Go | 📅 2021-11-19 : 美化数据显示。
* [go-unarr](https://github.com/gen2brain/go-unarr) ⭐ 308 | 🐛 3 | 🌐 Go | 📅 2024-10-22 :  `RAR、TAR、ZIP` 和`7z`文件的解压库。
* [battery](https://github.com/distatus/battery) ⭐ 275 | 🐛 7 | 🌐 Go | 📅 2023-09-27 :  跨平台电源信息库
* [healthcheck](https://github.com/etherlabsio/healthcheck) ⭐ 274 | 🐛 4 | 🌐 Go | 📅 2023-12-13 :  针对`RESTful`并发服务健康检查`HTTP`处理程序。
* [antch](https://github.com/antchfx/antch) ⭐ 265 | 🐛 5 | 🌐 Go | 📅 2020-05-31 :  一个快速、强大、可扩展的网络爬行和抓取框架。
...
* [turtle](https://github.com/hackebrot/turtle) ⭐ 165 | 🐛 3 | 🌐 Go | 📅 2021-10-04 :  `Go`的`Emojis`。
* [captcha](https://github.com/steambap/captcha) ⭐ 163 | 🐛 0 | 🌐 Go | 📅 2025-08-20 :  包 `captcha` 为验证码的生成提供了一个简单易用的 API。
* [gommit](https://github.com/antham/gommit) ⭐ 117 | 🐛 0 | 🌐 Go | 📅 2026-09-17 :  分析`git`提交消息,确保它们遵循定义的模式。
...
* [faker](https://github.com/pioz/faker) ⭐ 102 | 🐛 0 | 🌐 Go | 📅 2023-10-06 :  Go的随机伪造数据和结构生成器。
* [persian](https://github.com/mavihq/persian) ⭐ 95 | 🐛 2 | 🌐 Go | 📅 2024-01-28 :  用`go`编写的波斯语实用程序。
* [morse](https://github.com/alwindoss/morse) ⭐ 88 | 🐛 5 | 🌐 Go | 📅 2022-08-30 :   用于转换摩尔斯代码的库。
...
* [shellwords](https://github.com/Wing924/shellwords) ⭐ 27 | 🐛 0 | 🌐 Go | 📅 2023-04-20 :  Golang 库,用于根据`UNIX Bourne shell`的单词解析规则来处理字符串。
...
* [VarHandler](https://github.com/azr/generators/tree/master/varhandler) ⭐ 8 | 🐛 0 | 🌐 Go | 📅 2016-12-30 :  生成模板化的`http`输入和输出。
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,546 | 🐛 18 | 🌐 Go | 📅 2026-09-19 :  ,用于处理本地化文本 的软件包及相关工具
* [prose](https://github.com/jdkato/prose) ⭐ 3,091 | 🐛 20 | 🌐 Go | 📅 2026-07-29 :  文本处理库,支持词语切分、词性标记、命名实体提取等功能
* [gse](https://github.com/go-ego/gse) ⭐ 2,846 | 🐛 15 | 🌐 Go | 📅 2026-09-12 :   ` Go`高效的文本分割；支持英语、中文、日语和其他语言。
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,646 | 🐛 0 | 🌐 Go | 📅 2026-07-20 : 结巴分词的 `Go `语言实现的 [jieba](https://github.com/fxsjy/jieba) ⭐ 35,169 | 🐛 700 | 🌐 Python | 📅 2024-08-21 ,结巴分词是一个用于中文的分词算法
* [go-pinyin](https://github.com/mozillazg/go-pinyin) ⭐ 1,794 | 🐛 21 | 🌐 Go | 📅 2026-03-08 :   汉字到汉语拼音转换器。
* [when](https://github.com/olebedev/when) ⭐ 1,461 | 🐛 17 | 🌐 Go | 📅 2026-08-10 :  英语、俄语的自然语言日期、时间表达解析器。
* [kagome](https://github.com/ikawaha/kagome) ⭐ 983 | 🐛 0 | 🌐 Go | 📅 2026-09-19 :   用纯`Go`编写的`JP`形态分析器。
...
* [sentences](https://github.com/neurosnap/sentences) ⭐ 474 | 🐛 5 | 🌐 Go | 📅 2024-02-28 :  语句标记器：将文字段落转换为语句列表
* [nlp](https://github.com/Shixzie/nlp) ⚠️ Archived :  从字符串中提取值,并用nlp填充结构。
* [getlang](https://github.com/rylans/getlang) ⭐ 176 | 🐛 4 | 🌐 Go | 📅 2020-12-27 :   快速自然语言检测包。
* [go-unidecode](https://github.com/mozillazg/go-unidecode) ⭐ 146 | 🐛 4 | 🌐 Go | 📅 2023-05-14 :  `Unicode` 文本音译为` ASCII` 文本
...
* [segment](https://github.com/blevesearch/segment) ⭐ 90 | 🐛 6 | 🌐 Go | 📅 2026-07-29 :  用于进行 `Unicode` 文本分割的库,实现了[Unicode Standard Annex #29](http://www.unicode.org/reports/tr29/) 中描述的功能
...
* [go-localize](https://github.com/m1/go-localize) ⭐ 63 | 🐛 3 | 🌐 Go | 📅 2023-11-11 :  简单易用的`i18n`（国际化和本地化）引擎 - 用于翻译本地化字符串。
...
* [govader](https://github.com/jonreiter/govader) ⭐ 55 | 🐛 1 | 🌐 Go | 📅 2025-04-29 : [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 5,078 | 🐛 56 | 🌐 Python | 📅 2026-03-02 情感分析的`Go`实现
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,476 | 🐛 105 | 🌐 Go | 📅 2026-09-22 : `asthttp` 是一个快速的`HTTP`实现,比`net/http1`的性能快10倍
* [webrtc](https://github.com/pions/webrtc) ⭐ 16,799 | 🐛 121 | 🌐 Go | 📅 2026-09-24 :` WebRTC API`的纯`Go`实现。
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11,779 | 🐛 213 | 🌐 Go | 📅 2026-09-22 :   纯`Go`中`QUIC`协议的实现。
* [gnet](https://github.com/panjf2000/gnet) ⭐ 11,249 | 🐛 2 | 🌐 Go | 📅 2026-07-09 : `gnet`是用纯Go编写 的一个高性能、轻量级、非阻塞、事件驱动的网络框架,
* [dns](https://github.com/miekg/dns) ⭐ 8,773 | 🐛 1 | 🌐 Go | 📅 2026-09-01 :   用于处理` DNS` 的` Go` 语言库
* [gopacket](https://github.com/google/gopacket) ⭐ 6,794 | 🐛 370 | 🌐 Go | 📅 2025-03-19 : 用于报文处理的库
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,556 | 🐛 71 | 🌐 Go | 📅 2026-05-15 :` KCP` - 快速可靠的`ARQ`协议。
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 4,178 | 🐛 64 | 🌐 Go | 📅 2025-01-27 :  用于创建 SSH 服务器的高级` API`(封装了`crypto/ssh`).
* [HTTPLab](https://github.com/gchaincl/httplab) ⭐ 4,142 | 🐛 13 | 🌐 Go | 📅 2024-02-05 : `HTTPLabs`让你检查` HTTP`请求和伪造响应。
* [gobgp](https://github.com/osrg/gobgp) ⭐ 4,110 | 🐛 227 | 🌐 Go | 📅 2026-09-24 :  `Go`语言实现的BGP
* [fortio](https://github.com/fortio/fortio) ⭐ 3,727 | 🐛 89 | 🌐 Go | 📅 2026-09-21 :  负载测试库和命令行工具,提供先进的`echo`服务器和web用户界面。允许指定设定每秒钟查询的负载,记录延迟直方图和其他有用的统计数据,并将其绘制成图表。
* [water](https://github.com/songgao/water) ⭐ 2,167 | 🐛 30 | 🌐 Go | 📅 2024-07-30 :  一个简单的`TUN/TAP`库。
* [go-getter](https://github.com/hashicorp/go-getter) ⭐ 1,826 | 🐛 170 | 🌐 Go | 📅 2026-09-22 :   一个用于通过 URL 从多种源下载文件或目录的 Go 语言库
* [gev](https://github.com/Allenxuxu/gev) ⭐ 1,774 | 🐛 14 | 🌐 Go | 📅 2025-06-07 :  一个轻量、比标准库更快的基于` Reactor` 模式的非阻塞`TCP`网络库,支持自定义协议,可以轻松快速搭建高性能服务器。
* [sftp](https://github.com/pkg/sftp) ⭐ 1,663 | 🐛 62 | 🌐 Go | 📅 2026-07-22 : `sftp` 实现了<https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt> 中描述的 SSH 文件传输协议
* [grab](https://github.com/cavaliercoder/grab) ⭐ 1,486 | 🐛 29 | 🌐 Go | 📅 2026-08-23 :  管理文件下载的`Go` 语言库
* [NFF-Go](https://github.com/intel-go/nff-go) ⭐ 1,418 | 🐛 65 | 🌐 Go | 📅 2022-11-22 :   用于快速开发云和裸机（原`YANFF`）的高性能网络功能的框架。
* [ftp](https://github.com/jlaffaye/ftp) ⭐ 1,404 | 🐛 28 | 🌐 Go | 📅 2026-08-22 :` ftp` 实现了一个`FTP` 客户端,遵循 [RFC 959](http://tools.ietf.org/html/rfc959) 标准
* [mdns](https://github.com/hashicorp/mdns) ⭐ 1,372 | 🐛 37 | 🌐 Go | 📅 2026-09-14 :   简单的` mDNS` (组播 DNS)客户端/服务器库
...
* [gaio](https://github.com/xtaci/gaio) ⭐ 920 | 🐛 16 | 🌐 Go | 📅 2026-02-19 :  在`proactor`模式下为`Golang`提供高性能的异步io网络。
...
* [winrm](https://github.com/masterzen/winrm) ⭐ 479 | 🐛 53 | 🌐 Go | 📅 2026-04-07 :  用于在` Windows` 机器上远程执行命令的`Go WinRM`客户端。
...
* [arp](https://github.com/mdlayher/arp) ⭐ 391 | 🐛 7 | 🌐 Go | 📅 2026-09-23 :  遵循 RFC 826标准实现了` ARP`协议。
* [ethernet](https://github.com/mdlayher/ethernet) ⭐ 288 | 🐛 0 | 🌐 Go | 📅 2022-02-21 :  `ethernet`实现`了IEEE 802.3 Ethernet II`帧以及`IEEE 802.1Q VLAN`标签的组装和剥离.
* [gNxI](https://github.com/google/gnxi) ⭐ 287 | 🐛 28 | 🌐 Python | 📅 2026-08-25 :  使用`gNMI`和`gNOI`协议的网络管理工具集合。
...
* [utp](https://github.com/anacrolix/utp) ⭐ 183 | 🐛 5 | 🌐 Go | 📅 2026-09-08 :  `Go uTP`微传输协议的实现
...
* [go-powerdns](https://github.com/joeig/go-powerdns) ⭐ 105 | 🐛 0 | 🌐 Go | 📅 2026-07-31 :  Golang的`PowerDNS API`绑定。
...
* [httpproxy](https://github.com/wzshiming/httpproxy) ⭐ 33 | 🐛 0 | 🌐 Go | 📅 2026-09-16 : ` HTTP`代理处理程序和拨号器。
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,809 | 🐛 22 | 🌐 Go | 📅 2026-09-21 :  受`Ruby rest-client` 的启发,为`Go` 设计的简单` HTTP`和`REST`客户端。
* [heimdall](https://github.com/gojektech/heimdall) ⭐ 2,778 | 🐛 23 | 🌐 Go | 📅 2026-07-01 :  具有重试和`hystrix`功能的`http`客户端。
...
* [gentleman](https://github.com/h2non/gentleman) ⭐ 1,134 | 🐛 31 | 🌐 Go | 📅 2023-12-17 :  -插件驱动的`HTTP`客户端库。
...
* [glfw](https://github.com/go-gl/glfw) ⭐ 1,691 | 🐛 24 | 🌐 C | 📅 2026-08-23 : `GLFW 3`的`Go`语言接口
* [gl](https://github.com/go-gl/gl) ⭐ 1,206 | 🐛 21 | 🌐 C | 📅 2026-03-31 : `OpenGL`的`Go`语言接口
* [mathgl](https://github.com/go-gl/mathgl) ⭐ 609 | 🐛 9 | 🌐 Go | 📅 2024-11-03 : `Go`语言` 3D`数学库,专注于`3D`,受到`GLM` 启发
* [goxjs/gl](https://github.com/goxjs/gl) ⭐ 174 | 🐛 8 | 🌐 Go | 📅 2023-07-05 : `Go`语言跨平台`OpenGL` 接口(`OS X, Linux, Windows, browsers, iOS, Android`).
* [goxjs/glfw](https://github.com/goxjs/glfw) ⭐ 84 | 🐛 6 | 🌐 Go | 📅 2023-07-04 :` Go` 语言跨平台` glfw`库,用于创建` OpenGL`上下文并接收事件
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 39,966 | 🐛 537 | 🌐 Go | 📅 2026-09-14 :  超棒的` Go` 语言` ORM` 库,对开发者非常友好
* [ent](https://github.com/facebook/ent) ⭐ 17,204 | 🐛 626 | 🌐 Go | 📅 2026-09-04 :  简单而强大的用于数据建模和查询的ORM。
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,992 | 🐛 111 | 🌐 Go | 📅 2026-07-12 :`ORM` 生成器。为你的数据库表单生成一个功能全面、快速的` ORM`
* [go-pg](https://github.com/go-pg/pg) ⭐ 5,783 | 🐛 124 | 🌐 Go | 📅 2026-07-10 :   专注于`PostgreSQL`功能和性能的`ORM`。
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,732 | 🐛 3 | 🌐 Go | 📅 2026-08-21 :  灵活而强大的`SQL`字符串构建库,加上一个零配置的`ORM`。
* [pop/soda](https://github.com/gobuffalo/pop) ⭐ 1,526 | 🐛 93 | 🌐 Go | 📅 2026-09-16 :  支持` MySQL, PostgreSQL`, 以及`SQLite`.的数据库迁移、创建、`ORM` 的工具,
* [reform](https://github.com/go-reform/reform) ⭐ 1,456 | 🐛 88 | 🌐 Go | 📅 2025-12-15 :  基于非空接口和代码生成的优秀的` ORM`,
* [rel](https://github.com/go-rel/rel) ⭐ 787 | 🐛 34 | 🌐 Go | 📅 2026-09-07 :` Golang`的现代数据库访问层 - 可测试、可扩展,并支持生成简洁优雅的`API`。
* [beego orm](https://github.com/astaxie/beego/tree/master/orm) ⭐ 741 | 🐛 0 | 📅 2022-04-27 :  强大的`Go` 语言` orm` 框架,支持`pq/mysql/sqlite3`.
* [go-queryset](https://github.com/jirfag/go-queryset) ⭐ 729 | 🐛 20 | 🌐 Go | 📅 2023-02-24 :   100%类型安全的`ORM`,能够基于`GORM`进行代码生成和支持`MySQL、PostgreSQL、Sqlite3、SQL Server`等数据库
* [QBS](https://github.com/coocood/qbs) ⭐ 541 | 🐛 10 | 🌐 Go | 📅 2017-04-18 :  利用结构体进行标准查询,是一个` Go`语言`ORM`
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,237 | 🐛 536 | 🌐 Go | 📅 2026-09-24 :  分布式跟踪系统。
* [dep](https://github.com/golang/dep) ⚠️ Archived :  Go 语言依赖工具.
* [glide](https://github.com/Masterminds/glide) ⭐ 8,083 | 🐛 400 | 🌐 Go | 📅 2024-07-22 :  轻松管理你的`GO` 语言包发布者以及发布包。 受到类似` Maven, Bundler` 和`Pip`这些工具的的启发
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,539 | 🐛 396 | 🌐 C++ | 📅 2026-09-24 :  通过` eBPF` 对` Golang`应用程序进行无工具追踪。
...
* [statsviz](https://github.com/arl/statsviz) ⭐ 3,647 | 🐛 10 | 🌐 Go | 📅 2026-09-17 :  实时可视化你的`Go`应用程序运行时的统计数据。
* [gopm](https://github.com/gpmgo/gopm) ⚠️ Archived :  ` Go` 包管理器
* [profile](https://github.com/pkg/profile) ⭐ 2,058 | 🐛 13 | 🌐 Go | 📅 2022-10-20 :  `Go` 的简单剖析支持包。
* [gom](https://github.com/mattn/gom) ⚠️ Archived : ` Go Manager`
* [gpm](https://github.com/pote/gpm) ⭐ 1,173 | 🐛 11 | 🌐 Shell | 📅 2017-09-28 : ` Go`语言包管理工具
* [goop](https://github.com/nitrous-io/goop) ⭐ 769 | 🐛 28 | 🌐 Go | 📅 2015-12-02 :   简单的依赖管理工具,受到`Bundler`的启发
...
* [VenGO](https://github.com/DamnWidget/VenGO) ⭐ 124 | 🐛 3 | 🌐 Go | 📅 2016-07-14 :  创建和管理可导出的隔离的Go虚拟环境。
  绩效
* [tracer](https://github.com/kamilsk/tracer) ⭐ 89 | 🐛 11 | 🌐 Go | 📅 2026-07-22 :   简单、轻量级的代码追踪库。
...
* [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,145 | 🐛 246 | 🌐 Go | 📅 2026-06-23 : 为`Go`语言实现的`GraphQL`
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,043 | 🐛 25 | 🌐 Go | 📅 2026-08-16 :   基于命令行的选择器查询和更新数据结构。类似于`jq/yq`,但支持`JSON、YAML、TOML`和`XML`。
* [graphql](https://github.com/neelance/graphql-go) ⭐ 4,759 | 🐛 9 | 🌐 Go | 📅 2026-09-22 :  专注于易用性的`GraphQL` 服务器
* [gojsonq](https://github.com/thedevsaddam/gojsonq) ⭐ 2,222 | 🐛 26 | 🌐 Go | 📅 2022-11-28 : 用于查询`JSON`数据的`Go`包
...
* [jsonslice](https://github.com/bhmj/jsonslice) ⭐ 91 | 🐛 3 | 🌐 Go | 📅 2024-10-25 :  具有高级过滤器的`Json`路径查询。
* [rqp](https://github.com/timsolov/rest-query-parser) ⭐ 91 | 🐛 3 | 🌐 Go | 📅 2023-12-04 : ` REST API`的查询分析器。在查询中直接支持过滤、验证、AND、OR操作。
...
* [statik](https://github.com/rakyll/statik) ⭐ 3,828 | 🐛 39 | 🌐 Go | 📅 2026-01-10 :  将静态文件嵌入到`Go` 语言可执行文件中
* [packr](https://github.com/gobuffalo/packr) ⚠️ Archived : 将静态文件嵌入`Go`二进制文件的简单方法。
* [go.rice](https://github.com/GeertJohan/go.rice) ⭐ 2,437 | 🐛 38 | 🌐 Go | 📅 2022-11-16 :` Go.rice`是一个让你轻松使用`html,js,css,`图片以及模板这类资源的库
* [vfsgen](https://github.com/shurcooL/vfsgen) ⭐ 982 | 🐛 31 | 🌐 Go | 📅 2023-11-26 : 生成一个`vfsdata.Go`文件,静态实现了一个虚拟文件系统
...
* [statics](https://github.com/go-playground/statics) ⭐ 67 | 🐛 0 | 🌐 Go | 📅 2016-10-05 :   将静态资源嵌入到`Go` 文件中,用于单独二进制编译+使用`http.FileSystem + symlinks`.
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,434 | 🐛 257 | 🌐 Go | 📅 2026-08-30 :  用于` Go` 编程语言的数值库。它包含了矩阵、统计、优化等方面的库。
* [stats](https://github.com/montanaflynn/stats) ⭐ 3,026 | 🐛 1 | 🌐 Go | 📅 2026-09-19 :  统计库,包含一些` Go` 语言标准库中漏掉的常用函数
* [gonum/plot](https://github.com/gonum/plot) ⭐ 2,968 | 🐛 91 | 🌐 Go | 📅 2026-04-22 : `Gonum/plot`提供了用于创建和绘制图表的`API`
* [gosl](https://github.com/cpmech/gosl) ⭐ 1,881 | 🐛 0 | 🌐 Go | 📅 2025-12-30 :  用于线性代数、FFT、几何学、`NURBS`、数值方法、概率、优化、微分方程等的` Go` 科学库。
* [streamtools](https://github.com/nytlabs/streamtools) ⭐ 1,312 | 🐛 48 | 🌐 Go | 📅 2023-10-19 : 通用图形化工具,用于处理流数据
* [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) ⭐ 1,291 | 🐛 18 | 🌐 Go | 📅 2022-04-02 :  用于机器学习和统计的数据框类似于`pandas`
* [orb](https://github.com/paulmach/orb) ⭐ 1,132 | 🐛 20 | 🌐 Go | 📅 2026-03-30 :  支持剪裁、`GeoJSON` 和` Mapbox Vector Tile`的`2D` 几何类型。
* [go-dsp](https://github.com/mjibson/go-dsp) ⭐ 910 | 🐛 5 | 🌐 Go | 📅 2026-01-29 :   数字信号处理
...
* [goraph](https://github.com/gyuho/goraph) ⭐ 749 | 🐛 5 | 🌐 Go | 📅 2022-04-10 :   纯`Go`语言编写的图论库（数据结构,算法可视化）
* [ewma](https://github.com/VividCortex/ewma) ⭐ 447 | 🐛 5 | 🌐 Go | 📅 2023-12-14 :  指数加权移动平均数。
...
* [PiHex](https://github.com/claygod/PiHex) ⭐ 20 | 🐛 1 | 🌐 Go | 📅 2026-04-15 :   贝利-波尔温-普劳夫公式`"Bailey-Borwein-Plouffe"`）\`算法的实现,用于计算十六进制π
...
* [lego](https://github.com/go-acme/lego) ⭐ 9,889 | 🐛 104 | 🌐 Go | 📅 2026-09-23 :  纯` Go`语言开发的` ACME` 客户端库及命令行工具
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 5,224 | 🐛 22 | 🌐 Go | 📅 2026-09-23 :   用于远程入侵监控摄像头的`RTSP`流的工具库。
* [memguard](https://github.com/awnumar/memguard) ⭐ 2,759 | 🐛 12 | 🌐 Go | 📅 2026-05-08 : 用于处理内存中敏感数据的`Go` 语言库
* [secure](https://github.com/unrolled/secure) ⭐ 2,356 | 🐛 0 | 🌐 Go | 📅 2026-05-01 :  为 Go 提供了一些安全功能` HTTP` 中间件,
* [acmetool](https://github.com/hlandau/acme) ⭐ 2,094 | 🐛 72 | 🌐 Go | 📅 2023-05-27 :` ACME (Let's Encrypt)` 客户端工具,支持自动续期.
* [themis](https://github.com/cossacklabs/themis) ⭐ 1,975 | 🐛 31 | 🌐 C | 📅 2026-04-24 : 高级加密库,用于解决典型的数据安全任务（安全数据存储、安全消息传递、零知识证明认证）,提供14种语言,最适合多平台应用。
* [acra](https://github.com/cossacklabs/acra) ⭐ 1,493 | 🐛 29 | 🌐 Go | 📅 2026-04-23 :   用于保护基于数据库的应用程序的网络加密代理,用于防止数据泄露、`SQL`注入等。
* [go-password-validator](https://github.com/lane-c-wagner/go-password-validator) ⭐ 593 | 🐛 6 | 🌐 Go | 📅 2022-09-22 :  用于原始加密熵值的密码验证器。
* [nacl](https://github.com/kevinburke/nacl) ⭐ 550 | 🐛 8 | 🌐 Go | 📅 2026-07-22 : `NaCL`系列` API` 的`Go` 实现
* [ssh-vault](https://github.com/ssh-vault/ssh-vault) ⭐ 509 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 : 利用` ssh` 秘钥加解密 。
* [go-yara](https://github.com/hillu/go-yara) ⭐ 390 | 🐛 7 | 🌐 Go | 📅 2025-07-01 : Go Bindings for[YARA](https://github.com/plusvic/yara) ⭐ 137 | 🐛 1 | 🌐 C | 📅 2020-03-13 恶意软件研究人员（以及其他所有人）的模式匹配瑞士刀"。
...
* [simple-scrypt](https://github.com/elithrar/simple-scrypt) ⭐ 204 | 🐛 0 | 🌐 Go | 📅 2026-08-10 :  `Scrypt`库,具有简单、易懂的`API`,同时具有内置的自动校准功能
...
* [goprotobuf](https://github.com/golang/protobuf) ⭐ 10,083 | 🐛 113 | 🌐 Go | 📅 2026-09-15 :   以库和协议编译器插件的形式为` Google` 的协议缓冲区提供 Go 支持。
* [mapstructure](https://github.com/mitchellh/mapstructure) ⚠️ Archived :  用于将通用`map`值解码为本地Go结构的Go库。
* [gogoprotobuf](https://github.com/gogo/protobuf) ⭐ 5,661 | 🐛 233 | 🌐 Go | 📅 2023-07-27 :  用于`Gadgets` 的go协议缓冲区。
* [go-codec](https://github.com/ugorji/go) ⭐ 1,966 | 🐛 6 | 🌐 Go | 📅 2026-09-02 :  高性能、多功能、规范化编码解码以及`rpc`库, 用于` msgpack, cbor`和`json`,支持基于运行时的 OR 码生成
* [cbor](https://github.com/fxamacker/cbor) ⭐ 1,092 | 🐛 33 | 🌐 Go | 📅 2026-09-25 :  小巧、安全、简单的` CBOR` 编码和解码库。
* [csvutil](https://github.com/jszwec/csvutil) ⭐ 1,035 | 🐛 0 | 🌐 Go | 📅 2025-03-15 :  高性能的`CSV`记录编码和解码器
...
* [php\_session\_decoder](https://github.com/yvasiyarov/php_session_decoder) ⭐ 170 | 🐛 3 | 🌐 Go | 📅 2018-11-02 :  用于处理` PHP session` 格式和`PHP Serialize/Unserialize`函数的 GoLang 库。
* [structomap](https://github.com/tuvistavie/structomap) ⭐ 144 | 🐛 0 | 🌐 Go | 📅 2019-05-24 :  用于从静态结构中轻松动态地生成映射的库。
...
* [Caddy](https://github.com/mholt/caddy) ⭐ 76,058 | 🐛 296 | 🌐 Go | 📅 2026-09-24 :`  Caddy`是一个备选的` HTTP/2 web` 服务器,配置简单,使用方便。
* [minio](https://github.com/minio/minio) ⚠️ Archived :  Minio 是一个分布式对象存储服务器
* [etcd](https://github.com/coreos/etcd) ⭐ 52,310 | 🐛 351 | 🌐 Go | 📅 2026-09-24 :  高可用性的键值存储,用于分享配置和服务发现
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,575 | 🐛 177 | 🌐 Go | 📅 2026-09-24 :   功能齐全、高度可配置的`SFTP`服务器,可选择支持`FTP/S和WebDAV`。它可以为本地文件系统和云存储后端服务,如S3和谷歌云存储。
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,509 | 🐛 52 | 🌐 Go | 📅 2026-09-21 :   高性能的PHP应用服务器,负载均衡器和进程管理器。
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,911 | 🐛 46 | 🌐 Go | 📅 2026-09-24 :  用`Go`和`Vue.js`编写的自带功能标志的解决方案。
* [Fider](https://github.com/getfider/fider) ⭐ 4,541 | 🐛 61 | 🌐 Go | 📅 2026-09-23 : `Fider`是一个收集和整理客户反馈的开放平台。
* [devd](https://github.com/cortesi/devd) ⭐ 3,473 | 🐛 24 | 🌐 Go | 📅 2026-06-21 :   开发者使用的本地`web` 服务器
* [algernon](https://github.com/xyproto/algernon) ⭐ 3,029 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-22 :` HTTP/2 web`服务器,内置`Lua、Markdown、GCSS`和`Amber`支持。
* [Flagr](https://github.com/checkr/flagr) ⭐ 2,608 | 🐛 4 | 🌐 Go | 📅 2026-09-23 : ` Flagr`是一个开源的功能标志和A/B测试服务。
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,092 | 🐛 11 | 🌐 Go | 📅 2026-09-22 : `HTTP`反向代理缓存和时间序列加速器。
...
* [go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) ⭐ 151 | 🐛 16 | 🌐 Go | 📅 2026-09-22 : 简单的反向代理与缓存,用`Go`编写,使用`Redis`。
* [dudeldu](https://github.com/krotik/dudeldu) ⭐ 149 | 🐛 0 | 🌐 Go | 📅 2019-09-22 :   一个简单的`SHOUTcast`服务器。
* [lets-proxy2](https://github.com/rekby/lets-proxy2) ⭐ 102 | 🐛 42 | 🌐 Go | 📅 2024-04-01 :  反向代理,用于处理`https`,在fly中使用` lets-encrypt`发行证书。
* [psql-streamer](https://github.com/blind-oracle/psql-streamer) ⭐ 61 | 🐛 3 | 🌐 Go | 📅 2020-03-10 : 从`PostgreSQL`到`Kafka`的数据库事件流。
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,173 | 🐛 12 | 🌐 Go | 📅 2026-01-14 :` Go`流处理库。
* [machine](https://github.com/whitaker-io/machine) ⭐ 169 | 🐛 11 | 🌐 Go | 📅 2026-09-06 : 内置度量和具有可跟踪的用于编写和生成流式`worker`的`Go` 库
...
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,763 | 🐛 64 | 🌐 Go | 📅 2026-09-10 :  用Maroto的方式来创建PDF。Maroto的灵感来自于`Bootstrap`并使用`gofpdf`
* [hero](https://github.com/shiyanhui/hero) ⭐ 1,565 | 🐛 28 | 🌐 Go | 📅 2020-01-09 :` Hero`是一个趁手的、快速的、强大的` Go` 语言模板引擎
* [jet](https://github.com/CloudyKit/jet) ⭐ 1,409 | 🐛 21 | 🌐 Go | 📅 2026-09-24 :` Jet` 模板引擎
* [mustache](https://github.com/hoisie/mustache) ⭐ 1,116 | 🐛 34 | 🌐 Go | 📅 2024-04-28 :  `Go`语言实现的` Mustache`模板语言
* [amber](https://github.com/eknkc/amber) ⭐ 919 | 🐛 24 | 🌐 Go | 📅 2020-10-13 :  Amber 是一个优雅的模板引擎,受到`HAML`和`Jade`的启发
* [fasttemplate](https://github.com/valyala/fasttemplate) ⭐ 914 | 🐛 13 | 🌐 Go | 📅 2023-08-28 :  简单而快速的模板引擎。替换模板占位符的速度比[text/template](http://golang.org/pkg/text/template/) :  快10倍
* [Razor](https://github.com/sipin/gorazor) ⭐ 885 | 🐛 1 | 🌐 Go | 📅 2026-09-07 : ` Go`语言的` Razor` 视图引擎
...
* [ego](https://github.com/benbjohnson/ego) ⭐ 588 | 🐛 10 | 🌐 Go | 📅 2023-03-15 :  轻量级模板语言,让你可以使用` Go`语言来创建模板。模板会被转化为 Go 语言并编译
...
* [liquid](https://github.com/osteele/liquid) ⭐ 355 | 🐛 9 | 🌐 Go | 📅 2026-08-17 :  Go 语言实现的`Shopify Liquid`模板.
...
* [velvet](https://github.com/gobuffalo/velvet) ⭐ 72 | 🐛 2 | 🌐 Go | 📅 2017-03-20 :   使用` Go`语言实现的完整的\` handlebars
...
* 测试框架
  * [Testify](https://github.com/stretchr/testify) ⭐ 26,213 | 🐛 377 | 🌐 Go | 📅 2026-09-24 :  对标准测试包的扩展
  * [GoConvey](https://github.com/smartystreets/goconvey/) ⭐ 8,406 | 🐛 168 | 🌐 Go | 📅 2024-07-30 : `BDD` 风格的测试框架,具有` web` 界面和计时刷新功能
  * [go-cmp](https://github.com/google/go-cmp) ⭐ 4,678 | 🐛 66 | 🌐 Go | 📅 2026-06-18 :  用于比较测试中的` Go`值的软件包。
  * [httpexpect](https://github.com/gavv/httpexpect) ⭐ 2,727 | 🐛 26 | 🌐 Go | 📅 2025-11-20 :   简洁的、声明式的、易用的端到端HTTP 及 REST API 测试
  * [godog](https://github.com/DATA-DOG/godog) ⭐ 2,675 | 🐛 92 | 🌐 Go | 📅 2026-09-19 :  类似于`Cucumber`或`Behat`的`Go BDD`框架。
  * [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,395 | 🐛 5 | 🌐 Go | 📅 2026-09-21 :   记录并重放` HTTP`交互,用于快速的、确定性的、准确的测试
  * [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 1,236 | 🐛 13 | 🌐 Go | 📅 2026-03-18 :  作为另一个` Go`应用程序或测试的一部分,在`Linux、OSX` 或`Windows`上本地运行一个真正的 Postgres 数据库
  * [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,235 | 🐛 21 | 🌐 Go | 📅 2026-09-18 : 类似` Rails`的测试工具,用于测试数据库应用
  * [goblin](https://github.com/franela/goblin) ⭐ 885 | 🐛 21 | 🌐 Go | 📅 2022-12-22 :  类似` Mocha` 的测试框架
  * [goc](https://github.com/qiniu/goc) ⭐ 874 | 🐛 101 | 🌐 Go | 📅 2026-05-03 : `Goc`是一个针对` Go` 编程语言的综合覆盖测试系统。
  * [baloo](https://github.com/h2non/baloo) ⭐ 779 | 🐛 9 | 🌐 Go | 📅 2022-08-10 :   表达性强、多功能的、端到端的`HTTP API` 测试工具
  * [go-mutesting](https://github.com/zimmski/go-mutesting) ⭐ 676 | 🐛 43 | 🌐 Go | 📅 2024-07-04 :` Go`语言源代码突变测试`（Mutation testing ）`
  * [gotest.tools](https://github.com/gotestyourself/gotest.tools) ⭐ 576 | 🐛 37 | 🌐 Go | 📅 2026-09-14 :  用于增强 Go 测试包并支持常见模式的软件包集合。
  * [go-testdeep](https://github.com/maxatome/go-testdeep) ⭐ 462 | 🐛 3 | 🌐 Go | 📅 2026-09-17 :  扩展了` go` 测试包的极为灵活的`golang` 深度比较库,。
  * [gofight](https://github.com/appleboy/gofight) ⭐ 446 | 🐛 7 | 🌐 Go | 📅 2026-08-30 :  对`Go` 语言的路由框架进行`API` 测试
  * [cupaloy](https://github.com/bradleyjkemp/cupaloy) ⭐ 331 | 🐛 16 | 🌐 Go | 📅 2023-05-19 :   用于测试框架的简单快照测试插件。
  * [frisby](https://github.com/verdverm/frisby) ⭐ 275 | 🐛 12 | 🌐 Go | 📅 2020-03-03 : `REST API` 测试框架
  * [endly](https://github.com/viant/endly) ⭐ 269 | 🐛 4 | 🌐 Go | 📅 2026-09-09 :   声明式端到端功能测试。
  ...
  * [jsonassert](https://github.com/kinbiko/jsonassert) ⭐ 143 | 🐛 6 | 🌐 Go | 📅 2026-09-13 :  用于验证JSON有效载荷是否被正确序列化的软件包。
  * [testcase](https://github.com/adamluzsi/testcase) ⭐ 133 | 🐛 0 | 🌐 Go | 📅 2026-09-13 :  行为驱动开发的直观测试框架。
  * [GoSpec](https://github.com/orfjackal/gospec) ⭐ 113 | 🐛 3 | 🌐 Go | 📅 2014-07-31 :` BDD`风格的测试框架
  * [gocrest](https://github.com/corbym/gocrest) ⭐ 108 | 🐛 2 | 🌐 Go | 📅 2026-09-13 :   用于`Go` 断言的可组合的类似`hamcrest`的匹配器。
  ...
  * [restit](https://github.com/yookoala/restit) ⭐ 54 | 🐛 6 | 🌐 Go | 📅 2026-07-02 :   帮助编写`RESTful API`集成测试的`Go` 语言微型框架.
  ...
  * [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 23 | 🐛 2 | 🌐 Go | 📅 2026-09-22 : ` HTTP`客户端测试框架。
  ...
  * [stop-and-go](https://github.com/elgohr/stop-and-go) ⭐ 13 | 🐛 0 | 🌐 Go | 📅 2026-08-20 :    并发测试助手。
  ...
  * [Tt](https://github.com/vcaesar/tt) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2026-09-12 :  简单而多彩的测试工具。
...
* Mock
  ...
  * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,574 | 🐛 50 | 🌐 Go | 📅 2026-07-10 :` Mock SQL` ,用于测试数据库交互
  * [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,524 | 🐛 34 | 🌐 Go | 📅 2026-09-21 :`  HTTP(S) : proxy,`用于记录和模拟`REST/SOAP API`,具有可扩展的中间件和易于使用的 CLI。
  * [gock](https://github.com/h2non/gock) ⭐ 2,215 | 🐛 52 | 🌐 Go | 📅 2024-09-24 :   多功能、易用`HTTP mock`
  * [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,079 | 🐛 5 | 🌐 Go | 📅 2026-08-29 :  轻松模拟来自外部资源的 HTTP 响应。
  * [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,141 | 🐛 3 | 🌐 Go | 📅 2026-09-22 :  用于生成自包含`mock`对象的工具
  * [go-txdb](https://github.com/DATA-DOG/go-txdb) ⭐ 753 | 🐛 2 | 🌐 Go | 📅 2025-03-11 :  基于单事物的数据库驱动,主要用于测试目的
  * [minimock](https://github.com/gojuno/minimock) ⭐ 753 | 🐛 28 | 🌐 Go | 📅 2026-09-18 : `Mock`生成器
...
* Fuzzing and delta-debugging/reducing/shrinking.
  * [go-fuzz](https://github.com/dvyukov/go-fuzz) ⭐ 4,850 | 🐛 58 | 🌐 Go | 📅 2024-09-24 :  随机化测试系统
...
* Selenium及浏览器控制工具
  * [chromedp](https://github.com/knq/chromedp) ⭐ 13,284 | 🐛 180 | 🌐 Go | 📅 2026-07-14 :  用于驱动和测试`Chrome, Safari, Edge, Android Webviews`, 以及其他支持`Chrome`调试协议的产品
  * [rod](https://github.com/go-rod/rod) ⭐ 7,112 | 🐛 213 | 🌐 Go | 📅 2026-08-11 : `Devtools`驱动,使网络自动化测试变得简单。
...
* Fail injection
  * [failpoint](https://github.com/pingcap/failpoint) ⭐ 895 | 🐛 10 | 🌐 Go | 📅 2026-08-11 :  Golang中[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail) 的实现。
...
* 特定文本格式处理
  * [colly](https://github.com/asciimoo/colly) ⭐ 25,532 | 🐛 194 | 🌐 Go | 📅 2026-09-16 :  `go`语言版爬虫框架
  * [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,996 | 🐛 4 | 🌐 Go | 📅 2026-09-22 :`  GoQuery` 为` Go`语言带来了一组类似`jQuery` 的语法和功能
  * [sh](https://github.com/mvdan/sh) ⭐ 9,085 | 🐛 94 | 🌐 Go | 📅 2026-09-22 : `Shell`解析器及格式化工具
  * [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,601 | 🐛 224 | 🌐 Go | 📅 2024-01-29 : `Markdown` 解析器
  * [toml](https://github.com/BurntSushi/toml) ⭐ 5,009 | 🐛 27 | 🌐 Go | 📅 2026-08-18 : `TOML` 配置格式的编码解码器
  * [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,830 | 🐛 19 | 🌐 Go | 📅 2026-09-23 :    将时间、数字和内存大小格式化为人类可读的格式。
  * [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3,824 | 🐛 27 | 🌐 Go | 📅 2026-08-03 :  将`HTML`转换为`Markdown`。甚至适用于整个网站,并可通过规则进行扩展。
  * [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,724 | 🐛 35 | 🌐 Go | 📅 2025-04-04 : ` HTML` 清理工具
  * [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,876 | 🐛 18 | 🌐 Go | 📅 2026-09-14 :  使用`Go`语言解析`RSS`和`Atom`
  * [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,985 | 🐛 35 | 🌐 Go | 📅 2026-08-03 : `TOML`格式的`Go`库,
  * [inject](https://github.com/facebookgo/inject) ⚠️ Archived :  一个基于反射的注入器
  * [slug](https://github.com/gosimple/slug) ⭐ 1,334 | 🐛 14 | 🌐 Go | 📅 2024-12-23 :` URL`友好的` slug` 化工具,支持多种语言
  * [commonregex](https://github.com/mingrammer/commonregex) ⭐ 894 | 🐛 2 | 🌐 Go | 📅 2019-11-12 :` Go`常用正则表达式的集合。
  * [htmlquery](https://github.com/antchfx/htmlquery) ⭐ 784 | 🐛 7 | 🌐 Go | 📅 2026-07-02 :` HTML`的`XPath` 查询包,让您可以通过` XPath` 表达式从`HTML`文档中提取数据。
  * [go-runewidth](https://github.com/mattn/go-runewidth) ⭐ 723 | 🐛 1 | 🌐 Go | 📅 2026-09-24 :  用于获取固定宽度的字符或字符串的函数。
  * [dataflowkit](https://github.com/slotix/dataflowkit) ⭐ 713 | 🐛 4 | 🌐 Go | 📅 2023-03-07 : `Web`爬虫框架用于将网站转化为结构化数据。
  * [mxj](https://github.com/clbanning/mxj) ⭐ 627 | 🐛 2 | 🌐 Go | 📅 2025-08-10 :   通过点分路径和通配符来提取值 将` XML`编解码为` JSON` 或` map[string]interface{}`;目的是用于替代`Replaces x2j` 和`j2x` 包.
  * [gommon/bytes](https://github.com/labstack/gommon/tree/master/bytes) ⭐ 597 | 🐛 15 | 🌐 Go | 📅 2026-07-23 :   格式化二进制为字符串
  * [gographviz](https://github.com/awalterschulze/gographviz) ⭐ 567 | 🐛 8 | 🌐 Go | 📅 2023-02-28 :    用以解析`Graphviz DOT` 语言
  * [gotext](https://github.com/leonelquinteros/gotext) ⭐ 510 | 🐛 5 | 🌐 Go | 📅 2026-09-22 :  Go语言版本的`GNU gettext`工具。
  * [goq](https://github.com/andrewstuart/goq) ⭐ 269 | 🐛 3 | 🌐 Go | 📅 2021-09-02 :  声明式`HTML` 编组,使用结构标签和`jQuery`语法 (使用`GoQuery`).
  * [go-nmea](https://github.com/adrianmo/go-nmea) ⭐ 266 | 🐛 1 | 🌐 Go | 📅 2026-08-22 :   Go语言的NMEA解析库。
  * [editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) ⭐ 156 | 🐛 7 | 🌐 Go | 📅 2026-09-16 : Go 语言用的`Editorconfig` 文件解析和操作库
  * [podcast](https://github.com/eduncan911/podcast) ⭐ 140 | 🐛 7 | 🌐 Go | 📅 2020-11-04 :  `Golang`中兼容`iTunes`和`RSS 2.0`的播客生成器。
  * [go-vcard](https://github.com/emersion/go-vcard) ⭐ 129 | 🐛 6 | 🌐 Go | 📅 2026-08-18 :  解析和格式化`vCard`。
  ...
  * [gonameparts](https://github.com/polera/gonameparts) ⭐ 42 | 🐛 1 | 🌐 Go | 📅 2024-10-04 :  将人名解析为几个独立的部分
  ...
  * [bbConvert](https://github.com/CalebQ42/bbConvert) ⭐ 11 | 🐛 0 | 🌐 Go | 📅 2024-12-27 :   将`bbCode` 转换为`HTML`
...
* 文本工具
  * [xurls](https://github.com/mvdan/xurls) ⭐ 1,268 | 🐛 2 | 🌐 Go | 📅 2026-08-20 :  从文本中提取`URLs`。
  * [gotabulate](https://github.com/bndr/gotabulate) ⭐ 336 | 🐛 5 | 🌐 Go | 📅 2021-02-09 :  使用` Go`轻松地打印你的表格数据。
  * [radix](https://github.com/yourbasic/radix) ⭐ 196 | 🐛 0 | 🌐 Go | 📅 2018-03-08 :  快速字符串排序算法。
  ...
  * [TySug](https://github.com/Dynom/TySug) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2026-09-15 :  关于键盘布局的替代建议。
...
* [github](https://github.com/google/go-github) ⭐ 11,308 | 🐛 43 | 🌐 Go | 📅 2026-09-24 :  用于访问`GitHub REST API v3` 的`Go`库。
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) ⚠️ Archived : ` AWS` 提供的官方go语言` SDK`
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,991 | 🐛 232 | 🌐 Go | 📅 2026-02-14 :   用于与`Discord` 聊天` API`进行交互的`Go`语言客户端。
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,505 | 🐛 412 | 🌐 Go | 📅 2026-09-24 :`Google Cloud APIs Go`客户端库。
* [google](https://github.com/google/google-api-go-client) ⭐ 4,474 | 🐛 21 | 🌐 Go | 📅 2026-09-24 :  为`Go` 自动生成的`Google API`。
* [minio-go](https://github.com/minio/minio-go) ⭐ 3,003 | 🐛 9 | 🌐 Go | 📅 2026-09-15 :  `go` 语言`Minio` 客户端,用于` Amazon S3` 兼容的云存储
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,640 | 🐛 14 | 🌐 Go | 📅 2026-09-24 :  用于访问`Stripe API`的`Go`客户端。
* [go-jira](https://github.com/andygrunwald/go-jira) ⭐ 1,621 | 🐛 206 | 🌐 Go | 📅 2026-08-01 :   用于 [Atlassian JIRA](https://www.atlassian.com/software/jira) :  的Go客户端库。
* [go-twitter](https://github.com/dghubble/go-twitter) ⚠️ Archived :  用于`Twitter v1.1 APIs` 的` Go` 客户端库。
* [facebook](https://github.com/huandu/facebook) ⭐ 1,484 | 🐛 1 | 🌐 Go | 📅 2026-08-21 :  支持` Facebook Graph API` 的库
...
* [webhooks](https://github.com/go-playground/webhooks) ⭐ 1,030 | 🐛 35 | 🌐 Go | 📅 2024-08-06 : `GitHub` 和`Bitbucket`的`Webhook`接收器
...
* [geo-golang](https://github.com/codingsince1985/geo-golang) ⭐ 548 | 🐛 7 | 🌐 Go | 📅 2026-04-23 :  用于与  [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro),  [MapQuest](http://open.mapquestapi.com/geocoding/), [Nominatim](https://developer.mapquest.com/documentation/open/nominatim-search), [OpenCage](http://geocoder.opencagedata.com/api.html), [Bing](https://msdn.microsoft.com/en-us/library/ff701715.aspx) , [Mapbox](https://www.mapbox.com/developers/api/geocoding/) , 及 [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Nominatim)  地理编码 / 反编码 APIs 交互的库
* [ethrpc](https://github.com/onrik/ethrpc) ⭐ 271 | 🐛 13 | 🌐 Go | 📅 2024-01-05 : `Ethereum JSON RPC API` 的 Go 绑定
* [Trello](https://github.com/adlio/trello) ⭐ 229 | 🐛 10 | 🌐 Go | 📅 2026-09-01 : `Trello API`的` Go` 语言封装
* [simples3](https://github.com/rhnvrm/simples3) ⭐ 209 | 🐛 13 | 🌐 Go | 📅 2026-05-21 :  简单的不加修饰的`AWS S3`库,使用`Go`编写的`V4 Signing`的`REST api`。
* [go-marathon](https://github.com/gambol99/go-marathon) ⭐ 198 | 🐛 26 | 🌐 Go | 📅 2020-10-01 :  用于与`Mesosphere`的`Marathon PAAS`交互的Go库。
* [gosip](https://github.com/koltyakov/gosip) ⭐ 171 | 🐛 17 | 🌐 Go | 📅 2026-03-17 :  Go客户端库`SharePoint API`。
* [wit-go](https://github.com/wit-ai/wit-go) ⭐ 171 | 🐛 0 | 🌐 Go | 📅 2025-09-08 :   用于`wit.ai HTTP API` 的`Go` 客户端。
* [golang-tmdb](https://github.com/cyruzin/golang-tmdb) ⭐ 167 | 🐛 1 | 🌐 Go | 📅 2026-07-15 :   电影数据库`API v3`的`Golang` 版本`api`
...
* [igdb](https://github.com/Henry-Sarabia/igdb) ⭐ 86 | 🐛 3 | 🌐 Go | 📅 2023-01-30 :  [Internet Game Database API](https://api.igdb.com/) :的Go客户端。
...
* [ynab](https://github.com/brunomvsouza/ynab.go) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2026-09-13 : `YNAB API`的`Go`语言封装。
...
* [go-xkcd](https://github.com/nishanths/go-xkcd) ⭐ 50 | 🐛 0 | 🌐 Go | 📅 2022-10-23 :   -`xkcd API` 的` Go` 客户端。
...
* [coinpaprika-go](https://github.com/coinpaprika/coinpaprika-api-go-client) ⭐ 27 | 🐛 0 | 🌐 Go | 📅 2026-09-01 :  `Go`客户端库,用于与`Coinpaprika的API`进行交互。
...
* [go-aws-news](https://github.com/circa10a/go-aws-news) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2026-09-21 :   用于从`AWS`获取最新信息的 Go 应用程序和库。
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,240 | 🐛 331 | 🌐 Go | 📅 2026-09-21 :  命令行模糊查找工具
* [hub](https://github.com/github/hub) ⭐ 22,955 | 🐛 296 | 🌐 Go | 📅 2024-02-02 :  封装了`git`命令,提供了额外的功能用于在终端中和`Github` 进行交互
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,840 | 🐛 120 | 🌐 Go | 📅 2024-07-08 :  用于容器指标,类似于`Top`的接口（例如`htop`）。
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,743 | 🐛 395 | 🌐 Go | 📅 2024-08-15 :  为内建的`database/sql` 软件包提供扩展
* [Task](https://github.com/go-task/task) ⭐ 16,193 | 🐛 197 | 🌐 Go | 📅 2026-09-24 :  简单来讲就是`"Make"`的替代品
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 16,069 | 🐛 18 | 🌐 Go | 📅 2026-09-21 : 尽可能快速的发布`Go`语言二进制文件
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,735 | 🐛 41 | 🌐 Go | 📅 2026-08-04 :   交互式命令行程序,用于进行`HTTP` 检查
* [usql](https://github.com/knq/usql) ⭐ 10,127 | 🐛 74 | 🌐 Go | 📅 2026-09-23 :  `usql`是一个通用的命令行接口,用于操作`sql`数据库
* [peco](https://github.com/peco/peco) ⭐ 7,909 | 🐛 4 | 🌐 Go | 📅 2026-09-19 :  简单的交互式过滤工具。
...
* [godropbox](https://github.com/dropbox/godropbox) ⭐ 4,207 | 🐛 7 | 🌐 Go | 📅 2023-12-24 : `Dropbox`开发的用于编写` Go`语言服务／应用的库
* [minify](https://github.com/tdewolff/minify) ⭐ 4,142 | 🐛 36 | 🌐 Go | 📅 2026-09-23 :  快速压缩`HTML, CSS, JS, XML, JSON` 以及` SVG` 文件格式
...
* [mergo](https://github.com/imdario/mergo) ⭐ 3,108 | 🐛 23 | 🌐 Go | 📅 2026-08-24 :  Golang中合并结构和地图的助手。对配置默认值很有用,避免了混乱的if语句。
* [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,772 | 🐛 13 | 🌐 Go | 📅 2026-02-10 :  通过运行一个命令就可以创建一个新的生产就绪项目,包括后端（`Golang`）、前端（`JavaScript、TypeScript`）和部署自动化（`Ansible、Docker`）的强大的`CLI`。
* [spinner](https://github.com/briandowns/spinner) ⭐ 2,531 | 🐛 20 | 🌐 Go | 📅 2025-01-20 : ` Go` 语言软件包,提供多种选项,方便在终端中创建加载动画
* [filetype](https://github.com/h2non/filetype) ⭐ 2,300 | 🐛 56 | 🌐 Go | 📅 2026-07-01 :  用于推断文件类型的小程序包,它可以检查魔法数字签名。
* [Storm](https://github.com/asdine/storm) ⭐ 2,089 | 🐛 63 | 🌐 Go | 📅 2024-01-07 :  用于`BoltDB` 的简单又强大的工具
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 2,019 | 🐛 36 | 🌐 Go | 📅 2026-09-21 :  基于魔数的`MIME`类型检测包。
* [jump](https://github.com/gsamokovarov/jump) ⭐ 1,945 | 🐛 2 | 🌐 Go | 📅 2026-09-21 : `Jump`通过学习你的习惯来帮助你更快地浏览文件。
* [boilr](https://github.com/tmrts/boilr) ⭐ 1,765 | 🐛 44 | 🌐 Go | 📅 2023-03-07 :  用于从模板中快速创建项目的`CLI`工具。
* [mmake](https://github.com/tj/mmake) ⭐ 1,735 | 🐛 11 | 🌐 Go | 📅 2023-07-01 :  现代`Make`工具
* [mole](https://github.com/davrodpin/mole) ⭐ 1,727 | 🐛 29 | 🌐 Go | 📅 2024-05-13 :  用于轻松创建ssh隧道的`cli`应用程序。
* [scany](https://github.com/georgysavva/scany) ⭐ 1,520 | 🐛 3 | 🌐 Go | 📅 2025-03-19 :  用于将数据库中的数据扫描成` Go`结构等的库。
* [hostctl](https://github.com/guumaster/hostctl) ⭐ 1,237 | 🐛 19 | 🌐 Go | 📅 2024-01-26 :  用简单的命令管理`/etc/hosts` 的` CLI`工具。
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) ⭐ 1,165 | 🐛 22 | 🌐 Go | 📅 2024-05-15 :  `Go`中的断路器。
* [git-time-metric](https://github.com/git-time-metric/gtm) ⭐ 1,003 | 🐛 51 | 🌐 Go | 📅 2022-01-31 :  简单、无缝、轻量级的` Git`时间跟踪。
* [immortal](https://github.com/immortal/immortal) ⭐ 842 | 🐛 2 | 🌐 Go | 📅 2026-08-16 :  \*nix 跨平台 (与操作系统无关的)监控程序
* [circuit](https://github.com/cep21/circuit) ⭐ 816 | 🐛 7 | 🌐 Go | 📅 2026-09-24 :  高效且功能完整的`Hystrix`断路器模式的`go`语言实现
* [clockwork](https://github.com/jonboulle/clockwork) ⭐ 729 | 🐛 12 | 🌐 Go | 📅 2025-11-21 :  使用简单、流畅的语法来调度周期性任务
* [delve](https://github.com/derekparker/delve) ⭐ 660 | 🐛 2 | 🌐 Go | 📅 2026-09-16 : `Go`语言调试器
* [limiters](https://github.com/mennanov/limiters) ⭐ 653 | 🐛 2 | 🌐 Go | 📅 2026-09-02 : `Golang`中分布式应用的速率限制器,具有可配置的后端和分布式锁。
* [ergo](https://github.com/cristianoliveira/ergo) ⭐ 651 | 🐛 8 | 🌐 Go | 📅 2025-02-02 :  简化了对运行在不同端口的多个本地服务的管理。
* [scan](https://github.com/blockloop/scan) ⭐ 615 | 🐛 2 | 🌐 Go | 📅 2026-09-14 :  直接将`golang sql.Rows`扫描为` structs、slices`或`primitive`类型。
...
* [countries](https://github.com/biter777/countries) ⭐ 524 | 🐛 22 | 🌐 Go | 📅 2024-05-30 :   完全执行`ISO-3166-1、ISO-4217、ITU-T E.164、Unicode CLDR和IANA ccTLD`标准的库。
* [gubrak](https://github.com/novalagung/gubrak) ⭐ 514 | 🐛 0 | 🌐 Go | 📅 2026-05-02 :  带有语法糖的` Golang`工具库。它类似于`lodash`,但适用于` golang`。
...
* [taskctl](https://github.com/taskctl/taskctl) ⭐ 432 | 🐛 2 | 🌐 Go | 📅 2026-07-20 :  并发任务运行库。
...
* [serve](https://github.com/syntaqx/serve) ⭐ 357 | 🐛 0 | 🌐 Go | 📅 2026-09-16 :  静态` http`服务器。
* [retry](https://github.com/kamilsk/retry) ⭐ 344 | 🐛 10 | 🌐 Go | 📅 2026-07-22 :    最先进的功能机制,用于重复执行动作直到成功。
* [gotenv](https://github.com/subosito/gotenv) ⭐ 309 | 🐛 5 | 🌐 Go | 📅 2025-11-10 :  从 .env 或者任何`io.Reader`中加载环境变量
...
* [toolbox](https://github.com/viant/toolbox) ⭐ 230 | 🐛 6 | 🌐 Go | 📅 2026-01-07 :  `slice, map, multimap`, 结构体, 函数,数据转换工具、服务路由,宏求值和标记器工具
* [Death](https://github.com/vrecan/death) ⭐ 198 | 🐛 0 | 🌐 Go | 📅 2024-12-16 :  -利用信号管理应用程序的关闭
* [go-bind-plugin](https://github.com/wendigo/go-bind-plugin) ⭐ 181 | 🐛 0 | 🌐 Go | 📅 2026-08-25 :  用于包装` golang` 插件导出的符号的`go:generation`工具 (仅限 1.8)。
...
* [apm](https://github.com/topfreegames/apm) ⭐ 168 | 🐛 9 | 🌐 Go | 📅 2016-11-24 : 具有`HTTP API`的`Go`语言进程管理工具.
* [chyle](https://github.com/antham/chyle) ⭐ 164 | 🐛 3 | 🌐 Go | 📅 2026-08-31 :  使用`git`仓库的变更日志生成器,具有多种配置
* [rerun](https://github.com/ivpusic/rerun) ⭐ 163 | 🐛 0 | 🌐 Go | 📅 2018-03-22 :  当源码发生变化时,重新编译和重新运行`go`应用程序。
...
* [nostromo](https://github.com/pokanop/nostromo) ⭐ 150 | 🐛 27 | 🌐 Go | 📅 2026-09-10 :  用于构建强大别名的`CLI`。
...
* [mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) ⭐ 130 | 🐛 3 | 🌐 Go | 📅 2023-03-07官方`mongodb/mongo-go-driver`包的`Mongodb Pagination`,支持普通查询和聚合管道。
...
* [goseaweedfs](https://github.com/linxGnu/goseaweedfs) ⭐ 120 | 🐛 2 | 🌐 Go | 📅 2022-11-11 :  具有几乎全部功能的`SeaweedFS`客户端库。
* [mssqlx](https://github.com/linxGnu/mssqlx) ⭐ 104 | 🐛 3 | 🌐 Go | 📅 2024-04-29 :  数据库客户端库,代理任何主从,主主结构。考虑到轻量级和自动平衡。
...
* [pgo](https://github.com/arthurkushman/pgo) ⭐ 89 | 🐛 1 | 🌐 Go | 📅 2026-05-05 :  为PHP社区提供方便的功能。
...
* [repeat](https://github.com/ssgreg/repeat) ⭐ 82 | 🐛 0 | 🌐 Go | 📅 2020-07-24 : ` Go`实现不同的回退策略,对重试操作和心跳有用。
...
* [dbt](https://github.com/nikogura/dbt) ⭐ 70 | 🐛 7 | 🌐 Go | 📅 2026-05-06 :  从中央可信仓库运行自更新签名二进制文件的框架。
...
* [ghokin](https://github.com/antham/ghokin) ⭐ 59 | 🐛 0 | 🌐 Go | 📅 2026-09-14 :  并行化的格式化程序,不需要对`gherkin (cucumber, behat...)`,的外部依赖。
...
* [filler](https://github.com/yaronsumel/filler) ⭐ 18 | 🐛 1 | 🌐 Go | 📅 2017-04-10 :   使用`"fill "`标签来填充结构的小工具。
...
* [blank](https://github.com/Henry-Sarabia/blank) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2019-07-31 :  验证或删除字符串中的空白和空白字符。
...
* [sliceconv](https://github.com/Henry-Sarabia/sliceconv) ⭐ 9 | 🐛 0 | 🌐 Go | 📅 2020-02-03 :  原始类型之间的切片转换。
...
* [uuid](https://github.com/google/uuid) ⭐ 6,147 | 🐛 68 | 🌐 Go | 📅 2024-11-14 :  基于`RFC 4122`和`DCE 1.1`的`UUIDs Go`包。
* [ulid](https://github.com/oklog/ulid) ⭐ 5,047 | 🐛 8 | 🌐 Go | 📅 2026-07-23 : `ULID (Universally Unique Lexicographically Sortable Identifier)` 的` Go`实现。
* [uuid](https://github.com/gofrs/uuid) ⭐ 1,808 | 🐛 8 | 🌐 Go | 📅 2026-09-21 :  通用唯一标识符`（UUID）`的实现。支持`UUID`的创建和解析。
...
* [validator](https://github.com/go-playground/validator) ⭐ 20,179 | 🐛 338 | 🌐 Go | 📅 2026-09-23 :  `Go`结构体及域验证,包括：跨域、跨结构体,`Map`, 切片和数组
* [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,204 | 🐛 172 | 🌐 Go | 📅 2026-09-18 :  数据验证及清晰工具,用于字符串,数字, 数组切片及结构体
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 4,136 | 🐛 30 | 🌐 Go | 📅 2026-09-03 :   支持多种数据类型的验证 (结构体,字符串,键值对,数组切片等等),具有可配置、可扩展的验证规则,且使用常用代码结构定义,而非结构体标签
* [govalidator](https://github.com/thedevsaddam/govalidator) ⭐ 1,343 | 🐛 42 | 🌐 Go | 📅 2024-05-12 :  用简单的规则验证`Golang`请求数据. 高度受`Laravel`的请求验证的启发.
...
* [gody](https://github.com/guiferpa/gody) ⭐ 180 | 🐛 0 | 🌐 Go | 📅 2025-05-30 :  针对 'Go\` 的轻量级结构体验证器。
* [jio](https://github.com/faceair/jio) ⭐ 126 | 🐛 3 | 🌐 Go | 📅 2024-07-04 : `jio`是一个类似于[joi](https://github.com/hapijs/joi) ⭐ 21,172 | 🐛 201 | 🌐 JavaScript | 📅 2026-09-11 的json模式验证器.
* [govalid](https://github.com/twharmon/govalid) ⭐ 120 | 🐛 0 | 🌐 Go | 📅 2026-06-05 :  基于标签的快速结构体验证。
...
* [hercules](https://github.com/src-d/hercules) ⭐ 2,809 | 🐛 50 | 🌐 Go | 📅 2023-02-07 :  查看`git repo`历史的代码库
* [git2go](https://github.com/libgit2/git2go) ⭐ 2,005 | 🐛 84 | 🌐 Go | 📅 2024-03-04 :  `libgit2`的` Go`语言接口
* [go-vcs](https://github.com/sourcegraph/go-vcs) ⭐ 82 | 🐛 22 | 🌐 Go | 📅 2026-09-16 :  通过`Go`语言来操作和检视` VCS`代码仓
...
* [goav](https://github.com/giorgisio/goav) ⭐ 2,136 | 🐛 48 | 🌐 Go | 📅 2022-05-19 :  易用的` FFmpeg`Go 语言接口
* [m3u8](https://github.com/grafov/m3u8) ⚠️ Archived :  用于苹果`HLS`的`M3U8`播放列表解析器和生成器库
* [gmf](https://github.com/3d0c/gmf) ⭐ 932 | 🐛 49 | 🌐 Go | 📅 2022-09-06 : `FFmpeg av*`库的 Go 语言接口.
* [go-astisub](https://github.com/asticode/go-astisub) ⭐ 716 | 🐛 9 | 🌐 Go | 📅 2026-09-17 :  使用 Go 语言操作字幕`(.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).`
* [go-astits](https://github.com/asticode/go-astits) ⭐ 619 | 🐛 8 | 🌐 Go | 📅 2026-09-18 :  在 GO 中解析和解调` MPEG` 传输流（.ts）。
* [libvlc-go](https://github.com/adrg/libvlc-go) ⭐ 511 | 🐛 13 | 🌐 Go | 📅 2026-07-16 : `libvlc 2.X/3.X/4.X`的go语言封装)(`VLC` 媒体播放器使用）。
* [gst](https://github.com/ziutek/gst) ⭐ 175 | 🐛 9 | 🌐 Go | 📅 2021-01-07 : `GStreamer`的 Go 语言接口
* [go-m3u8](https://github.com/quangngotan95/go-m3u8) ⭐ 119 | 🐛 2 | 🌐 Go | 📅 2022-12-24 :  苹果`m3u8`播放列表的解析器和生成库。
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 89,258 | 🐛 773 | 🌐 Go | 📅 2026-09-19 :  ` Gin` 是一个` Go` 语言编写的 web 框架,提供了一组类似`martini`的`API`,且具有更好的性能（40倍的性能提升）。如果你需要高性能和高生产率,这个框架很适合你
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,181 | 🐛 25 | 🌐 Go | 📅 2026-09-24 :  受` Express.js`启发的` Web` 框架,构建在`Fasthttp`上。
* [Echo](https://github.com/labstack/echo) ⭐ 32,729 | 🐛 49 | 🌐 Go | 📅 2026-09-21 :   高性能、极简的` Go`语言`web` 框架
...
* [Goyave](https://github.com/System-Glitch/goyave) ⭐ 1,779 | 🐛 16 | 🌐 Go | 📅 2026-09-24 :  功能完整的`Web`框架,旨在实现简洁的代码和快速开发,具有强大的内置功能。
* [tigertonic](https://github.com/rcrowley/go-tigertonic) ⭐ 986 | 🐛 24 | 🌐 Go | 📅 2026-09-03 :  受到 Dropwizard 启发,用于构建`JSON web`服务的` Go`语言框架,
* [tango](https://github.com/lunny/tango) ⚠️ Archived :  微型的、支持插件的`web`框架
* [Gearbox](https://github.com/abahmed/gearbox) ⭐ 804 | 🐛 1 | 🌐 Go | 📅 2026-01-06 :  用Go编写的网络框架,专注于高性能和内存优化。
* [Beego](https://github.com/astaxie/beego) ⭐ 741 | 🐛 0 | 📅 2022-04-27 :   beeGo 是一个开源的、高性能的 Go 语言`web`框架
* [Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) ⭐ 594 | 🐛 26 | 🌐 Go | 📅 2026-09-23 :   提供电子商务功能,使用简洁的架构,如`DDD`、端口和适配器,你可以用它来构建灵活的电子商务应用。
* [Aero](https://github.com/aerogo/aero) ⚠️ Archived : `Go`的高性能Web框架,在`Lighthouse` 评比中拿到最高分
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 559 | 🐛 30 | 🌐 Go | 📅 2026-09-24 :  可插拔的`we`b项目框架。包括模块的概念,并提供`DI、Configareas、i18n`、模板引擎、graphql、可观察性、安全性、事件、路由和反向路由等功能。
* [gongular](https://github.com/mustafaakin/gongular) ⭐ 500 | 🐛 7 | 🌐 Go | 📅 2020-07-05 :  快速` Go web` 框架,支持输入映射／验证以及依赖注入
...
* [Gondola](https://github.com/rainycape/gondola) ⭐ 314 | 🐛 9 | 🌐 Go | 📅 2019-02-19 :  用于快速编写高性能网站的框架
* [WebGo](https://github.com/bnkamalesh/webgo) ⭐ 309 | 🐛 2 | 🌐 Go | 📅 2025-09-23 :  构建`Web`应用的微服务框架；具有处理程序链、中间件和上下文注入功能。具有标准库兼容的`HTTP`处理程序（即`http.HandlerFunc`）。
...
* [hiboot](https://github.com/hidevopsio/hiboot) ⭐ 180 | 🐛 2 | 🌐 Go | 📅 2026-06-08 : `hiboot`是一个高性能的web应用框架,支持自动配置和依赖注入。
...
* [patron](https://github.com/beatlabs/patron) ⭐ 127 | 🐛 18 | 🌐 Go | 📅 2026-09-17 : `Patron`是一个遵循最佳云实践的微服务框架,专注于生产力。
* [Microservice](https://github.com/claygod/microservice) ⭐ 123 | 🐛 0 | 🌐 Go | 📅 2026-08-05 : 用于创建微服务的框架,使用` Go`语言编写
* [rux](https://github.com/gookit/rux) ⭐ 101 | 🐛 2 | 🌐 Go | 📅 2026-09-24 :  用于构建`golang HTTP`应用程序的简单、快速的`web`框架。
...
* [rex](https://github.com/goanywhere/rex) ⭐ 33 | 🐛 0 | 🌐 Go | 📅 2017-12-22 :` Rex` 是一个用于进行模块化开发的库,基于`Gorilla/mux` 完全兼容大多数的`net/HTTP`
...
* [CORS](https://github.com/rs/cors) ⭐ 2,899 | 🐛 25 | 🌐 Go | 📅 2026-06-04 :  非常方便地向你的`api`中添加` CORS`功能
* [Tollbooth](https://github.com/didip/tollbooth) ⭐ 2,850 | 🐛 11 | 🌐 Go | 📅 2025-01-12 : `HTTP` 请求限速中间件
* [Limiter](https://github.com/ulule/limiter) ⭐ 2,344 | 🐛 18 | 🌐 Go | 📅 2024-12-10 :  超级简单的限速中间件
* [go-server-timing](https://github.com/mitchellh/go-server-timing) ⚠️ Archived : 向头信息中 添加/解析服务器计时信息。
* [go-fault](https://github.com/github/go-fault) ⭐ 556 | 🐛 1 | 🌐 Go | 📅 2026-09-07 : `Go`的错误注入中间件。
...
* [XFF](https://github.com/sebest/xff) ⭐ 99 | 🐛 6 | 🌐 Go | 📅 2022-01-18 :  理`X-Forwarded-For`头的中间件
...
* [negroni](https://github.com/urfave/negroni) ⭐ 7,528 | 🐛 6 | 🌐 Go | 📅 2026-07-26 :  符合语言习惯的`HTTP`中间件库
* [alice](https://github.com/justinas/alice) ⭐ 3,367 | 🐛 12 | 🌐 Go | 📅 2024-06-06 :  创建链式中间件的库
* [render](https://github.com/unrolled/render) ⭐ 1,998 | 🐛 0 | 🌐 Go | 📅 2026-09-14 :  用于轻松渲染`JSON, XML`, 及`HTML` 模板响应的库
* [stats](https://github.com/thoas/stats) ⭐ 594 | 🐛 8 | 🌐 Go | 📅 2022-12-12 : `Go`语言中间件,用于存储`web`应用的多种信息
* [interpose](https://github.com/carbocation/interpose) ⭐ 291 | 🐛 1 | 🌐 Go | 📅 2016-12-06 :  极简的`net/HTTP` 中间件
* [renderer](https://github.com/thedevsaddam/renderer) ⭐ 261 | 🐛 0 | 🌐 Go | 📅 2026-04-22 :  简单、轻量级和更快的响应`JSON、JSONP、XML、YAML、HTML、File`的Go渲染包。
...
* [mediary](https://github.com/HereMobilityDevelopers/mediary) ⭐ 87 | 🐛 0 | 🌐 Go | 📅 2020-06-24 :  为` http.Client` 添加拦截器,允许转储/重构/跟踪/...请求/响应。
...
* [chi](https://github.com/go-chi/chi) ⭐ 22,886 | 🐛 105 | 🌐 Go | 📅 2026-09-18 :   基于`net/context`的小巧、快速、具有丰富表达力的`HTTP`路由.
* [mux](https://github.com/gorilla/mux) ⭐ 21,836 | 🐛 44 | 🌐 Go | 📅 2024-08-15 :  强大的`URL`路由和分发库
* [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 17,135 | 🐛 84 | 🌐 Go | 📅 2024-07-22 :  高性能路由,使用这个库和标准http处理工具可以构建一个非常高性能大web框架
...
* [httptreemux](https://github.com/dimfeld/httptreemux) ⚠️ Archived :  快速,灵活,树状结构的` HTTP`路由。受到了` httprouter` 的启发
* [xujiajun/gorouter](https://github.com/xujiajun/gorouter) ⭐ 524 | 🐛 0 | 🌐 Go | 📅 2019-09-27 :   简单快速的`go HTTP`路由器。
* [ozzo-routing](https://github.com/go-ozzo/ozzo-routing) ⭐ 452 | 🐛 9 | 🌐 Go | 📅 2026-08-25 :  极快的` Go (golang)  HTTP`路由器,支持正则表达式路由匹配。完全支持构建`RESTful API`。
* [lars](https://github.com/go-playground/lars) ⭐ 384 | 🐛 1 | 🌐 Go | 📅 2019-05-15 :   轻量级、快速、可扩展、零分配的`HTTP`路由,用于创建定制化的框架
...
* [pure](https://github.com/go-playground/pure) ⭐ 153 | 🐛 0 | 🌐 Go | 📅 2023-07-13 :   是一个轻量级http路由,严格参照`net/HTTP`标准实现
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 17,782 | 🐛 533 | 🌐 Go | 📅 2026-09-24 :  基于`LLVM`,适用于微型场景的`Go`编译器。包括微控制器、`WebAssembly`和命令行工具。
...
* [webapi](https://github.com/gowebapi/webapi) ⭐ 182 | 🐛 3 | 🌐 Go | 📅 2026-09-09 :  从`WebIDL`生成`DOM`和`HTML`的封装。
...
* [go-ole](https://github.com/go-ole/go-ole) ⭐ 1,320 | 🐛 4 | 🌐 Go | 📅 2026-03-30 :  为`Go`语言实现的`Win32 OLE`
...
* [xpath](https://github.com/antchfx/xpath) ⭐ 742 | 🐛 22 | 🌐 Go | 📅 2026-09-24 : `XPath` 库
...
* [gosimple](https://github.com/dominikh/go-tools/tree/master/cmd/gosimple) ⭐ 6,903 | 🐛 579 | 🌐 Go | 📅 2026-08-24 : 针对 Go 语言的`lint`工具,专注于简化代码
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,903 | 🐛 579 | 🌐 Go | 📅 2026-08-24 :  -`staticcheck`在`Go vet`阶段中执行大量的静态分析检查,类似`ReSharper for C#`这样的工具。
* [unused](https://github.com/dominikh/go-tools/tree/master/cmd/unused) ⭐ 6,903 | 🐛 579 | 🌐 Go | 📅 2026-08-24 :  `unused`会检查 Go 语言代码中没有用到的常量,变量,函数和类型
* [GoLint](https://github.com/golang/lint) ⚠️ Archived :  针对 Go 语言源码的` lint` 工具
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,528 | 🐛 17 | 🌐 Go | 📅 2026-05-12 : `Errcheck`是一个用于检测go语言程序中存在未处理错误的程序
* [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,082 | 🐛 39 | 🌐 Go | 📅 2025-10-16 :  生成文本`plantUML`图的库和`CLI`,包含结构和接口的信息以及它们之间的关系。
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,073 | 🐛 154 | 🌐 Go | 📅 2026-09-20 :  源代码检查器,它带来了目前其他检查器没有实现的检查。
...
* [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) ⭐ 983 | 🐛 5 | 🌐 Go | 📅 2021-11-08 :` Go-cleanarch`用于检查代码是否符合简洁架构的相关法则,比如依赖法则以及你的Go语言项目中各个库的交互情况
...
* [vim-go](https://github.com/fatih/vim-go) ⭐ 16,218 | 🐛 44 | 🌐 Vim Script | 📅 2026-08-23 : `Vim`使用的`Go` 语言开发插件
* [gocode](https://github.com/nsf/gocode) ⭐ 4,986 | 🐛 66 | 🌐 Go | 📅 2026-02-07 : `go`语言自动补全
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,262 | 🐛 438 | 🌐 TypeScript | 📅 2026-09-19 : `Visual Studio Code (VS Code)` : 使用的一个扩展,为` Go` 语言提供了支持
...
* [goimports-reviser](https://github.com/incu6us/goimports-reviser) ⭐ 718 | 🐛 11 | 🌐 Go | 📅 2026-08-29 : 用于导入的格式化工具。
...
* [gotests](https://github.com/cweill/gotests) ⭐ 5,335 | 🐛 39 | 🌐 Go | 📅 2025-10-30 :  根据源代码生成`Go`测试代码。
* [genny](https://github.com/cheekybits/genny) ⭐ 1,718 | 🐛 27 | 🌐 Go | 📅 2021-08-24 :  为` Go`提供优雅的泛型。
* [xgen](https://github.com/xuri/xgen) ⭐ 426 | 🐛 35 | 🌐 Go | 📅 2026-09-02 : ` XSD (XML Schema Definition)`  解析器,能够生成`Go/C/Java/Rust/Typescript`代码
* [hasgo](https://github.com/DylanMeeus/hasgo) ⭐ 144 | 🐛 16 | 🌐 Go | 📅 2021-04-29 :  为`slices`生成`Haskell`的启发函数。
* [gocontracts](https://github.com/Parquery/gocontracts) ⭐ 119 | 🐛 1 | 🌐 Go | 📅 2019-01-26 :   通过同步代码和文档,将按合约设计引入` Go`。
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 10,012 | 🐛 302 | 🌐 Go | 📅 2026-09-24 :  为 Go 语言实现的`Swagger 2.0`.
* [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6,526 | 🐛 73 | 🌐 Go | 📅 2026-03-30 :   使用`dot`语言将你的 Go 语言程序函数调用关系可视化
* [OctoLinker](https://github.com/OctoLinker/browser-extension) ⭐ 5,386 | 🐛 62 | 🌐 HTML | 📅 2023-10-02 :  - 使用`github` 的浏览器插件` OctoLinker`高效浏览`Go` 语言文件
* [depth](https://github.com/KyleBanks/depth) ⭐ 1,082 | 🐛 10 | 🌐 Go | 📅 2022-02-08 :  通过分析导入的库,将某个包的依赖关系用树状结构进行显示
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 127,963 | 🐛 3,101 | 🌐 Go | 📅 2026-09-24 :  来自`Google`的容器集群管理器
* [Moby](https://github.com/moby/moby) ⭐ 72,132 | 🐛 3,905 | 🌐 Go | 📅 2026-09-24 :  为容器生态系统创建的一个合作项目,用于构建基于容器的系统
* [traefik](https://github.com/containous/traefik) ⭐ 64,955 | 🐛 933 | 🌐 Go | 📅 2026-09-24 :  能对接多个后端的反向代理和负载均衡器。
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 58,153 | 🐛 2,461 | 🌐 Go | 📅 2026-09-25 :  社区驱动的`Gogs`的`fork`库
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 25,202 | 🐛 123 | 🌐 Go | 📅 2026-09-24 :  `HTTP 加`载测试工具和代码库
* [Hey](https://github.com/rakyll/hey) ⭐ 20,282 | 🐛 188 | 🌐 Go | 📅 2026-01-10 :` Hey`是一个微型程序,用于向`web` 应用发送负载
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,800 | 🐛 317 | 🌐 Go | 📅 2026-09-24 :` Packer`通过单一的配置文件,为不同的平台创建独立镜像
* [webhook](https://github.com/adnanh/webhook) ⭐ 12,148 | 🐛 127 | 🌐 Go | 📅 2026-09-04 :  允许用户创建`HTTP`钩子,并在服务器上执行命令
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,699 | 🐛 243 | 🌐 Shell | 📅 2024-08-08 : ` GVM`提供了用于管理`Go`语言版本的接口
* [script](https://github.com/bitfield/script) ⭐ 7,037 | 🐛 15 | 🌐 Go | 📅 2026-09-06 :  在Go中轻松编写类似`shell`的脚本,用于`DevOps`和系统管理任务。
...
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 5,017 | 🐛 166 | 🌐 Go | 📅 2026-09-24 :  `Pomerium`是一个身份感知的访问代理。
* [gox](https://github.com/mitchellh/gox) ⚠️ Archived :  非常简单的`Go`语言交叉编译工具
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 4,199 | 🐛 200 | 🌐 Go | 📅 2025-06-13 :  快速的` S3` 和本地文件系统执行工具。
...
* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) ⭐ 1,703 | 🐛 17 | 🌐 Go | 📅 2024-08-17 :   让你的` Go` 语言程序可以自我更新
...
* [s3gof3r](https://github.com/rlmcpherson/s3gof3r) ⭐ 1,142 | 🐛 53 | 🌐 Go | 📅 2021-08-28 :  为了从`Amazon S3`中高速存取大型对象而特别优化的库
* [skm](https://github.com/TimothyYe/skm) ⭐ 1,082 | 🐛 1 | 🌐 Go | 📅 2026-08-02 :  SKM是一个简单而强大的`SSH`密钥管理器,它可以帮助您轻松管理您的多个`SSH`密钥。
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 997 | 🐛 260 | 🌐 Go | 📅 2026-09-24 :  通过命令行来管理 裸金属服务器 (和使用`Docker`一样容易)。
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 486 | 🐛 20 | 🌐 Go | 📅 2026-09-22 : `S3`代理,具有`GET、PUT`和`DELETE`方法和认证（`OpenID Connect`和`Basic Auth`）。
* [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 458 | 🐛 1 | 🌐 Go | 📅 2026-03-28 :  灵活的`HTTP`命令行压力测试工具
* [jcli](https://github.com/jenkins-zh/jenkins-cli) ⭐ 430 | 🐛 82 | 🌐 Go | 📅 2025-03-28 :  `Jenkins CLI`允许你以一种简单的方式管理你的`Jenkins`。
* [easyssh-proxy](https://github.com/appleboy/easyssh-proxy) ⭐ 349 | 🐛 14 | 🌐 Go | 📅 2026-07-17 :   一个用于通过 ssh 远程执行命令以及可通过`ProxyCommand` 来进行 SCP 下载
* [lstags](https://github.com/ivanilves/lstags) ⭐ 340 | 🐛 10 | 🌐 Go | 📅 2023-05-11 :  在不同的注册表中同步`Docker`镜像的工具和`API`。
* [gonative](https://github.com/inconshreveable/gonative) ⚠️ Archived : 为`Go` 语言创建可以在多平台进行交叉编译的工具,使用`CGo-enabled`标准库
* [trubka](https://github.com/xitonix/trubka) ⭐ 336 | 🐛 5 | 🌐 Go | 📅 2025-04-18 : `CLI`工具,用于管理`Apache Kafka`集群并排除其故障,能够向`Kafka`发布/消费协议缓冲区和纯文本事件。
* [Mora](https://github.com/emicklei/mora) ⭐ 314 | 🐛 10 | 🌐 Go | 📅 2024-04-23 :  REST 服务器,用于获取`MonGoDB`文件和元数据
* [manssh](https://github.com/xwjdsh/manssh) ⭐ 309 | 🐛 2 | 🌐 Go | 📅 2022-02-11 : ` manssh`是一个命令行工具,用于轻松管理ssh别名配置。
...
* [godbg](https://github.com/sirnewton01/godbg) ⭐ 225 | 🐛 6 | 🌐 JavaScript | 📅 2018-07-09 :  基于`Web` 的前端` gdb` 应用程序
* [kcli](https://github.com/cswank/kcli) ⭐ 225 | 🐛 1 | 🌐 Go | 📅 2020-01-04 :  用于检查`kafka`主题/分区/消息的命令行工具。
* [Blast](https://github.com/dave/blast) ⭐ 220 | 🐛 1 | 🌐 Go | 📅 2018-03-01 : 一个简单的API负载测试和批量作业管理的工具。
* [gobrew](https://github.com/cryptojuice/gobrew) ⭐ 189 | 🐛 4 | 🌐 Shell | 📅 2020-05-21 : `Gobrew`让你可以在不同版本的` Go` 语言之间轻松切换
* [Dockerfile-Generator](https://github.com/ozankasikci/dockerfile-generator) ⭐ 186 | 🐛 0 | 🌐 Go | 📅 2022-05-23 :  包含`go`代码库和可执行文件,其可以利用各种输入管道信息生成有效的Dockerfiles。
* [ostent](https://github.com/ostrost/ostent) ⭐ 178 | 🐛 0 | 🌐 Go | 📅 2022-12-12 :  收集并显示系统数据,可以作` Graphite`和／或`InfluxDB` 的中间件
* [drone-scp](https://github.com/appleboy/drone-scp) ⭐ 174 | 🐛 24 | 🌐 Go | 📅 2026-09-06 :  通过` SSH` 拷贝文件及可执行程序,可以通过二进制文件、` docker` 或者`Drone CI`来使用
* [winrm-cli](https://github.com/masterzen/winrm-cli) ⭐ 174 | 🐛 1 | 🌐 Go | 📅 2021-12-30 :  命令行工具,可以远程在` windows`机器上执行命令
* [grapes](https://github.com/yaronsumel/grapes) ⭐ 170 | 🐛 1 | 🌐 Go | 📅 2026-09-14 :   一款轻量级工具,用于通过` ssh`发送命令
...
* [drone-jenkins](https://github.com/appleboy/drone-jenkins) ⭐ 43 | 🐛 2 | 🌐 Go | 📅 2026-09-06 : 可以通过二进制文件、` docker`或者` Drone CI`来触发下游`Jenkins` 任务,
...
* [croc](https://github.com/schollz/croc) ⭐ 40,443 | 🐛 2 | 🌐 Go | 📅 2026-09-22 :    轻松安全地将文件或文件夹从一台计算机发送到另一台计算机。
* [restic](https://github.com/restic/restic) ⭐ 36,234 | 🐛 593 | 🌐 Go | 📅 2026-09-20 :  解耦备份程序
* [Gor](https://github.com/buger/gor) ⭐ 19,323 | 🐛 341 | 🌐 Go | 📅 2026-01-27 :  Http 流量复制工具,用于将生产环境的流量在开发环境进行重放
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12,360 | 🐛 106 | 🌐 Go | 📅 2026-09-15 :  用于自动化测试中模拟网络和系统状态的代理服务。
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,515 | 🐛 26 | 🌐 Go | 📅 2025-03-20 :   模拟网络波动情况下的网络数据连接
* [scc](https://github.com/boyter/scc) ⭐ 8,776 | 🐛 26 | 🌐 Go | 📅 2026-09-24 :   一个非常快速准确的代码计数器,具有复杂度计算和`COCOMO`估计功能。
...
* [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,684 | 🐛 336 | 🌐 Go | 📅 2026-08-06 :  跨平台网络和云备份工具
...
* [Documize](https://github.com/documize/community) ⭐ 2,417 | 🐛 47 | 🌐 JavaScript | 📅 2026-05-18 :  维基软件,可以使用`SaaS`工具提供的数据
...
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,507 | 🐛 6 | 🌐 Go | 📅 2026-08-08 :  通过HTTP服务器执行`shell`命令行(用于原型验证或远程控制)。
* [vFlow](https://github.com/VerizonDigital/vflow) ⭐ 1,156 | 🐛 71 | 🌐 Go | 📅 2024-08-22 :  高性能、可扩展、可靠的`IPFIX`,`sFlow`和`Netflow`集合.
...
* [mockingjay](https://github.com/quii/mockingjay-server) ⭐ 566 | 🐛 9 | 🌐 Go | 📅 2022-05-26 : 伪`HTTP`服务器,通过单一配置文件构造访问请求。同时你还可以让服务器提升负载,以进行更加符合现实情况的性能测试
* [woke](https://github.com/get-woke/woke) ⭐ 517 | 🐛 48 | 🌐 Go | 📅 2024-05-07 :   检测源代码中的排他性代码段。
* [go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) ⭐ 478 | 🐛 11 | 🌐 Go | 📅 2023-03-23 : 视频流下载客户端。
* [ide](https://github.com/thestrukture/ide) ⭐ 364 | 🐛 1 | 🌐 Go | 📅 2026-08-24 :  为`Go`语言设计可以在浏览器的`IDE`。
* [ipe](https://github.com/dimiro1/ipe) ⚠️ Archived : `Go`语言编写的开源`Pusher`服务器,兼容` Pusher`客户端。
* [tcpprobe](https://github.com/mehrdadrad/tcpprobe) ⭐ 355 | 🐛 4 | 🌐 Go | 📅 2021-02-21 :  -`TCP`工具,用于网络性能和路径监控,包括套接字统计等。
...
* [vaku](https://github.com/lingrino/vaku) ⭐ 160 | 🐛 1 | 🌐 Go | 📅 2026-09-24 :  为`Vault`中基于文件夹的功能如复制、移动和搜索提供`CLI`和`API`。
...
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 41 | 🐛 1 | 🌐 Go | 📅 2026-09-25 :  快速、简单、可扩展的分布式文件系统,具有`O(1)`的磁盘查找效率
