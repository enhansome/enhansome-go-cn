【导读】：[awesome-go](https://github.com/avelino/awesome-Go) ⭐ 180,982 | 🐛 209 | 🌐 Go | 📅 2026-08-13 就是 `avelino` 发起维护的 Go 资源列表，内容包括：音频和音乐库、命令行工具、服务端应用、流处理、持续集成、数据库、机器学习、NLP、物联网、中间件、文本处理、安全、机器人技术等。
...
* [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,947 | 🐛 21 | 🌐 Go | 📅 2026-08-13 :  可用于在多个平台上播放音频的底层库
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 20,322 | 🐛 42 | 🌐 Go | 📅 2026-08-13 : 支持`ACL`、`RBAC`、`ABAC`等访问控制模型的授权与认证库。
* [jwt-go](https://github.com/dgrijalva/jwt-go) ⚠️ Archived :   -`JSON Web Tokens`（JWT）的Golang实现。
* [goth](https://github.com/markbates/goth) ⭐ 6,589 | 🐛 147 | 🌐 Go | 📅 2026-02-11 :   以简单、干净、常用的方式来使用`OAuth`和`OAuth2`。支持多种身份认证。
* [oauth2](https://github.com/golang/oauth2) ⭐ 5,889 | 🐛 61 | 🌐 Go | 📅 2026-03-08 :  继承自`goauth2`。实现了JWT,Google APIs,GCE,GAE的通用`OAuth 2.0`授权包。
...
* [gologin](https://github.com/dghubble/gologin) ⭐ 1,958 | 🐛 1 | 🌐 Go | 📅 2026-08-11 :  适用于OAuth1和OAuth2多身份登录认证的实现方案
...
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,634 | 🐛 65 | 🌐 Go | 📅 2026-06-16 :  用`Go`编写的`Telegram`机器人框架。
...
* [cobra](https://github.com/spf13/cobra) ⭐ 44,459 | 🐛 430 | 🌐 Go | 📅 2026-07-11 :   一个现代化的命令行。
* [urfave/cli](https://github.com/urfave/cli) ⭐ 24,192 | 🐛 84 | 🌐 Go | 📅 2026-08-13 :   简单、快速、有趣的、用于构建 Go 语言命令行程序的软件包。
* [kingpin](https://github.com/alecthomas/kingpin) ⭐ 3,568 | 🐛 28 | 🌐 Go | 📅 2026-07-08 :  支持子命令的命令行和标志位解析器。
* [Dnote](https://github.com/dnote/dnote) ⭐ 3,053 | 🐛 40 | 🌐 Go | 📅 2026-07-25 :  支持多设备同步的命令行笔记工具。
...
* [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,268 | 🐛 34 | 🌐 Go | 📅 2025-12-27 :  `Go`中基于结构体的参数解析。
* [mitchellh/cli](https://github.com/mitchellh/cli) ⚠️ Archived :  用于实现命令行交互的 `Go `语言库
* [ops](https://github.com/nanovms/ops) ⭐ 1,509 | 🐛 144 | 🌐 Go | 📅 2026-08-02 : `Unikernel `编辑器和生成器
...
* [pterm](https://github.com/pterm/pterm) ⭐ 5,514 | 🐛 83 | 🌐 Go | 📅 2026-07-11 :  在每个平台上美化控制台输出的库,有许多可组合的组件。
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,488 | 🐛 114 | 🌐 Go | 📅 2025-08-12 :   受 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,552 | 🐛 705 | 🌐 Python | 📅 2026-07-26  的启发，用于构建强大的交互式提示符的go语言库
* [termbox-go](https://github.com/nsf/termbox-go) ⭐ 4,787 | 🐛 50 | 🌐 Go | 📅 2026-06-23 :   Termbox是一个用于创建跨平台文本界面的库。
* [progressbar](https://github.com/schollz/progressbar) ⭐ 4,691 | 🐛 11 | 🌐 Go | 📅 2026-07-17 :   适用于各种操作系统的,线程安全进度条管理库。
...
* [aurora](https://github.com/logrusorgru/aurora) ⭐ 1,493 | 🐛 2 | 🌐 Go | 📅 2025-01-07 :   `ANSI` 终端颜色,支持 `fmt.Printf/Sprintf`
...
* [gommon/color](https://github.com/labstack/gommon/tree/master/color) ⭐ 593 | 🐛 15 | 🌐 Go | 📅 2026-07-23 ：多样的命令行文本
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 10,581 | 🐛 80 | 🌐 Go | 📅 2026-08-04 : 把 `Ruby`的 `dotenv `库移植到 `Go `（从 `.env `中加载环境变量）。
* [env](https://github.com/caarlos0/env) ⭐ 6,283 | 🐛 32 | 🌐 Go | 📅 2026-08-03 :   解析环境变量为` Go` 语言结构体
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,461 | 🐛 57 | 🌐 Go | 📅 2025-06-28 :  用于管理环境变量配置数据的` Go` 库。
* [koanf](https://github.com/knadh/koanf) ⭐ 4,156 | 🐛 1 | 🌐 Go | 📅 2026-08-09 :  轻量级、可扩展的库,用于读取Go应用程序中的配置。内置支持`JSON、TOML、YAML、env`、命令行。
* [ini](https://github.com/go-ini/ini) ⭐ 3,544 | 🐛 81 | 🌐 Go | 📅 2026-06-10 :  用于读写INI 文件的库
...
* [harvester](https://github.com/beatlabs/harvester) ⭐ 135 | 🐛 12 | 🌐 Go | 📅 2026-08-03 :   `Harvester,`一个易于使用的静态和动态配置包,支持 `envars` 和 `Consul` 集成。
...
* [drone](https://github.com/drone/drone) ⭐ 37,830 | 🐛 104 | 🌐 Go | 📅 2026-08-13 : ` Drone` 是一个基于` Docker`的持续集成平台,使用 `Go `语言编写
* [CDS](https://github.com/ovh/cds) ⭐ 4,831 | 🐛 158 | 🌐 Go | 📅 2026-08-13 :  企业级`CI/CD`和`DevOps`自动化开源平台。
...
* [gods](https://github.com/emirpasic/gods) ⭐ 17,451 | 🐛 74 | 🌐 Go | 📅 2025-03-12 :` Go`语言数据结构、容器、集合、列表、栈、键值对、 `BidiMaps`、树、`HashSet`等
* [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,946 | 🐛 29 | 🌐 Go | 📅 2026-07-31:一组有用的、高性能的、线程安全的数据结构
...
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,916 | 🐛 71 | 🌐 Go | 📅 2026-08-13 :  实现了压缩`bitsets`算法的Go语言库
...
* [ttlcache](https://github.com/ReneKroon/ttlcache) ⭐ 1,273 | 🐛 16 | 🌐 Go | 📅 2026-08-13 : 基于过期时间的内存字符串缓存接口。
...
* [hyperloglog](https://github.com/axiomhq/hyperloglog) ⭐ 1,045 | 🐛 7 | 🌐 Go | 📅 2026-07-24 : `HyperLogLog` 的go语言实现
* [algorithms](https://github.com/shady831213/algorithms) ⭐ 843 | 🐛 0 | 🌐 Go | 📅 2021-03-17 :  算法和数据结构学习资料
...
* [merkletree](https://github.com/cbergoon/merkletree) ⭐ 539 | 🐛 1 | 🌐 Go | 📅 2026-08-13 :  实现了梅克尔树,提供了一种高效、安全的数据结构内容验证方法
...
* [goterator](https://github.com/yaa110/goterator) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2025-10-15 :   迭代器的实现,提供映射和减少功能。
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,729 | 🐛 887 | 🌐 Go | 📅 2026-08-13 :  监控系统及时间序列数据库
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,426 | 🐛 6,787 | 🌐 Go | 📅 2026-08-13 : ` TiDB` 是一个分布式的` SQL` 数据库。受到了` Google F1`的启发
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,387 | 🐛 8,204 | 🌐 Go | 📅 2026-08-07 :  可扩展的、一致的事务型数据库
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 31,692 | 🐛 2,148 | 🌐 Rust | 📅 2026-08-13 :  用于度量、事件和实时分析的可扩展数据存储。
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,773 | 🐛 94 | 🌐 Go | 📅 2026-08-13 :  可扩展的、分布式的、低延时、高吞吐的图数据库
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 17,678 | 🐛 79 | 🌐 Go | 📅 2026-08-10 :  基于 `SQLite `的轻量级的、分布式的关系型数据库
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,525 | 🐛 775 | 🌐 Go | 📅 2026-08-13 :  快速、资源高效、可扩展的开源时间序列数据库。可作为`Prometheus`的长期远程存储。支持`PromQL`。
* [badger](https://github.com/dgraph-io/badger) ⭐ 15,749 | 🐛 68 | 🌐 Go | 📅 2026-08-13 : `Go`中的快速键值存储库。
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,336 | 🐛 45 | 🌐 Go | 📅 2024-11-29 :  `Groupcache`是一个缓存及缓存填充库,在很多情况下用于替代 `memcached`.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,681 | 🐛 28 | 🌐 Go | 📅 2026-08-13 :  `Go`的嵌入式键值数据库。
* [immudb](https://github.com/codenotary/immudb) ⭐ 9,019 | 🐛 103 | 🌐 Go | 📅 2026-08-03 :  `immudb `是一个轻量级、高速的不可变数据库,适用于用`Go`编写的系统和应用程序。
* [go-cache](https://github.com/pmylund/go-cache) ⭐ 8,842 | 🐛 76 | 🌐 Go | 📅 2023-11-20 :   基于内存存储的缓存,适用于分布式部署的应用
* [BigCache](https://github.com/allegro/bigcache) ⭐ 8,145 | 🐛 93 | 🌐 Go | 📅 2026-08-11 :  为GB量级数据设计的高效键/值缓存
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,321 | 🐛 111 | 🌐 Go | 📅 2024-05-14 :  `Go`中[LevelDB](https://github.com/google/leveldb) ⭐ 39,325 | 🐛 401 | 🌐 C++ | 📅 2026-03-11键/值数据库的实现
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,813 | 🐛 486 | 🌐 Go | 📅 2026-07-05 :   数据库迁移。命令行及 `Go `语言库
* [goose](https://github.com/pressly/goose) ⭐ 11,321 | 🐛 137 | 🌐 Go | 📅 2026-08-08 :   数据库迁移工具。你可以通过编写增量 `SQL `或 `Go` 语言脚本来管理你的数据库
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,221 | 🐛 1,070 | 🌐 Go | 📅 2026-08-13 :  `vitess` 提供了能够使大型 `web `服务 `MySQL` 数据库的扩展变得更加容易的服务器及工具
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,476 | 🐛 55 | 🌐 Go | 📅 2026-07-26 :  基于 `Web` 的 `PostgreSQL` 数据库浏览工具
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,964 | 🐛 156 | 🌐 Go | 📅 2026-08-07 :   用于处理` MySQL` 协议及复制的`Go`语言工具集
* [pREST](https://github.com/nuveo/prest) ⭐ 4,611 | 🐛 151 | 🌐 Go | 📅 2026-08-11 :  为 `PostgreSQL `数据库提供 `RESTful API`
...
* [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1,477 | 🐛 90 | 🌐 Go | 📅 2026-04-15 : ` HTTP`代理的`ClickHouse`数据库。
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,775 | 🐛 43 | 🌐 Go | 📅 2026-06-22 :  在`Go`中编写类型安全的`SQL`查询框架,能够轻松地将数据库查询结果转换为所需的任意对象结构。
...
* 关系型数据库
  ...
  * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 15,276 | 🐛 73 | 🌐 Go | 📅 2026-08-13 :  Go 语言 `MySQL`驱动
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,207 | 🐛 159 | 🌐 C | 📅 2026-07-30 :  Go 语言的 `SQLite3 `驱动
  ...
  * [pgx](https://github.com/jackc/pgx) ⭐ 14,133 | 🐛 258 | 🌐 Go | 📅 2026-08-01 :  `PostgreSQL` 驱动,支持比 `database/sql `更多的特性
  * [pq](https://github.com/lib/pq) ⭐ 9,918 | 🐛 50 | 🌐 Go | 📅 2026-08-03 :  用于`database/sql`的`Pure Go Postgres`驱动。
  * [Sqinn-Go](https://github.com/cvilsmeier/sqinn-go) ⭐ 538 | 🐛 0 | 🌐 Go | 📅 2026-07-05 :  纯Go的`SQLite`驱动。

***

* NoSQL数据库
  * [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) ⭐ 459 | 🐛 43 | 🌐 Go | 📅 2026-08-12 :   `Go`语言的`Aerospike`客户端。
  ...
  * [mgm](https://github.com/kamva/mgm) ⭐ 763 | 🐛 17 | 🌐 Go | 📅 2026-08-03 :  用于 `Go` 的基于` MongoDB` 模型的` ODM`（基于官方 MongoDB 驱动程序）
  * [mgo](https://github.com/globalsign/mgo) ⭐ 1,960 | 🐛 64 | 🌐 Go | 📅 2021-10-29 :`  MonGoDB` 驱动,通过简单的 `API` 现了丰富的、经过测试的特性,这些 API 遵循 Go 语言的习惯
  * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,535 | 🐛 16 | 🌐 Go | 📅 2026-08-13 :   `Go`语言的官方`MongoDB`驱动。
  ...
  * [redigo](https://github.com/gomodule/redigo) ⭐ 9,856 | 🐛 24 | 🌐 Go | 📅 2025-11-02 : ` RediGo`是 `Redis` 数据库的`Go` 语言客户端.
  * [redis](https://github.com/go-redis/redis) ⭐ 22,217 | 🐛 63 | 🌐 Go | 📅 2026-08-13 :  兼容R`edis`协议的 `TCP` 服务器/服务.
  * [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 :  类型安全的、可定制的、简洁易用的 `Redis` 客户端

***

* 搜索引擎和文本数据库
  * [bleve](https://github.com/blevesearch/bleve) ⭐ 11,179 | 🐛 299 | 🌐 Go | 📅 2026-08-13 :  现代文本索引库
  * [elastic](https://github.com/olivere/elastic) ⭐ 7,447 | 🐛 116 | 🌐 Go | 📅 2024-08-08 :  ` Go` 语言的 `Elasticsearch `客户端
  * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 6,059 | 🐛 24 | 🌐 Go | 📅 2026-08-04 : Go的官方`Elasticsearch`客户端。
...
* [feiertage](https://github.com/wlbr/feiertage) ⭐ 53 | 🐛 0 | 🌐 Go | 📅 2026-05-18 :   一组计算德国公共假期的函数,比如复活节、感恩节等
...
* [tuesday](https://github.com/osteele/tuesday) ⭐ 13 | 🐛 2 | 🌐 Go | 📅 2026-08-11 :  `Ruby`兼容的`Strftime`函数。
...
* [raft](https://github.com/coreos/etcd/tree/master/raft) ⭐ 52,121 | 🐛 307 | 🌐 Go | 📅 2026-08-13 : ` Raft`共识协议的 `Go` 实现,由 `CoreOS` 提供。
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,426 | 🐛 60 | 🌐 Go | 📅 2024-07-19 :   为服务工具吧,支持服务发现、负载均衡 、可插拔传输以及请求追踪等
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 23,034 | 🐛 128 | 🌐 Go | 📅 2026-08-13 : ` gRPC`的Go语言实现。基于`HTTP/2的RPC`。
* [go-micro](https://github.com/micro/go-micro) ⭐ 23,009 | 🐛 8 | 🌐 Go | 📅 2026-08-12 :   一个分布式系统开发框架。
* [NATS](https://github.com/nats-io/gnatsd) ⭐ 20,493 | 🐛 541 | 🌐 Go | 📅 2026-08-13 :  轻量级、高性能微服务系统,用于微服务、物联网以及云
* [raft](https://github.com/hashicorp/raft) ⭐ 9,084 | 🐛 51 | 🌐 Go | 📅 2026-08-02 :  `Raft` 共识协议的 `Golang `实现,由 `HashiCorp`.开发。
* [rpcx](https://github.com/smallnest/rpcx) ⭐ 8,311 | 🐛 3 | 🌐 Go | 📅 2026-07-10 :   `rpcx`是一个类似阿里巴巴` Dubbo` 和微博` Motan` 的分布式的`RPC`服务框架
* [KrakenD](https://github.com/devopsfaith/krakend) ⭐ 6,787 | 🐛 13 | 🌐 Go | 📅 2026-08-04 :  带有中间件的,高性能`API`网关框架
* [torrent](https://github.com/anacrolix/torrent) ⭐ 6,090 | 🐛 68 | 🌐 Go | 📅 2026-08-13 :   `BitTorrent` 客户端
* [tendermint](https://github.com/tendermint/tendermint) ⭐ 5,864 | 🐛 20 | 🌐 Go | 📅 2026-08-12 : 使用`Tendermint` 一致性及区块链协议的高性能的中间件,用于将任何语言编写的状态机转换为一个拜占庭容错状态机,
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,323 | 🐛 64 | 🌐 Go | 📅 2025-07-23 :  `Go`中一个功能完整且高性能的多组`Raft`库。
* [emitter-io](https://github.com/emitter-io/emitter) ⭐ 4,003 | 🐛 16 | 🌐 Go | 📅 2026-04-29 :  使用` MQTT、Websockets` 和 `love` 构建的高性能、分布式、安全和低延迟的发布-订阅平台。
...
* [hprose](https://github.com/hprose/hprose-golang) ⭐ 1,257 | 🐛 5 | 🌐 Go | 📅 2024-02-18 :  非常新颖的RPC库,现在支持25种以上的语言。
...
* [consistent](https://github.com/buraksezer/consistent) ⭐ 779 | 🐛 7 | 🌐 Go | 📅 2023-11-07 :  有限负载的一致哈希算法库。
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 388 | 🐛 0 | 🌐 Go | 📅 2023-07-09 :  在 `HTTP `服务之间进行无主` p2p` 自动发现和 RPC通信(使用 [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,963 | 🐛 379 | 🌐 C++ | 📅 2026-07-26)ß
* [jsonrpc](https://github.com/ybbus/jsonrpc) ⭐ 371 | 🐛 0 | 🌐 Go | 📅 2025-10-26 :  `JSON-RPC 2.0 HTTP `客户端实现
* [dht](https://github.com/anacrolix/dht) ⭐ 362 | 🐛 5 | 🌐 Go | 📅 2026-05-25 : `BitTorrent Kademlia DHT`的实现。
* [jsonrpc](https://github.com/osamingo/jsonrpc) ⭐ 193 | 🐛 6 | 🌐 Go | 📅 2025-03-28 : `jsonrpc` 包实现了 `JSON-RPC 2.0`.
* [outboxer](https://github.com/italolelis/outboxer) ⭐ 168 | 🐛 5 | 🌐 Go | 📅 2026-08-12 : ` Outboxer`是一个实现`outbox`模式的`go`库。
...
* [GoDNS](https://github.com/timothyye/godns) ⭐ 1,772 | 🐛 15 | 🌐 Go | 📅 2026-07-26 : 用Go编写的动态`DNS`客户端工具,支持`DNSPod`和`HE.net`。
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 16,118 | 🐛 255 | 🌐 Go | 📅 2024-02-13 :  `Email` 及 `SMTP` 测试工具,具有 web 及 API 接口
...
* [go-imap](https://github.com/emersion/go-imap) ⭐ 2,346 | 🐛 79 | 🌐 Go | 📅 2026-07-02 :  ` IMAP` 库,用于客户端和服务器
* [SendGrid](https://github.com/sendgrid/sendgrid-go) ⭐ 1,061 | 🐛 34 | 🌐 Go | 📅 2026-06-25 : `SendGrid`的 Go 语言库,用于发送电子邮件
* [mailgun-go](https://github.com/mailgun/mailgun-go) ⭐ 745 | 🐛 2 | 🌐 Go | 📅 2026-08-10 :  使用`Mailgun API`发送邮件的Go库。
...
* [expr](https://github.com/antonmedv/expr) ⭐ 7,973 | 🐛 89 | 🌐 Go | 📅 2026-07-07 :  ` Go` 的表达式评估引擎，具有快速、非图灵完备、动态类型化、静态类型化的特性。
* [goja](https://github.com/dop251/goja) ⭐ 7,044 | 🐛 31 | 🌐 Go | 📅 2026-08-06 :  在 Go 中实现 `ECMAScript 5.1(+)` 。
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,965 | 🐛 103 | 🌐 Go | 📅 2026-04-01 :  ` Go` 语言编写的 `Lua 5.1` 虚拟机和编译器
* [tengo](https://github.com/d5/tengo) ⭐ 3,830 | 🐛 89 | 🌐 Go | 📅 2026-04-29 : `Go`的字节码编译脚本语言。
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,446 | 🐛 48 | 🌐 Go | 📅 2025-07-18 :  `Lua 5.2`虚拟机的纯 Go 语言接口
* [cel-go](https://github.com/google/cel-go) ⭐ 3,064 | 🐛 64 | 🌐 Go | 📅 2026-08-13 :  快速、可移植、非图灵完全表达式评估和渐进分型。
...
* [go-multierror](https://github.com/hashicorp/go-multierror) ⭐ 2,577 | 🐛 29 | 🌐 Go | 📅 2026-07-06 : 用于将错误列表表示为单个错误的包
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 8,778 | 🐛 108 | 🌐 Go | 📅 2026-08-11 :   PDF 处理器。
* [afero](https://github.com/spf13/afero) ⭐ 6,687 | 🐛 127 | 🌐 Go | 📅 2026-07-08 : ` go`语言编写的对文件系统进行抽象的系统框架
* [notify](https://github.com/rjeczalik/notify) ⭐ 936 | 🐛 46 | 🌐 Go | 📅 2026-06-01 : 类似 `os/signal`的文件系统提示库,具有简单的 API.
* [copy](https://github.com/otiai10/copy) ⭐ 771 | 🐛 22 | 🌐 Go | 📅 2025-01-05 :  递归复制目录。
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 7,466 | 🐛 154 | 🌐 Go | 📅 2026-06-29 :  支持任意精度的十进制数的go包
* [go-money](https://github.com/rhymond/go-money) ⭐ 1,910 | 🐛 28 | 🌐 Go | 📅 2026-04-29 :   `Fowler's Money`模式的实现。
...
* [currency](https://github.com/bojanz/currency) ⭐ 644 | 🐛 4 | 🌐 Go | 📅 2026-08-10 :  处理货币金额,提供货币信息和格式。
...
* [form](https://github.com/go-playground/form) ⭐ 922 | 🐛 15 | 🌐 Go | 📅 2025-10-11 :  解码 `url `中的数据到 `Go` 语言变量中以及将 `Go `语言变量编码进 `url` 。
...
* [Ebiten](https://github.com/hajimehoshi/ebiten) ⭐ 13,397 | 🐛 294 | 🌐 Go | 📅 2026-08-13 :  `Go` 语言编写的简单的 `2D` 游戏库
...
* [nano](https://github.com/lonng/nano) ⭐ 3,219 | 🐛 33 | 🌐 Go | 📅 2026-02-26 :  基于`golang`的轻量级、设施、高性能的游戏服务器框架。
* [g3n](https://github.com/g3n/engine) ⭐ 3,103 | 🐛 36 | 🌐 Go | 📅 2026-08-01 :  `Go 3D`游戏引擎。
* [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2,821 | 🐛 67 | 🌐 Go | 📅 2026-07-22 :  可扩展的游戏服务器框架,支持集群,并通过`C SDK`为`iOS、Android、Unity`等提供客户端库。
* [goworld](https://github.com/xiaonanln/goworld) ⭐ 2,719 | 🐛 27 | 🌐 Go | 📅 2025-11-14 :  可扩展的游戏服务器引擎。
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,506 | 🐛 10 | 🌐 C | 📅 2026-08-07 :   raylib的 Go 语言接口,简单、易用的用于学习游戏编程的库
...
* [Oak](https://github.com/oakmound/oak) ⭐ 1,666 | 🐛 14 | 🌐 Go | 📅 2026-08-10 :  `go`游戏引擎。
...
* [jennifer](https://github.com/dave/jennifer) ⭐ 3,626 | 🐛 19 | 🌐 Go | 📅 2024-09-08 :   不适用模板生成任意 `Go` 语言代码
* [gen](https://github.com/clipperhouse/gen) ⭐ 1,424 | 🐛 30 | 🌐 Go | 📅 2023-10-31 :  代码生成工具,用于提供类似泛型的功能
...
* [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 13,172 | 🐛 191 | 🌐 Go | 📅 2026-07-27 :  把` Go` 编译为` JavaScript.`
...
* [osm](https://github.com/paulmach/osm) ⭐ 465 | 🐛 9 | 🌐 Go | 📅 2026-07-16 :   用于读取、写入和处理`OpenStreetMap`数据和API的库。
...
* [ants](https://github.com/panjf2000/ants) ⭐ 14,485 | 🐛 1 | 🌐 Go | 📅 2026-07-04 : 高性能和低消耗的`goroutine`池。
* [tunny](https://github.com/Jeffail/tunny) ⭐ 4,029 | 🐛 8 | 🌐 Go | 📅 2023-03-09 :  `Go `语言协程池
* [goworker](https://github.com/benmanns/goworker) ⭐ 2,844 | 🐛 34 | 🌐 Go | 📅 2025-04-15 :  `Goworker `是一个基于 Go 语言的后台worker
* [pond](https://github.com/alitto/pond) ⭐ 2,184 | 🐛 6 | 🌐 Go | 📅 2026-06-22 :   在 `Go` 中编写的最小化和高性能的 `goroutine `工作池。
* [workerpool](https://github.com/gammazero/workerpool) ⭐ 1,457 | 🐛 4 | 🌐 Go | 📅 2026-07-02 :   用于限制任务执行的并发性的`goroutine`缓冲池。
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 28,592 | 🐛 720 | 🌐 Go | 📅 2026-08-13 :   基于`Material Design`为`Go`设计的跨平台本地GUI。支持 Linux, macOS, Windows, BSD, iOS\` 和 Android.
* [webview](https://github.com/zserge/webview) ⭐ 14,198 | 🐛 206 | 🌐 C++ | 📅 2026-03-09 :   支持双向`JavaScript`绑定的跨平台 webview 窗口库（`Windows，macOS，Linux`）。
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,768 | 🐛 3 | 🌐 Go | 📅 2026-07-29 :   跨平台`GUI`自动化工具，可以控制鼠标、键盘及其他设备
* [app](https://github.com/murlokswarm/app) ⭐ 8,954 | 🐛 53 | 🌐 Go | 📅 2026-08-12 :  使用`Go, HTML` 和 `CSS` 进行应用程序开发的库， 支持` MacOS, Windows`。
* [ui](https://github.com/andlabs/ui) ⭐ 8,357 | 🐛 126 | 🌐 Go | 📅 2022-05-19 :  跨平台的原生 GUI 库
...
* [systray](https://github.com/getlantern/systray) ⭐ 3,723 | 🐛 114 | 🌐 Go | 📅 2024-07-03 :  跨平台的` Go` 语言库,用于在桌面提醒区域放置按钮及菜单
...
* [gocv](https://github.com/hybridgroup/gocv) ⭐ 7,484 | 🐛 352 | 🌐 Go | 📅 2026-05-28 : 使用` OpenCV 3.3+` 的计算机视觉的 `Go` 包。
...
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,202 | 🐛 17 | 🌐 Go | 📅 2026-08-01 :  汇集了使用 `Go `语言编写的图像处理算法
...
* [bimg](https://github.com/h2non/bimg) ⭐ 3,024 | 🐛 180 | 🌐 Go | 📅 2025-01-23 :   利用`libvips`进行快速高效的图像处理
* [picfit](https://github.com/thoas/picfit) ⭐ 2,339 | 🐛 12 | 🌐 Go | 📅 2026-07-24 :  一个使用 `Go `语言编写的图片缩放服务器
...
* [canvas](https://github.com/tdewolff/canvas) ⭐ 1,828 | 🐛 23 | 🌐 Go | 📅 2026-08-09 :  将矢量图形转换成 `PDF、SVG `或光栅化图像。
...
* [gltf](https://github.com/qmuntal/gltf) ⭐ 285 | 🐛 3 | 🌐 Go | 📅 2026-05-28 :  高效且强大的`glTF 2.0`读取器、写入器和验证器。
...
* [go-cairo](https://github.com/ungerik/go-cairo) ⭐ 153 | 🐛 3 | 🌐 Go | 📅 2026-04-28 :   `cairo` 图形库的 `Go `语言接口
...
* [mpo](https://github.com/donatj/mpo) ⭐ 27 | 🐛 2 | 🌐 Go | 📅 2026-07-19 :  ` MPO 3D` 照片解码与转换工具.

## 物联网(IOT)

* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,447 | 🐛 99 | 🌐 Go | 📅 2026-01-07 : ` Gobot` 是一个用于机器人,物理计算以及物联网的库
...
* [connectordb](https://github.com/connectordb/connectordb) ⭐ 421 | 🐛 22 | 🌐 Go | 📅 2022-06-27 :  针对`iot`的开源物联网平台
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 7,132 | 🐛 2 | 🌐 Go | 📅 2026-07-21 : 简单流畅的`Go`作业调度。这是·`jasonlvhit/gocron`·\`的一个积极维护的fork.
* [go-quartz](https://github.com/reugn/go-quartz) ⭐ 2,013 | 🐛 4 | 🌐 Go | 📅 2026-01-20 :  简单、零依赖的`Go`调度库。
* [JobRunner](https://github.com/bamzi/jobrunner) ⭐ 1,088 | 🐛 11 | 🌐 Go | 📅 2020-11-14 :  智能且功能丰富的`cron`任务调度器,内置任务队列和实时监控。
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,549 | 🐛 101 | 🌐 Go | 📅 2026-05-14 :  用一行代码获取`JSON`值。
...
* [logrus](https://github.com/sirupsen/logrus) ⭐ 25,750 | 🐛 42 | 🌐 Go | 📅 2026-08-13 : `Go`的结构化日志记录器。
* [zap](https://github.com/uber-go/zap) ⭐ 24,654 | 🐛 188 | 🌐 Go | 📅 2026-08-05 :  快速的、结构化的、分级的日志库
* [zerolog](https://github.com/rs/zerolog) ⭐ 12,490 | 🐛 144 | 🌐 Go | 📅 2026-08-10 :  零内存分配 的`JSON `日志库.
* [spew](https://github.com/davecgh/go-spew) ⭐ 6,402 | 🐛 69 | 🌐 Go | 📅 2024-04-06 :  - 为 `Go `语言的数据结构实现了一个整洁的打印功能,有助于调试
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,458 | 🐛 102 | 🌐 Go | 📅 2024-08-05 :  简单的循环日志工具。
...
* [logur](https://github.com/logur/logur) ⚠️ Archived :  日志记录接口和日志记录最佳实践的整合,它对诸多知名库如[logrus](https://github.com/sirupsen/logrus) ⭐ 25,750 | 🐛 42 | 🌐 Go | 📅 2026-08-13、[go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,426 | 🐛 60 | 🌐 Go | 📅 2024-07-19、[zap](https://github.com/uber-go/zap) ⭐ 24,654 | 🐛 188 | 🌐 Go | 📅 2026-08-05 ， [zerolog](https://github.com/rs/zerolog) ⭐ 12,490 | 🐛 144 | 🌐 Go | 📅 2026-08-10等的功能进行了集成
...
* [logrusly](https://github.com/sebest/logrusly) ⭐ 29 | 🐛 3 | 🌐 Go | 📅 2021-07-27 :  [logrus](https://github.com/sirupsen/logrus) ⭐ 25,750 | 🐛 42 | 🌐 Go | 📅 2026-08-13插件,用于将错误发送到[Loggly](https://www.loggly.com/)
...
* [kemba](https://github.com/clok/kemba) ⭐ 18 | 🐛 9 | 🌐 Go | 📅 2026-08-04 :  受[debug](https://github.com/visionmedia/debug) ⭐ 11,452 | 🐛 90 | 🌐 JavaScript | 📅 2026-04-01 启发的小型调试日志工具,非常适合CLI工具和应用程序。
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,923 | 🐛 124 | 🌐 Go | 📅 2024-08-12 :  基于图的计算库,类似于 `Theano`。提供了一些原型用于构建各种个样的机器学习和神经网络算法
* [gosseract](https://github.com/otiai10/gosseract) ⭐ 3,126 | 🐛 32 | 🌐 Go | 📅 2026-01-16 :    用于`OCR`（光学字符识别）的`Go`包,使用`Tesseract C++`库。
...
* [onnx-go](https://github.com/owulveryck/onnx-go) ⭐ 903 | 🐛 44 | 🌐 Go | 📅 2024-09-02 :  `Open Neural Network Exchange (ONNX)`的`Go`接口。
...
* [go-deep](https://github.com/patrikeh/go-deep) ⭐ 558 | 🐛 2 | 🌐 Go | 📅 2024-07-11 :  用`Go`编写的功能丰富的神经网络库。
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 13,628 | 🐛 291 | 🌐 Go | 📅 2026-06-22 :   建立在 `Redis` 之上，为 `Go` 提供的简单、可靠、高效的分布式任务队列,。
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,504 | 🐛 28 | 🌐 Go | 📅 2026-08-12 :  用于 `Apache Kafka `的库
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10,618 | 🐛 23 | 🌐 Go | 📅 2026-08-12 :  实时消息服务器
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,757 | 🐛 67 | 🌐 Go | 📅 2026-07-25  通知推送服务器,使用 [APNs2](https://github.com/sideshow/apns2) ⭐ 3,187 | 🐛 32 | 🌐 Go | 📅 2025-07-22 和 [GCM](https://github.com/google/go-gcm) ⚠️ Archived 。
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,732 | 🐛 321 | 🌐 Go | 📅 2026-08-13 : 在一系列协议之间建立消息流`go`代码库
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,969 | 🐛 245 | 🌐 Go | 📅 2025-11-15 :  异步任务队列,基于分布式消息处理
* [NATS Go Client](https://github.com/nats-io/nats) ⭐ 6,722 | 🐛 158 | 🌐 Go | 📅 2026-08-12 :   原生的 `oplog/replication `系统,用于 `REST APIs`场景
* [go-socket.io](https://github.com/googollee/go-socket.io) ⚠️ ArchivedGo 语言的 `socket.io`库 ,一个实时应用框架.
* [Mercure](https://github.com/dunglas/mercure) ⭐ 5,299 | 🐛 17 | 🌐 Go | 📅 2026-08-10 :   使用`Mercure`协议（建立在`Server-Sent Events`之上）来调度服务器发送的更新的代码库。
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 5,160 | 🐛 277 | 🌐 HTML | 📅 2026-08-13   是`Confluent`为`Apache Kafka`和`Confluent Platform`开发的`Golang`客户端。
* [melody](https://github.com/olahol/melody) ⭐ 4,080 | 🐛 14 | 🌐 Go | 📅 2025-10-28 :  用于处理`websocket`会话的简约框架,包括广播和自动`ping/pong`处理。
...
* [dbus](https://github.com/godbus/dbus) ⭐ 1,190 | 🐛 54 | 🌐 Go | 📅 2026-05-01 : ` D-Bus`的 `Go` 语言接口
...
* [rabtap](https://github.com/jandelgado/rabtap) ⭐ 288 | 🐛 5 | 🌐 Go | 📅 2026-08-10 :  -` RabbitMQ` 瑞士军刀 `cli `应用。
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,923 | 🐛 9 | 🌐 Go | 📅 2026-08-13 :  用于创建和处理`Office Word (.docx)、Excel (.xlsx)`和`Powerpoint (.pptx)`文档的纯`go`库。

### EXCEL

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) ⭐ 20,852 | 🐛 131 | 🌐 Go | 📅 2026-08-12 :  用于读写 `Microsoft Excel™ (XLSX)` 文件的 `Golang `库
...
* [fx](https://github.com/uber-go/fx) ⭐ 7,634 | 🐛 78 | 🌐 Go | 📅 2025-12-27 :  基于 `Go `的依赖注入应用框架（建立在 `dig` 的基础上）。
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 56,454 | 🐛 95 | 🌐 Makefile | 📅 2026-04-28 :  -` Go` 生态系统中常见的历史和新兴项目布局模式集。
...
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,896 | 🐛 218 | 🌐 Go | 📅 2026-08-09 :  跨平台库,用于检索进程和系统利用率（`CPU`、内存、磁盘等）。
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 11,805 | 🐛 360 | 🌐 Go | 📅 2026-08-09 :  自动化的服务健康仪表板。
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 5,376 | 🐛 8 | 🌐 Go | 📅 2026-05-15 :   用`go`编写的随机数据生成器。
...
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 2,115 | 🐛 10 | 🌐 Go | 📅 2026-08-01 :  快速将整个` org/users` 仓库克隆到一个目录中 - 支持` GitHub、GitLab` 和 `Bitbucket`。
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,650 | 🐛 78 | 🌐 Go | 📅 2026-07-01 :  提供轻松访问各种消息服务的通知库,如`slack, mattermost, gotify`和`smtp`等。
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,537 | 🐛 16 | 🌐 Go | 📅 2026-07-06 :  ,用于处理本地化文本 的软件包及相关工具
* [prose](https://github.com/jdkato/prose) ⭐ 3,083 | 🐛 20 | 🌐 Go | 📅 2026-07-29 :  文本处理库,支持词语切分、词性标记、命名实体提取等功能
* [gse](https://github.com/go-ego/gse) ⭐ 2,841 | 🐛 15 | 🌐 Go | 📅 2026-06-10 :   ` Go`高效的文本分割；支持英语、中文、日语和其他语言。
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,647 | 🐛 0 | 🌐 Go | 📅 2026-07-20 : 结巴分词的 `Go `语言实现的 [jieba](https://github.com/fxsjy/jieba) ⭐ 35,115 | 🐛 700 | 🌐 Python | 📅 2024-08-21 ,结巴分词是一个用于中文的分词算法
* [go-pinyin](https://github.com/mozillazg/go-pinyin) ⭐ 1,787 | 🐛 21 | 🌐 Go | 📅 2026-03-08 :   汉字到汉语拼音转换器。
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,428 | 🐛 83 | 🌐 Go | 📅 2026-08-11 : `asthttp` 是一个快速的`HTTP`实现,比`net/http1`的性能快10倍
* [webrtc](https://github.com/pions/webrtc) ⭐ 16,713 | 🐛 113 | 🌐 Go | 📅 2026-08-12 :` WebRTC API`的纯`Go`实现。
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11,741 | 🐛 220 | 🌐 Go | 📅 2026-08-13 :   纯`Go`中`QUIC`协议的实现。
* [gnet](https://github.com/panjf2000/gnet) ⭐ 11,228 | 🐛 1 | 🌐 Go | 📅 2026-07-09 : `gnet`是用纯Go编写 的一个高性能、轻量级、非阻塞、事件驱动的网络框架,
* [dns](https://github.com/miekg/dns) ⭐ 8,752 | 🐛 1 | 🌐 Go | 📅 2026-08-01 :   用于处理` DNS` 的` Go` 语言库
...
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 4,164 | 🐛 62 | 🌐 Go | 📅 2025-01-27 :  用于创建 SSH 服务器的高级` API`(封装了`crypto/ssh`).
* [HTTPLab](https://github.com/gchaincl/httplab) ⭐ 4,149 | 🐛 13 | 🌐 Go | 📅 2024-02-05 : `HTTPLabs`让你检查` HTTP`请求和伪造响应。
* [gobgp](https://github.com/osrg/gobgp) ⭐ 4,098 | 🐛 230 | 🌐 Go | 📅 2026-08-12 :  `Go`语言实现的BGP
* [fortio](https://github.com/fortio/fortio) ⭐ 3,717 | 🐛 85 | 🌐 Go | 📅 2026-07-31 :  负载测试库和命令行工具,提供先进的`echo`服务器和web用户界面。允许指定设定每秒钟查询的负载,记录延迟直方图和其他有用的统计数据,并将其绘制成图表。
* [water](https://github.com/songgao/water) ⭐ 2,165 | 🐛 30 | 🌐 Go | 📅 2024-07-30 :  一个简单的`TUN/TAP`库。
* [go-getter](https://github.com/hashicorp/go-getter) ⭐ 1,822 | 🐛 172 | 🌐 Go | 📅 2026-08-13 :   一个用于通过 URL 从多种源下载文件或目录的 Go 语言库
...
* [grab](https://github.com/cavaliercoder/grab) ⭐ 1,481 | 🐛 28 | 🌐 Go | 📅 2026-08-13 :  管理文件下载的`Go` 语言库
...
* [mdns](https://github.com/hashicorp/mdns) ⭐ 1,371 | 🐛 37 | 🌐 Go | 📅 2026-07-27 :   简单的` mDNS` (组播 DNS)客户端/服务器库
...
* [gaio](https://github.com/xtaci/gaio) ⭐ 933 | 🐛 16 | 🌐 Go | 📅 2026-02-19 :  在`proactor`模式下为`Golang`提供高性能的异步io网络。
...
* [gotcp](https://github.com/gansidui/gotcp) ⭐ 511 | 🐛 0 | 🌐 Go | 📅 2023-08-08 :   用于快速编写`tcp`应用的库
...
* [ethernet](https://github.com/mdlayher/ethernet) ⭐ 289 | 🐛 0 | 🌐 Go | 📅 2022-02-21 :  `ethernet`实现`了IEEE 802.3 Ethernet II`帧以及`IEEE 802.1Q VLAN`标签的组装和剥离.
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,749 | 🐛 23 | 🌐 Go | 📅 2026-07-26 :  受`Ruby rest-client` 的启发,为`Go` 设计的简单` HTTP`和`REST`客户端。
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 39,912 | 🐛 520 | 🌐 Go | 📅 2026-06-25 :  超棒的` Go` 语言` ORM` 库,对开发者非常友好
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,724 | 🐛 4 | 🌐 Go | 📅 2026-06-21 :  灵活而强大的`SQL`字符串构建库,加上一个零配置的`ORM`。
...
* [rel](https://github.com/go-rel/rel) ⭐ 787 | 🐛 41 | 🌐 Go | 📅 2026-08-01 :` Golang`的现代数据库访问层 - 可测试、可扩展,并支持生成简洁优雅的`API`。
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,099 | 🐛 558 | 🌐 Go | 📅 2026-08-13 :  分布式跟踪系统。
...
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,513 | 🐛 395 | 🌐 C++ | 📅 2026-07-30 :  通过` eBPF` 对` Golang`应用程序进行无工具追踪。
...
* [statsviz](https://github.com/arl/statsviz) ⭐ 3,646 | 🐛 15 | 🌐 Go | 📅 2026-08-10 :  实时可视化你的`Go`应用程序运行时的统计数据。
...
* [graphql-go](https://github.com/graphql-go/graphql) ⭐ 10,147 | 🐛 243 | 🌐 Go | 📅 2026-06-23 : 为`Go`语言实现的`GraphQL`
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,016 | 🐛 23 | 🌐 Go | 📅 2026-08-01 :   基于命令行的选择器查询和更新数据结构。类似于`jq/yq`,但支持`JSON、YAML、TOML`和`XML`。
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,419 | 🐛 251 | 🌐 Go | 📅 2026-07-21 :  用于` Go` 编程语言的数值库。它包含了矩阵、统计、优化等方面的库。
* [stats](https://github.com/montanaflynn/stats) ⭐ 3,023 | 🐛 1 | 🌐 Go | 📅 2026-08-10 :  统计库,包含一些` Go` 语言标准库中漏掉的常用函数
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,125 | 🐛 18 | 🌐 Go | 📅 2026-03-30 :  支持剪裁、`GeoJSON` 和` Mapbox Vector Tile`的`2D` 几何类型。
...
* [TextRank](https://github.com/DavidBelicza/TextRank) ⭐ 224 | 🐛 0 | 🌐 Go | 📅 2026-08-10 :` Golang`中的`TextRank` 实现,具有可扩展的特性（摘要、加权、短语提取）和多线程（goroutine）支持。
...
* [lego](https://github.com/go-acme/lego) ⭐ 9,806 | 🐛 100 | 🌐 Go | 📅 2026-08-03 :  纯` Go`语言开发的` ACME` 客户端库及命令行工具
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 5,161 | 🐛 18 | 🌐 Go | 📅 2026-08-11 :   用于远程入侵监控摄像头的`RTSP`流的工具库。
...
* [ssh-vault](https://github.com/ssh-vault/ssh-vault) ⭐ 508 | 🐛 1 | 🌐 Rust | 📅 2026-07-20 : 利用` ssh` 秘钥加解密 。
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 1,077 | 🐛 28 | 🌐 Go | 📅 2026-08-12 :  小巧、安全、简单的` CBOR` 编码和解码库。
...
* [fixedwidth](https://github.com/huydang284/fixedwidth) ⭐ 9 | 🐛 0 | 🌐 Go | 📅 2019-12-20 :   固定宽度的文本格式（支持UTF-8）。
...
* [Caddy](https://github.com/mholt/caddy) ⭐ 74,917 | 🐛 273 | 🌐 Go | 📅 2026-08-13 :`  Caddy`是一个备选的` HTTP/2 web` 服务器,配置简单,使用方便。
* [minio](https://github.com/minio/minio) ⚠️ Archived :  Minio 是一个分布式对象存储服务器
* [etcd](https://github.com/coreos/etcd) ⭐ 52,121 | 🐛 307 | 🌐 Go | 📅 2026-08-13 :  高可用性的键值存储,用于分享配置和服务发现
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,395 | 🐛 168 | 🌐 Go | 📅 2026-08-13 :   功能齐全、高度可配置的`SFTP`服务器,可选择支持`FTP/S和WebDAV`。它可以为本地文件系统和云存储后端服务,如S3和谷歌云存储。
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,500 | 🐛 66 | 🌐 Go | 📅 2026-08-13 :   高性能的PHP应用服务器,负载均衡器和进程管理器。
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,869 | 🐛 45 | 🌐 Go | 📅 2026-08-13 :  用`Go`和`Vue.js`编写的自带功能标志的解决方案。
* [Fider](https://github.com/getfider/fider) ⭐ 4,466 | 🐛 49 | 🌐 Go | 📅 2026-08-09 : `Fider`是一个收集和整理客户反馈的开放平台。
* [devd](https://github.com/cortesi/devd) ⭐ 3,476 | 🐛 24 | 🌐 Go | 📅 2026-06-21 :   开发者使用的本地`web` 服务器
* [algernon](https://github.com/xyproto/algernon) ⭐ 3,023 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-13 :` HTTP/2 web`服务器,内置`Lua、Markdown、GCSS`和`Amber`支持。
* [Flagr](https://github.com/checkr/flagr) ⭐ 2,605 | 🐛 2 | 🌐 Go | 📅 2026-08-11 : ` Flagr`是一个开源的功能标志和A/B测试服务。
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,086 | 🐛 30 | 🌐 Go | 📅 2026-08-04 : `HTTP`反向代理缓存和时间序列加速器。
...
* [machine](https://github.com/whitaker-io/machine) ⭐ 169 | 🐛 9 | 🌐 Go | 📅 2026-08-13 : 内置度量和具有可跟踪的用于编写和生成流式`worker`的`Go` 库
...
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,747 | 🐛 72 | 🌐 Go | 📅 2026-07-10 :  用Maroto的方式来创建PDF。Maroto的灵感来自于`Bootstrap`并使用`gofpdf`
* [hero](https://github.com/shiyanhui/hero) ⭐ 1,565 | 🐛 28 | 🌐 Go | 📅 2020-01-09 :` Hero`是一个趁手的、快速的、强大的` Go` 语言模板引擎
* [jet](https://github.com/CloudyKit/jet) ⭐ 1,402 | 🐛 22 | 🌐 Go | 📅 2026-06-18 :` Jet` 模板引擎
...
* [liquid](https://github.com/osteele/liquid) ⭐ 353 | 🐛 6 | 🌐 Go | 📅 2026-08-12 :  Go 语言实现的`Shopify Liquid`模板.
...
* 测试框架
  ...
  * [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 1,218 | 🐛 13 | 🌐 Go | 📅 2026-03-18 :  作为另一个` Go`应用程序或测试的一部分,在`Linux、OSX` 或`Windows`上本地运行一个真正的 Postgres 数据库
  * [endly](https://github.com/viant/endly) ⭐ 269 | 🐛 4 | 🌐 Go | 📅 2026-04-16 :   声明式端到端功能测试。
  * [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 23 | 🐛 3 | 🌐 Go | 📅 2026-08-12 : ` HTTP`客户端测试框架。
  ...
  * [Testify](https://github.com/stretchr/testify) ⭐ 26,154 | 🐛 365 | 🌐 Go | 📅 2026-07-21 :  对标准测试包的扩展
...
* Mock
  ...
  * [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,509 | 🐛 33 | 🌐 Go | 📅 2026-08-05 :`  HTTP(S) : proxy,`用于记录和模拟`REST/SOAP API`,具有可扩展的中间件和易于使用的 CLI。
  ...
  * [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,139 | 🐛 22 | 🌐 Go | 📅 2026-07-14 :  用于生成自包含`mock`对象的工具
...
* Selenium及浏览器控制工具
  * [chromedp](https://github.com/knq/chromedp) ⭐ 13,251 | 🐛 177 | 🌐 Go | 📅 2026-07-14 :  用于驱动和测试`Chrome, Safari, Edge, Android Webviews`, 以及其他支持`Chrome`调试协议的产品
  * [rod](https://github.com/go-rod/rod) ⭐ 7,060 | 🐛 209 | 🌐 Go | 📅 2026-08-11 : `Devtools`驱动,使网络自动化测试变得简单。
...
* Fail injection
  * [failpoint](https://github.com/pingcap/failpoint) ⭐ 892 | 🐛 9 | 🌐 Go | 📅 2026-08-11 :  Golang中[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail) 的实现。
...
* 特定文本格式处理
  * [colly](https://github.com/asciimoo/colly) ⭐ 25,416 | 🐛 193 | 🌐 Go | 📅 2026-08-11 :  `go`语言版爬虫框架
  * [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,973 | 🐛 3 | 🌐 Go | 📅 2026-07-31 :`  GoQuery` 为` Go`语言带来了一组类似`jQuery` 的语法和功能
  * [sh](https://github.com/mvdan/sh) ⭐ 8,975 | 🐛 94 | 🌐 Go | 📅 2026-08-13 : `Shell`解析器及格式化工具
  * [blackfriday](https://github.com/russross/blackfriday) ⭐ 5,605 | 🐛 224 | 🌐 Go | 📅 2024-01-29 : `Markdown` 解析器
  * [toml](https://github.com/BurntSushi/toml) ⭐ 4,994 | 🐛 32 | 🌐 Go | 📅 2026-06-27 : `TOML` 配置格式的编码解码器
  * [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,813 | 🐛 59 | 🌐 Go | 📅 2026-03-02 :    将时间、数字和内存大小格式化为人类可读的格式。
  * [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3,779 | 🐛 25 | 🌐 Go | 📅 2026-08-03 :  将`HTML`转换为`Markdown`。甚至适用于整个网站,并可通过规则进行扩展。
  * [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,708 | 🐛 32 | 🌐 Go | 📅 2025-04-04 : ` HTML` 清理工具
  * [gofeed](https://github.com/mmcdole/gofeed) ⭐ 2,865 | 🐛 16 | 🌐 Go | 📅 2026-08-10 :  使用`Go`语言解析`RSS`和`Atom`
  * [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,974 | 🐛 30 | 🌐 Go | 📅 2026-08-03 : `TOML`格式的`Go`库,
  ...
  * [gommon/bytes](https://github.com/labstack/gommon/tree/master/bytes) ⭐ 593 | 🐛 15 | 🌐 Go | 📅 2026-07-23 :   格式化二进制为字符串
  ...
  * [pagser](https://github.com/foolin/pagser) ⭐ 111 | 🐛 8 | 🌐 Go | 📅 2023-10-15 :   `Pagser`是一个简单的、可扩展的、可配置的、基于`goquery`和`struct`标签的`golang` 爬虫解析和反序列化工具,能够将`html`页面映射到struct结构体中。
  ...
  * [did](https://github.com/ockam-network/did) ⭐ 95 | 🐛 7 | 🌐 Go | 📅 2023-01-03 :   Go中的`DID`（去中心化标识符）解析器和`Stringer`。
...
* [github](https://github.com/google/go-github) ⭐ 11,279 | 🐛 37 | 🌐 Go | 📅 2026-08-13 :  用于访问`GitHub REST API v3` 的`Go`库。
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,493 | 🐛 424 | 🌐 Go | 📅 2026-08-13 :`Google Cloud APIs Go`客户端库。
* [google](https://github.com/google/google-api-go-client) ⭐ 4,462 | 🐛 18 | 🌐 Go | 📅 2026-08-13 :  为`Go` 自动生成的`Google API`。
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,990 | 🐛 10 | 🌐 Go | 📅 2026-08-11 :  `go` 语言`Minio` 客户端,用于` Amazon S3` 兼容的云存储
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,624 | 🐛 10 | 🌐 Go | 📅 2026-08-13 :  用于访问`Stripe API`的`Go`客户端。
...
* [githubql](https://github.com/shurcooL/githubql) ⭐ 1,197 | 🐛 42 | 🌐 Go | 📅 2026-02-09 :  用于访问`GitHub GraphQL API v4` 的`Go` 库。
...
* [simples3](https://github.com/rhnvrm/simples3) ⭐ 206 | 🐛 13 | 🌐 Go | 📅 2026-05-21 :  简单的不加修饰的`AWS S3`库,使用`Go`编写的`V4 Signing`的`REST api`。
...
* [ynab](https://github.com/brunomvsouza/ynab.go) ⭐ 78 | 🐛 0 | 🌐 Go | 📅 2026-08-11 : `YNAB API`的`Go`语言封装。
...
* [golyrics](https://github.com/mamal72/golyrics) ⭐ 40 | 🐛 0 | 🌐 Go | 📅 2018-06-30 : 用于从`Wikia` 网站获取音乐歌词数据的 Go 库。
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,551 | 🐛 327 | 🌐 Go | 📅 2026-08-11 :  命令行模糊查找工具
* [hub](https://github.com/github/hub) ⭐ 22,955 | 🐛 294 | 🌐 Go | 📅 2024-02-02 :  封装了`git`命令,提供了额外的功能用于在终端中和`Github` 进行交互
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,817 | 🐛 121 | 🌐 Go | 📅 2024-07-08 :  用于容器指标,类似于`Top`的接口（例如`htop`）。
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,725 | 🐛 393 | 🌐 Go | 📅 2024-08-15 :  为内建的`database/sql` 软件包提供扩展
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 15,981 | 🐛 23 | 🌐 Go | 📅 2026-08-13 : 尽可能快速的发布`Go`语言二进制文件
* [Task](https://github.com/go-task/task) ⭐ 15,964 | 🐛 196 | 🌐 Go | 📅 2026-08-13 :  简单来讲就是`"Make"`的替代品
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,716 | 🐛 42 | 🌐 Go | 📅 2026-08-04 :   交互式命令行程序,用于进行`HTTP` 检查
* [usql](https://github.com/knq/usql) ⭐ 10,068 | 🐛 119 | 🌐 Go | 📅 2026-06-19 :  `usql`是一个通用的命令行接口,用于操作`sql`数据库
* [peco](https://github.com/peco/peco) ⭐ 7,906 | 🐛 10 | 🌐 Go | 📅 2026-08-01 :  简单的交互式过滤工具。
...
* [hystrix-go](https://github.com/afex/hystrix-go) ⭐ 4,406 | 🐛 57 | 🌐 Go | 📅 2024-02-24 :  实现 Hystrix 风格的、程序员预定义的`fallback` 机制（熔断）
* [godropbox](https://github.com/dropbox/godropbox) ⭐ 4,204 | 🐛 6 | 🌐 Go | 📅 2023-12-24 : `Dropbox`开发的用于编写` Go`语言服务／应用的库
* [minify](https://github.com/tdewolff/minify) ⭐ 4,131 | 🐛 36 | 🌐 Go | 📅 2026-08-11 :  快速压缩`HTML, CSS, JS, XML, JSON` 以及` SVG` 文件格式
...
* [mergo](https://github.com/imdario/mergo) ⭐ 3,105 | 🐛 24 | 🌐 Go | 📅 2026-03-23 :  Golang中合并结构和地图的助手。对配置默认值很有用,避免了混乱的if语句。
* [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,765 | 🐛 13 | 🌐 Go | 📅 2026-02-10 :  通过运行一个命令就可以创建一个新的生产就绪项目,包括后端（`Golang`）、前端（`JavaScript、TypeScript`）和部署自动化（`Ansible、Docker`）的强大的`CLI`。
...
* [Storm](https://github.com/asdine/storm) ⭐ 2,092 | 🐛 64 | 🌐 Go | 📅 2024-01-07 :  用于`BoltDB` 的简单又强大的工具
* [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 2,006 | 🐛 33 | 🌐 Go | 📅 2026-08-10 :  基于魔数的`MIME`类型检测包。
...
* [immortal](https://github.com/immortal/immortal) ⭐ 837 | 🐛 2 | 🌐 Go | 📅 2026-08-04 :  \*nix 跨平台 (与操作系统无关的)监控程序
* [circuit](https://github.com/cep21/circuit) ⭐ 813 | 🐛 6 | 🌐 Go | 📅 2026-07-16 :  高效且功能完整的`Hystrix`断路器模式的`go`语言实现
* [clockwork](https://github.com/jonboulle/clockwork) ⭐ 727 | 🐛 12 | 🌐 Go | 📅 2025-11-21 :  使用简单、流畅的语法来调度周期性任务
* [delve](https://github.com/derekparker/delve) ⭐ 661 | 🐛 2 | 🌐 Go | 📅 2026-08-12 : `Go`语言调试器
* [ergo](https://github.com/cristianoliveira/ergo) ⭐ 651 | 🐛 8 | 🌐 Go | 📅 2025-02-02 :  简化了对运行在不同端口的多个本地服务的管理。
* [limiters](https://github.com/mennanov/limiters) ⭐ 650 | 🐛 1 | 🌐 Go | 📅 2026-08-01 : `Golang`中分布式应用的速率限制器,具有可配置的后端和分布式锁。
...
* [serve](https://github.com/syntaqx/serve) ⭐ 351 | 🐛 0 | 🌐 Go | 📅 2026-07-20 :  静态` http`服务器。
...
* [uuid](https://github.com/google/uuid) ⭐ 6,133 | 🐛 64 | 🌐 Go | 📅 2024-11-14 :  基于`RFC 4122`和`DCE 1.1`的`UUIDs Go`包。
* [ulid](https://github.com/oklog/ulid) ⭐ 5,047 | 🐛 7 | 🌐 Go | 📅 2026-07-23 : `ULID (Universally Unique Lexicographically Sortable Identifier)` 的` Go`实现。
...
* [validator](https://github.com/go-playground/validator) ⭐ 20,108 | 🐛 320 | 🌐 Go | 📅 2026-07-29 :  `Go`结构体及域验证,包括：跨域、跨结构体,`Map`, 切片和数组
* [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,204 | 🐛 166 | 🌐 Go | 📅 2026-07-29 :  数据验证及清晰工具,用于字符串,数字, 数组切片及结构体
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 4,124 | 🐛 30 | 🌐 Go | 📅 2026-08-11 :   支持多种数据类型的验证 (结构体,字符串,键值对,数组切片等等),具有可配置、可扩展的验证规则,且使用常用代码结构定义,而非结构体标签
* [govalidator](https://github.com/thedevsaddam/govalidator) ⭐ 1,342 | 🐛 42 | 🌐 Go | 📅 2024-05-12 :  用简单的规则验证`Golang`请求数据. 高度受`Laravel`的请求验证的启发.
* [validate](https://github.com/gookit/validate) ⭐ 1,162 | 🐛 4 | 🌐 Go | 📅 2026-08-08 :  用于数据验证和过滤的`Go`包,支持验证`Map、Struct、Request(Form、JSON、url.Values、Uploaded Files`)数据和更多的功能。
...
* [go-astits](https://github.com/asticode/go-astits) ⭐ 616 | 🐛 10 | 🌐 Go | 📅 2026-05-14 :  在 GO 中解析和解调` MPEG` 传输流（.ts）。
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 89,114 | 🐛 759 | 🌐 Go | 📅 2026-08-04 :  ` Gin` 是一个` Go` 语言编写的 web 框架,提供了一组类似`martini`的`API`,且具有更好的性能（40倍的性能提升）。如果你需要高性能和高生产率,这个框架很适合你
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,060 | 🐛 50 | 🌐 Go | 📅 2026-08-13 :  受` Express.js`启发的` Web` 框架,构建在`Fasthttp`上。
* [Echo](https://github.com/labstack/echo) ⭐ 32,649 | 🐛 24 | 🌐 Go | 📅 2026-08-04 :   高性能、极简的` Go`语言`web` 框架
* [Revel](https://github.com/revel/revel) ⭐ 13,221 | 🐛 94 | 🌐 Go | 📅 2023-10-28 :` go`语言高生产率框架
...
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 559 | 🐛 32 | 🌐 Go | 📅 2026-08-13 :  可插拔的`we`b项目框架。包括模块的概念,并提供`DI、Configareas、i18n`、模板引擎、graphql、可观察性、安全性、事件、路由和反向路由等功能。
...
* [chi](https://github.com/go-chi/chi) ⭐ 22,666 | 🐛 109 | 🌐 Go | 📅 2026-08-10 :   基于`net/context`的小巧、快速、具有丰富表达力的`HTTP`路由.
* [mux](https://github.com/gorilla/mux) ⭐ 21,842 | 🐛 38 | 🌐 Go | 📅 2024-08-15 :  强大的`URL`路由和分发库
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 17,643 | 🐛 562 | 🌐 Go | 📅 2026-08-12 :  基于`LLVM`,适用于微型场景的`Go`编译器。包括微控制器、`WebAssembly`和命令行工具。
...
* [go-ole](https://github.com/go-ole/go-ole) ⭐ 1,318 | 🐛 1 | 🌐 Go | 📅 2026-03-30 :  为`Go`语言实现的`Win32 OLE`
...
* [gosimple](https://github.com/dominikh/go-tools/tree/master/cmd/gosimple) ⭐ 6,851 | 🐛 574 | 🌐 Go | 📅 2026-06-30 : 针对 Go 语言的`lint`工具,专注于简化代码
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,851 | 🐛 574 | 🌐 Go | 📅 2026-06-30 :  -`staticcheck`在`Go vet`阶段中执行大量的静态分析检查,类似`ReSharper for C#`这样的工具。
* [unused](https://github.com/dominikh/go-tools/tree/master/cmd/unused) ⭐ 6,851 | 🐛 574 | 🌐 Go | 📅 2026-06-30 :  `unused`会检查 Go 语言代码中没有用到的常量,变量,函数和类型
* [GoLint](https://github.com/golang/lint) ⚠️ Archived :  针对 Go 语言源码的` lint` 工具
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,525 | 🐛 14 | 🌐 Go | 📅 2026-05-12 : `Errcheck`是一个用于检测go语言程序中存在未处理错误的程序
* [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2,089 | 🐛 39 | 🌐 Go | 📅 2025-10-16 :  生成文本`plantUML`图的库和`CLI`,包含结构和接口的信息以及它们之间的关系。
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,064 | 🐛 151 | 🌐 Go | 📅 2026-06-26 :  源代码检查器,它带来了目前其他检查器没有实现的检查。
...
* [php-parser](https://github.com/z7zmey/php-parser) ⭐ 958 | 🐛 18 | 🌐 Go | 📅 2021-04-28 : `Go`编写的`PHP`解析器。
...
* [unconvert](https://github.com/mdempsky/unconvert) ⭐ 387 | 🐛 9 | 🌐 Go | 📅 2025-02-16 :   从go语言代码中移除不必要的类型转换
...
* [vim-go](https://github.com/fatih/vim-go) ⭐ 16,219 | 🐛 47 | 🌐 Vim Script | 📅 2026-07-24 : `Vim`使用的`Go` 语言开发插件
* [gocode](https://github.com/nsf/gocode) ⭐ 4,991 | 🐛 66 | 🌐 Go | 📅 2026-02-07 : `go`语言自动补全
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,258 | 🐛 449 | 🌐 TypeScript | 📅 2026-08-13 : `Visual Studio Code (VS Code)` : 使用的一个扩展,为` Go` 语言提供了支持
...
* [gotests](https://github.com/cweill/gotests) ⭐ 5,325 | 🐛 39 | 🌐 Go | 📅 2025-10-30 :  根据源代码生成`Go`测试代码。
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 9,989 | 🐛 305 | 🌐 Go | 📅 2026-08-13 :  为 Go 语言实现的`Swagger 2.0`.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 124,489 | 🐛 2,884 | 🌐 Go | 📅 2026-08-13 :  来自`Google`的容器集群管理器
* [Moby](https://github.com/moby/moby) ⭐ 72,018 | 🐛 3,881 | 🌐 Go | 📅 2026-08-13 :  为容器生态系统创建的一个合作项目,用于构建基于容器的系统
* [traefik](https://github.com/containous/traefik) ⭐ 64,452 | 🐛 892 | 🌐 Go | 📅 2026-08-13 :  能对接多个后端的反向代理和负载均衡器。
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 57,359 | 🐛 2,620 | 🌐 Go | 📅 2026-08-13 :  社区驱动的`Gogs`的`fork`库
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 25,145 | 🐛 121 | 🌐 Go | 📅 2026-02-16 :  `HTTP 加`载测试工具和代码库
* [Hey](https://github.com/rakyll/hey) ⭐ 20,223 | 🐛 189 | 🌐 Go | 📅 2026-01-10 :` Hey`是一个微型程序,用于向`web` 应用发送负载
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,755 | 🐛 314 | 🌐 Go | 📅 2026-08-13 :` Packer`通过单一的配置文件,为不同的平台创建独立镜像
* [webhook](https://github.com/adnanh/webhook) ⭐ 12,036 | 🐛 126 | 🌐 Go | 📅 2026-08-05 :  允许用户创建`HTTP`钩子,并在服务器上执行命令
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,675 | 🐛 242 | 🌐 Shell | 📅 2024-08-08 : ` GVM`提供了用于管理`Go`语言版本的接口
* [script](https://github.com/bitfield/script) ⭐ 7,019 | 🐛 23 | 🌐 Go | 📅 2026-07-30 :  在Go中轻松编写类似`shell`的脚本,用于`DevOps`和系统管理任务。
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,821 | 🐛 27 | 🌐 Go | 📅 2026-03-31 :  快速的、跨平台的`HTTP`基准工具.
* [gaia](https://github.com/gaia-pipeline/gaia) ⚠️ Archived :   利用任何编程语言都可以构建强大的管道的库。
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,954 | 🐛 146 | 🌐 Go | 📅 2026-08-13 :  `Pomerium`是一个身份感知的访问代理。
* [gox](https://github.com/mitchellh/gox) ⚠️ Archived :  非常简单的`Go`语言交叉编译工具
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 4,162 | 🐛 190 | 🌐 Go | 📅 2025-06-13 :  快速的` S3` 和本地文件系统执行工具。
...
* [uTask](https://github.com/ovh/utask) ⭐ 1,393 | 🐛 85 | 🌐 Go | 📅 2026-07-29 :  自动化引擎,可对`yaml`中声明的业务流程进行建模和执行。
...
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 991 | 🐛 264 | 🌐 Go | 📅 2026-08-13 :  通过命令行来管理 裸金属服务器 (和使用`Docker`一样容易)。
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 483 | 🐛 18 | 🌐 Go | 📅 2026-08-13 : `S3`代理,具有`GET、PUT`和`DELETE`方法和认证（`OpenID Connect`和`Basic Auth`）。
...
* [drone-scp](https://github.com/appleboy/drone-scp) ⭐ 174 | 🐛 24 | 🌐 Go | 📅 2026-07-18 :  通过` SSH` 拷贝文件及可执行程序,可以通过二进制文件、` docker` 或者`Drone CI`来使用
...
* [drone-jenkins](https://github.com/appleboy/drone-jenkins) ⭐ 43 | 🐛 7 | 🌐 Go | 📅 2026-07-18 : 可以通过二进制文件、` docker`或者` Drone CI`来触发下游`Jenkins` 任务,
...
* [croc](https://github.com/schollz/croc) ⭐ 39,727 | 🐛 7 | 🌐 Go | 📅 2026-08-12 :    轻松安全地将文件或文件夹从一台计算机发送到另一台计算机。
* [restic](https://github.com/restic/restic) ⭐ 35,496 | 🐛 561 | 🌐 Go | 📅 2026-08-01 :  解耦备份程序
* [Gor](https://github.com/buger/gor) ⭐ 19,309 | 🐛 341 | 🌐 Go | 📅 2026-01-27 :  Http 流量复制工具,用于将生产环境的流量在开发环境进行重放
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12,244 | 🐛 104 | 🌐 Go | 📅 2026-08-04 :  用于自动化测试中模拟网络和系统状态的代理服务。
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,511 | 🐛 26 | 🌐 Go | 📅 2025-03-20 :   模拟网络波动情况下的网络数据连接
* [scc](https://github.com/boyter/scc) ⭐ 8,620 | 🐛 27 | 🌐 Go | 📅 2026-08-11 :   一个非常快速准确的代码计数器,具有复杂度计算和`COCOMO`估计功能。
* [confd](https://github.com/kelseyhightower/confd) ⭐ 8,423 | 🐛 178 | 🌐 Go | 📅 2024-07-16 :  使用`etcd`或` consul`来管理本地应用的配置文件
* [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,766 | 🐛 413 | 🌐 C++ | 📅 2026-08-13 : `LiteIDE` 是一个简单、开源、跨平台的` Go`语言` IDE`
* [drive](https://github.com/odeke-em/drive) ⭐ 6,731 | 🐛 287 | 🌐 Go | 📅 2024-02-09 :  命令行版本的`Google Drive`客户端。
* [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,668 | 🐛 333 | 🌐 Go | 📅 2026-08-06 :  跨平台网络和云备份工具
...
* [mockingjay](https://github.com/quii/mockingjay-server) ⭐ 568 | 🐛 9 | 🌐 Go | 📅 2022-05-26 : 伪`HTTP`服务器,通过单一配置文件构造访问请求。同时你还可以让服务器提升负载,以进行更加符合现实情况的性能测试
