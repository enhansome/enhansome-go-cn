【导读】：[awesome-go](https://github.com/avelino/awesome-Go) ⭐ 184,157 | 🐛 231 | 🌐 Go | 📅 2026-09-14 就是 `avelino` 发起维护的 Go 资源列表，内容包括：音频和音乐库、命令行工具、服务端应用、流处理、持续集成、数据库、机器学习、NLP、物联网、中间件、文本处理、安全、机器人技术等。
...
* [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,969 | 🐛 20 | 🌐 Go | 📅 2026-09-12 :  可用于在多个平台上播放音频的底层库
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 20,387 | 🐛 38 | 🌐 Go | 📅 2026-09-11 : 支持`ACL`、`RBAC`、`ABAC`等访问控制模型的授权与认证库。
* [jwt-go](https://github.com/dgrijalva/jwt-go) ⚠️ Archived :   -`JSON Web Tokens`（JWT）的Golang实现。
* [goth](https://github.com/markbates/goth) ⭐ 6,598 | 🐛 147 | 🌐 Go | 📅 2026-02-11 :   以简单、干净、常用的方式来使用`OAuth`和`OAuth2`。支持多种身份认证。
...
* [scs](https://github.com/alexedwards/scs) ⭐ 2,620 | 🐛 21 | 🌐 Go | 📅 2025-11-20 : `HTTP`服务器的会话管理器。
...
* [jwt](https://github.com/cristalhq/jwt) ⭐ 688 | 🐛 2 | 🌐 Go | 📅 2025-06-22 : 针对go语言的 安全、简单、快速的JSON Web Tokens 。
...
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,632 | 🐛 66 | 🌐 Go | 📅 2026-06-16 :  用`Go`编写的`Telegram`机器人框架。
...
* [cobra](https://github.com/spf13/cobra) ⭐ 44,602 | 🐛 442 | 🌐 Go | 📅 2026-07-11 :   一个现代化的命令行。
* [urfave/cli](https://github.com/urfave/cli) ⭐ 24,234 | 🐛 68 | 🌐 Go | 📅 2026-09-14 :   简单、快速、有趣的、用于构建 Go 语言命令行程序的软件包。
* [kingpin](https://github.com/alecthomas/kingpin) ⭐ 3,568 | 🐛 28 | 🌐 Go | 📅 2026-09-14 :  支持子命令的命令行和标志位解析器。
* [Dnote](https://github.com/dnote/dnote) ⭐ 3,079 | 🐛 40 | 🌐 Go | 📅 2026-07-25 :  支持多设备同步的命令行笔记工具。
* [pflag](https://github.com/spf13/pflag) ⭐ 2,766 | 🐛 135 | 🌐 Go | 📅 2026-09-06 :  Go flag软件包的替代品, 实现了`POSIX/GNU`风格的`flags`.
* [go-flags](https://github.com/jessevdk/go-flags) ⭐ 2,694 | 🐛 68 | 🌐 Go | 📅 2024-07-26 : `  GO`命令行选项解析器。
* [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,277 | 🐛 36 | 🌐 Go | 📅 2025-12-27 :  `Go`中基于结构体的参数解析。
...
* [termui](https://github.com/gizak/termui) ⭐ 13,583 | 🐛 106 | 🌐 Go | 📅 2025-07-10 :   基于 `termbox-go` 的 `Go` 终端仪表盘,灵感来源于[blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,771 | 🐛 97 | 🌐 JavaScript | 📅 2026-05-01 。
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,602 | 🐛 59 | 🌐 Go | 📅 2025-05-01 :  极简的控制台用户界面创建库.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,537 | 🐛 86 | 🌐 Go | 📅 2026-07-11 :  在每个平台上美化控制台输出的库,有许多可组合的组件。
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,500 | 🐛 113 | 🌐 Go | 📅 2025-08-12 :   受 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,572 | 🐛 718 | 🌐 Python | 📅 2026-07-26  的启发，用于构建强大的交互式提示符的go语言库
...
* [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 3,091 | 🐛 5 | 🌐 Go | 📅 2026-06-21 :   没有其他依赖的可以在命令行应用中制作轻量级的`ASCII`行图┈┈╭╯的go语言工具包
...
* [gookit/color](https://github.com/gookit/color) ⭐ 1,607 | 🐛 3 | 🌐 Go | 📅 2026-09-07 :  格式化终端文本。
...
* [godotenv](https://github.com/joho/godotenv) ⭐ 10,626 | 🐛 82 | 🌐 Go | 📅 2026-08-04 : 把 `Ruby`的 `dotenv `库移植到 `Go `（从 `.env `中加载环境变量）。
* [env](https://github.com/caarlos0/env) ⭐ 6,308 | 🐛 31 | 🌐 Go | 📅 2026-09-04 :   解析环境变量为` Go` 语言结构体
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,468 | 🐛 59 | 🌐 Go | 📅 2025-06-28 :  用于管理环境变量配置数据的` Go` 库。
* [koanf](https://github.com/knadh/koanf) ⭐ 4,196 | 🐛 9 | 🌐 Go | 📅 2026-09-02 :  轻量级、可扩展的库,用于读取Go应用程序中的配置。内置支持`JSON、TOML、YAML、env`、命令行。
* [ini](https://github.com/go-ini/ini) ⭐ 3,544 | 🐛 82 | 🌐 Go | 📅 2026-09-05 :  用于读写INI 文件的库
* [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 2,158 | 🐛 54 | 🌐 Go | 📅 2025-09-15 :   简约的配置读取器(从文件、`ENV`以及任何你想要的地方读取)。
...
* [drone](https://github.com/drone/drone) ⭐ 38,347 | 🐛 108 | 🌐 Go | 📅 2026-09-10 : ` Drone` 是一个基于` Docker`的持续集成平台,使用 `Go `语言编写
* [CDS](https://github.com/ovh/cds) ⭐ 4,841 | 🐛 162 | 🌐 Go | 📅 2026-09-14 :  企业级`CI/CD`和`DevOps`自动化开源平台。
...
* [gods](https://github.com/emirpasic/gods) ⭐ 17,466 | 🐛 73 | 🌐 Go | 📅 2025-03-12 :` Go`语言数据结构、容器、集合、列表、栈、键值对、 `BidiMaps`、树、`HashSet`等
* [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,954 | 🐛 30 | 🌐 Go | 📅 2026-07-31:一组有用的、高性能的、线程安全的数据结构
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,702 | 🐛 23 | 🌐 Go | 📅 2026-06-27 :  线程安全和非线程安全的高性能集合
* [gota](https://github.com/kniren/gota) ⚠️ Archived :  为go语言实现了数据帧,序列以及数据噪音的方法
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,937 | 🐛 80 | 🌐 Go | 📅 2026-09-02 :  实现了压缩`bitsets`算法的Go语言库
...
* [go-edlib](https://github.com/hbollon/go-edlib) ⭐ 604 | 🐛 1 | 🌐 Go | 📅 2026-02-05 :  与 Unicode 兼容的 Go 字符串比较和编辑距离算法库（`Levenshtein、LCS、Hamming、Damerau levenshtein、Jaro-Winkler` 等）。
* [merkletree](https://github.com/cbergoon/merkletree) ⭐ 541 | 🐛 0 | 🌐 Go | 📅 2026-08-14 :  实现了梅克尔树,提供了一种高效、安全的数据结构内容验证方法
* [levenshtein](https://github.com/agnivade/levenshtein) ⭐ 477 | 🐛 2 | 🌐 Go | 📅 2026-09-03 : 在Go中计算`levenshtein`距离的实现。
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,074 | 🐛 881 | 🌐 Go | 📅 2026-09-14 :  监控系统及时间序列数据库
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,528 | 🐛 6,994 | 🌐 Go | 📅 2026-09-14 : ` TiDB` 是一个分布式的` SQL` 数据库。受到了` Google F1`的启发
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,457 | 🐛 8,454 | 🌐 Go | 📅 2026-09-08 :  可扩展的、一致的事务型数据库
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 31,740 | 🐛 2,165 | 🌐 Rust | 📅 2026-09-15 :  用于度量、事件和实时分析的可扩展数据存储。
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,798 | 🐛 99 | 🌐 Go | 📅 2026-09-11 :  可扩展的、分布式的、低延时、高吞吐的图数据库
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 17,734 | 🐛 82 | 🌐 Go | 📅 2026-09-14 :  基于 `SQLite `的轻量级的、分布式的关系型数据库
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,714 | 🐛 793 | 🌐 Go | 📅 2026-09-14 :  快速、资源高效、可扩展的开源时间序列数据库。可作为`Prometheus`的长期远程存储。支持`PromQL`。
...
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,742 | 🐛 30 | 🌐 Go | 📅 2026-09-14 :  `Go`的嵌入式键值数据库。
* [immudb](https://github.com/codenotary/immudb) ⭐ 9,035 | 🐛 112 | 🌐 Go | 📅 2026-09-10 :  `immudb `是一个轻量级、高速的不可变数据库,适用于用`Go`编写的系统和应用程序。
* [go-cache](https://github.com/pmylund/go-cache) ⭐ 8,844 | 🐛 80 | 🌐 Go | 📅 2023-11-20 :   基于内存存储的缓存,适用于分布式部署的应用
* [BigCache](https://github.com/allegro/bigcache) ⭐ 8,163 | 🐛 94 | 🌐 Go | 📅 2026-09-14 :  为GB量级数据设计的高效键/值缓存
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,322 | 🐛 111 | 🌐 Go | 📅 2024-05-14 :  `Go`中[LevelDB](https://github.com/google/leveldb) ⭐ 39,414 | 🐛 408 | 🌐 C++ | 📅 2026-03-11键/值数据库的实现
...
* [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,580 | 🐛 51 | 🌐 Go | 📅 2026-08-09 :  `Nutsdb`是一个用纯`Go`编写的简单、快速、可嵌入、持久化的键/值存储。它支持完全可序列化的事务和许多数据结构,如列表、集合、排序集合。
* [GCache](https://github.com/bluele/gcache) ⭐ 2,730 | 🐛 30 | 🌐 Go | 📅 2024-03-01 :  支持缓存过期、 `LFU、 LRU `和 `ARC `的缓存库
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,918 | 🐛 493 | 🌐 Go | 📅 2026-09-09 :   数据库迁移。命令行及 `Go `语言库
* [goose](https://github.com/pressly/goose) ⭐ 11,458 | 🐛 131 | 🌐 Go | 📅 2026-09-12 :   数据库迁移工具。你可以通过编写增量 `SQL `或 `Go` 语言脚本来管理你的数据库
* [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,418 | 🐛 98 | 🌐 Go | 📅 2026-07-14 :  数据库迁移工具,允许利用 `Go-bindata` 将数据库迁移嵌入应用程序
* [soda](https://github.com/gobuffalo/pop/tree/master/soda) ⭐ 1,525 | 🐛 94 | 🌐 Go | 📅 2026-09-11 : 数据库迁移、创建、 ORM等等,用于`MySQL, PostgreSQL,`以及 `SQLite`.
* [skeema](https://github.com/skeema/skeema) ⭐ 1,381 | 🐛 15 | 🌐 Go | 📅 2026-09-10 :  `MySQL`的纯SQL模式管理系统,支持`sharding`和外部在线模式变更工具
* [gormigrate](https://github.com/go-gormigrate/gormigrate) ⭐ 1,173 | 🐛 17 | 🌐 Go | 📅 2026-05-26 :   数据库模式迁移帮助工具,用于` Gorm ORM.`
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,332 | 🐛 1,108 | 🌐 Go | 📅 2026-09-14 :  `vitess` 提供了能够使大型 `web `服务 `MySQL` 数据库的扩展变得更加容易的服务器及工具
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,502 | 🐛 56 | 🌐 Go | 📅 2026-07-26 :  基于 `Web` 的 `PostgreSQL` 数据库浏览工具
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,966 | 🐛 156 | 🌐 Go | 📅 2026-09-08 :   用于处理` MySQL` 协议及复制的`Go`语言工具集
* [pREST](https://github.com/nuveo/prest) ⭐ 4,617 | 🐛 156 | 🌐 Go | 📅 2026-09-10 :  为 `PostgreSQL `数据库提供 `RESTful API`
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,397 | 🐛 0 | 🌐 Go | 📅 2026-09-14 : `PostgreSQL` 的高级调度。
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,798 | 🐛 45 | 🌐 Go | 📅 2026-08-31 :  在`Go`中编写类型安全的`SQL`查询框架,能够轻松地将数据库查询结果转换为所需的任意对象结构。
* [goqu](https://github.com/doug-martin/goqu) ⭐ 2,675 | 🐛 146 | 🌐 Go | 📅 2024-05-22 :  地道的 `SQL` 语句创建器和查询库
...
* 关系型数据库
  * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 15,282 | 🐛 58 | 🌐 Go | 📅 2026-09-06 :  Go 语言 `MySQL`驱动
  * [pgx](https://github.com/jackc/pgx) ⭐ 14,247 | 🐛 215 | 🌐 Go | 📅 2026-09-12 :  `PostgreSQL` 驱动,支持比 `database/sql `更多的特性
  * [pq](https://github.com/lib/pq) ⭐ 9,956 | 🐛 52 | 🌐 Go | 📅 2026-08-20 :  用于`database/sql`的`Pure Go Postgres`驱动。
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,237 | 🐛 152 | 🌐 C | 📅 2026-09-05 :  Go 语言的 `SQLite3 `驱动
...
* NoSQL数据库
  * [redis](https://github.com/go-redis/redis) ⭐ 22,233 | 🐛 66 | 🌐 Go | 📅 2026-09-14 :  兼容R`edis`协议的 `TCP` 服务器/服务.
  * [redigo](https://github.com/gomodule/redigo) ⭐ 9,852 | 🐛 25 | 🌐 Go | 📅 2025-11-02 : ` RediGo`是 `Redis` 数据库的`Go` 语言客户端.
  * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,538 | 🐛 22 | 🌐 Go | 📅 2026-09-14 :   `Go`语言的官方`MongoDB`驱动。
...
* 搜索引擎和文本数据库
  * [bleve](https://github.com/blevesearch/bleve) ⭐ 11,207 | 🐛 293 | 🌐 Go | 📅 2026-09-10 :  现代文本索引库
  ...
  * [riot](https://github.com/go-ego/riot) ⭐ 6,047 | 🐛 0 | 🌐 Go | 📅 2026-09-13 :  `Go`开源,分布式,简单高效的搜索引擎。
...
* 多个后端:
  * [cayley](https://github.com/google/cayley) ⭐ 15,062 | 🐛 93 | 🌐 Go | 📅 2026-08-27 :  支持多个后端的图形数据库。
...
* [durafmt](https://github.com/hako/durafmt) ⭐ 511 | 🐛 12 | 🌐 Go | 📅 2021-06-08 :  持续时间格式化
...
* [raft](https://github.com/coreos/etcd/tree/master/raft) ⭐ 52,264 | 🐛 349 | 🌐 Go | 📅 2026-09-14 : ` Raft`共识协议的 `Go` 实现,由 `CoreOS` 提供。
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,423 | 🐛 60 | 🌐 Go | 📅 2024-07-19 :   为服务工具吧,支持服务发现、负载均衡 、可插拔传输以及请求追踪等
* [go-micro](https://github.com/micro/go-micro) ⭐ 23,066 | 🐛 6 | 🌐 Go | 📅 2026-09-11 :   一个分布式系统开发框架。
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 23,061 | 🐛 143 | 🌐 Go | 📅 2026-09-11 : ` gRPC`的Go语言实现。基于`HTTP/2的RPC`。
* [NATS](https://github.com/nats-io/gnatsd) ⭐ 20,704 | 🐛 536 | 🌐 Go | 📅 2026-09-14 :  轻量级、高性能微服务系统,用于微服务、物联网以及云
* [raft](https://github.com/hashicorp/raft) ⭐ 9,121 | 🐛 52 | 🌐 Go | 📅 2026-08-30 :  `Raft` 共识协议的 `Golang `实现,由 `HashiCorp`.开发。
...
* [dragonboat](https://github.com/lni/dragonboat) ⭐ 5,325 | 🐛 65 | 🌐 Go | 📅 2025-07-23 :  `Go`中一个功能完整且高性能的多组`Raft`库。
...
* [gleam](https://github.com/chrislusf/gleam) ⭐ 3,564 | 🐛 38 | 🌐 Go | 📅 2026-09-09 :   快速、可扩展的分布式` map/reduce` 系统,使用纯` Go` 语言和` Luajit` 编写,融合了 Go 语言的高并发能力和 Luajit 的高性能,可以独立或分布式部署运行。
* [glow](https://github.com/chrislusf/glow) ⭐ 3,215 | 🐛 15 | 🌐 Go | 📅 2018-11-02 :   易于使用的可扩展的分布式大数据处理、`Map-Reduce、DAG`执行,全部用纯Go编写。
* [liftbridge](https://github.com/liftbridge-io/liftbridge) ⭐ 2,799 | 🐛 45 | 🌐 Go | 📅 2026-09-09 :  用于`NATS`的轻量级、容错消息流。
...
* [arpc](https://github.com/lesismal/arpc) ⭐ 1,088 | 🐛 0 | 🌐 Go | 📅 2026-07-04 :  更有效的网络通信,支持双向呼叫、通知、广播。
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 387 | 🐛 0 | 🌐 Go | 📅 2023-07-09 :  在 `HTTP `服务之间进行无主` p2p` 自动发现和 RPC通信(使用 [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,998 | 🐛 382 | 🌐 C++ | 📅 2026-07-26)ß
...
* [GoDNS](https://github.com/timothyye/godns) ⭐ 1,778 | 🐛 12 | 🌐 Go | 📅 2026-09-12 : 用Go编写的动态`DNS`客户端工具,支持`DNSPod`和`HE.net`。
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 16,152 | 🐛 256 | 🌐 Go | 📅 2024-02-13 :  `Email` 及 `SMTP` 测试工具,具有 web 及 API 接口
* [hermes](https://github.com/matcornic/hermes) ⭐ 3,030 | 🐛 22 | 🌐 Go | 📅 2025-04-04 :  一个用于生成干净、响应式 `HTML e-mail` 的包
* [email](https://github.com/jordan-wright/email) ⭐ 2,797 | 🐛 58 | 🌐 Go | 📅 2024-02-21 : 健壮的、灵活的 `email `库
* [go-imap](https://github.com/emersion/go-imap) ⭐ 2,348 | 🐛 77 | 🌐 Go | 📅 2026-09-08 :  ` IMAP` 库,用于客户端和服务器
...
* [go-simple-mail](https://github.com/xhit/go-simple-mail) ⭐ 698 | 🐛 19 | 🌐 Go | 📅 2024-07-20 :  `go`语言实现的基于简单`smtp`协议的邮件发送库
* [go-message](https://github.com/emersion/go-message) ⭐ 458 | 🐛 31 | 🌐 Go | 📅 2025-02-16 :  用于互联网消息格式和邮件的库
...
* [expr](https://github.com/antonmedv/expr) ⭐ 8,011 | 🐛 91 | 🌐 Go | 📅 2026-07-07 :  ` Go` 的表达式评估引擎，具有快速、非图灵完备、动态类型化、静态类型化的特性。
* [goja](https://github.com/dop251/goja) ⭐ 7,090 | 🐛 33 | 🌐 Go | 📅 2026-09-11 :  在 Go 中实现 `ECMAScript 5.1(+)` 。
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,981 | 🐛 104 | 🌐 Go | 📅 2026-04-01 :  ` Go` 语言编写的 `Lua 5.1` 虚拟机和编译器
* [tengo](https://github.com/d5/tengo) ⭐ 3,837 | 🐛 90 | 🌐 Go | 📅 2026-04-29 : `Go`的字节码编译脚本语言。
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 :  基于[gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,981 | 🐛 104 | 🌐 Go | 📅 2026-04-01的go语言Lua 接口,
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 8,834 | 🐛 121 | 🌐 Go | 📅 2026-09-14 :   PDF 处理器。
* [afero](https://github.com/spf13/afero) ⭐ 6,696 | 🐛 136 | 🌐 Go | 📅 2026-09-11 : ` go`语言编写的对文件系统进行抽象的系统框架
...
* [vfs](https://github.com/C2FO/vfs) ⭐ 368 | 🐛 10 | 🌐 Go | 📅 2026-08-28 :  适用于 `Go` 的多个文件系统类型,如 `os、S3 `和 `GCS`的可插拔、可扩展的文件系统功能库。
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 7,475 | 🐛 155 | 🌐 Go | 📅 2026-08-19 :  支持任意精度的十进制数的go包
* [go-money](https://github.com/rhymond/go-money) ⭐ 1,911 | 🐛 29 | 🌐 Go | 📅 2026-04-29 :   `Fowler's Money`模式的实现。
* [techan](https://github.com/sdcoffey/techan) ⭐ 909 | 🐛 17 | 🌐 Go | 📅 2026-09-04 :   具有高级市场分析和交易策略的技术分析库。
...
* [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,210 | 🐛 36 | 🌐 Go | 📅 2025-04-14 : 为 `Go` 语言 `web` 应用提供 `CSRF` 防御
...
* [Ebiten](https://github.com/hajimehoshi/ebiten) ⭐ 13,483 | 🐛 282 | 🌐 Go | 📅 2026-09-14 :  `Go` 语言编写的简单的 `2D` 游戏库
* [Leaf](https://github.com/name5566/leaf) ⭐ 5,515 | 🐛 26 | 🌐 Go | 📅 2024-05-23 :  轻量级游戏服务器框架
* [Pixel](https://github.com/faiface/pixel) ⭐ 4,528 | 🐛 44 | 🌐 Go | 📅 2024-05-23 :`2D` 游戏引擎库
* [nano](https://github.com/lonng/nano) ⭐ 3,225 | 🐛 32 | 🌐 Go | 📅 2026-02-26 :  基于`golang`的轻量级、设施、高性能的游戏服务器框架。
* [g3n](https://github.com/g3n/engine) ⭐ 3,117 | 🐛 37 | 🌐 Go | 📅 2026-08-01 :  `Go 3D`游戏引擎。
...
* [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2,532 | 🐛 8 | 🌐 C | 📅 2026-08-15 :   raylib的 Go 语言接口,简单、易用的用于学习游戏编程的库
* [go-sdl2](https://github.com/veandco/go-sdl2) ⭐ 2,327 | 🐛 88 | 🌐 C | 📅 2025-02-20 :  [Simple DirectMedia Layer](https://www.libsdl.org/) 的 `Go`封装。
* [engo](https://github.com/EngoEngine/engo) ⭐ 1,821 | 🐛 54 | 🌐 Go | 📅 2026-03-30 :  `EnGo`是一个开源的`2D`游戏引擎,遵循实体-组件-系统范式
...
* [S2 geometry](https://github.com/golang/geo) ⭐ 1,853 | 🐛 37 | 🌐 Go | 📅 2026-09-14 :  `Go`中的`S2`几何库。
...
* [WGS84](https://github.com/wroge/wgs84) ⭐ 142 | 🐛 0 | 🌐 Go | 📅 2026-09-03 :  坐标转换和变换的库（`ETRS89, OSGB36, NAD83, RGF93, Web Mercator, UTM`）。
...
* [ants](https://github.com/panjf2000/ants) ⭐ 14,503 | 🐛 1 | 🌐 Go | 📅 2026-07-04 : 高性能和低消耗的`goroutine`池。
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 28,699 | 🐛 738 | 🌐 Go | 📅 2026-09-14 :   基于`Material Design`为`Go`设计的跨平台本地GUI。支持 Linux, macOS, Windows, BSD, iOS\` 和 Android.
* [webview](https://github.com/zserge/webview) ⭐ 14,230 | 🐛 212 | 🌐 C++ | 📅 2026-03-09 :   支持双向`JavaScript`绑定的跨平台 webview 窗口库（`Windows，macOS，Linux`）。
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,807 | 🐛 3 | 🌐 Go | 📅 2026-09-09 :   跨平台`GUI`自动化工具，可以控制鼠标、键盘及其他设备
...
* [walk](https://github.com/lxn/walk) ⭐ 7,103 | 🐛 345 | 🌐 Go | 📅 2024-01-21 :  `windows `应用程序开发工具包
* [go-astilectron](https://github.com/asticode/go-astilectron) ⚠️ Archived :  使用`GO`和`HTML/JS/CSS`（由Electron提供支持）构建跨平台GUI应用程序
* [systray](https://github.com/getlantern/systray) ⭐ 3,729 | 🐛 114 | 🌐 Go | 📅 2024-07-03 :  跨平台的` Go` 语言库,用于在桌面提醒区域放置按钮及菜单
* [go-sciter](https://github.com/sciter-sdk/go-sciter) ⭐ 2,618 | 🐛 98 | 🌐 C++ | 📅 2023-05-13 :   `Sciter` 的` Go` 语言接口，支持现代 GUI 程序开发的、嵌入式 HTML/CSS/脚本引擎。具有跨平台特性。
...
* [imaginary](https://github.com/h2non/imaginary) ⭐ 6,075 | 🐛 136 | 🌐 Go | 📅 2025-11-08 :  快速且简单的 `HTTP `微服务,用于图像缩放
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,754 | 🐛 35 | 🌐 Go | 📅 2023-09-21 :  简单的`Go`图像处理包。
* [gg](https://github.com/fogleman/gg) ⭐ 4,797 | 🐛 97 | 🌐 Go | 📅 2023-12-14 :  使用`Go`编写的 `2D `渲染程序
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,212 | 🐛 19 | 🌐 Go | 📅 2026-09-07 :  汇集了使用 `Go `语言编写的图像处理算法
* [ln](https://github.com/fogleman/ln) ⭐ 3,374 | 🐛 12 | 🌐 Go | 📅 2019-07-19 : ` 3D` 图线艺术渲染
* [resize](https://github.com/nfnt/resize) ⚠️ Archived :  使用 `Go`语言编写的具有常见差值功能的图片缩放工具
* [bimg](https://github.com/h2non/bimg) ⭐ 3,031 | 🐛 179 | 🌐 Go | 📅 2025-01-23 :   利用`libvips`进行快速高效的图像处理
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,470 | 🐛 100 | 🌐 Go | 📅 2026-01-07 : ` Gobot` 是一个用于机器人,物理计算以及物联网的库
* [flogo](https://github.com/tibcosoftware/flogo) ⭐ 2,491 | 🐛 128 | 🌐 CSS | 📅 2024-04-24 :` FloGo`是一个用于物联网 `Edge App `及集成的开源框架
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 7,161 | 🐛 7 | 🌐 Go | 📅 2026-09-01 : 简单流畅的`Go`作业调度。这是·`jasonlvhit/gocron`·\`的一个积极维护的fork.
...
* [GJSON](https://github.com/tidwall/gjson) ⭐ 15,558 | 🐛 100 | 🌐 Go | 📅 2026-08-28 :  用一行代码获取`JSON`值。
...
* [zap](https://github.com/uber-go/zap) ⭐ 24,657 | 🐛 193 | 🌐 Go | 📅 2026-08-31 :  快速的、结构化的、分级的日志库
* [zerolog](https://github.com/rs/zerolog) ⭐ 12,505 | 🐛 148 | 🌐 Go | 📅 2026-09-08 :  零内存分配 的`JSON `日志库.
* [spew](https://github.com/davecgh/go-spew) ⭐ 6,420 | 🐛 70 | 🌐 Go | 📅 2024-04-06 :  - 为 `Go `语言的数据结构实现了一个整洁的打印功能,有助于调试
...
* [tail](https://github.com/hpcloud/tail) ⭐ 2,781 | 🐛 78 | 🌐 Go | 📅 2022-10-25 :  这个 `Go `语言软件包力争模拟 `BSD tail `的功能
...
* [phuslu/log](https://github.com/phuslu/log) ⭐ 871 | 🐛 12 | 🌐 Go | 📅 2026-09-14 :  - 结构化日志系统。
* [httpretty](https://github.com/henvic/httpretty) ⭐ 456 | 🐛 3 | 🌐 Go | 📅 2026-08-10 :  将常规的 `HTTP` 请求漂亮地打印在终端上用于调试（类似于 `http.DumpRequest`）。
* [onelog](https://github.com/francoispqt/onelog) ⭐ 411 | 🐛 2 | 🌐 Go | 📅 2019-03-06 :  `Onelog`是一个简单但非常高效的JSON日志库。它是目前所有场景下最快的JSON日志器。同时,它也是所需最少内存分配的库。
...
* [logur](https://github.com/logur/logur) ⚠️ Archived :  日志记录接口和日志记录最佳实践的整合,它对诸多知名库如[logrus](https://github.com/sirupsen/logrus) ⭐ 25,746 | 🐛 46 | 🌐 Go | 📅 2026-08-25、[go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,423 | 🐛 60 | 🌐 Go | 📅 2024-07-19、[zap](https://github.com/uber-go/zap) ⭐ 24,657 | 🐛 193 | 🌐 Go | 📅 2026-08-31 ， [zerolog](https://github.com/rs/zerolog) ⭐ 12,505 | 🐛 148 | 🌐 Go | 📅 2026-09-08等的功能进行了集成
...
* [kemba](https://github.com/clok/kemba) ⭐ 18 | 🐛 9 | 🌐 Go | 📅 2026-09-01 :  受[debug](https://github.com/visionmedia/debug) ⭐ 11,454 | 🐛 96 | 🌐 JavaScript | 📅 2026-04-01 启发的小型调试日志工具,非常适合CLI工具和应用程序。
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 13,702 | 🐛 291 | 🌐 Go | 📅 2026-06-22 :   建立在 `Redis` 之上，为 `Go` 提供的简单、可靠、高效的分布式任务队列,。
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,520 | 🐛 45 | 🌐 Go | 📅 2026-09-14 :  用于 `Apache Kafka `的库
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10,749 | 🐛 23 | 🌐 Go | 📅 2026-09-14 :  实时消息服务器
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,771 | 🐛 68 | 🌐 Go | 📅 2026-07-25  通知推送服务器,使用 [APNs2](https://github.com/sideshow/apns2) ⭐ 3,187 | 🐛 32 | 🌐 Go | 📅 2025-07-22 和 [GCM](https://github.com/google/go-gcm) ⚠️ Archived 。
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,748 | 🐛 327 | 🌐 Go | 📅 2026-09-14 : 在一系列协议之间建立消息流`go`代码库
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,972 | 🐛 248 | 🌐 Go | 📅 2025-11-15 :  异步任务队列,基于分布式消息处理
* [NATS Go Client](https://github.com/nats-io/nats) ⭐ 6,749 | 🐛 169 | 🌐 Go | 📅 2026-09-14 :   原生的 `oplog/replication `系统,用于 `REST APIs`场景
* [go-socket.io](https://github.com/googollee/go-socket.io) ⚠️ ArchivedGo 语言的 `socket.io`库 ,一个实时应用框架.
* [Mercure](https://github.com/dunglas/mercure) ⭐ 5,309 | 🐛 23 | 🌐 Go | 📅 2026-09-14 :   使用`Mercure`协议（建立在`Server-Sent Events`之上）来调度服务器发送的更新的代码库。
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 5,163 | 🐛 282 | 🌐 Go | 📅 2026-09-14   是`Confluent`为`Apache Kafka`和`Confluent Platform`开发的`Golang`客户端。
...
* [zmq4](https://github.com/pebbe/zmq4) ⭐ 1,262 | 🐛 58 | 🌐 Go | 📅 2025-07-06 :  `ZeroMQ version 4`的 `GO `语言接口。也有适用于[version 3](https://github.com/pebbe/zmq3) ⭐ 132 | 🐛 1 | 🌐 Go | 📅 2025-05-11 及 [version 2](https://github.com/pebbe/zmq2) ⭐ 19 | 🐛 1 | 🌐 Go | 📅 2025-05-11 的
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,934 | 🐛 9 | 🌐 Go | 📅 2026-08-13 :  用于创建和处理`Office Word (.docx)、Excel (.xlsx)`和`Powerpoint (.pptx)`文档的纯`go`库。

### EXCEL

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) ⭐ 20,906 | 🐛 133 | 🌐 Go | 📅 2026-09-14 :  用于读写 `Microsoft Excel™ (XLSX)` 文件的 `Golang `库
...
* [fx](https://github.com/uber-go/fx) ⭐ 7,663 | 🐛 80 | 🌐 Go | 📅 2025-12-27 :  基于 `Go `的依赖注入应用框架（建立在 `dig` 的基础上）。
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 56,577 | 🐛 94 | 🌐 Makefile | 📅 2026-04-28 :  -` Go` 生态系统中常见的历史和新兴项目布局模式集。
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 12,074 | 🐛 386 | 🌐 Go | 📅 2026-09-08 :  自动化的服务健康仪表板。
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,914 | 🐛 222 | 🌐 Go | 📅 2026-09-14 :  跨平台库,用于检索进程和系统利用率（`CPU`、内存、磁盘等）。
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 5,386 | 🐛 7 | 🌐 Go | 📅 2026-09-11 :   用`go`编写的随机数据生成器。
...
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 2,143 | 🐛 10 | 🌐 Go | 📅 2026-09-13 :  快速将整个` org/users` 仓库克隆到一个目录中 - 支持` GitHub、GitLab` 和 `Bitbucket`。
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,672 | 🐛 81 | 🌐 Go | 📅 2026-07-01 :  提供轻松访问各种消息服务的通知库,如`slack, mattermost, gotify`和`smtp`等。
...
* [health](https://github.com/dimiro1/health) ⭐ 449 | 🐛 8 | 🌐 Go | 📅 2023-11-18 :  简单易用、可扩展的服务健康检查库
...
* [VarHandler](https://github.com/azr/generators/tree/master/varhandler) ⭐ 7 | 🐛 0 | 🌐 Go | 📅 2016-12-30 :  生成模板化的`http`输入和输出。
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,544 | 🐛 18 | 🌐 Go | 📅 2026-09-01 :  ,用于处理本地化文本 的软件包及相关工具
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,646 | 🐛 0 | 🌐 Go | 📅 2026-07-20 : 结巴分词的 `Go `语言实现的 [jieba](https://github.com/fxsjy/jieba) ⭐ 35,152 | 🐛 700 | 🌐 Python | 📅 2024-08-21 ,结巴分词是一个用于中文的分词算法
...
* [kagome](https://github.com/ikawaha/kagome) ⭐ 981 | 🐛 1 | 🌐 Go | 📅 2026-09-04 :   用纯`Go`编写的`JP`形态分析器。
...
* [govader](https://github.com/jonreiter/govader) ⭐ 55 | 🐛 1 | 🌐 Go | 📅 2025-04-29 : [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 5,064 | 🐛 56 | 🌐 Python | 📅 2026-03-02 情感分析的`Go`实现
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,468 | 🐛 91 | 🌐 Go | 📅 2026-09-14 : `asthttp` 是一个快速的`HTTP`实现,比`net/http1`的性能快10倍
* [webrtc](https://github.com/pions/webrtc) ⭐ 16,776 | 🐛 122 | 🌐 Go | 📅 2026-09-14 :` WebRTC API`的纯`Go`实现。
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11,768 | 🐛 220 | 🌐 Go | 📅 2026-09-14 :   纯`Go`中`QUIC`协议的实现。
...
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 4,176 | 🐛 63 | 🌐 Go | 📅 2025-01-27 :  用于创建 SSH 服务器的高级` API`(封装了`crypto/ssh`).
* [HTTPLab](https://github.com/gchaincl/httplab) ⭐ 4,141 | 🐛 13 | 🌐 Go | 📅 2024-02-05 : `HTTPLabs`让你检查` HTTP`请求和伪造响应。
* [gobgp](https://github.com/osrg/gobgp) ⭐ 4,107 | 🐛 243 | 🌐 Go | 📅 2026-09-14 :  `Go`语言实现的BGP
* [fortio](https://github.com/fortio/fortio) ⭐ 3,725 | 🐛 87 | 🌐 Go | 📅 2026-09-14 :  负载测试库和命令行工具,提供先进的`echo`服务器和web用户界面。允许指定设定每秒钟查询的负载,记录延迟直方图和其他有用的统计数据,并将其绘制成图表。
* [water](https://github.com/songgao/water) ⭐ 2,167 | 🐛 30 | 🌐 Go | 📅 2024-07-30 :  一个简单的`TUN/TAP`库。
* [go-getter](https://github.com/hashicorp/go-getter) ⭐ 1,824 | 🐛 170 | 🌐 Go | 📅 2026-09-14 :   一个用于通过 URL 从多种源下载文件或目录的 Go 语言库
...
* [vssh](https://github.com/yahoo/vssh) ⭐ 989 | 🐛 6 | 🌐 Go | 📅 2023-12-07 : `Go`库,用于通过`SSH`协议构建网络和服务器自动化。
...
* [gNxI](https://github.com/google/gnxi) ⭐ 289 | 🐛 28 | 🌐 Python | 📅 2026-08-25 :  使用`gNMI`和`gNOI`协议的网络管理工具集合。
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,798 | 🐛 19 | 🌐 Go | 📅 2026-09-07 :  受`Ruby rest-client` 的启发,为`Go` 设计的简单` HTTP`和`REST`客户端。
...
* [gentleman](https://github.com/h2non/gentleman) ⭐ 1,132 | 🐛 27 | 🌐 Go | 📅 2023-12-17 :  -插件驱动的`HTTP`客户端库。
...
* [mathgl](https://github.com/go-gl/mathgl) ⭐ 610 | 🐛 9 | 🌐 Go | 📅 2024-11-03 : `Go`语言` 3D`数学库,专注于`3D`,受到`GLM` 启发
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 39,956 | 🐛 534 | 🌐 Go | 📅 2026-09-14 :  超棒的` Go` 语言` ORM` 库,对开发者非常友好
* [ent](https://github.com/facebook/ent) ⭐ 17,199 | 🐛 622 | 🌐 Go | 📅 2026-09-04 :  简单而强大的用于数据建模和查询的ORM。
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,991 | 🐛 108 | 🌐 Go | 📅 2026-07-12 :`ORM` 生成器。为你的数据库表单生成一个功能全面、快速的` ORM`
...
* [pop/soda](https://github.com/gobuffalo/pop) ⭐ 1,525 | 🐛 94 | 🌐 Go | 📅 2026-09-11 :  支持` MySQL, PostgreSQL`, 以及`SQLite`.的数据库迁移、创建、`ORM` 的工具,
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,208 | 🐛 546 | 🌐 Go | 📅 2026-09-14 :  分布式跟踪系统。
...
* [pixie](https://github.com/pixie-labs/pixie) ⭐ 6,535 | 🐛 396 | 🌐 C++ | 📅 2026-07-30 :  通过` eBPF` 对` Golang`应用程序进行无工具追踪。
...
* [stats](https://github.com/montanaflynn/stats) ⭐ 3,025 | 🐛 1 | 🌐 Go | 📅 2026-09-13 :  统计库,包含一些` Go` 语言标准库中漏掉的常用函数
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,130 | 🐛 20 | 🌐 Go | 📅 2026-03-30 :  支持剪裁、`GeoJSON` 和` Mapbox Vector Tile`的`2D` 几何类型。
...
* [lego](https://github.com/go-acme/lego) ⭐ 9,867 | 🐛 103 | 🌐 Go | 📅 2026-09-10 :  纯` Go`语言开发的` ACME` 客户端库及命令行工具
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 5,191 | 🐛 20 | 🌐 Go | 📅 2026-09-14 :   用于远程入侵监控摄像头的`RTSP`流的工具库。
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 1,089 | 🐛 30 | 🌐 Go | 📅 2026-09-14 :  小巧、安全、简单的` CBOR` 编码和解码库。
...
* [Caddy](https://github.com/mholt/caddy) ⭐ 75,736 | 🐛 282 | 🌐 Go | 📅 2026-09-14 :`  Caddy`是一个备选的` HTTP/2 web` 服务器,配置简单,使用方便。
* [minio](https://github.com/minio/minio) ⚠️ Archived :  Minio 是一个分布式对象存储服务器
* [etcd](https://github.com/coreos/etcd) ⭐ 52,264 | 🐛 349 | 🌐 Go | 📅 2026-09-14 :  高可用性的键值存储,用于分享配置和服务发现
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,521 | 🐛 176 | 🌐 Go | 📅 2026-09-07 :   功能齐全、高度可配置的`SFTP`服务器,可选择支持`FTP/S和WebDAV`。它可以为本地文件系统和云存储后端服务,如S3和谷歌云存储。
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,505 | 🐛 45 | 🌐 Go | 📅 2026-09-14 :   高性能的PHP应用服务器,负载均衡器和进程管理器。
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,897 | 🐛 43 | 🌐 Go | 📅 2026-09-14 :  用`Go`和`Vue.js`编写的自带功能标志的解决方案。
* [Fider](https://github.com/getfider/fider) ⭐ 4,522 | 🐛 60 | 🌐 Go | 📅 2026-09-12 : `Fider`是一个收集和整理客户反馈的开放平台。
...
* [Flagr](https://github.com/checkr/flagr) ⭐ 2,607 | 🐛 0 | 🌐 Go | 📅 2026-09-14 : ` Flagr`是一个开源的功能标志和A/B测试服务。
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,090 | 🐛 2 | 🌐 Go | 📅 2026-09-14 : `HTTP`反向代理缓存和时间序列加速器。
...
* [go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) ⭐ 151 | 🐛 16 | 🌐 Go | 📅 2026-09-12 : 简单的反向代理与缓存,用`Go`编写,使用`Redis`。
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,172 | 🐛 11 | 🌐 Go | 📅 2026-01-14 :` Go`流处理库。
...
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,753 | 🐛 64 | 🌐 Go | 📅 2026-09-10 :  用Maroto的方式来创建PDF。Maroto的灵感来自于`Bootstrap`并使用`gofpdf`
...
* 测试框架
  * [Testify](https://github.com/stretchr/testify) ⭐ 26,203 | 🐛 377 | 🌐 Go | 📅 2026-09-02 :  对标准测试包的扩展
  ...
  * [godog](https://github.com/DATA-DOG/godog) ⭐ 2,671 | 🐛 92 | 🌐 Go | 📅 2026-09-10 :  类似于`Cucumber`或`Behat`的`Go BDD`框架。
  * [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,393 | 🐛 6 | 🌐 Go | 📅 2026-07-16 :   记录并重放` HTTP`交互,用于快速的、确定性的、准确的测试
  * [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,234 | 🐛 20 | 🌐 Go | 📅 2026-09-02 : 类似` Rails`的测试工具,用于测试数据库应用
  * [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 1,231 | 🐛 13 | 🌐 Go | 📅 2026-03-18 :  作为另一个` Go`应用程序或测试的一部分,在`Linux、OSX` 或`Windows`上本地运行一个真正的 Postgres 数据库
  ...
  * [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 23 | 🐛 2 | 🌐 Go | 📅 2026-09-14 : ` HTTP`客户端测试框架。
...
* Mock
  ...
  * [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,514 | 🐛 34 | 🌐 Go | 📅 2026-09-13 :`  HTTP(S) : proxy,`用于记录和模拟`REST/SOAP API`,具有可扩展的中间件和易于使用的 CLI。
  * [gock](https://github.com/h2non/gock) ⭐ 2,217 | 🐛 49 | 🌐 Go | 📅 2024-09-24 :   多功能、易用`HTTP mock`
  * [httpmock](https://github.com/jarcoal/httpmock) ⭐ 2,077 | 🐛 5 | 🌐 Go | 📅 2026-08-29 :  轻松模拟来自外部资源的 HTTP 响应。
  * [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) ⭐ 1,140 | 🐛 2 | 🌐 Go | 📅 2026-09-11 :  用于生成自包含`mock`对象的工具
...
* Selenium及浏览器控制工具
  * [chromedp](https://github.com/knq/chromedp) ⭐ 13,276 | 🐛 180 | 🌐 Go | 📅 2026-07-14 :  用于驱动和测试`Chrome, Safari, Edge, Android Webviews`, 以及其他支持`Chrome`调试协议的产品
  * [rod](https://github.com/go-rod/rod) ⭐ 7,096 | 🐛 212 | 🌐 Go | 📅 2026-08-11 : `Devtools`驱动,使网络自动化测试变得简单。
...
* 特定文本格式处理
  * [colly](https://github.com/asciimoo/colly) ⭐ 25,516 | 🐛 195 | 🌐 Go | 📅 2026-09-02 :  `go`语言版爬虫框架
  * [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,988 | 🐛 4 | 🌐 Go | 📅 2026-09-14 :`  GoQuery` 为` Go`语言带来了一组类似`jQuery` 的语法和功能
  * [sh](https://github.com/mvdan/sh) ⭐ 9,057 | 🐛 93 | 🌐 Go | 📅 2026-09-09 : `Shell`解析器及格式化工具
  ...
  * [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,824 | 🐛 61 | 🌐 Go | 📅 2026-03-02 :    将时间、数字和内存大小格式化为人类可读的格式。
  * [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3,810 | 🐛 26 | 🌐 Go | 📅 2026-08-03 :  将`HTML`转换为`Markdown`。甚至适用于整个网站,并可通过规则进行扩展。
  * [bluemonday](https://github.com/microcosm-cc/bluemonday) ⭐ 3,719 | 🐛 35 | 🌐 Go | 📅 2025-04-04 : ` HTML` 清理工具
  ...
  * [dataflowkit](https://github.com/slotix/dataflowkit) ⭐ 714 | 🐛 4 | 🌐 Go | 📅 2023-03-07 : `Web`爬虫框架用于将网站转化为结构化数据。
  ...
  * [editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) ⭐ 156 | 🐛 8 | 🌐 Go | 📅 2026-09-14 : Go 语言用的`Editorconfig` 文件解析和操作库
...
* [github](https://github.com/google/go-github) ⭐ 11,307 | 🐛 41 | 🌐 Go | 📅 2026-09-14 :  用于访问`GitHub REST API v3` 的`Go`库。
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) ⚠️ Archived : ` AWS` 提供的官方go语言` SDK`
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,988 | 🐛 232 | 🌐 Go | 📅 2026-02-14 :   用于与`Discord` 聊天` API`进行交互的`Go`语言客户端。
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,505 | 🐛 407 | 🌐 Go | 📅 2026-09-14 :`Google Cloud APIs Go`客户端库。
* [google](https://github.com/google/google-api-go-client) ⭐ 4,474 | 🐛 19 | 🌐 Go | 📅 2026-09-14 :  为`Go` 自动生成的`Google API`。
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,998 | 🐛 11 | 🌐 Go | 📅 2026-09-10 :  `go` 语言`Minio` 客户端,用于` Amazon S3` 兼容的云存储
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,634 | 🐛 10 | 🌐 Go | 📅 2026-09-14 :  用于访问`Stripe API`的`Go`客户端。
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,984 | 🐛 328 | 🌐 Go | 📅 2026-09-14 :  命令行模糊查找工具
...
* [Task](https://github.com/go-task/task) ⭐ 16,142 | 🐛 190 | 🌐 Go | 📅 2026-09-14 :  简单来讲就是`"Make"`的替代品
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 16,048 | 🐛 21 | 🌐 Go | 📅 2026-09-12 : 尽可能快速的发布`Go`语言二进制文件
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,732 | 🐛 42 | 🌐 Go | 📅 2026-08-04 :   交互式命令行程序,用于进行`HTTP` 检查
* [usql](https://github.com/knq/usql) ⭐ 10,113 | 🐛 121 | 🌐 Go | 📅 2026-09-13 :  `usql`是一个通用的命令行接口,用于操作`sql`数据库
...
* [minify](https://github.com/tdewolff/minify) ⭐ 4,142 | 🐛 40 | 🌐 Go | 📅 2026-09-13 :  快速压缩`HTML, CSS, JS, XML, JSON` 以及` SVG` 文件格式
...
* [filetype](https://github.com/h2non/filetype) ⭐ 2,299 | 🐛 52 | 🌐 Go | 📅 2026-07-01 :  用于推断文件类型的小程序包,它可以检查魔法数字签名。
...
* [immortal](https://github.com/immortal/immortal) ⭐ 839 | 🐛 2 | 🌐 Go | 📅 2026-08-16 :  \*nix 跨平台 (与操作系统无关的)监控程序
...
* [delve](https://github.com/derekparker/delve) ⭐ 661 | 🐛 2 | 🌐 Go | 📅 2026-09-14 : `Go`语言调试器
...
* [serve](https://github.com/syntaqx/serve) ⭐ 353 | 🐛 0 | 🌐 Go | 📅 2026-09-09 :  静态` http`服务器。
...
* [uuid](https://github.com/gofrs/uuid) ⭐ 1,808 | 🐛 5 | 🌐 Go | 📅 2026-08-17 :  通用唯一标识符`（UUID）`的实现。支持`UUID`的创建和解析。
...
* [validator](https://github.com/go-playground/validator) ⭐ 20,166 | 🐛 329 | 🌐 Go | 📅 2026-09-14 :  `Go`结构体及域验证,包括：跨域、跨结构体,`Map`, 切片和数组
* [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,204 | 🐛 169 | 🌐 Go | 📅 2026-09-13 :  数据验证及清晰工具,用于字符串,数字, 数组切片及结构体
...
* [jio](https://github.com/faceair/jio) ⭐ 126 | 🐛 3 | 🌐 Go | 📅 2024-07-04 : `jio`是一个类似于[joi](https://github.com/hapijs/joi) ⭐ 21,174 | 🐛 199 | 🌐 JavaScript | 📅 2026-09-11 的json模式验证器.
...
* [hercules](https://github.com/src-d/hercules) ⭐ 2,807 | 🐛 50 | 🌐 Go | 📅 2023-02-07 :  查看`git repo`历史的代码库
* [git2go](https://github.com/libgit2/git2go) ⭐ 2,007 | 🐛 84 | 🌐 Go | 📅 2024-03-04 :  `libgit2`的` Go`语言接口
* [go-vcs](https://github.com/sourcegraph/go-vcs) ⭐ 81 | 🐛 22 | 🌐 Go | 📅 2026-09-01 :  通过`Go`语言来操作和检视` VCS`代码仓
...
* [go-astisub](https://github.com/asticode/go-astisub) ⭐ 709 | 🐛 10 | 🌐 Go | 📅 2026-09-09 :  使用 Go 语言操作字幕`(.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).`
* [go-astits](https://github.com/asticode/go-astits) ⭐ 617 | 🐛 8 | 🌐 Go | 📅 2026-08-15 :  在 GO 中解析和解调` MPEG` 传输流（.ts）。
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 89,217 | 🐛 771 | 🌐 Go | 📅 2026-08-15 :  ` Gin` 是一个` Go` 语言编写的 web 框架,提供了一组类似`martini`的`API`,且具有更好的性能（40倍的性能提升）。如果你需要高性能和高生产率,这个框架很适合你
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,158 | 🐛 34 | 🌐 Go | 📅 2026-09-14 :  受` Express.js`启发的` Web` 框架,构建在`Fasthttp`上。
* [Echo](https://github.com/labstack/echo) ⭐ 32,705 | 🐛 39 | 🌐 Go | 📅 2026-09-11 :   高性能、极简的` Go`语言`web` 框架
...
* [Goyave](https://github.com/System-Glitch/goyave) ⭐ 1,776 | 🐛 14 | 🌐 Go | 📅 2026-09-14 :  功能完整的`Web`框架,旨在实现简洁的代码和快速开发,具有强大的内置功能。
...
* [Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) ⭐ 594 | 🐛 32 | 🌐 Go | 📅 2026-09-10 :   提供电子商务功能,使用简洁的架构,如`DDD`、端口和适配器,你可以用它来构建灵活的电子商务应用。
* [Aero](https://github.com/aerogo/aero) ⚠️ Archived : `Go`的高性能Web框架,在`Lighthouse` 评比中拿到最高分
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 559 | 🐛 36 | 🌐 Go | 📅 2026-09-09 :  可插拔的`we`b项目框架。包括模块的概念,并提供`DI、Configareas、i18n`、模板引擎、graphql、可观察性、安全性、事件、路由和反向路由等功能。
...
* [CORS](https://github.com/rs/cors) ⭐ 2,899 | 🐛 23 | 🌐 Go | 📅 2026-06-04 :  非常方便地向你的`api`中添加` CORS`功能
...
* [chi](https://github.com/go-chi/chi) ⭐ 22,825 | 🐛 94 | 🌐 Go | 📅 2026-09-08 :   基于`net/context`的小巧、快速、具有丰富表达力的`HTTP`路由.
* [mux](https://github.com/gorilla/mux) ⭐ 21,836 | 🐛 41 | 🌐 Go | 📅 2024-08-15 :  强大的`URL`路由和分发库
* [httprouter](https://github.com/julienschmidt/httprouter) ⭐ 17,131 | 🐛 84 | 🌐 Go | 📅 2024-07-22 :  高性能路由,使用这个库和标准http处理工具可以构建一个非常高性能大web框架
...
* [httptreemux](https://github.com/dimfeld/httptreemux) ⭐ 618 | 🐛 9 | 🌐 Go | 📅 2024-07-10 :  快速,灵活,树状结构的` HTTP`路由。受到了` httprouter` 的启发
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 17,729 | 🐛 553 | 🌐 Go | 📅 2026-09-14 :  基于`LLVM`,适用于微型场景的`Go`编译器。包括微控制器、`WebAssembly`和命令行工具。
...
* [xpath](https://github.com/antchfx/xpath) ⭐ 742 | 🐛 21 | 🌐 Go | 📅 2026-09-11 : `XPath` 库
...
* [gosimple](https://github.com/dominikh/go-tools/tree/master/cmd/gosimple) ⭐ 6,894 | 🐛 576 | 🌐 Go | 📅 2026-08-24 : 针对 Go 语言的`lint`工具,专注于简化代码
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,894 | 🐛 576 | 🌐 Go | 📅 2026-08-24 :  -`staticcheck`在`Go vet`阶段中执行大量的静态分析检查,类似`ReSharper for C#`这样的工具。
* [unused](https://github.com/dominikh/go-tools/tree/master/cmd/unused) ⭐ 6,894 | 🐛 576 | 🌐 Go | 📅 2026-08-24 :  `unused`会检查 Go 语言代码中没有用到的常量,变量,函数和类型
...
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,264 | 🐛 439 | 🌐 TypeScript | 📅 2026-09-10 : `Visual Studio Code (VS Code)` : 使用的一个扩展,为` Go` 语言提供了支持
...
* [xgen](https://github.com/xuri/xgen) ⭐ 424 | 🐛 35 | 🌐 Go | 📅 2026-09-02 : ` XSD (XML Schema Definition)`  解析器,能够生成`Go/C/Java/Rust/Typescript`代码
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 127,713 | 🐛 3,040 | 🌐 Go | 📅 2026-09-14 :  来自`Google`的容器集群管理器
* [Moby](https://github.com/moby/moby) ⭐ 72,104 | 🐛 3,912 | 🌐 Go | 📅 2026-09-14 :  为容器生态系统创建的一个合作项目,用于构建基于容器的系统
* [traefik](https://github.com/containous/traefik) ⭐ 64,840 | 🐛 923 | 🌐 Go | 📅 2026-09-14 :  能对接多个后端的反向代理和负载均衡器。
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 57,983 | 🐛 2,465 | 🌐 Go | 📅 2026-09-14 :  社区驱动的`Gogs`的`fork`库
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 25,187 | 🐛 122 | 🌐 Go | 📅 2026-02-16 :  `HTTP 加`载测试工具和代码库
* [Hey](https://github.com/rakyll/hey) ⭐ 20,260 | 🐛 188 | 🌐 Go | 📅 2026-01-10 :` Hey`是一个微型程序,用于向`web` 应用发送负载
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,787 | 🐛 322 | 🌐 Go | 📅 2026-09-14 :` Packer`通过单一的配置文件,为不同的平台创建独立镜像
* [webhook](https://github.com/adnanh/webhook) ⭐ 12,127 | 🐛 127 | 🌐 Go | 📅 2026-09-04 :  允许用户创建`HTTP`钩子,并在服务器上执行命令
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,686 | 🐛 243 | 🌐 Shell | 📅 2024-08-08 : ` GVM`提供了用于管理`Go`语言版本的接口
* [script](https://github.com/bitfield/script) ⭐ 7,036 | 🐛 15 | 🌐 Go | 📅 2026-09-06 :  在Go中轻松编写类似`shell`的脚本,用于`DevOps`和系统管理任务。
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,836 | 🐛 28 | 🌐 Go | 📅 2026-08-25 :  快速的、跨平台的`HTTP`基准工具.
* [gaia](https://github.com/gaia-pipeline/gaia) ⚠️ Archived :   利用任何编程语言都可以构建强大的管道的库。
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 5,004 | 🐛 154 | 🌐 Go | 📅 2026-09-14 :  `Pomerium`是一个身份感知的访问代理。
* [gox](https://github.com/mitchellh/gox) ⚠️ Archived :  非常简单的`Go`语言交叉编译工具
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 4,189 | 🐛 192 | 🌐 Go | 📅 2025-06-13 :  快速的` S3` 和本地文件系统执行工具。
...
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 997 | 🐛 282 | 🌐 Go | 📅 2026-09-14 :  通过命令行来管理 裸金属服务器 (和使用`Docker`一样容易)。
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 484 | 🐛 20 | 🌐 Go | 📅 2026-09-14 : `S3`代理,具有`GET、PUT`和`DELETE`方法和认证（`OpenID Connect`和`Basic Auth`）。
* [Pewpew](https://github.com/bengadbois/pewpew) ⭐ 458 | 🐛 1 | 🌐 Go | 📅 2026-03-28 :  灵活的`HTTP`命令行压力测试工具
* [jcli](https://github.com/jenkins-zh/jenkins-cli) ⭐ 431 | 🐛 82 | 🌐 Go | 📅 2025-03-28 :  `Jenkins CLI`允许你以一种简单的方式管理你的`Jenkins`。
...
* [croc](https://github.com/schollz/croc) ⭐ 40,333 | 🐛 2 | 🌐 Go | 📅 2026-09-14 :    轻松安全地将文件或文件夹从一台计算机发送到另一台计算机。
* [restic](https://github.com/restic/restic) ⭐ 36,046 | 🐛 596 | 🌐 Go | 📅 2026-09-01 :  解耦备份程序
* [Gor](https://github.com/buger/gor) ⭐ 19,319 | 🐛 341 | 🌐 Go | 📅 2026-01-27 :  Http 流量复制工具,用于将生产环境的流量在开发环境进行重放
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12,341 | 🐛 105 | 🌐 Go | 📅 2026-09-01 :  用于自动化测试中模拟网络和系统状态的代理服务。
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,512 | 🐛 26 | 🌐 Go | 📅 2025-03-20 :   模拟网络波动情况下的网络数据连接
* [scc](https://github.com/boyter/scc) ⭐ 8,748 | 🐛 27 | 🌐 Go | 📅 2026-09-14 :   一个非常快速准确的代码计数器,具有复杂度计算和`COCOMO`估计功能。
* [confd](https://github.com/kelseyhightower/confd) ⭐ 8,429 | 🐛 178 | 🌐 Go | 📅 2024-07-16 :  使用`etcd`或` consul`来管理本地应用的配置文件
* [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,763 | 🐛 413 | 🌐 C++ | 📅 2026-09-09 : `LiteIDE` 是一个简单、开源、跨平台的` Go`语言` IDE`
* [drive](https://github.com/odeke-em/drive) ⭐ 6,729 | 🐛 287 | 🌐 Go | 📅 2024-02-09 :  命令行版本的`Google Drive`客户端。
* [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,679 | 🐛 336 | 🌐 Go | 📅 2026-08-06 :  跨平台网络和云备份工具
...
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 39 | 🐛 1 | 🌐 Go | 📅 2026-09-14 :  快速、简单、可扩展的分布式文件系统,具有`O(1)`的磁盘查找效率
