【导读】：[awesome-go](https://github.com/avelino/awesome-Go) ⭐ 184,533 | 🐛 230 | 🌐 Go | 📅 2026-09-16 就是 `avelino` 发起维护的 Go 资源列表，内容包括：音频和音乐库、命令行工具、服务端应用、流处理、持续集成、数据库、机器学习、NLP、物联网、中间件、文本处理、安全、机器人技术等。
...
* [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,970 | 🐛 20 | 🌐 Go | 📅 2026-09-16 :  可用于在多个平台上播放音频的底层库
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 20,394 | 🐛 38 | 🌐 Go | 📅 2026-09-11 : 支持`ACL`、`RBAC`、`ABAC`等访问控制模型的授权与认证库。
* [jwt-go](https://github.com/dgrijalva/jwt-go) ⚠️ Archived :   -`JSON Web Tokens`（JWT）的Golang实现。
* [goth](https://github.com/markbates/goth) ⭐ 6,603 | 🐛 147 | 🌐 Go | 📅 2026-02-11 :   以简单、干净、常用的方式来使用`OAuth`和`OAuth2`。支持多种身份认证。
...
* [cobra](https://github.com/spf13/cobra) ⭐ 44,612 | 🐛 444 | 🌐 Go | 📅 2026-07-11 :   一个现代化的命令行。
* [urfave/cli](https://github.com/urfave/cli) ⭐ 24,240 | 🐛 69 | 🌐 Go | 📅 2026-09-14 :   简单、快速、有趣的、用于构建 Go 语言命令行程序的软件包。
* [kingpin](https://github.com/alecthomas/kingpin) ⭐ 3,568 | 🐛 28 | 🌐 Go | 📅 2026-09-14 :  支持子命令的命令行和标志位解析器。
* [Dnote](https://github.com/dnote/dnote) ⭐ 3,079 | 🐛 41 | 🌐 Go | 📅 2026-07-25 :  支持多设备同步的命令行笔记工具。
* [pflag](https://github.com/spf13/pflag) ⭐ 2,767 | 🐛 137 | 🌐 Go | 📅 2026-09-06 :  Go flag软件包的替代品, 实现了`POSIX/GNU`风格的`flags`.
* [go-flags](https://github.com/jessevdk/go-flags) ⭐ 2,694 | 🐛 68 | 🌐 Go | 📅 2024-07-26 : `  GO`命令行选项解析器。
* [go-arg](https://github.com/alexflint/go-arg) ⭐ 2,279 | 🐛 36 | 🌐 Go | 📅 2025-12-27 :  `Go`中基于结构体的参数解析。
...
* [termui](https://github.com/gizak/termui) ⭐ 13,584 | 🐛 106 | 🌐 Go | 📅 2025-07-10 :   基于 `termbox-go` 的 `Go` 终端仪表盘,灵感来源于[blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,773 | 🐛 97 | 🌐 JavaScript | 📅 2026-05-01 。
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,604 | 🐛 59 | 🌐 Go | 📅 2025-05-01 :  极简的控制台用户界面创建库.
* [pterm](https://github.com/pterm/pterm) ⭐ 5,536 | 🐛 86 | 🌐 Go | 📅 2026-07-11 :  在每个平台上美化控制台输出的库,有许多可组合的组件。
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,501 | 🐛 113 | 🌐 Go | 📅 2025-08-12 :   受 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,575 | 🐛 719 | 🌐 Python | 📅 2026-07-26  的启发，用于构建强大的交互式提示符的go语言库
* [termbox-go](https://github.com/nsf/termbox-go) ⭐ 4,788 | 🐛 50 | 🌐 Go | 📅 2026-08-23 :   Termbox是一个用于创建跨平台文本界面的库。
* [progressbar](https://github.com/schollz/progressbar) ⭐ 4,704 | 🐛 15 | 🌐 Go | 📅 2026-08-18 :   适用于各种操作系统的,线程安全进度条管理库。
* [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 3,093 | 🐛 5 | 🌐 Go | 📅 2026-06-21 :   没有其他依赖的可以在命令行应用中制作轻量级的`ASCII`行图┈┈╭╯的go语言工具包
* [termdash](https://github.com/mum4k/termdash) ⭐ 3,037 | 🐛 49 | 🌐 Go | 📅 2026-09-14 :   基于 `termbox-go `的 `Go` 终端仪表盘,灵感来自 [termui](https://github.com/gizak/termui) ⭐ 13,584 | 🐛 106 | 🌐 Go | 📅 2025-07-10 。
* [mpb](https://github.com/vbauerster/mpb) ⭐ 2,509 | 🐛 15 | 🌐 Go | 📅 2026-09-01 :  为命令行提供多个进度条的工具
...
* [gookit/color](https://github.com/gookit/color) ⭐ 1,608 | 🐛 3 | 🌐 Go | 📅 2026-09-07 :  格式化终端文本。
...
* [viper](https://github.com/spf13/viper) ⭐ 30,458 | 🐛 133 | 🌐 Go | 📅 2026-01-12 :`Go`语言配置工具
* [godotenv](https://github.com/joho/godotenv) ⭐ 10,635 | 🐛 84 | 🌐 Go | 📅 2026-08-04 : 把 `Ruby`的 `dotenv `库移植到 `Go `（从 `.env `中加载环境变量）。
* [env](https://github.com/caarlos0/env) ⭐ 6,311 | 🐛 31 | 🌐 Go | 📅 2026-09-04 :   解析环境变量为` Go` 语言结构体
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) ⭐ 5,466 | 🐛 62 | 🌐 Go | 📅 2025-06-28 :  用于管理环境变量配置数据的` Go` 库。
* [koanf](https://github.com/knadh/koanf) ⭐ 4,202 | 🐛 9 | 🌐 Go | 📅 2026-09-02 :  轻量级、可扩展的库,用于读取Go应用程序中的配置。内置支持`JSON、TOML、YAML、env`、命令行。
* [ini](https://github.com/go-ini/ini) ⭐ 3,543 | 🐛 95 | 🌐 Go | 📅 2026-09-05 :  用于读写INI 文件的库
* [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 2,161 | 🐛 54 | 🌐 Go | 📅 2025-09-15 :   简约的配置读取器(从文件、`ENV`以及任何你想要的地方读取)。
* [konfig](https://github.com/lalamove/konfig) ⭐ 645 | 🐛 5 | 🌐 Go | 📅 2020-10-28 :  为分布式处理时代的`Go`提供可组合、可观察和可执行的配置处理。
* [aconfig](https://github.com/cristalhq/aconfig) ⭐ 641 | 🐛 19 | 🌐 Go | 📅 2025-11-28 :   简单、有用的配置加载器。
...
* [drone](https://github.com/drone/drone) ⭐ 38,379 | 🐛 109 | 🌐 Go | 📅 2026-09-17 : ` Drone` 是一个基于` Docker`的持续集成平台,使用 `Go `语言编写
* [CDS](https://github.com/ovh/cds) ⭐ 4,843 | 🐛 160 | 🌐 Go | 📅 2026-09-17 :  企业级`CI/CD`和`DevOps`自动化开源平台。
...
* [go-datastructures](https://github.com/Workiva/go-datastructures) ⭐ 7,955 | 🐛 30 | 🌐 Go | 📅 2026-07-31:一组有用的、高性能的、线程安全的数据结构
* [golang-set](https://github.com/deckarep/golang-set) ⭐ 4,703 | 🐛 12 | 🌐 Go | 📅 2026-09-15 :  线程安全和非线程安全的高性能集合
* [gota](https://github.com/kniren/gota) ⚠️ Archived :  为go语言实现了数据帧,序列以及数据噪音的方法
* [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2,940 | 🐛 82 | 🌐 Go | 📅 2026-09-15 :  实现了压缩`bitsets`算法的Go语言库
* [gocache](https://github.com/eko/gocache) ⭐ 2,885 | 🐛 4 | 🌐 Go | 📅 2026-09-13 :   完整的`Go`缓存库,支持多个存储（内存、`memcache、redis......`）。
* [willf/bloom](https://github.com/willf/bloom) ⭐ 2,813 | 🐛 19 | 🌐 Go | 📅 2026-07-10 :   实现了布隆过滤器的库
...
* [ttlcache](https://github.com/ReneKroon/ttlcache) ⭐ 1,283 | 🐛 16 | 🌐 Go | 📅 2026-09-14 : 基于过期时间的内存字符串缓存接口。
* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) ⭐ 1,234 | 🐛 15 | 🌐 Go | 📅 2024-07-15 : `Cuckoo`过滤器：一个用go语言实现的计数布隆过滤器的替代品
* [gostl](https://github.com/liyue201/gostl) ⭐ 1,140 | 🐛 7 | 🌐 Go | 📅 2025-08-28 :  数据结构和算法库,旨在提供类似于` C++ STL` 的功能。
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,108 | 🐛 897 | 🌐 Go | 📅 2026-09-17 :  监控系统及时间序列数据库
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,541 | 🐛 7,064 | 🌐 Go | 📅 2026-09-17 : ` TiDB` 是一个分布式的` SQL` 数据库。受到了` Google F1`的启发
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,473 | 🐛 8,428 | 🌐 Go | 📅 2026-09-16 :  可扩展的、一致的事务型数据库
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 31,747 | 🐛 2,179 | 🌐 Rust | 📅 2026-09-17 :  用于度量、事件和实时分析的可扩展数据存储。
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,800 | 🐛 104 | 🌐 Go | 📅 2026-09-17 :  可扩展的、分布式的、低延时、高吞吐的图数据库
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 17,741 | 🐛 79 | 🌐 Go | 📅 2026-09-15 :  基于 `SQLite `的轻量级的、分布式的关系型数据库
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,732 | 🐛 816 | 🌐 Go | 📅 2026-09-17 :  快速、资源高效、可扩展的开源时间序列数据库。可作为`Prometheus`的长期远程存储。支持`PromQL`。
...
* [go-cache](https://github.com/pmylund/go-cache) ⭐ 8,843 | 🐛 80 | 🌐 Go | 📅 2023-11-20 :   基于内存存储的缓存,适用于分布式部署的应用
* [BigCache](https://github.com/allegro/bigcache) ⭐ 8,162 | 🐛 94 | 🌐 Go | 📅 2026-09-14 :  为GB量级数据设计的高效键/值缓存
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,322 | 🐛 111 | 🌐 Go | 📅 2024-05-14 :  `Go`中[LevelDB](https://github.com/google/leveldb) ⭐ 39,423 | 🐛 409 | 🌐 C++ | 📅 2026-03-11键/值数据库的实现
...
* [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,579 | 🐛 51 | 🌐 Go | 📅 2026-08-09 :  `Nutsdb`是一个用纯`Go`编写的简单、快速、可嵌入、持久化的键/值存储。它支持完全可序列化的事务和许多数据结构,如列表、集合、排序集合。
...
* [Databunker](https://github.com/paranoidguy/databunker) ⭐ 1,484 | 🐛 4 | 🌐 Go | 📅 2026-07-28 :  为符合`GDPR`和`CCPA`而构建的个人身份信息`PII`存储服务。
...
* [goose](https://github.com/pressly/goose) ⭐ 11,473 | 🐛 131 | 🌐 Go | 📅 2026-09-12 :   数据库迁移工具。你可以通过编写增量 `SQL `或 `Go` 语言脚本来管理你的数据库
...
* [skeema](https://github.com/skeema/skeema) ⭐ 1,380 | 🐛 15 | 🌐 Go | 📅 2026-09-10 :  `MySQL`的纯SQL模式管理系统,支持`sharding`和外部在线模式变更工具
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,343 | 🐛 1,112 | 🌐 Go | 📅 2026-09-17 :  `vitess` 提供了能够使大型 `web `服务 `MySQL` 数据库的扩展变得更加容易的服务器及工具
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,507 | 🐛 56 | 🌐 Go | 📅 2026-07-26 :  基于 `Web` 的 `PostgreSQL` 数据库浏览工具
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,967 | 🐛 156 | 🌐 Go | 📅 2026-09-08 :   用于处理` MySQL` 协议及复制的`Go`语言工具集
* [pREST](https://github.com/nuveo/prest) ⭐ 4,618 | 🐛 155 | 🌐 Go | 📅 2026-09-17 :  为 `PostgreSQL `数据库提供 `RESTful API`
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) ⭐ 4,146 | 🐛 219 | 🌐 Go | 📅 2023-10-22 :  将你的 `MySQL` 数据自动同步到` Elasticsearch`
* [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1,482 | 🐛 90 | 🌐 Go | 📅 2026-04-15 : ` HTTP`代理的`ClickHouse`数据库。
...
* [dbbench](https://github.com/sj14/dbbench) ⭐ 118 | 🐛 9 | 🌐 Go | 📅 2026-09-02 :  数据库基准测试工具,支持多个数据库和脚本。
...
* [Squirrel](https://github.com/Masterminds/squirrel) ⭐ 7,988 | 🐛 97 | 🌐 Go | 📅 2024-04-24 :  一个帮助你构建 `SQL` 查询的库
* [xo](https://github.com/knq/xo) ⭐ 3,895 | 🐛 70 | 🌐 Go | 📅 2026-09-08 :  基于已知的数据库表或自定义查询生成地道的`Go`语言代码,支持 `PostgreSQL, MySQL, SQLite, Oracle`, 以及 `Microsoft SQL Server`.
...
* [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) ⭐ 669 | 🐛 2 | 🌐 Go | 📅 2026-09-03 :  强大的数据检索方法以及与`DB`无关的查询构建能力。
...
* 关系型数据库
  * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 15,284 | 🐛 57 | 🌐 Go | 📅 2026-09-17 :  Go 语言 `MySQL`驱动
  * [pgx](https://github.com/jackc/pgx) ⭐ 14,253 | 🐛 214 | 🌐 Go | 📅 2026-09-17 :  `PostgreSQL` 驱动,支持比 `database/sql `更多的特性
  * [pq](https://github.com/lib/pq) ⭐ 9,955 | 🐛 52 | 🌐 Go | 📅 2026-08-20 :  用于`database/sql`的`Pure Go Postgres`驱动。
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,236 | 🐛 152 | 🌐 C | 📅 2026-09-05 :  Go 语言的 `SQLite3 `驱动
  ...
  * [Sqinn-Go](https://github.com/cvilsmeier/sqinn-go) ⭐ 541 | 🐛 0 | 🌐 Go | 📅 2026-08-27 :  纯Go的`SQLite`驱动。
  * [goracle](https://github.com/go-goracle/goracle) ⚠️ Archived :  用于 `Go `的 `Oracle `驱动程序,使用 `ODPI-C` 驱动程序。
  * [firebirdsql](https://github.com/nakagami/firebirdsql) ⭐ 266 | 🐛 1 | 🌐 Go | 📅 2026-09-17 :  `Firebird RDBMS SQL `驱动
...
* NoSQL数据库
  * [redis](https://github.com/go-redis/redis) ⭐ 22,242 | 🐛 70 | 🌐 Go | 📅 2026-09-17 :  兼容R`edis`协议的 `TCP` 服务器/服务.
  * [redigo](https://github.com/gomodule/redigo) ⭐ 9,853 | 🐛 25 | 🌐 Go | 📅 2025-11-02 : ` RediGo`是 `Redis` 数据库的`Go` 语言客户端.
  * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,538 | 🐛 29 | 🌐 Go | 📅 2026-09-17 :   `Go`语言的官方`MongoDB`驱动。
  ...
  * [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) ⭐ 461 | 🐛 51 | 🌐 Go | 📅 2026-09-14 :   `Go`语言的`Aerospike`客户端。
...
* 搜索引擎和文本数据库
  * [bleve](https://github.com/blevesearch/bleve) ⭐ 11,217 | 🐛 293 | 🌐 Go | 📅 2026-09-16 :  现代文本索引库
  * [elastic](https://github.com/olivere/elastic) ⭐ 7,443 | 🐛 116 | 🌐 Go | 📅 2024-08-08 :  ` Go` 语言的 `Elasticsearch `客户端
  * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 6,068 | 🐛 27 | 🌐 Go | 📅 2026-09-08 : Go的官方`Elasticsearch`客户端。
  * [riot](https://github.com/go-ego/riot) ⭐ 6,047 | 🐛 1 | 🌐 Go | 📅 2026-09-17 :  `Go`开源,分布式,简单高效的搜索引擎。
...
* 多个后端:
  * [cayley](https://github.com/google/cayley) ⭐ 15,064 | 🐛 93 | 🌐 Go | 📅 2026-08-27 :  支持多个后端的图形数据库。
...
* [now](https://github.com/jinzhu/now) ⭐ 4,698 | 🐛 19 | 🌐 Go | 📅 2026-02-02 :  `Now` 是一个 `Go` 语言的时间工具集
* [dateparse](https://github.com/araddon/dateparse) ⭐ 2,140 | 🐛 63 | 🌐 Go | 📅 2023-12-30 :  在不知道格式的情况下解析日期。
...
* [go-str2duration](https://github.com/xhit/go-str2duration) ⭐ 118 | 🐛 1 | 🌐 Go | 📅 2026-09-14 :  将字符串转换为持续时间。支持`time.Duration`返回字符串等。
...
* [raft](https://github.com/coreos/etcd/tree/master/raft) ⭐ 52,270 | 🐛 354 | 🌐 Go | 📅 2026-09-17 : ` Raft`共识协议的 `Go` 实现,由 `CoreOS` 提供。
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,423 | 🐛 60 | 🌐 Go | 📅 2024-07-19 :   为服务工具吧,支持服务发现、负载均衡 、可插拔传输以及请求追踪等
* [go-micro](https://github.com/micro/go-micro) ⭐ 23,069 | 🐛 6 | 🌐 Go | 📅 2026-09-11 :   一个分布式系统开发框架。
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 23,068 | 🐛 137 | 🌐 Go | 📅 2026-09-17 : ` gRPC`的Go语言实现。基于`HTTP/2的RPC`。
* [NATS](https://github.com/nats-io/gnatsd) ⭐ 20,738 | 🐛 538 | 🌐 Go | 📅 2026-09-17 :  轻量级、高性能微服务系统,用于微服务、物联网以及云
...
* [torrent](https://github.com/anacrolix/torrent) ⭐ 6,111 | 🐛 78 | 🌐 Go | 📅 2026-09-11 :   `BitTorrent` 客户端
...
* [emitter-io](https://github.com/emitter-io/emitter) ⭐ 4,006 | 🐛 16 | 🌐 Go | 📅 2026-04-29 :  使用` MQTT、Websockets` 和 `love` 构建的高性能、分布式、安全和低延迟的发布-订阅平台。
* [gleam](https://github.com/chrislusf/gleam) ⭐ 3,565 | 🐛 38 | 🌐 Go | 📅 2026-09-09 :   快速、可扩展的分布式` map/reduce` 系统,使用纯` Go` 语言和` Luajit` 编写,融合了 Go 语言的高并发能力和 Luajit 的高性能,可以独立或分布式部署运行。
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 387 | 🐛 0 | 🌐 Go | 📅 2023-07-09 :  在 `HTTP `服务之间进行无主` p2p` 自动发现和 RPC通信(使用 [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 11,003 | 🐛 383 | 🌐 C++ | 📅 2026-07-26)ß
...
* [MailHog](https://github.com/mailhog/MailHog) ⭐ 16,161 | 🐛 256 | 🌐 Go | 📅 2024-02-13 :  `Email` 及 `SMTP` 测试工具,具有 web 及 API 接口
...
* [mailgun-go](https://github.com/mailgun/mailgun-go) ⭐ 745 | 🐛 3 | 🌐 Go | 📅 2026-09-07 :  使用`Mailgun API`发送邮件的Go库。
...
* [expr](https://github.com/antonmedv/expr) ⭐ 8,016 | 🐛 92 | 🌐 Go | 📅 2026-07-07 :  ` Go` 的表达式评估引擎，具有快速、非图灵完备、动态类型化、静态类型化的特性。
* [goja](https://github.com/dop251/goja) ⭐ 7,100 | 🐛 33 | 🌐 Go | 📅 2026-09-17 :  在 Go 中实现 `ECMAScript 5.1(+)` 。
* [gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,979 | 🐛 104 | 🌐 Go | 📅 2026-04-01 :  ` Go` 语言编写的 `Lua 5.1` 虚拟机和编译器
* [tengo](https://github.com/d5/tengo) ⭐ 3,838 | 🐛 91 | 🌐 Go | 📅 2026-04-29 : `Go`的字节码编译脚本语言。
...
* [binder](https://github.com/alexeyco/binder) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2022-07-07 :  基于[gopher-lua](https://github.com/yuin/gopher-lua) ⭐ 6,979 | 🐛 104 | 🌐 Go | 📅 2026-04-01的go语言Lua 接口,
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 8,842 | 🐛 126 | 🌐 Go | 📅 2026-09-14 :   PDF 处理器。
* [afero](https://github.com/spf13/afero) ⭐ 6,697 | 🐛 137 | 🌐 Go | 📅 2026-09-11 : ` go`语言编写的对文件系统进行抽象的系统框架
...
* [vfs](https://github.com/C2FO/vfs) ⭐ 369 | 🐛 10 | 🌐 Go | 📅 2026-09-16 :  适用于 `Go` 的多个文件系统类型,如 `os、S3 `和 `GCS`的可插拔、可扩展的文件系统功能库。
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 7,479 | 🐛 154 | 🌐 Go | 📅 2026-08-19 :  支持任意精度的十进制数的go包
...
* [Ebiten](https://github.com/hajimehoshi/ebiten) ⭐ 13,489 | 🐛 295 | 🌐 Go | 📅 2026-09-17 :  `Go` 语言编写的简单的 `2D` 游戏库
...
* [g3n](https://github.com/g3n/engine) ⭐ 3,114 | 🐛 37 | 🌐 Go | 📅 2026-08-01 :  `Go 3D`游戏引擎。
...
* [jennifer](https://github.com/dave/jennifer) ⭐ 3,632 | 🐛 19 | 🌐 Go | 📅 2024-09-08 :   不适用模板生成任意 `Go` 语言代码
...
* [go-enum](https://github.com/abice/go-enum) ⭐ 959 | 🐛 23 | 🌐 Go | 📅 2026-09-14 :   从代码注释中生成`enums`代码。
...
* [mbtileserver](https://github.com/consbio/mbtileserver) ⭐ 792 | 🐛 23 | 🌐 Go | 📅 2025-05-21 :  简单的基于`Go`的服务器,用于存储`mbtiles`格式的地理信息。
...
* [ants](https://github.com/panjf2000/ants) ⭐ 14,506 | 🐛 1 | 🌐 Go | 📅 2026-07-04 : 高性能和低消耗的`goroutine`池。
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 28,701 | 🐛 738 | 🌐 Go | 📅 2026-09-17 :   基于`Material Design`为`Go`设计的跨平台本地GUI。支持 Linux, macOS, Windows, BSD, iOS\` 和 Android.
* [webview](https://github.com/zserge/webview) ⭐ 14,232 | 🐛 214 | 🌐 C++ | 📅 2026-03-09 :   支持双向`JavaScript`绑定的跨平台 webview 窗口库（`Windows，macOS，Linux`）。
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,813 | 🐛 5 | 🌐 Go | 📅 2026-09-09 :   跨平台`GUI`自动化工具，可以控制鼠标、键盘及其他设备
...
* [imaginary](https://github.com/h2non/imaginary) ⭐ 6,076 | 🐛 136 | 🌐 Go | 📅 2025-11-08 :  快速且简单的 `HTTP `微服务,用于图像缩放
...
* [ln](https://github.com/fogleman/ln) ⭐ 3,375 | 🐛 12 | 🌐 Go | 📅 2019-07-19 : ` 3D` 图线艺术渲染
* [resize](https://github.com/nfnt/resize) ⚠️ Archived :  使用 `Go`语言编写的具有常见差值功能的图片缩放工具
* [bimg](https://github.com/h2non/bimg) ⭐ 3,033 | 🐛 179 | 🌐 Go | 📅 2025-01-23 :   利用`libvips`进行快速高效的图像处理
...
* [canvas](https://github.com/tdewolff/canvas) ⭐ 1,839 | 🐛 25 | 🌐 Go | 📅 2026-09-13 :  将矢量图形转换成 `PDF、SVG `或光栅化图像。
...
* [geopattern](https://github.com/pravj/geopattern) ⭐ 1,286 | 🐛 3 | 🌐 Go | 📅 2019-01-08 :  从字符串创建优美的图样
...
* [goimagehash](https://github.com/corona10/goimagehash) ⭐ 840 | 🐛 13 | 🌐 Go | 📅 2024-01-21 :  `Go`感知图像哈希包。
...
* [go-nude](https://github.com/koyachi/go-nude) ⭐ 421 | 🐛 3 | 🌐 Go | 📅 2023-10-11 :  使用 `Go` 语言进行裸替检测
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,471 | 🐛 100 | 🌐 Go | 📅 2026-01-07 : ` Gobot` 是一个用于机器人,物理计算以及物联网的库
...
* [devices](https://github.com/goiot/devices) ⭐ 264 | 🐛 9 | 🌐 Go | 📅 2016-07-10 :  管理物联网设备的套件库
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 7,162 | 🐛 7 | 🌐 Go | 📅 2026-09-01 : 简单流畅的`Go`作业调度。这是·`jasonlvhit/gocron`·\`的一个积极维护的fork.
...
* [scheduler](https://github.com/carlescere/scheduler) ⭐ 468 | 🐛 6 | 🌐 Go | 📅 2022-06-23 : `  Cronjobs`调度系统。
...
* [logrus](https://github.com/sirupsen/logrus) ⭐ 25,744 | 🐛 46 | 🌐 Go | 📅 2026-08-25 : `Go`的结构化日志记录器。
* [zap](https://github.com/uber-go/zap) ⭐ 24,653 | 🐛 191 | 🌐 Go | 📅 2026-09-16 :  快速的、结构化的、分级的日志库
...
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,468 | 🐛 101 | 🌐 Go | 📅 2024-08-05 :  简单的循环日志工具。
...
* [phuslu/log](https://github.com/phuslu/log) ⭐ 871 | 🐛 12 | 🌐 Go | 📅 2026-09-16 :  - 结构化日志系统。
...
* [logur](https://github.com/logur/logur) ⚠️ Archived :  日志记录接口和日志记录最佳实践的整合,它对诸多知名库如[logrus](https://github.com/sirupsen/logrus) ⭐ 25,744 | 🐛 46 | 🌐 Go | 📅 2026-08-25、[go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,423 | 🐛 60 | 🌐 Go | 📅 2024-07-19、[zap](https://github.com/uber-go/zap) ⭐ 24,653 | 🐛 191 | 🌐 Go | 📅 2026-09-16 ， [zerolog](https://github.com/rs/zerolog) ⭐ 12,504 | 🐛 150 | 🌐 Go | 📅 2026-09-08等的功能进行了集成
...
* [logrusly](https://github.com/sebest/logrusly) ⭐ 29 | 🐛 3 | 🌐 Go | 📅 2021-07-27 :  [logrus](https://github.com/sirupsen/logrus) ⭐ 25,744 | 🐛 46 | 🌐 Go | 📅 2026-08-25插件,用于将错误发送到[Loggly](https://www.loggly.com/)
...
* [kemba](https://github.com/clok/kemba) ⭐ 18 | 🐛 9 | 🌐 Go | 📅 2026-09-01 :  受[debug](https://github.com/visionmedia/debug) ⭐ 11,454 | 🐛 98 | 🌐 JavaScript | 📅 2026-04-01 启发的小型调试日志工具,非常适合CLI工具和应用程序。
...
* [tfgo](https://github.com/galeone/tfgo) ⭐ 2,493 | 🐛 20 | 🌐 Go | 📅 2024-03-13 :   易于使用的`Tensorflow `` g`o语言封装：简化了官方`Tensorflow Go`的使用。
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 13,714 | 🐛 291 | 🌐 Go | 📅 2026-06-22 :   建立在 `Redis` 之上，为 `Go` 提供的简单、可靠、高效的分布式任务队列,。
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,522 | 🐛 43 | 🌐 Go | 📅 2026-09-17 :  用于 `Apache Kafka `的库
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10,762 | 🐛 23 | 🌐 Go | 📅 2026-09-14 :  实时消息服务器
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,775 | 🐛 68 | 🌐 Go | 📅 2026-07-25  通知推送服务器,使用 [APNs2](https://github.com/sideshow/apns2) ⭐ 3,188 | 🐛 32 | 🌐 Go | 📅 2025-07-22 和 [GCM](https://github.com/google/go-gcm) ⚠️ Archived 。
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,758 | 🐛 329 | 🌐 Go | 📅 2026-09-17 : 在一系列协议之间建立消息流`go`代码库
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,971 | 🐛 248 | 🌐 Go | 📅 2025-11-15 :  异步任务队列,基于分布式消息处理
* [NATS Go Client](https://github.com/nats-io/nats) ⭐ 6,749 | 🐛 165 | 🌐 Go | 📅 2026-09-16 :   原生的 `oplog/replication `系统,用于 `REST APIs`场景
* [go-socket.io](https://github.com/googollee/go-socket.io) ⚠️ ArchivedGo 语言的 `socket.io`库 ,一个实时应用框架.
* [Mercure](https://github.com/dunglas/mercure) ⭐ 5,323 | 🐛 26 | 🌐 Go | 📅 2026-09-16 :   使用`Mercure`协议（建立在`Server-Sent Events`之上）来调度服务器发送的更新的代码库。
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 5,165 | 🐛 279 | 🌐 Go | 📅 2026-09-17   是`Confluent`为`Apache Kafka`和`Confluent Platform`开发的`Golang`客户端。
...
* [rabtap](https://github.com/jandelgado/rabtap) ⭐ 288 | 🐛 5 | 🌐 Go | 📅 2026-09-14 :  -` RabbitMQ` 瑞士军刀 `cli `应用。
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,938 | 🐛 9 | 🌐 Go | 📅 2026-08-13 :  用于创建和处理`Office Word (.docx)、Excel (.xlsx)`和`Powerpoint (.pptx)`文档的纯`go`库。

### EXCEL

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) ⭐ 20,918 | 🐛 131 | 🌐 Go | 📅 2026-09-16 :  用于读写 `Microsoft Excel™ (XLSX)` 文件的 `Golang `库
...
* [fx](https://github.com/uber-go/fx) ⭐ 7,683 | 🐛 80 | 🌐 Go | 📅 2025-12-27 :  基于 `Go `的依赖注入应用框架（建立在 `dig` 的基础上）。
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 56,602 | 🐛 94 | 🌐 Makefile | 📅 2026-04-28 :  -` Go` 生态系统中常见的历史和新兴项目布局模式集。
* [modern-go-application](https://github.com/sagikazarmark/modern-go-application) ⭐ 1,943 | 🐛 23 | 🌐 Go | 📅 2024-11-01 :   应用现代实践的` Go` 应用程序模板和示例。
* [cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) ⭐ 737 | 🐛 4 | 🌐 Go | 📅 2026-04-13 :Go应用程序模板,用于按照生产最佳实践快速启动项目。
...
* [xstrings](https://github.com/huandu/xstrings) ⭐ 1,412 | 🐛 0 | 🌐 Go | 📅 2026-09-14 :  从其他语言移植过来的字符串函数集合。
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 12,096 | 🐛 388 | 🌐 Go | 📅 2026-09-08 :  自动化的服务健康仪表板。
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,921 | 🐛 220 | 🌐 Go | 📅 2026-09-15 :  跨平台库,用于检索进程和系统利用率（`CPU`、内存、磁盘等）。
* [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 5,389 | 🐛 7 | 🌐 Go | 📅 2026-09-11 :   用`go`编写的随机数据生成器。
...
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 2,147 | 🐛 10 | 🌐 Go | 📅 2026-09-13 :  快速将整个` org/users` 仓库克隆到一个目录中 - 支持` GitHub、GitLab` 和 `Bitbucket`。
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,673 | 🐛 81 | 🌐 Go | 📅 2026-07-01 :  提供轻松访问各种消息服务的通知库,如`slack, mattermost, gotify`和`smtp`等。
...
* [llvm](https://github.com/llir/llvm) ⭐ 1,277 | 🐛 18 | 🌐 Go | 📅 2024-12-06 :  - 用于在纯`Go`中与`LLVM IR`交互的库。
...
* [go-i18n](https://github.com/nicksnyder/go-i18n/) ⭐ 3,545 | 🐛 18 | 🌐 Go | 📅 2026-09-01 :  ,用于处理本地化文本 的软件包及相关工具
* [prose](https://github.com/jdkato/prose) ⭐ 3,090 | 🐛 20 | 🌐 Go | 📅 2026-07-29 :  文本处理库,支持词语切分、词性标记、命名实体提取等功能
* [gse](https://github.com/go-ego/gse) ⭐ 2,843 | 🐛 15 | 🌐 Go | 📅 2026-09-12 :   ` Go`高效的文本分割；支持英语、中文、日语和其他语言。
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,646 | 🐛 0 | 🌐 Go | 📅 2026-07-20 : 结巴分词的 `Go `语言实现的 [jieba](https://github.com/fxsjy/jieba) ⭐ 35,155 | 🐛 700 | 🌐 Python | 📅 2024-08-21 ,结巴分词是一个用于中文的分词算法
...
* [kagome](https://github.com/ikawaha/kagome) ⭐ 982 | 🐛 1 | 🌐 Go | 📅 2026-09-04 :   用纯`Go`编写的`JP`形态分析器。
...
* [govader](https://github.com/jonreiter/govader) ⭐ 55 | 🐛 1 | 🌐 Go | 📅 2025-04-29 : [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 5,072 | 🐛 56 | 🌐 Python | 📅 2026-03-02 情感分析的`Go`实现
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,468 | 🐛 95 | 🌐 Go | 📅 2026-09-14 : `asthttp` 是一个快速的`HTTP`实现,比`net/http1`的性能快10倍
* [webrtc](https://github.com/pions/webrtc) ⭐ 16,782 | 🐛 125 | 🌐 Go | 📅 2026-09-17 :` WebRTC API`的纯`Go`实现。
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11,773 | 🐛 219 | 🌐 Go | 📅 2026-09-14 :   纯`Go`中`QUIC`协议的实现。
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,555 | 🐛 70 | 🌐 Go | 📅 2026-05-15 :` KCP` - 快速可靠的`ARQ`协议。
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 4,107 | 🐛 243 | 🌐 Go | 📅 2026-09-17 :  `Go`语言实现的BGP
* [fortio](https://github.com/fortio/fortio) ⭐ 3,726 | 🐛 87 | 🌐 Go | 📅 2026-09-14 :  负载测试库和命令行工具,提供先进的`echo`服务器和web用户界面。允许指定设定每秒钟查询的负载,记录延迟直方图和其他有用的统计数据,并将其绘制成图表。
* [water](https://github.com/songgao/water) ⭐ 2,167 | 🐛 30 | 🌐 Go | 📅 2024-07-30 :  一个简单的`TUN/TAP`库。
* [go-getter](https://github.com/hashicorp/go-getter) ⭐ 1,824 | 🐛 170 | 🌐 Go | 📅 2026-09-16 :   一个用于通过 URL 从多种源下载文件或目录的 Go 语言库
* [gev](https://github.com/Allenxuxu/gev) ⭐ 1,772 | 🐛 14 | 🌐 Go | 📅 2025-06-07 :  一个轻量、比标准库更快的基于` Reactor` 模式的非阻塞`TCP`网络库,支持自定义协议,可以轻松快速搭建高性能服务器。
* [sftp](https://github.com/pkg/sftp) ⭐ 1,663 | 🐛 60 | 🌐 Go | 📅 2026-07-22 : `sftp` 实现了<https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt> 中描述的 SSH 文件传输协议
...
* [gmqtt](https://github.com/DrmagicE/gmqtt) ⭐ 1,047 | 🐛 2 | 🌐 Go | 📅 2026-04-05 : `Gmqtt`是一个灵活、高性能的` MQTT`代理库,它完全实现了` MQTT 协议 V3.1.1`版本
...
* [winrm](https://github.com/masterzen/winrm) ⭐ 480 | 🐛 53 | 🌐 Go | 📅 2026-04-07 :  用于在` Windows` 机器上远程执行命令的`Go WinRM`客户端。
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,803 | 🐛 21 | 🌐 Go | 📅 2026-09-07 :  受`Ruby rest-client` 的启发,为`Go` 设计的简单` HTTP`和`REST`客户端。
...
* [gentleman](https://github.com/h2non/gentleman) ⭐ 1,132 | 🐛 31 | 🌐 Go | 📅 2023-12-17 :  -插件驱动的`HTTP`客户端库。
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 39,958 | 🐛 536 | 🌐 Go | 📅 2026-09-14 :  超棒的` Go` 语言` ORM` 库,对开发者非常友好
* [ent](https://github.com/facebook/ent) ⭐ 17,197 | 🐛 623 | 🌐 Go | 📅 2026-09-04 :  简单而强大的用于数据建模和查询的ORM。
...
* [gormt](https://github.com/xxjwxc/gormt) ⭐ 2,423 | 🐛 59 | 🌐 Go | 📅 2026-07-10 : `Mysql`数据库到Golang 结构体的`orm`库。
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,217 | 🐛 552 | 🌐 Go | 📅 2026-09-16 :  分布式跟踪系统。
* [dep](https://github.com/golang/dep) ⚠️ Archived :  Go 语言依赖工具.
* [glide](https://github.com/Masterminds/glide) ⭐ 8,084 | 🐛 400 | 🌐 Go | 📅 2024-07-22 :  轻松管理你的`GO` 语言包发布者以及发布包。 受到类似` Maven, Bundler` 和`Pip`这些工具的的启发
...
* [statsviz](https://github.com/arl/statsviz) ⭐ 3,645 | 🐛 10 | 🌐 Go | 📅 2026-09-17 :  实时可视化你的`Go`应用程序运行时的统计数据。
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,034 | 🐛 25 | 🌐 Go | 📅 2026-08-16 :   基于命令行的选择器查询和更新数据结构。类似于`jq/yq`,但支持`JSON、YAML、TOML`和`XML`。
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,426 | 🐛 256 | 🌐 Go | 📅 2026-08-30 :  用于` Go` 编程语言的数值库。它包含了矩阵、统计、优化等方面的库。
* [stats](https://github.com/montanaflynn/stats) ⭐ 3,025 | 🐛 2 | 🌐 Go | 📅 2026-09-13 :  统计库,包含一些` Go` 语言标准库中漏掉的常用函数
* [gonum/plot](https://github.com/gonum/plot) ⭐ 2,968 | 🐛 91 | 🌐 Go | 📅 2026-04-22 : `Gonum/plot`提供了用于创建和绘制图表的`API`
* [gosl](https://github.com/cpmech/gosl) ⭐ 1,878 | 🐛 0 | 🌐 Go | 📅 2025-12-30 :  用于线性代数、FFT、几何学、`NURBS`、数值方法、概率、优化、微分方程等的` Go` 科学库。
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,131 | 🐛 20 | 🌐 Go | 📅 2026-03-30 :  支持剪裁、`GeoJSON` 和` Mapbox Vector Tile`的`2D` 几何类型。
...
* [lego](https://github.com/go-acme/lego) ⭐ 9,873 | 🐛 103 | 🌐 Go | 📅 2026-09-17 :  纯` Go`语言开发的` ACME` 客户端库及命令行工具
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 5,211 | 🐛 20 | 🌐 Go | 📅 2026-09-15 :   用于远程入侵监控摄像头的`RTSP`流的工具库。
...
* [ssh-vault](https://github.com/ssh-vault/ssh-vault) ⭐ 508 | 🐛 2 | 🌐 Rust | 📅 2026-09-14 : 利用` ssh` 秘钥加解密 。
* [go-yara](https://github.com/hillu/go-yara) ⭐ 389 | 🐛 7 | 🌐 Go | 📅 2025-07-01 : Go Bindings for[YARA](https://github.com/plusvic/yara) ⭐ 137 | 🐛 1 | 🌐 C | 📅 2020-03-13 恶意软件研究人员（以及其他所有人）的模式匹配瑞士刀"。
...
* [go-codec](https://github.com/ugorji/go) ⭐ 1,965 | 🐛 5 | 🌐 Go | 📅 2026-09-02 :  高性能、多功能、规范化编码解码以及`rpc`库, 用于` msgpack, cbor`和`json`,支持基于运行时的 OR 码生成
* [cbor](https://github.com/fxamacker/cbor) ⭐ 1,089 | 🐛 29 | 🌐 Go | 📅 2026-09-17 :  小巧、安全、简单的` CBOR` 编码和解码库。
...
* [Caddy](https://github.com/mholt/caddy) ⭐ 75,829 | 🐛 286 | 🌐 Go | 📅 2026-09-17 :`  Caddy`是一个备选的` HTTP/2 web` 服务器,配置简单,使用方便。
* [minio](https://github.com/minio/minio) ⚠️ Archived :  Minio 是一个分布式对象存储服务器
* [etcd](https://github.com/coreos/etcd) ⭐ 52,270 | 🐛 354 | 🌐 Go | 📅 2026-09-17 :  高可用性的键值存储,用于分享配置和服务发现
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,532 | 🐛 177 | 🌐 Go | 📅 2026-09-07 :   功能齐全、高度可配置的`SFTP`服务器,可选择支持`FTP/S和WebDAV`。它可以为本地文件系统和云存储后端服务,如S3和谷歌云存储。
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,506 | 🐛 44 | 🌐 Go | 📅 2026-09-17 :   高性能的PHP应用服务器,负载均衡器和进程管理器。
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,902 | 🐛 39 | 🌐 Go | 📅 2026-09-17 :  用`Go`和`Vue.js`编写的自带功能标志的解决方案。
* [Fider](https://github.com/getfider/fider) ⭐ 4,530 | 🐛 60 | 🌐 Go | 📅 2026-09-17 : `Fider`是一个收集和整理客户反馈的开放平台。
* [devd](https://github.com/cortesi/devd) ⭐ 3,473 | 🐛 24 | 🌐 Go | 📅 2026-06-21 :   开发者使用的本地`web` 服务器
* [algernon](https://github.com/xyproto/algernon) ⭐ 3,028 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-11 :` HTTP/2 web`服务器,内置`Lua、Markdown、GCSS`和`Amber`支持。
* [Flagr](https://github.com/checkr/flagr) ⭐ 2,607 | 🐛 2 | 🌐 Go | 📅 2026-09-16 : ` Flagr`是一个开源的功能标志和A/B测试服务。
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,091 | 🐛 2 | 🌐 Go | 📅 2026-09-16 : `HTTP`反向代理缓存和时间序列加速器。
...
* [go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) ⭐ 151 | 🐛 16 | 🌐 Go | 📅 2026-09-17 : 简单的反向代理与缓存,用`Go`编写,使用`Redis`。
...
* [go-streams](https://github.com/reugn/go-streams) ⭐ 2,172 | 🐛 12 | 🌐 Go | 📅 2026-01-14 :` Go`流处理库。
...
* [quicktemplate](https://github.com/valyala/quicktemplate) ⭐ 3,323 | 🐛 41 | 🌐 Go | 📅 2024-07-21 :  快速、强大且易用的模板引擎。将模板转化为` Go` 语言并进行编译
* [pongo2](https://github.com/flosch/pongo2) ⭐ 3,082 | 🐛 71 | 🌐 Go | 📅 2026-05-02 :  类似`Django`的模板引擎
* [maroto](https://github.com/johnfercher/maroto) ⭐ 2,756 | 🐛 64 | 🌐 Go | 📅 2026-09-10 :  用Maroto的方式来创建PDF。Maroto的灵感来自于`Bootstrap`并使用`gofpdf`
...
* [ego](https://github.com/benbjohnson/ego) ⭐ 586 | 🐛 10 | 🌐 Go | 📅 2023-03-15 :  轻量级模板语言,让你可以使用` Go`语言来创建模板。模板会被转化为 Go 语言并编译
...
* 测试框架
  * [Testify](https://github.com/stretchr/testify) ⭐ 26,202 | 🐛 378 | 🌐 Go | 📅 2026-09-02 :  对标准测试包的扩展
  ...
  * [httpexpect](https://github.com/gavv/httpexpect) ⭐ 2,726 | 🐛 26 | 🌐 Go | 📅 2025-11-20 :   简洁的、声明式的、易用的端到端HTTP 及 REST API 测试
  * [godog](https://github.com/DATA-DOG/godog) ⭐ 2,672 | 🐛 92 | 🌐 Go | 📅 2026-09-17 :  类似于`Cucumber`或`Behat`的`Go BDD`框架。
  * [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1,394 | 🐛 5 | 🌐 Go | 📅 2026-09-17 :   记录并重放` HTTP`交互,用于快速的、确定性的、准确的测试
  * [testfixtures](https://github.com/go-testfixtures/testfixtures) ⭐ 1,235 | 🐛 20 | 🌐 Go | 📅 2026-09-02 : 类似` Rails`的测试工具,用于测试数据库应用
  ...
  * [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 23 | 🐛 2 | 🌐 Go | 📅 2026-09-17 : ` HTTP`客户端测试框架。
...
* Mock
  ...
  * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,572 | 🐛 49 | 🌐 Go | 📅 2026-07-10 :` Mock SQL` ,用于测试数据库交互
  * [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,515 | 🐛 34 | 🌐 Go | 📅 2026-09-13 :`  HTTP(S) : proxy,`用于记录和模拟`REST/SOAP API`,具有可扩展的中间件和易于使用的 CLI。
  * [gock](https://github.com/h2non/gock) ⭐ 2,217 | 🐛 51 | 🌐 Go | 📅 2024-09-24 :   多功能、易用`HTTP mock`
  ...
  * [minimock](https://github.com/gojuno/minimock) ⭐ 752 | 🐛 27 | 🌐 Go | 📅 2026-09-02 : `Mock`生成器
...
* Selenium及浏览器控制工具
  * [chromedp](https://github.com/knq/chromedp) ⭐ 13,278 | 🐛 180 | 🌐 Go | 📅 2026-07-14 :  用于驱动和测试`Chrome, Safari, Edge, Android Webviews`, 以及其他支持`Chrome`调试协议的产品
  * [rod](https://github.com/go-rod/rod) ⭐ 7,104 | 🐛 212 | 🌐 Go | 📅 2026-08-11 : `Devtools`驱动,使网络自动化测试变得简单。
...
* 特定文本格式处理
  * [colly](https://github.com/asciimoo/colly) ⭐ 25,522 | 🐛 194 | 🌐 Go | 📅 2026-09-16 :  `go`语言版爬虫框架
  * [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,990 | 🐛 4 | 🌐 Go | 📅 2026-09-14 :`  GoQuery` 为` Go`语言带来了一组类似`jQuery` 的语法和功能
  * [sh](https://github.com/mvdan/sh) ⭐ 9,062 | 🐛 93 | 🌐 Go | 📅 2026-09-09 : `Shell`解析器及格式化工具
  ...
  * [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,828 | 🐛 31 | 🌐 Go | 📅 2026-09-17 :    将时间、数字和内存大小格式化为人类可读的格式。
  * [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3,817 | 🐛 27 | 🌐 Go | 📅 2026-08-03 :  将`HTML`转换为`Markdown`。甚至适用于整个网站,并可通过规则进行扩展。
  ...
  * [slug](https://github.com/gosimple/slug) ⭐ 1,332 | 🐛 13 | 🌐 Go | 📅 2024-12-23 :` URL`友好的` slug` 化工具,支持多种语言
  * [commonregex](https://github.com/mingrammer/commonregex) ⭐ 894 | 🐛 2 | 🌐 Go | 📅 2019-11-12 :` Go`常用正则表达式的集合。
  * [htmlquery](https://github.com/antchfx/htmlquery) ⭐ 782 | 🐛 7 | 🌐 Go | 📅 2026-07-02 :` HTML`的`XPath` 查询包,让您可以通过` XPath` 表达式从`HTML`文档中提取数据。
  ...
  * [gonameparts](https://github.com/polera/gonameparts) ⭐ 43 | 🐛 1 | 🌐 Go | 📅 2024-10-04 :  将人名解析为几个独立的部分
...
* [github](https://github.com/google/go-github) ⭐ 11,308 | 🐛 40 | 🌐 Go | 📅 2026-09-17 :  用于访问`GitHub REST API v3` 的`Go`库。
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) ⚠️ Archived : ` AWS` 提供的官方go语言` SDK`
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,993 | 🐛 232 | 🌐 Go | 📅 2026-02-14 :   用于与`Discord` 聊天` API`进行交互的`Go`语言客户端。
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,504 | 🐛 413 | 🌐 Go | 📅 2026-09-17 :`Google Cloud APIs Go`客户端库。
* [google](https://github.com/google/google-api-go-client) ⭐ 4,474 | 🐛 21 | 🌐 Go | 📅 2026-09-17 :  为`Go` 自动生成的`Google API`。
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,998 | 🐛 8 | 🌐 Go | 📅 2026-09-15 :  `go` 语言`Minio` 客户端,用于` Amazon S3` 兼容的云存储
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,636 | 🐛 12 | 🌐 Go | 📅 2026-09-17 :  用于访问`Stripe API`的`Go`客户端。
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,082 | 🐛 329 | 🌐 Go | 📅 2026-09-14 :  命令行模糊查找工具
* [hub](https://github.com/github/hub) ⭐ 22,955 | 🐛 296 | 🌐 Go | 📅 2024-02-02 :  封装了`git`命令,提供了额外的功能用于在终端中和`Github` 进行交互
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,838 | 🐛 120 | 🌐 Go | 📅 2024-07-08 :  用于容器指标,类似于`Top`的接口（例如`htop`）。
* [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17,735 | 🐛 395 | 🌐 Go | 📅 2024-08-15 :  为内建的`database/sql` 软件包提供扩展
* [Task](https://github.com/go-task/task) ⭐ 16,157 | 🐛 191 | 🌐 Go | 📅 2026-09-17 :  简单来讲就是`"Make"`的替代品
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 16,055 | 🐛 16 | 🌐 Go | 📅 2026-09-17 : 尽可能快速的发布`Go`语言二进制文件
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,734 | 🐛 41 | 🌐 Go | 📅 2026-08-04 :   交互式命令行程序,用于进行`HTTP` 检查
* [usql](https://github.com/knq/usql) ⭐ 10,117 | 🐛 121 | 🌐 Go | 📅 2026-09-13 :  `usql`是一个通用的命令行接口,用于操作`sql`数据库
* [peco](https://github.com/peco/peco) ⭐ 7,910 | 🐛 7 | 🌐 Go | 📅 2026-09-12 :  简单的交互式过滤工具。
* [go-funk](https://github.com/thoas/go-funk) ⭐ 4,929 | 🐛 12 | 🌐 Go | 📅 2024-07-24 :  `Go`语言工具库,提供了很多有用的工具`(map, find, contains, filter, chunk, reverse, ...)`
* [realize](https://github.com/tockins/realize) ⭐ 4,434 | 🐛 72 | 🌐 Go | 📅 2021-05-14 : `Go` 语言构建系统,可以监控文件变化并重新加载。运行,构建,监控文件并支持自定义路径
* [hystrix-go](https://github.com/afex/hystrix-go) ⭐ 4,400 | 🐛 57 | 🌐 Go | 📅 2024-02-24 :  实现 Hystrix 风格的、程序员预定义的`fallback` 机制（熔断）
* [godropbox](https://github.com/dropbox/godropbox) ⭐ 4,208 | 🐛 7 | 🌐 Go | 📅 2023-12-24 : `Dropbox`开发的用于编写` Go`语言服务／应用的库
* [minify](https://github.com/tdewolff/minify) ⭐ 4,141 | 🐛 40 | 🌐 Go | 📅 2026-09-17 :  快速压缩`HTML, CSS, JS, XML, JSON` 以及` SVG` 文件格式
...
* [goreporter](https://github.com/wgliang/goreporter) ⭐ 3,121 | 🐛 30 | 🌐 Go | 📅 2018-10-27 :  进行代码静态分析,单元测试,代码检视并生成代码质量报告的工具
...
* [immortal](https://github.com/immortal/immortal) ⭐ 840 | 🐛 2 | 🌐 Go | 📅 2026-08-16 :  \*nix 跨平台 (与操作系统无关的)监控程序
...
* [go-trigger](https://github.com/sadlil/go-trigger) ⭐ 251 | 🐛 1 | 🌐 Go | 📅 2017-03-28 :` Go`语言全局事件触发器,通过 id 和触发器,在程序的任何地方注册事件
...
* [uuid](https://github.com/google/uuid) ⭐ 6,146 | 🐛 68 | 🌐 Go | 📅 2024-11-14 :  基于`RFC 4122`和`DCE 1.1`的`UUIDs Go`包。
...
* [validator](https://github.com/go-playground/validator) ⭐ 20,171 | 🐛 333 | 🌐 Go | 📅 2026-09-17 :  `Go`结构体及域验证,包括：跨域、跨结构体,`Map`, 切片和数组
* [govalidator](https://github.com/asaskevich/govalidator) ⭐ 6,205 | 🐛 171 | 🌐 Go | 📅 2026-09-17 :  数据验证及清晰工具,用于字符串,数字, 数组切片及结构体
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) ⭐ 4,134 | 🐛 30 | 🌐 Go | 📅 2026-09-03 :   支持多种数据类型的验证 (结构体,字符串,键值对,数组切片等等),具有可配置、可扩展的验证规则,且使用常用代码结构定义,而非结构体标签
...
* [jio](https://github.com/faceair/jio) ⭐ 126 | 🐛 3 | 🌐 Go | 📅 2024-07-04 : `jio`是一个类似于[joi](https://github.com/hapijs/joi) ⭐ 21,173 | 🐛 200 | 🌐 JavaScript | 📅 2026-09-11 的json模式验证器.
...
* [go-astisub](https://github.com/asticode/go-astisub) ⭐ 710 | 🐛 9 | 🌐 Go | 📅 2026-09-17 :  使用 Go 语言操作字幕`(.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).`
* [go-astits](https://github.com/asticode/go-astits) ⭐ 617 | 🐛 9 | 🌐 Go | 📅 2026-08-15 :  在 GO 中解析和解调` MPEG` 传输流（.ts）。
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 89,232 | 🐛 768 | 🌐 Go | 📅 2026-09-16 :  ` Gin` 是一个` Go` 语言编写的 web 框架,提供了一组类似`martini`的`API`,且具有更好的性能（40倍的性能提升）。如果你需要高性能和高生产率,这个框架很适合你
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,160 | 🐛 36 | 🌐 Go | 📅 2026-09-17 :  受` Express.js`启发的` Web` 框架,构建在`Fasthttp`上。
* [Echo](https://github.com/labstack/echo) ⭐ 32,708 | 🐛 42 | 🌐 Go | 📅 2026-09-16 :   高性能、极简的` Go`语言`web` 框架
* [Revel](https://github.com/revel/revel) ⭐ 13,216 | 🐛 94 | 🌐 Go | 📅 2023-10-28 :` go`语言高生产率框架
...
* [Goyave](https://github.com/System-Glitch/goyave) ⭐ 1,777 | 🐛 15 | 🌐 Go | 📅 2026-09-17 :  功能完整的`Web`框架,旨在实现简洁的代码和快速开发,具有强大的内置功能。
...
* [Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) ⭐ 594 | 🐛 30 | 🌐 Go | 📅 2026-09-16 :   提供电子商务功能,使用简洁的架构,如`DDD`、端口和适配器,你可以用它来构建灵活的电子商务应用。
...
* [chi](https://github.com/go-chi/chi) ⭐ 22,840 | 🐛 99 | 🌐 Go | 📅 2026-09-08 :   基于`net/context`的小巧、快速、具有丰富表达力的`HTTP`路由.
...
* [Bone](https://github.com/go-zoo/bone) ⭐ 1,280 | 🐛 3 | 🌐 Go | 📅 2019-05-06 :  轻量、快速的`HTTP` 多路复用器
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 17,734 | 🐛 544 | 🌐 Go | 📅 2026-09-17 :  基于`LLVM`,适用于微型场景的`Go`编译器。包括微控制器、`WebAssembly`和命令行工具。
...
* [xpath](https://github.com/antchfx/xpath) ⭐ 742 | 🐛 20 | 🌐 Go | 📅 2026-09-15 : `XPath` 库
...
* [gosimple](https://github.com/dominikh/go-tools/tree/master/cmd/gosimple) ⭐ 6,898 | 🐛 578 | 🌐 Go | 📅 2026-08-24 : 针对 Go 语言的`lint`工具,专注于简化代码
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,898 | 🐛 578 | 🌐 Go | 📅 2026-08-24 :  -`staticcheck`在`Go vet`阶段中执行大量的静态分析检查,类似`ReSharper for C#`这样的工具。
* [unused](https://github.com/dominikh/go-tools/tree/master/cmd/unused) ⭐ 6,898 | 🐛 578 | 🌐 Go | 📅 2026-08-24 :  `unused`会检查 Go 语言代码中没有用到的常量,变量,函数和类型
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,068 | 🐛 152 | 🌐 Go | 📅 2026-09-07 :  源代码检查器,它带来了目前其他检查器没有实现的检查。
...
* [vim-go](https://github.com/fatih/vim-go) ⭐ 16,219 | 🐛 44 | 🌐 Vim Script | 📅 2026-08-23 : `Vim`使用的`Go` 语言开发插件
* [gocode](https://github.com/nsf/gocode) ⭐ 4,986 | 🐛 66 | 🌐 Go | 📅 2026-02-07 : `go`语言自动补全
* [vscode-go](https://github.com/golang/vscode-go) ⭐ 4,262 | 🐛 439 | 🌐 TypeScript | 📅 2026-09-15 : `Visual Studio Code (VS Code)` : 使用的一个扩展,为` Go` 语言提供了支持
...
* [go-mode](https://github.com/dominikh/go-mode.el) ⭐ 1,454 | 🐛 50 | 🌐 Emacs Lisp | 📅 2026-05-29 : ` GNU/Emacs`的`Go`语言模式
...
* [xgen](https://github.com/xuri/xgen) ⭐ 425 | 🐛 35 | 🌐 Go | 📅 2026-09-02 : ` XSD (XML Schema Definition)`  解析器,能够生成`Go/C/Java/Rust/Typescript`代码
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 10,010 | 🐛 301 | 🌐 Go | 📅 2026-09-13 :  为 Go 语言实现的`Swagger 2.0`.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 127,796 | 🐛 3,056 | 🌐 Go | 📅 2026-09-17 :  来自`Google`的容器集群管理器
* [Moby](https://github.com/moby/moby) ⭐ 72,108 | 🐛 3,904 | 🌐 Go | 📅 2026-09-17 :  为容器生态系统创建的一个合作项目,用于构建基于容器的系统
* [traefik](https://github.com/containous/traefik) ⭐ 64,885 | 🐛 941 | 🌐 Go | 📅 2026-09-17 :  能对接多个后端的反向代理和负载均衡器。
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 58,047 | 🐛 2,463 | 🌐 Go | 📅 2026-09-17 :  社区驱动的`Gogs`的`fork`库
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 25,193 | 🐛 122 | 🌐 Go | 📅 2026-02-16 :  `HTTP 加`载测试工具和代码库
* [Hey](https://github.com/rakyll/hey) ⭐ 20,265 | 🐛 188 | 🌐 Go | 📅 2026-01-10 :` Hey`是一个微型程序,用于向`web` 应用发送负载
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,792 | 🐛 317 | 🌐 Go | 📅 2026-09-17 :` Packer`通过单一的配置文件,为不同的平台创建独立镜像
* [webhook](https://github.com/adnanh/webhook) ⭐ 12,135 | 🐛 127 | 🌐 Go | 📅 2026-09-04 :  允许用户创建`HTTP`钩子,并在服务器上执行命令
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,690 | 🐛 243 | 🌐 Shell | 📅 2024-08-08 : ` GVM`提供了用于管理`Go`语言版本的接口
...
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 5,009 | 🐛 159 | 🌐 Go | 📅 2026-09-17 :  `Pomerium`是一个身份感知的访问代理。
* [gox](https://github.com/mitchellh/gox) ⚠️ Archived :  非常简单的`Go`语言交叉编译工具
* [s5cmd](https://github.com/peak/s5cmd) ⭐ 4,189 | 🐛 199 | 🌐 Go | 📅 2025-06-13 :  快速的` S3` 和本地文件系统执行工具。
...
* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) ⭐ 1,702 | 🐛 17 | 🌐 Go | 📅 2024-08-17 :   让你的` Go` 语言程序可以自我更新
...
* [uTask](https://github.com/ovh/utask) ⭐ 1,399 | 🐛 88 | 🌐 Go | 📅 2026-07-29 :  自动化引擎,可对`yaml`中声明的业务流程进行建模和执行。
...
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 997 | 🐛 282 | 🌐 Go | 📅 2026-09-17 :  通过命令行来管理 裸金属服务器 (和使用`Docker`一样容易)。
...
* [croc](https://github.com/schollz/croc) ⭐ 40,366 | 🐛 7 | 🌐 Go | 📅 2026-09-14 :    轻松安全地将文件或文件夹从一台计算机发送到另一台计算机。
* [restic](https://github.com/restic/restic) ⭐ 36,103 | 🐛 598 | 🌐 Go | 📅 2026-09-01 :  解耦备份程序
* [Gor](https://github.com/buger/gor) ⭐ 19,323 | 🐛 341 | 🌐 Go | 📅 2026-01-27 :  Http 流量复制工具,用于将生产环境的流量在开发环境进行重放
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12,349 | 🐛 106 | 🌐 Go | 📅 2026-09-15 :  用于自动化测试中模拟网络和系统状态的代理服务。
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,512 | 🐛 26 | 🌐 Go | 📅 2025-03-20 :   模拟网络波动情况下的网络数据连接
* [scc](https://github.com/boyter/scc) ⭐ 8,760 | 🐛 26 | 🌐 Go | 📅 2026-09-15 :   一个非常快速准确的代码计数器,具有复杂度计算和`COCOMO`估计功能。
* [confd](https://github.com/kelseyhightower/confd) ⭐ 8,428 | 🐛 178 | 🌐 Go | 📅 2024-07-16 :  使用`etcd`或` consul`来管理本地应用的配置文件
* [LiteIDE](https://github.com/visualfc/liteide) ⭐ 7,765 | 🐛 413 | 🌐 C++ | 📅 2026-09-09 : `LiteIDE` 是一个简单、开源、跨平台的` Go`语言` IDE`
* [drive](https://github.com/odeke-em/drive) ⭐ 6,729 | 🐛 287 | 🌐 Go | 📅 2024-02-09 :  命令行版本的`Google Drive`客户端。
* [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,681 | 🐛 336 | 🌐 Go | 📅 2026-08-06 :  跨平台网络和云备份工具
...
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 39 | 🐛 1 | 🌐 Go | 📅 2026-09-17 :  快速、简单、可扩展的分布式文件系统,具有`O(1)`的磁盘查找效率
