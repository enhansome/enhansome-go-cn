【导读】：[awesome-go](https://github.com/avelino/awesome-Go) ⭐ 182,052 | 🐛 215 | 🌐 Go | 📅 2026-08-21 就是 `avelino` 发起维护的 Go 资源列表，内容包括：音频和音乐库、命令行工具、服务端应用、流处理、持续集成、数据库、机器学习、NLP、物联网、中间件、文本处理、安全、机器人技术等。
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 20,337 | 🐛 38 | 🌐 Go | 📅 2026-08-21 : 支持`ACL`、`RBAC`、`ABAC`等访问控制模型的授权与认证库。
...
* [cobra](https://github.com/spf13/cobra) ⭐ 44,501 | 🐛 435 | 🌐 Go | 📅 2026-07-11 :   一个现代化的命令行。
* [urfave/cli](https://github.com/urfave/cli) ⭐ 24,201 | 🐛 71 | 🌐 Go | 📅 2026-08-18 :   简单、快速、有趣的、用于构建 Go 语言命令行程序的软件包。
* [kingpin](https://github.com/alecthomas/kingpin) ⭐ 3,569 | 🐛 28 | 🌐 Go | 📅 2026-08-20 :  支持子命令的命令行和标志位解析器。
* [Dnote](https://github.com/dnote/dnote) ⭐ 3,065 | 🐛 40 | 🌐 Go | 📅 2026-07-25 :  支持多设备同步的命令行笔记工具。
...
* [ops](https://github.com/nanovms/ops) ⭐ 1,510 | 🐛 143 | 🌐 Go | 📅 2026-08-23 : `Unikernel `编辑器和生成器
...
* [termui](https://github.com/gizak/termui) ⭐ 13,582 | 🐛 106 | 🌐 Go | 📅 2025-07-10 :   基于 `termbox-go` 的 `Go` 终端仪表盘,灵感来源于[blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,764 | 🐛 97 | 🌐 JavaScript | 📅 2026-05-01 。
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 3,033 | 🐛 48 | 🌐 Go | 📅 2026-07-27 :   基于 `termbox-go `的 `Go` 终端仪表盘,灵感来自 [termui](https://github.com/gizak/termui) ⭐ 13,582 | 🐛 106 | 🌐 Go | 📅 2025-07-10 。
* [mpb](https://github.com/vbauerster/mpb) ⭐ 2,509 | 🐛 15 | 🌐 Go | 📅 2026-08-23 :  为命令行提供多个进度条的工具
...
* [viper](https://github.com/spf13/viper) ⭐ 30,445 | 🐛 133 | 🌐 Go | 📅 2026-01-12 :`Go`语言配置工具
...
* [envh](https://github.com/antham/envh) ⭐ 101 | 🐛 3 | 🌐 Go | 📅 2026-08-23 :  管理环境变量的助手
...
* [go-aws-ssm](https://github.com/PaddleHQ/go-aws-ssm) ⭐ 66 | 🐛 5 | 🌐 Go | 📅 2026-08-23 :   从` AWS System Manager - Parameter Store` 获取参数的` Go` 包。
...
* [drone](https://github.com/drone/drone) ⭐ 38,091 | 🐛 107 | 🌐 Go | 📅 2026-08-21 : ` Drone` 是一个基于` Docker`的持续集成平台,使用 `Go `语言编写
* [CDS](https://github.com/ovh/cds) ⭐ 4,836 | 🐛 160 | 🌐 Go | 📅 2026-08-21 :  企业级`CI/CD`和`DevOps`自动化开源平台。
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,787 | 🐛 922 | 🌐 Go | 📅 2026-08-23 :  监控系统及时间序列数据库
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,461 | 🐛 6,832 | 🌐 Go | 📅 2026-08-23 : ` TiDB` 是一个分布式的` SQL` 数据库。受到了` Google F1`的启发
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,412 | 🐛 8,324 | 🌐 Go | 📅 2026-08-07 :  可扩展的、一致的事务型数据库
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 31,708 | 🐛 2,148 | 🌐 Rust | 📅 2026-08-20 :  用于度量、事件和实时分析的可扩展数据存储。
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,780 | 🐛 96 | 🌐 Go | 📅 2026-08-23 :  可扩展的、分布式的、低延时、高吞吐的图数据库
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 17,698 | 🐛 82 | 🌐 Go | 📅 2026-08-20 :  基于 `SQLite `的轻量级的、分布式的关系型数据库
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,582 | 🐛 778 | 🌐 Go | 📅 2026-08-22 :  快速、资源高效、可扩展的开源时间序列数据库。可作为`Prometheus`的长期远程存储。支持`PromQL`。
* [badger](https://github.com/dgraph-io/badger) ⭐ 15,757 | 🐛 70 | 🌐 Go | 📅 2026-08-22 : `Go`中的快速键值存储库。
* [groupcache](https://github.com/golang/groupcache) ⭐ 13,331 | 🐛 45 | 🌐 Go | 📅 2024-11-29 :  `Groupcache`是一个缓存及缓存填充库,在很多情况下用于替代 `memcached`.
* [bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,697 | 🐛 31 | 🌐 Go | 📅 2026-08-21 :  `Go`的嵌入式键值数据库。
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,323 | 🐛 111 | 🌐 Go | 📅 2024-05-14 :  `Go`中[LevelDB](https://github.com/google/leveldb) ⭐ 39,351 | 🐛 403 | 🌐 C++ | 📅 2026-03-11键/值数据库的实现
...
* [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3,577 | 🐛 50 | 🌐 Go | 📅 2026-08-09 :  `Nutsdb`是一个用纯`Go`编写的简单、快速、可嵌入、持久化的键/值存储。它支持完全可序列化的事务和许多数据结构,如列表、集合、排序集合。
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,845 | 🐛 489 | 🌐 Go | 📅 2026-07-05 :   数据库迁移。命令行及 `Go `语言库
* [goose](https://github.com/pressly/goose) ⭐ 11,354 | 🐛 139 | 🌐 Go | 📅 2026-08-22 :   数据库迁移工具。你可以通过编写增量 `SQL `或 `Go` 语言脚本来管理你的数据库
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,242 | 🐛 1,086 | 🌐 Go | 📅 2026-08-23 :  `vitess` 提供了能够使大型 `web `服务 `MySQL` 数据库的扩展变得更加容易的服务器及工具
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,484 | 🐛 55 | 🌐 Go | 📅 2026-07-26 :  基于 `Web` 的 `PostgreSQL` 数据库浏览工具
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,395 | 🐛 4 | 🌐 Go | 📅 2026-08-21 : `PostgreSQL` 的高级调度。
...
* 关系型数据库
  ...
  * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 15,271 | 🐛 72 | 🌐 Go | 📅 2026-08-20 :  Go 语言 `MySQL`驱动
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,221 | 🐛 159 | 🌐 C | 📅 2026-08-17 :  Go 语言的 `SQLite3 `驱动
  ...
  * [pgx](https://github.com/jackc/pgx) ⭐ 14,174 | 🐛 253 | 🌐 Go | 📅 2026-08-22 :  `PostgreSQL` 驱动,支持比 `database/sql `更多的特性
...
* NoSQL数据库
  ...
  * [redis](https://github.com/go-redis/redis) ⭐ 22,215 | 🐛 65 | 🌐 Go | 📅 2026-08-23 :  兼容R`edis`协议的 `TCP` 服务器/服务.
  * [xredis](https://github.com/shomali11/xredis) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2019-06-08 :  类型安全的、可定制的、简洁易用的 `Redis` 客户端

***

* 搜索引擎和文本数据库
  * [bleve](https://github.com/blevesearch/bleve) ⭐ 11,184 | 🐛 299 | 🌐 Go | 📅 2026-08-21 :  现代文本索引库
...
* [raft](https://github.com/coreos/etcd/tree/master/raft) ⭐ 52,159 | 🐛 318 | 🌐 Go | 📅 2026-08-23 : ` Raft`共识协议的 `Go` 实现,由 `CoreOS` 提供。
* [go-kit](https://github.com/go-kit/kit) ⭐ 27,422 | 🐛 60 | 🌐 Go | 📅 2024-07-19 :   为服务工具吧,支持服务发现、负载均衡 、可插拔传输以及请求追踪等
* [go-micro](https://github.com/micro/go-micro) ⭐ 23,034 | 🐛 8 | 🌐 Go | 📅 2026-08-23 :   一个分布式系统开发框架。
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 23,031 | 🐛 132 | 🌐 Go | 📅 2026-08-21 : ` gRPC`的Go语言实现。基于`HTTP/2的RPC`。
* [NATS](https://github.com/nats-io/gnatsd) ⭐ 20,571 | 🐛 545 | 🌐 Go | 📅 2026-08-22 :  轻量级、高性能微服务系统,用于微服务、物联网以及云
* [raft](https://github.com/hashicorp/raft) ⭐ 9,100 | 🐛 52 | 🌐 Go | 📅 2026-08-23 :  `Raft` 共识协议的 `Golang `实现,由 `HashiCorp`.开发。
...
* [torrent](https://github.com/anacrolix/torrent) ⭐ 6,098 | 🐛 62 | 🌐 Go | 📅 2026-08-23 :   `BitTorrent` 客户端
...
* [hermes](https://github.com/matcornic/hermes) ⭐ 3,023 | 🐛 22 | 🌐 Go | 📅 2025-04-04 :  一个用于生成干净、响应式 `HTML e-mail` 的包
* [email](https://github.com/jordan-wright/email) ⭐ 2,796 | 🐛 58 | 🌐 Go | 📅 2024-02-21 : 健壮的、灵活的 `email `库
* [go-imap](https://github.com/emersion/go-imap) ⭐ 2,348 | 🐛 76 | 🌐 Go | 📅 2026-07-02 :  ` IMAP` 库,用于客户端和服务器
* [SendGrid](https://github.com/sendgrid/sendgrid-go) ⭐ 1,061 | 🐛 34 | 🌐 Go | 📅 2026-06-25 : `SendGrid`的 Go 语言库,用于发送电子邮件
* [mailgun-go](https://github.com/mailgun/mailgun-go) ⭐ 745 | 🐛 6 | 🌐 Go | 📅 2026-08-23 :  使用`Mailgun API`发送邮件的Go库。
...
* [goja](https://github.com/dop251/goja) ⭐ 7,057 | 🐛 30 | 🌐 Go | 📅 2026-08-22 :  在 Go 中实现 `ECMAScript 5.1(+)` 。
...
* [cel-go](https://github.com/google/cel-go) ⭐ 3,077 | 🐛 66 | 🌐 Go | 📅 2026-08-21 :  快速、可移植、非图灵完全表达式评估和渐进分型。
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 8,795 | 🐛 112 | 🌐 Go | 📅 2026-08-20 :   PDF 处理器。
...
* [afs](https://github.com/viant/afs) ⭐ 395 | 🐛 7 | 🌐 Go | 📅 2026-08-05 :  适用于 `Go` 的抽象文件存储。
...
* [Ebiten](https://github.com/hajimehoshi/ebiten) ⭐ 13,416 | 🐛 278 | 🌐 Go | 📅 2026-08-23 :  `Go` 语言编写的简单的 `2D` 游戏库
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) ⭐ 3,726 | 🐛 4 | 🌐 Go | 📅 2026-08-23 :  类似`.NET LINQ`的`Go`查询方法。
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,716 | 🐛 163 | 🌐 Go | 📅 2026-08-07 :  具有空间索引和实时地理围栏的地理位置数据库。
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 28,635 | 🐛 722 | 🌐 Go | 📅 2026-08-22 :   基于`Material Design`为`Go`设计的跨平台本地GUI。支持 Linux, macOS, Windows, BSD, iOS\` 和 Android.
...
* [gocron](https://github.com/go-co-op/gocron) ⭐ 7,140 | 🐛 3 | 🌐 Go | 📅 2026-08-18 : 简单流畅的`Go`作业调度。这是·`jasonlvhit/gocron`·\`的一个积极维护的fork.
...
* [logrus](https://github.com/sirupsen/logrus) ⭐ 25,749 | 🐛 44 | 🌐 Go | 📅 2026-08-19 : `Go`的结构化日志记录器。
* [zap](https://github.com/uber-go/zap) ⭐ 24,638 | 🐛 192 | 🌐 Go | 📅 2026-08-05 :  快速的、结构化的、分级的日志库
* [zerolog](https://github.com/rs/zerolog) ⭐ 12,493 | 🐛 147 | 🌐 Go | 📅 2026-08-10 :  零内存分配 的`JSON `日志库.
...
* [logur](https://github.com/logur/logur) ⚠️ Archived :  日志记录接口和日志记录最佳实践的整合,它对诸多知名库如[logrus](https://github.com/sirupsen/logrus) ⭐ 25,749 | 🐛 44 | 🌐 Go | 📅 2026-08-19、[go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,422 | 🐛 60 | 🌐 Go | 📅 2024-07-19、[zap](https://github.com/uber-go/zap) ⭐ 24,638 | 🐛 192 | 🌐 Go | 📅 2026-08-05 ， [zerolog](https://github.com/rs/zerolog) ⭐ 12,493 | 🐛 147 | 🌐 Go | 📅 2026-08-10等的功能进行了集成
...
* [logrusly](https://github.com/sebest/logrusly) ⭐ 29 | 🐛 3 | 🌐 Go | 📅 2021-07-27 :  [logrus](https://github.com/sirupsen/logrus) ⭐ 25,749 | 🐛 44 | 🌐 Go | 📅 2026-08-19插件,用于将错误发送到[Loggly](https://www.loggly.com/)
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 13,657 | 🐛 293 | 🌐 Go | 📅 2026-06-22 :   建立在 `Redis` 之上，为 `Go` 提供的简单、可靠、高效的分布式任务队列,。
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,509 | 🐛 40 | 🌐 Go | 📅 2026-08-23 :  用于 `Apache Kafka `的库
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10,657 | 🐛 25 | 🌐 Go | 📅 2026-08-23 :  实时消息服务器
...
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,732 | 🐛 322 | 🌐 Go | 📅 2026-08-23 : 在一系列协议之间建立消息流`go`代码库
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,971 | 🐛 247 | 🌐 Go | 📅 2025-11-15 :  异步任务队列,基于分布式消息处理
* [NATS Go Client](https://github.com/nats-io/nats) ⭐ 6,730 | 🐛 158 | 🌐 Go | 📅 2026-08-20 :   原生的 `oplog/replication `系统,用于 `REST APIs`场景
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 5,163 | 🐛 277 | 🌐 Go | 📅 2026-08-23   是`Confluent`为`Apache Kafka`和`Confluent Platform`开发的`Golang`客户端。
...
* [unioffice](https://github.com/unidoc/unioffice) ⭐ 4,928 | 🐛 9 | 🌐 Go | 📅 2026-08-13 :  用于创建和处理`Office Word (.docx)、Excel (.xlsx)`和`Powerpoint (.pptx)`文档的纯`go`库。

### EXCEL

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) ⭐ 20,868 | 🐛 133 | 🌐 Go | 📅 2026-08-23 :  用于读写 `Microsoft Excel™ (XLSX)` 文件的 `Golang `库
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 56,488 | 🐛 95 | 🌐 Makefile | 📅 2026-04-28 :  -` Go` 生态系统中常见的历史和新兴项目布局模式集。
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 11,889 | 🐛 373 | 🌐 Go | 📅 2026-08-18 :  自动化的服务健康仪表板。
...
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 2,133 | 🐛 10 | 🌐 Go | 📅 2026-08-23 :  快速将整个` org/users` 仓库克隆到一个目录中 - 支持` GitHub、GitLab` 和 `Bitbucket`。
* [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1,662 | 🐛 80 | 🌐 Go | 📅 2026-07-01 :  提供轻松访问各种消息服务的通知库,如`slack, mattermost, gotify`和`smtp`等。
...
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,646 | 🐛 0 | 🌐 Go | 📅 2026-07-20 : 结巴分词的 `Go `语言实现的 [jieba](https://github.com/fxsjy/jieba) ⭐ 35,126 | 🐛 700 | 🌐 Python | 📅 2024-08-21 ,结巴分词是一个用于中文的分词算法
...
* [govader](https://github.com/jonreiter/govader) ⭐ 55 | 🐛 1 | 🌐 Go | 📅 2025-04-29 : [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment) ⭐ 5,051 | 🐛 56 | 🌐 Python | 📅 2026-03-02 情感分析的`Go`实现
...
* [webrtc](https://github.com/pions/webrtc) ⭐ 16,730 | 🐛 117 | 🌐 Go | 📅 2026-08-22 :` WebRTC API`的纯`Go`实现。
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11,748 | 🐛 223 | 🌐 Go | 📅 2026-08-23 :   纯`Go`中`QUIC`协议的实现。
* [gnet](https://github.com/panjf2000/gnet) ⭐ 11,234 | 🐛 0 | 🌐 Go | 📅 2026-07-09 : `gnet`是用纯Go编写 的一个高性能、轻量级、非阻塞、事件驱动的网络框架,
* [dns](https://github.com/miekg/dns) ⭐ 8,760 | 🐛 0 | 🌐 Go | 📅 2026-08-19 :   用于处理` DNS` 的` Go` 语言库
...
* [ssh](https://github.com/gliderlabs/ssh) ⭐ 4,167 | 🐛 62 | 🌐 Go | 📅 2025-01-27 :  用于创建 SSH 服务器的高级` API`(封装了`crypto/ssh`).
* [HTTPLab](https://github.com/gchaincl/httplab) ⭐ 4,141 | 🐛 13 | 🌐 Go | 📅 2024-02-05 : `HTTPLabs`让你检查` HTTP`请求和伪造响应。
* [gobgp](https://github.com/osrg/gobgp) ⭐ 4,102 | 🐛 235 | 🌐 Go | 📅 2026-08-12 :  `Go`语言实现的BGP
* [fortio](https://github.com/fortio/fortio) ⭐ 3,722 | 🐛 86 | 🌐 Go | 📅 2026-08-17 :  负载测试库和命令行工具,提供先进的`echo`服务器和web用户界面。允许指定设定每秒钟查询的负载,记录延迟直方图和其他有用的统计数据,并将其绘制成图表。
* [water](https://github.com/songgao/water) ⭐ 2,166 | 🐛 30 | 🌐 Go | 📅 2024-07-30 :  一个简单的`TUN/TAP`库。
* [go-getter](https://github.com/hashicorp/go-getter) ⭐ 1,823 | 🐛 171 | 🌐 Go | 📅 2026-08-23 :   一个用于通过 URL 从多种源下载文件或目录的 Go 语言库
...
* [mdns](https://github.com/hashicorp/mdns) ⭐ 1,372 | 🐛 38 | 🌐 Go | 📅 2026-08-23 :   简单的` mDNS` (组播 DNS)客户端/服务器库
...
* [glfw](https://github.com/go-gl/glfw) ⭐ 1,690 | 🐛 22 | 🌐 C | 📅 2026-08-23 : `GLFW 3`的`Go`语言接口
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 39,921 | 🐛 518 | 🌐 Go | 📅 2026-06-25 :  超棒的` Go` 语言` ORM` 库,对开发者非常友好
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1,725 | 🐛 3 | 🌐 Go | 📅 2026-08-21 :  灵活而强大的`SQL`字符串构建库,加上一个零配置的`ORM`。
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,131 | 🐛 569 | 🌐 Go | 📅 2026-08-23 :  分布式跟踪系统。
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,024 | 🐛 25 | 🌐 Go | 📅 2026-08-16 :   基于命令行的选择器查询和更新数据结构。类似于`jq/yq`,但支持`JSON、YAML、TOML`和`XML`。
...
* [cbor](https://github.com/fxamacker/cbor) ⭐ 1,080 | 🐛 30 | 🌐 Go | 📅 2026-08-21 :  小巧、安全、简单的` CBOR` 编码和解码库。
...
* [Caddy](https://github.com/mholt/caddy) ⭐ 75,145 | 🐛 273 | 🌐 Go | 📅 2026-08-22 :`  Caddy`是一个备选的` HTTP/2 web` 服务器,配置简单,使用方便。
* [minio](https://github.com/minio/minio) ⚠️ Archived :  Minio 是一个分布式对象存储服务器
* [etcd](https://github.com/coreos/etcd) ⭐ 52,159 | 🐛 318 | 🌐 Go | 📅 2026-08-23 :  高可用性的键值存储,用于分享配置和服务发现
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,433 | 🐛 172 | 🌐 Go | 📅 2026-08-13 :   功能齐全、高度可配置的`SFTP`服务器,可选择支持`FTP/S和WebDAV`。它可以为本地文件系统和云存储后端服务,如S3和谷歌云存储。
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,501 | 🐛 52 | 🌐 Go | 📅 2026-08-22 :   高性能的PHP应用服务器,负载均衡器和进程管理器。
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,877 | 🐛 44 | 🌐 Go | 📅 2026-08-23 :  用`Go`和`Vue.js`编写的自带功能标志的解决方案。
* [Fider](https://github.com/getfider/fider) ⭐ 4,482 | 🐛 51 | 🌐 Go | 📅 2026-08-09 : `Fider`是一个收集和整理客户反馈的开放平台。
* [devd](https://github.com/cortesi/devd) ⭐ 3,477 | 🐛 24 | 🌐 Go | 📅 2026-06-21 :   开发者使用的本地`web` 服务器
* [algernon](https://github.com/xyproto/algernon) ⭐ 3,026 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-20 :` HTTP/2 web`服务器,内置`Lua、Markdown、GCSS`和`Amber`支持。
* [Flagr](https://github.com/checkr/flagr) ⭐ 2,605 | 🐛 0 | 🌐 Go | 📅 2026-08-20 : ` Flagr`是一个开源的功能标志和A/B测试服务。
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,088 | 🐛 23 | 🌐 Go | 📅 2026-08-23 : `HTTP`反向代理缓存和时间序列加速器。
...
* 测试框架
  ...
  * [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 23 | 🐛 4 | 🌐 Go | 📅 2026-08-23 : ` HTTP`客户端测试框架。
  ...
  * [go-cmp](https://github.com/google/go-cmp) ⭐ 4,675 | 🐛 63 | 🌐 Go | 📅 2026-06-18 :  用于比较测试中的` Go`值的软件包。
  ...
  * [go-testdeep](https://github.com/maxatome/go-testdeep) ⭐ 463 | 🐛 3 | 🌐 Go | 📅 2026-08-23 :  扩展了` go` 测试包的极为灵活的`golang` 深度比较库,。
  ...
  * [Testify](https://github.com/stretchr/testify) ⭐ 26,174 | 🐛 365 | 🌐 Go | 📅 2026-08-20 :  对标准测试包的扩展
...
* Mock
  ...
  * [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,507 | 🐛 33 | 🌐 Go | 📅 2026-08-23 :`  HTTP(S) : proxy,`用于记录和模拟`REST/SOAP API`,具有可扩展的中间件和易于使用的 CLI。
...
* Selenium及浏览器控制工具
  * [chromedp](https://github.com/knq/chromedp) ⭐ 13,262 | 🐛 177 | 🌐 Go | 📅 2026-07-14 :  用于驱动和测试`Chrome, Safari, Edge, Android Webviews`, 以及其他支持`Chrome`调试协议的产品
...
* 特定文本格式处理
  * [colly](https://github.com/asciimoo/colly) ⭐ 25,472 | 🐛 193 | 🌐 Go | 📅 2026-08-14 :  `go`语言版爬虫框架
  * [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,981 | 🐛 4 | 🌐 Go | 📅 2026-08-17 :`  GoQuery` 为` Go`语言带来了一组类似`jQuery` 的语法和功能
  * [sh](https://github.com/mvdan/sh) ⭐ 9,000 | 🐛 94 | 🌐 Go | 📅 2026-08-23 : `Shell`解析器及格式化工具
  ...
  * [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3,792 | 🐛 25 | 🌐 Go | 📅 2026-08-03 :  将`HTML`转换为`Markdown`。甚至适用于整个网站,并可通过规则进行扩展。
...
* [github](https://github.com/google/go-github) ⭐ 11,279 | 🐛 34 | 🌐 Go | 📅 2026-08-21 :  用于访问`GitHub REST API v3` 的`Go`库。
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) ⚠️ Archived : ` AWS` 提供的官方go语言` SDK`
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,973 | 🐛 230 | 🌐 Go | 📅 2026-02-14 :   用于与`Discord` 聊天` API`进行交互的`Go`语言客户端。
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,497 | 🐛 428 | 🌐 Go | 📅 2026-08-22 :`Google Cloud APIs Go`客户端库。
* [google](https://github.com/google/google-api-go-client) ⭐ 4,466 | 🐛 19 | 🌐 Go | 📅 2026-08-23 :  为`Go` 自动生成的`Google API`。
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,994 | 🐛 7 | 🌐 Go | 📅 2026-08-23 :  `go` 语言`Minio` 客户端,用于` Amazon S3` 兼容的云存储
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,630 | 🐛 12 | 🌐 Go | 📅 2026-08-23 :  用于访问`Stripe API`的`Go`客户端。
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,622 | 🐛 327 | 🌐 Go | 📅 2026-08-23 :  命令行模糊查找工具
...
* [Task](https://github.com/go-task/task) ⭐ 16,030 | 🐛 189 | 🌐 Go | 📅 2026-08-23 :  简单来讲就是`"Make"`的替代品
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 15,994 | 🐛 12 | 🌐 Go | 📅 2026-08-23 : 尽可能快速的发布`Go`语言二进制文件
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,721 | 🐛 42 | 🌐 Go | 📅 2026-08-04 :   交互式命令行程序,用于进行`HTTP` 检查
* [usql](https://github.com/knq/usql) ⭐ 10,086 | 🐛 118 | 🌐 Go | 📅 2026-06-19 :  `usql`是一个通用的命令行接口,用于操作`sql`数据库
...
* [minify](https://github.com/tdewolff/minify) ⭐ 4,135 | 🐛 39 | 🌐 Go | 📅 2026-08-23 :  快速压缩`HTML, CSS, JS, XML, JSON` 以及` SVG` 文件格式
...
* [mergo](https://github.com/imdario/mergo) ⭐ 3,106 | 🐛 18 | 🌐 Go | 📅 2026-08-23 :  Golang中合并结构和地图的助手。对配置默认值很有用,避免了混乱的if语句。
* [create-go-app](https://github.com/create-go-app/cli) ⭐ 2,766 | 🐛 13 | 🌐 Go | 📅 2026-02-10 :  通过运行一个命令就可以创建一个新的生产就绪项目,包括后端（`Golang`）、前端（`JavaScript、TypeScript`）和部署自动化（`Ansible、Docker`）的强大的`CLI`。
...
* [validator](https://github.com/go-playground/validator) ⭐ 20,126 | 🐛 323 | 🌐 Go | 📅 2026-08-18 :  `Go`结构体及域验证,包括：跨域、跨结构体,`Map`, 切片和数组
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 89,100 | 🐛 761 | 🌐 Go | 📅 2026-08-15 :  ` Gin` 是一个` Go` 语言编写的 web 框架,提供了一组类似`martini`的`API`,且具有更好的性能（40倍的性能提升）。如果你需要高性能和高生产率,这个框架很适合你
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,074 | 🐛 50 | 🌐 Go | 📅 2026-08-23 :  受` Express.js`启发的` Web` 框架,构建在`Fasthttp`上。
* [Echo](https://github.com/labstack/echo) ⭐ 32,652 | 🐛 25 | 🌐 Go | 📅 2026-08-20 :   高性能、极简的` Go`语言`web` 框架
...
* [Flamingo](https://github.com/i-love-flamingo/flamingo) ⭐ 559 | 🐛 34 | 🌐 Go | 📅 2026-08-23 :  可插拔的`we`b项目框架。包括模块的概念,并提供`DI、Configareas、i18n`、模板引擎、graphql、可观察性、安全性、事件、路由和反向路由等功能。
...
* [chi](https://github.com/go-chi/chi) ⭐ 22,716 | 🐛 84 | 🌐 Go | 📅 2026-08-20 :   基于`net/context`的小巧、快速、具有丰富表达力的`HTTP`路由.
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 17,665 | 🐛 560 | 🌐 Go | 📅 2026-08-23 :  基于`LLVM`,适用于微型场景的`Go`编译器。包括微控制器、`WebAssembly`和命令行工具。
...
* [gosimple](https://github.com/dominikh/go-tools/tree/master/cmd/gosimple) ⭐ 6,855 | 🐛 570 | 🌐 Go | 📅 2026-08-21 : 针对 Go 语言的`lint`工具,专注于简化代码
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,855 | 🐛 570 | 🌐 Go | 📅 2026-08-21 :  -`staticcheck`在`Go vet`阶段中执行大量的静态分析检查,类似`ReSharper for C#`这样的工具。
* [unused](https://github.com/dominikh/go-tools/tree/master/cmd/unused) ⭐ 6,855 | 🐛 570 | 🌐 Go | 📅 2026-08-21 :  `unused`会检查 Go 语言代码中没有用到的常量,变量,函数和类型
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 124,932 | 🐛 3,011 | 🌐 Go | 📅 2026-08-21 :  来自`Google`的容器集群管理器
* [Moby](https://github.com/moby/moby) ⭐ 71,991 | 🐛 3,901 | 🌐 Go | 📅 2026-08-22 :  为容器生态系统创建的一个合作项目,用于构建基于容器的系统
* [traefik](https://github.com/containous/traefik) ⭐ 64,549 | 🐛 916 | 🌐 Go | 📅 2026-08-21 :  能对接多个后端的反向代理和负载均衡器。
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 57,559 | 🐛 2,525 | 🌐 Go | 📅 2026-08-23 :  社区驱动的`Gogs`的`fork`库
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 25,159 | 🐛 122 | 🌐 Go | 📅 2026-02-16 :  `HTTP 加`载测试工具和代码库
* [Hey](https://github.com/rakyll/hey) ⭐ 20,237 | 🐛 189 | 🌐 Go | 📅 2026-01-10 :` Hey`是一个微型程序,用于向`web` 应用发送负载
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,762 | 🐛 317 | 🌐 Go | 📅 2026-08-23 :` Packer`通过单一的配置文件,为不同的平台创建独立镜像
* [webhook](https://github.com/adnanh/webhook) ⭐ 12,060 | 🐛 126 | 🌐 Go | 📅 2026-08-05 :  允许用户创建`HTTP`钩子,并在服务器上执行命令
* [GVM](https://github.com/moovweb/gvm) ⭐ 11,676 | 🐛 242 | 🌐 Shell | 📅 2024-08-08 : ` GVM`提供了用于管理`Go`语言版本的接口
* [script](https://github.com/bitfield/script) ⭐ 7,027 | 🐛 14 | 🌐 Go | 📅 2026-08-15 :  在Go中轻松编写类似`shell`的脚本,用于`DevOps`和系统管理任务。
* [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6,825 | 🐛 27 | 🌐 Go | 📅 2026-03-31 :  快速的、跨平台的`HTTP`基准工具.
* [gaia](https://github.com/gaia-pipeline/gaia) ⚠️ Archived :   利用任何编程语言都可以构建强大的管道的库。
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,972 | 🐛 149 | 🌐 Go | 📅 2026-08-21 :  `Pomerium`是一个身份感知的访问代理。
...
* [croc](https://github.com/schollz/croc) ⭐ 40,065 | 🐛 3 | 🌐 Go | 📅 2026-08-23 :    轻松安全地将文件或文件夹从一台计算机发送到另一台计算机。
* [restic](https://github.com/restic/restic) ⭐ 35,678 | 🐛 576 | 🌐 Go | 📅 2026-08-01 :  解耦备份程序
* [Gor](https://github.com/buger/gor) ⭐ 19,319 | 🐛 341 | 🌐 Go | 📅 2026-01-27 :  Http 流量复制工具,用于将生产环境的流量在开发环境进行重放
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12,277 | 🐛 105 | 🌐 Go | 📅 2026-08-04 :  用于自动化测试中模拟网络和系统状态的代理服务。
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,512 | 🐛 26 | 🌐 Go | 📅 2025-03-20 :   模拟网络波动情况下的网络数据连接
* [scc](https://github.com/boyter/scc) ⭐ 8,642 | 🐛 25 | 🌐 Go | 📅 2026-08-21 :   一个非常快速准确的代码计数器,具有复杂度计算和`COCOMO`估计功能。
...
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,503 | 🐛 6 | 🌐 Go | 📅 2026-08-08 :  通过HTTP服务器执行`shell`命令行(用于原型验证或远程控制)。
