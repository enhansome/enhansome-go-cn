【导读】：[awesome-go](https://github.com/avelino/awesome-Go) ⭐ 183,846 | 🐛 233 | 🌐 Go | 📅 2026-09-10 就是 `avelino` 发起维护的 Go 资源列表，内容包括：音频和音乐库、命令行工具、服务端应用、流处理、持续集成、数据库、机器学习、NLP、物联网、中间件、文本处理、安全、机器人技术等。
...
* [Oto](https://github.com/hajimehoshi/oto) ⭐ 1,968 | 🐛 21 | 🌐 Go | 📅 2026-09-07 :  可用于在多个平台上播放音频的底层库
...
* [casbin](https://github.com/hsluoyz/casbin) ⭐ 20,383 | 🐛 38 | 🌐 Go | 📅 2026-09-11 : 支持`ACL`、`RBAC`、`ABAC`等访问控制模型的授权与认证库。
...
* [urfave/cli](https://github.com/urfave/cli) ⭐ 24,234 | 🐛 73 | 🌐 Go | 📅 2026-09-04 :   简单、快速、有趣的、用于构建 Go 语言命令行程序的软件包。
...
* [ops](https://github.com/nanovms/ops) ⭐ 1,514 | 🐛 143 | 🌐 Go | 📅 2026-09-09 : `Unikernel `编辑器和生成器
...
* [termui](https://github.com/gizak/termui) ⭐ 13,582 | 🐛 106 | 🌐 Go | 📅 2025-07-10 :   基于 `termbox-go` 的 `Go` 终端仪表盘,灵感来源于[blessed-contrib](https://github.com/yaronn/blessed-contrib) ⭐ 15,770 | 🐛 97 | 🌐 JavaScript | 📅 2026-05-01 。
...
* [go-prompt](https://github.com/c-bata/go-prompt) ⭐ 5,498 | 🐛 113 | 🌐 Go | 📅 2025-08-12 :   受 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,567 | 🐛 715 | 🌐 Python | 📅 2026-07-26  的启发，用于构建强大的交互式提示符的go语言库
...
* [termdash](https://github.com/mum4k/termdash) ⭐ 3,036 | 🐛 49 | 🌐 Go | 📅 2026-09-07 :   基于 `termbox-go `的 `Go` 终端仪表盘,灵感来自 [termui](https://github.com/gizak/termui) ⭐ 13,582 | 🐛 106 | 🌐 Go | 📅 2025-07-10 。
...
* [gookit/color](https://github.com/gookit/color) ⭐ 1,606 | 🐛 2 | 🌐 Go | 📅 2026-09-07 :  格式化终端文本。
...
* [ini](https://github.com/go-ini/ini) ⭐ 3,544 | 🐛 80 | 🌐 Go | 📅 2026-09-05 :  用于读写INI 文件的库
...
* [drone](https://github.com/drone/drone) ⭐ 38,323 | 🐛 108 | 🌐 Go | 📅 2026-09-10 : ` Drone` 是一个基于` Docker`的持续集成平台,使用 `Go `语言编写
...
* [ttlcache](https://github.com/ReneKroon/ttlcache) ⭐ 1,281 | 🐛 18 | 🌐 Go | 📅 2026-09-09 : 基于过期时间的内存字符串缓存接口。
* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) ⭐ 1,234 | 🐛 15 | 🌐 Go | 📅 2024-07-15 : `Cuckoo`过滤器：一个用go语言实现的计数布隆过滤器的替代品
* [gostl](https://github.com/liyue201/gostl) ⭐ 1,139 | 🐛 7 | 🌐 Go | 📅 2025-08-28 :  数据结构和算法库,旨在提供类似于` C++ STL` 的功能。
...
* [deque](https://github.com/gammazero/deque) ⭐ 785 | 🐛 5 | 🌐 Go | 📅 2026-07-02 :  快速的环形缓冲区` deque`（双端队列）。
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,048 | 🐛 888 | 🌐 Go | 📅 2026-09-11 :  监控系统及时间序列数据库
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,514 | 🐛 6,962 | 🌐 Go | 📅 2026-09-11 : ` TiDB` 是一个分布式的` SQL` 数据库。受到了` Google F1`的启发
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,452 | 🐛 8,422 | 🌐 Go | 📅 2026-09-08 :  可扩展的、一致的事务型数据库
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 31,734 | 🐛 2,166 | 🌐 Rust | 📅 2026-09-10 :  用于度量、事件和实时分析的可扩展数据存储。
* [dgraph](https://github.com/dgraph-io/dgraph) ⭐ 21,792 | 🐛 99 | 🌐 Go | 📅 2026-09-11 :  可扩展的、分布式的、低延时、高吞吐的图数据库
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 17,729 | 🐛 77 | 🌐 Go | 📅 2026-09-11 :  基于 `SQLite `的轻量级的、分布式的关系型数据库
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,700 | 🐛 798 | 🌐 Go | 📅 2026-09-11 :  快速、资源高效、可扩展的开源时间序列数据库。可作为`Prometheus`的长期远程存储。支持`PromQL`。
* [badger](https://github.com/dgraph-io/badger) ⭐ 15,760 | 🐛 68 | 🌐 Go | 📅 2026-09-08 : `Go`中的快速键值存储库。
...
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,322 | 🐛 111 | 🌐 Go | 📅 2024-05-14 :  `Go`中[LevelDB](https://github.com/google/leveldb) ⭐ 39,403 | 🐛 409 | 🌐 C++ | 📅 2026-03-11键/值数据库的实现
...
* [goose](https://github.com/pressly/goose) ⭐ 11,451 | 🐛 131 | 🌐 Go | 📅 2026-09-05 :   数据库迁移工具。你可以通过编写增量 `SQL `或 `Go` 语言脚本来管理你的数据库
* [sql-migrate](https://github.com/rubenv/sql-migrate) ⭐ 3,419 | 🐛 98 | 🌐 Go | 📅 2026-07-14 :  数据库迁移工具,允许利用 `Go-bindata` 将数据库迁移嵌入应用程序
* [soda](https://github.com/gobuffalo/pop/tree/master/soda) ⭐ 1,524 | 🐛 94 | 🌐 Go | 📅 2026-09-11 : 数据库迁移、创建、 ORM等等,用于`MySQL, PostgreSQL,`以及 `SQLite`.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,323 | 🐛 1,101 | 🌐 Go | 📅 2026-09-11 :  `vitess` 提供了能够使大型 `web `服务 `MySQL` 数据库的扩展变得更加容易的服务器及工具
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,500 | 🐛 56 | 🌐 Go | 📅 2026-07-26 :  基于 `Web` 的 `PostgreSQL` 数据库浏览工具
...
* [jet](https://github.com/go-jet/jet) ⭐ 3,796 | 🐛 45 | 🌐 Go | 📅 2026-08-31 :  在`Go`中编写类型安全的`SQL`查询框架,能够轻松地将数据库查询结果转换为所需的任意对象结构。
...
* 关系型数据库
  * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 15,284 | 🐛 58 | 🌐 Go | 📅 2026-09-06 :  Go 语言 `MySQL`驱动
  * [pgx](https://github.com/jackc/pgx) ⭐ 14,238 | 🐛 217 | 🌐 Go | 📅 2026-09-08 :  `PostgreSQL` 驱动,支持比 `database/sql `更多的特性
  * [pq](https://github.com/lib/pq) ⭐ 9,955 | 🐛 52 | 🌐 Go | 📅 2026-08-20 :  用于`database/sql`的`Pure Go Postgres`驱动。
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,237 | 🐛 151 | 🌐 C | 📅 2026-09-05 :  Go 语言的 `SQLite3 `驱动
...
* NoSQL数据库
  * [redis](https://github.com/go-redis/redis) ⭐ 22,230 | 🐛 61 | 🌐 Go | 📅 2026-09-11 :  兼容R`edis`协议的 `TCP` 服务器/服务.
...
* 搜索引擎和文本数据库
  ...
  * [riot](https://github.com/go-ego/riot) ⭐ 6,047 | 🐛 0 | 🌐 Go | 📅 2026-09-11 :  `Go`开源,分布式,简单高效的搜索引擎。
...
* 多个后端:
  * [cayley](https://github.com/google/cayley) ⭐ 15,061 | 🐛 93 | 🌐 Go | 📅 2026-08-27 :  支持多个后端的图形数据库。
...
* [raft](https://github.com/coreos/etcd/tree/master/raft) ⭐ 52,250 | 🐛 339 | 🌐 Go | 📅 2026-09-11 : ` Raft`共识协议的 `Go` 实现,由 `CoreOS` 提供。
...
* [grpc-go](https://github.com/grpc/grpc-go) ⭐ 23,052 | 🐛 137 | 🌐 Go | 📅 2026-09-11 : ` gRPC`的Go语言实现。基于`HTTP/2的RPC`。
* [NATS](https://github.com/nats-io/gnatsd) ⭐ 20,697 | 🐛 531 | 🌐 Go | 📅 2026-09-11 :  轻量级、高性能微服务系统,用于微服务、物联网以及云
* [raft](https://github.com/hashicorp/raft) ⭐ 9,120 | 🐛 52 | 🌐 Go | 📅 2026-08-30 :  `Raft` 共识协议的 `Golang `实现,由 `HashiCorp`.开发。
...
* [torrent](https://github.com/anacrolix/torrent) ⭐ 6,110 | 🐛 78 | 🌐 Go | 📅 2026-09-08 :   `BitTorrent` 客户端
...
* [sleuth](https://github.com/ursiform/sleuth) ⭐ 387 | 🐛 0 | 🌐 Go | 📅 2023-07-09 :  在 `HTTP `服务之间进行无主` p2p` 自动发现和 RPC通信(使用 [ZeroMQ](https://github.com/zeromq/libzmq) ⭐ 10,995 | 🐛 382 | 🌐 C++ | 📅 2026-07-26)ß
...
* [GoDNS](https://github.com/timothyye/godns) ⭐ 1,778 | 🐛 16 | 🌐 Go | 📅 2026-08-30 : 用Go编写的动态`DNS`客户端工具,支持`DNSPod`和`HE.net`。
...
* [goja](https://github.com/dop251/goja) ⭐ 7,085 | 🐛 33 | 🌐 Go | 📅 2026-09-11 :  在 Go 中实现 `ECMAScript 5.1(+)` 。
...
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,454 | 🐛 49 | 🌐 Go | 📅 2025-07-18 :  `Lua 5.2`虚拟机的纯 Go 语言接口
...
* [gval](https://github.com/PaesslerAG/gval) ⭐ 814 | 🐛 25 | 🌐 Go | 📅 2026-08-12 :  Go编写的高度可定制的表达式语言。
...
* [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 8,831 | 🐛 120 | 🌐 Go | 📅 2026-09-07 :   PDF 处理器。
* [afero](https://github.com/spf13/afero) ⭐ 6,696 | 🐛 133 | 🌐 Go | 📅 2026-09-11 : ` go`语言编写的对文件系统进行抽象的系统框架
...
* [afs](https://github.com/viant/afs) ⭐ 399 | 🐛 7 | 🌐 Go | 📅 2026-08-05 :  适用于 `Go` 的抽象文件存储。
...
* [decimal](https://github.com/shopspring/decimal) ⭐ 7,472 | 🐛 155 | 🌐 Go | 📅 2026-08-19 :  支持任意精度的十进制数的go包
...
* [form](https://github.com/go-playground/form) ⭐ 930 | 🐛 15 | 🌐 Go | 📅 2026-09-08 :  解码 `url `中的数据到 `Go` 语言变量中以及将 `Go `语言变量编码进 `url` 。
...
* [Ebiten](https://github.com/hajimehoshi/ebiten) ⭐ 13,467 | 🐛 289 | 🌐 Go | 📅 2026-09-11 :  `Go` 语言编写的简单的 `2D` 游戏库
...
* [go-enum](https://github.com/abice/go-enum) ⭐ 957 | 🐛 22 | 🌐 Go | 📅 2026-09-10 :   从代码注释中生成`enums`代码。
...
* [fyne](https://github.com/fyne-io/fyne) ⭐ 28,689 | 🐛 735 | 🌐 Go | 📅 2026-09-10 :   基于`Material Design`为`Go`设计的跨平台本地GUI。支持 Linux, macOS, Windows, BSD, iOS\` 和 Android.
* [webview](https://github.com/zserge/webview) ⭐ 14,229 | 🐛 212 | 🌐 C++ | 📅 2026-03-09 :   支持双向`JavaScript`绑定的跨平台 webview 窗口库（`Windows，macOS，Linux`）。
...
* [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10,802 | 🐛 3 | 🌐 Go | 📅 2026-09-09 :   跨平台`GUI`自动化工具，可以控制鼠标、键盘及其他设备
...
* [imaging](https://github.com/disintegration/imaging) ⭐ 5,753 | 🐛 35 | 🌐 Go | 📅 2023-09-21 :  简单的`Go`图像处理包。
...
* [canvas](https://github.com/tdewolff/canvas) ⭐ 1,838 | 🐛 25 | 🌐 Go | 📅 2026-09-01 :  将矢量图形转换成 `PDF、SVG `或光栅化图像。
* [gift](https://github.com/disintegration/gift) ⭐ 1,795 | 🐛 9 | 🌐 Go | 📅 2023-09-20 :    图像处理过滤器包
...
* [gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,468 | 🐛 100 | 🌐 Go | 📅 2026-01-07 : ` Gobot` 是一个用于机器人,物理计算以及物联网的库
...
* [zap](https://github.com/uber-go/zap) ⭐ 24,654 | 🐛 192 | 🌐 Go | 📅 2026-08-31 :  快速的、结构化的、分级的日志库
* [zerolog](https://github.com/rs/zerolog) ⭐ 12,501 | 🐛 148 | 🌐 Go | 📅 2026-09-08 :  零内存分配 的`JSON `日志库.
* [spew](https://github.com/davecgh/go-spew) ⭐ 6,416 | 🐛 70 | 🌐 Go | 📅 2024-04-06 :  - 为 `Go `语言的数据结构实现了一个整洁的打印功能,有助于调试
* [lumberjack](https://github.com/natefinch/lumberjack) ⭐ 5,466 | 🐛 101 | 🌐 Go | 📅 2024-08-05 :  简单的循环日志工具。
...
* [phuslu/log](https://github.com/phuslu/log) ⭐ 871 | 🐛 12 | 🌐 Go | 📅 2026-09-11 :  - 结构化日志系统。
...
* [logur](https://github.com/logur/logur) ⚠️ Archived :  日志记录接口和日志记录最佳实践的整合,它对诸多知名库如[logrus](https://github.com/sirupsen/logrus) ⭐ 25,746 | 🐛 46 | 🌐 Go | 📅 2026-08-25、[go-kit log](https://github.com/go-kit/kit/tree/master/log) ⭐ 27,422 | 🐛 60 | 🌐 Go | 📅 2024-07-19、[zap](https://github.com/uber-go/zap) ⭐ 24,654 | 🐛 192 | 🌐 Go | 📅 2026-08-31 ， [zerolog](https://github.com/rs/zerolog) ⭐ 12,501 | 🐛 148 | 🌐 Go | 📅 2026-09-08等的功能进行了集成
...
* [Asynq](https://github.com/hibiken/asynq) ⭐ 13,694 | 🐛 291 | 🌐 Go | 📅 2026-06-22 :   建立在 `Redis` 之上，为 `Go` 提供的简单、可靠、高效的分布式任务队列,。
* [sarama](https://github.com/Shopify/sarama) ⭐ 12,519 | 🐛 43 | 🌐 Go | 📅 2026-09-09 :  用于 `Apache Kafka `的库
* [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10,741 | 🐛 24 | 🌐 Go | 📅 2026-09-11 :  实时消息服务器
* [gorush](https://github.com/appleboy/gorush) ⭐ 8,769 | 🐛 68 | 🌐 Go | 📅 2026-07-25  通知推送服务器,使用 [APNs2](https://github.com/sideshow/apns2) ⭐ 3,187 | 🐛 32 | 🌐 Go | 📅 2025-07-22 和 [GCM](https://github.com/google/go-gcm) ⚠️ Archived 。
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,743 | 🐛 327 | 🌐 Go | 📅 2026-09-11 : 在一系列协议之间建立消息流`go`代码库
* [machinery](https://github.com/RichardKnop/machinery) ⭐ 7,972 | 🐛 248 | 🌐 Go | 📅 2025-11-15 :  异步任务队列,基于分布式消息处理
* [NATS Go Client](https://github.com/nats-io/nats) ⭐ 6,747 | 🐛 170 | 🌐 Go | 📅 2026-09-11 :   原生的 `oplog/replication `系统,用于 `REST APIs`场景
* [go-socket.io](https://github.com/googollee/go-socket.io) ⚠️ ArchivedGo 语言的 `socket.io`库 ,一个实时应用框架.
* [Mercure](https://github.com/dunglas/mercure) ⭐ 5,307 | 🐛 23 | 🌐 Go | 📅 2026-09-11 :   使用`Mercure`协议（建立在`Server-Sent Events`之上）来调度服务器发送的更新的代码库。
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) ⭐ 5,163 | 🐛 280 | 🌐 Go | 📅 2026-09-11   是`Confluent`为`Apache Kafka`和`Confluent Platform`开发的`Golang`客户端。
...
* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) ⭐ 20,900 | 🐛 134 | 🌐 Go | 📅 2026-09-11 :  用于读写 `Microsoft Excel™ (XLSX)` 文件的 `Golang `库
...
* [fx](https://github.com/uber-go/fx) ⭐ 7,661 | 🐛 80 | 🌐 Go | 📅 2025-12-27 :  基于 `Go `的依赖注入应用框架（建立在 `dig` 的基础上）。
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 56,563 | 🐛 94 | 🌐 Makefile | 📅 2026-04-28 :  -` Go` 生态系统中常见的历史和新兴项目布局模式集。
...
* [xstrings](https://github.com/huandu/xstrings) ⭐ 1,412 | 🐛 0 | 🌐 Go | 📅 2024-06-06 :  从其他语言移植过来的字符串函数集合。
...
* [gatus](https://github.com/TwinProduction/gatus) ⭐ 12,056 | 🐛 382 | 🌐 Go | 📅 2026-09-08 :  自动化的服务健康仪表板。
* [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11,911 | 🐛 224 | 🌐 Go | 📅 2026-09-10 :  跨平台库,用于检索进程和系统利用率（`CPU`、内存、磁盘等）。
...
* [ghorg](https://github.com/gabrie30/ghorg) ⭐ 2,138 | 🐛 10 | 🌐 Go | 📅 2026-09-06 :  快速将整个` org/users` 仓库克隆到一个目录中 - 支持` GitHub、GitLab` 和 `Bitbucket`。
...
* [gse](https://github.com/go-ego/gse) ⭐ 2,842 | 🐛 15 | 🌐 Go | 📅 2026-09-09 :   ` Go`高效的文本分割；支持英语、中文、日语和其他语言。
* [gojieba](https://github.com/yanyiwu/gojieba) ⭐ 2,644 | 🐛 0 | 🌐 Go | 📅 2026-07-20 : 结巴分词的 `Go `语言实现的 [jieba](https://github.com/fxsjy/jieba) ⭐ 35,148 | 🐛 700 | 🌐 Python | 📅 2024-08-21 ,结巴分词是一个用于中文的分词算法
...
* [fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,469 | 🐛 94 | 🌐 Go | 📅 2026-09-09 : `asthttp` 是一个快速的`HTTP`实现,比`net/http1`的性能快10倍
* [webrtc](https://github.com/pions/webrtc) ⭐ 16,772 | 🐛 122 | 🌐 Go | 📅 2026-09-09 :` WebRTC API`的纯`Go`实现。
* [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11,765 | 🐛 215 | 🌐 Go | 📅 2026-09-07 :   纯`Go`中`QUIC`协议的实现。
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,553 | 🐛 70 | 🌐 Go | 📅 2026-05-15 :` KCP` - 快速可靠的`ARQ`协议。
...
* [gobgp](https://github.com/osrg/gobgp) ⭐ 4,106 | 🐛 245 | 🌐 Go | 📅 2026-09-02 :  `Go`语言实现的BGP
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,795 | 🐛 19 | 🌐 Go | 📅 2026-09-07 :  受`Ruby rest-client` 的启发,为`Go` 设计的简单` HTTP`和`REST`客户端。
...
* [glfw](https://github.com/go-gl/glfw) ⭐ 1,692 | 🐛 22 | 🌐 C | 📅 2026-08-23 : `GLFW 3`的`Go`语言接口
...
* [GORM](https://github.com/go-gorm/gorm) ⭐ 39,953 | 🐛 525 | 🌐 Go | 📅 2026-06-25 :  超棒的` Go` 语言` ORM` 库,对开发者非常友好
* [ent](https://github.com/facebook/ent) ⭐ 17,198 | 🐛 621 | 🌐 Go | 📅 2026-09-04 :  简单而强大的用于数据建模和查询的ORM。
...
* [pop/soda](https://github.com/gobuffalo/pop) ⭐ 1,524 | 🐛 94 | 🌐 Go | 📅 2026-09-11 :  支持` MySQL, PostgreSQL`, 以及`SQLite`.的数据库迁移、创建、`ORM` 的工具,
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,202 | 🐛 556 | 🌐 Go | 📅 2026-09-10 :  分布式跟踪系统。
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,029 | 🐛 25 | 🌐 Go | 📅 2026-08-16 :   基于命令行的选择器查询和更新数据结构。类似于`jq/yq`,但支持`JSON、YAML、TOML`和`XML`。
...
* [gonum](https://github.com/gonum/gonum) ⭐ 8,425 | 🐛 256 | 🌐 Go | 📅 2026-08-30 :  用于` Go` 编程语言的数值库。它包含了矩阵、统计、优化等方面的库。
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,130 | 🐛 19 | 🌐 Go | 📅 2026-03-30 :  支持剪裁、`GeoJSON` 和` Mapbox Vector Tile`的`2D` 几何类型。
...
* [lego](https://github.com/go-acme/lego) ⭐ 9,868 | 🐛 103 | 🌐 Go | 📅 2026-09-10 :  纯` Go`语言开发的` ACME` 客户端库及命令行工具
* [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 5,184 | 🐛 19 | 🌐 Go | 📅 2026-09-09 :   用于远程入侵监控摄像头的`RTSP`流的工具库。
...
* [Caddy](https://github.com/mholt/caddy) ⭐ 75,662 | 🐛 276 | 🌐 Go | 📅 2026-09-11 :`  Caddy`是一个备选的` HTTP/2 web` 服务器,配置简单,使用方便。
* [minio](https://github.com/minio/minio) ⚠️ Archived :  Minio 是一个分布式对象存储服务器
* [etcd](https://github.com/coreos/etcd) ⭐ 52,250 | 🐛 339 | 🌐 Go | 📅 2026-09-11 :  高可用性的键值存储,用于分享配置和服务发现
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,508 | 🐛 176 | 🌐 Go | 📅 2026-09-07 :   功能齐全、高度可配置的`SFTP`服务器,可选择支持`FTP/S和WebDAV`。它可以为本地文件系统和云存储后端服务,如S3和谷歌云存储。
* [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8,505 | 🐛 45 | 🌐 Go | 📅 2026-09-09 :   高性能的PHP应用服务器,负载均衡器和进程管理器。
* [flipt](https://github.com/markphelps/flipt) ⭐ 4,896 | 🐛 41 | 🌐 Go | 📅 2026-09-11 :  用`Go`和`Vue.js`编写的自带功能标志的解决方案。
* [Fider](https://github.com/getfider/fider) ⭐ 4,516 | 🐛 57 | 🌐 Go | 📅 2026-09-02 : `Fider`是一个收集和整理客户反馈的开放平台。
...
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,090 | 🐛 10 | 🌐 Go | 📅 2026-09-11 : `HTTP`反向代理缓存和时间序列加速器。
...
* [go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) ⭐ 151 | 🐛 19 | 🌐 Go | 📅 2026-09-10 : 简单的反向代理与缓存,用`Go`编写,使用`Redis`。
...
* 测试框架
  ...
  * [jsonassert](https://github.com/kinbiko/jsonassert) ⭐ 143 | 🐛 7 | 🌐 Go | 📅 2026-09-04 :  用于验证JSON有效载荷是否被正确序列化的软件包。
  ...
  * [flute](https://github.com/suzuki-shunsuke/flute) ⭐ 23 | 🐛 2 | 🌐 Go | 📅 2026-09-10 : ` HTTP`客户端测试框架。
...
* Mock
  ...
  * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) ⭐ 6,571 | 🐛 48 | 🌐 Go | 📅 2026-07-10 :` Mock SQL` ,用于测试数据库交互
...
* Selenium及浏览器控制工具
  * [chromedp](https://github.com/knq/chromedp) ⭐ 13,275 | 🐛 180 | 🌐 Go | 📅 2026-07-14 :  用于驱动和测试`Chrome, Safari, Edge, Android Webviews`, 以及其他支持`Chrome`调试协议的产品
...
* 特定文本格式处理
  * [colly](https://github.com/asciimoo/colly) ⭐ 25,507 | 🐛 194 | 🌐 Go | 📅 2026-09-02 :  `go`语言版爬虫框架
  * [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14,985 | 🐛 3 | 🌐 Go | 📅 2026-09-08 :`  GoQuery` 为` Go`语言带来了一组类似`jQuery` 的语法和功能
  ...
  * [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4,816 | 🐛 59 | 🌐 Go | 📅 2026-03-02 :    将时间、数字和内存大小格式化为人类可读的格式。
  * [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3,812 | 🐛 26 | 🌐 Go | 📅 2026-08-03 :  将`HTML`转换为`Markdown`。甚至适用于整个网站,并可通过规则进行扩展。
  ...
  * [go-toml](https://github.com/pelletier/go-toml) ⭐ 1,979 | 🐛 32 | 🌐 Go | 📅 2026-08-03 : `TOML`格式的`Go`库,
  ...
  * [go-nmea](https://github.com/adrianmo/go-nmea) ⭐ 265 | 🐛 1 | 🌐 Go | 📅 2026-08-22 :   Go语言的NMEA解析库。
...
* [github](https://github.com/google/go-github) ⭐ 11,305 | 🐛 42 | 🌐 Go | 📅 2026-09-11 :  用于访问`GitHub REST API v3` 的`Go`库。
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) ⚠️ Archived : ` AWS` 提供的官方go语言` SDK`
* [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5,986 | 🐛 232 | 🌐 Go | 📅 2026-02-14 :   用于与`Discord` 聊天` API`进行交互的`Go`语言客户端。
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) ⭐ 4,505 | 🐛 409 | 🌐 Go | 📅 2026-09-11 :`Google Cloud APIs Go`客户端库。
* [google](https://github.com/google/google-api-go-client) ⭐ 4,474 | 🐛 20 | 🌐 Go | 📅 2026-09-11 :  为`Go` 自动生成的`Google API`。
* [minio-go](https://github.com/minio/minio-go) ⭐ 2,998 | 🐛 7 | 🌐 Go | 📅 2026-09-10 :  `go` 语言`Minio` 客户端,用于` Amazon S3` 兼容的云存储
* [stripe](https://github.com/stripe/stripe-go) ⭐ 2,636 | 🐛 13 | 🌐 Go | 📅 2026-09-11 :  用于访问`Stripe API`的`Go`客户端。
...
* [githubql](https://github.com/shurcooL/githubql) ⭐ 1,199 | 🐛 42 | 🌐 Go | 📅 2026-02-09 :  用于访问`GitHub GraphQL API v4` 的`Go` 库。
...
* [simples3](https://github.com/rhnvrm/simples3) ⭐ 208 | 🐛 13 | 🌐 Go | 📅 2026-05-21 :  简单的不加修饰的`AWS S3`库,使用`Go`编写的`V4 Signing`的`REST api`。
...
* [golang-tmdb](https://github.com/cyruzin/golang-tmdb) ⭐ 165 | 🐛 1 | 🌐 Go | 📅 2026-07-15 :   电影数据库`API v3`的`Golang` 版本`api`
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,922 | 🐛 328 | 🌐 Go | 📅 2026-09-11 :  命令行模糊查找工具
...
* [Task](https://github.com/go-task/task) ⭐ 16,126 | 🐛 187 | 🌐 Go | 📅 2026-09-11 :  简单来讲就是`"Make"`的替代品
* [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 16,028 | 🐛 17 | 🌐 Go | 📅 2026-09-11 : 尽可能快速的发布`Go`语言二进制文件
* [wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,733 | 🐛 42 | 🌐 Go | 📅 2026-08-04 :   交互式命令行程序,用于进行`HTTP` 检查
* [usql](https://github.com/knq/usql) ⭐ 10,110 | 🐛 119 | 🌐 Go | 📅 2026-06-19 :  `usql`是一个通用的命令行接口,用于操作`sql`数据库
* [peco](https://github.com/peco/peco) ⭐ 7,910 | 🐛 6 | 🌐 Go | 📅 2026-09-05 :  简单的交互式过滤工具。
* [go-funk](https://github.com/thoas/go-funk) ⭐ 4,930 | 🐛 11 | 🌐 Go | 📅 2024-07-24 :  `Go`语言工具库,提供了很多有用的工具`(map, find, contains, filter, chunk, reverse, ...)`
...
* [minify](https://github.com/tdewolff/minify) ⭐ 4,139 | 🐛 40 | 🌐 Go | 📅 2026-09-09 :  快速压缩`HTML, CSS, JS, XML, JSON` 以及` SVG` 文件格式
...
* [limiters](https://github.com/mennanov/limiters) ⭐ 651 | 🐛 2 | 🌐 Go | 📅 2026-09-02 : `Golang`中分布式应用的速率限制器,具有可配置的后端和分布式锁。
...
* [ghokin](https://github.com/antham/ghokin) ⭐ 58 | 🐛 0 | 🌐 Go | 📅 2026-08-22 :  并行化的格式化程序,不需要对`gherkin (cucumber, behat...)`,的外部依赖。
...
* [validator](https://github.com/go-playground/validator) ⭐ 20,155 | 🐛 329 | 🌐 Go | 📅 2026-09-10 :  `Go`结构体及域验证,包括：跨域、跨结构体,`Map`, 切片和数组
...
* [validate](https://github.com/gookit/validate) ⭐ 1,165 | 🐛 5 | 🌐 Go | 📅 2026-08-18 :  用于数据验证和过滤的`Go`包,支持验证`Map、Struct、Request(Form、JSON、url.Values、Uploaded Files`)数据和更多的功能。
* [gody](https://github.com/guiferpa/gody) ⭐ 180 | 🐛 0 | 🌐 Go | 📅 2025-05-30 :  针对 'Go\` 的轻量级结构体验证器。
* [jio](https://github.com/faceair/jio) ⭐ 126 | 🐛 3 | 🌐 Go | 📅 2024-07-04 : `jio`是一个类似于[joi](https://github.com/hapijs/joi) ⭐ 21,172 | 🐛 199 | 🌐 JavaScript | 📅 2026-09-11 的json模式验证器.
...
* [go-astisub](https://github.com/asticode/go-astisub) ⭐ 705 | 🐛 9 | 🌐 Go | 📅 2026-09-09 :  使用 Go 语言操作字幕`(.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).`
...
* [Gin](https://github.com/gin-gonic/gin) ⭐ 89,201 | 🐛 770 | 🌐 Go | 📅 2026-08-15 :  ` Gin` 是一个` Go` 语言编写的 web 框架,提供了一组类似`martini`的`API`,且具有更好的性能（40倍的性能提升）。如果你需要高性能和高生产率,这个框架很适合你
* [Fiber](https://github.com/gofiber/fiber) ⭐ 40,146 | 🐛 37 | 🌐 Go | 📅 2026-09-11 :  受` Express.js`启发的` Web` 框架,构建在`Fasthttp`上。
* [Echo](https://github.com/labstack/echo) ⭐ 32,706 | 🐛 36 | 🌐 Go | 📅 2026-09-11 :   高性能、极简的` Go`语言`web` 框架
...
* [Goyave](https://github.com/System-Glitch/goyave) ⭐ 1,774 | 🐛 14 | 🌐 Go | 📅 2026-09-08 :  功能完整的`Web`框架,旨在实现简洁的代码和快速开发,具有强大的内置功能。
...
* [Tollbooth](https://github.com/didip/tollbooth) ⭐ 2,850 | 🐛 10 | 🌐 Go | 📅 2025-01-12 : `HTTP` 请求限速中间件
...
* [alice](https://github.com/justinas/alice) ⭐ 3,365 | 🐛 11 | 🌐 Go | 📅 2024-06-06 :  创建链式中间件的库
...
* [chi](https://github.com/go-chi/chi) ⭐ 22,817 | 🐛 92 | 🌐 Go | 📅 2026-09-08 :   基于`net/context`的小巧、快速、具有丰富表达力的`HTTP`路由.
* [mux](https://github.com/gorilla/mux) ⭐ 21,837 | 🐛 41 | 🌐 Go | 📅 2024-08-15 :  强大的`URL`路由和分发库
...
* [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 17,721 | 🐛 556 | 🌐 Go | 📅 2026-09-11 :  基于`LLVM`,适用于微型场景的`Go`编译器。包括微控制器、`WebAssembly`和命令行工具。
...
* [gosimple](https://github.com/dominikh/go-tools/tree/master/cmd/gosimple) ⭐ 6,890 | 🐛 575 | 🌐 Go | 📅 2026-08-24 : 针对 Go 语言的`lint`工具,专注于简化代码
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) ⭐ 6,890 | 🐛 575 | 🌐 Go | 📅 2026-08-24 :  -`staticcheck`在`Go vet`阶段中执行大量的静态分析检查,类似`ReSharper for C#`这样的工具。
* [unused](https://github.com/dominikh/go-tools/tree/master/cmd/unused) ⭐ 6,890 | 🐛 575 | 🌐 Go | 📅 2026-08-24 :  `unused`会检查 Go 语言代码中没有用到的常量,变量,函数和类型
...
* [go-swagger](https://github.com/go-swagger/go-swagger) ⭐ 10,008 | 🐛 302 | 🌐 Go | 📅 2026-09-11 :  为 Go 语言实现的`Swagger 2.0`.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 127,347 | 🐛 3,026 | 🌐 Go | 📅 2026-09-11 :  来自`Google`的容器集群管理器
* [Moby](https://github.com/moby/moby) ⭐ 72,082 | 🐛 3,896 | 🌐 Go | 📅 2026-09-11 :  为容器生态系统创建的一个合作项目,用于构建基于容器的系统
* [traefik](https://github.com/containous/traefik) ⭐ 64,814 | 🐛 918 | 🌐 Go | 📅 2026-09-11 :  能对接多个后端的反向代理和负载均衡器。
* [Gitea](https://github.com/go-gitea/gitea) ⭐ 57,954 | 🐛 2,457 | 🌐 Go | 📅 2026-09-11 :  社区驱动的`Gogs`的`fork`库
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 25,187 | 🐛 122 | 🌐 Go | 📅 2026-02-16 :  `HTTP 加`载测试工具和代码库
* [Hey](https://github.com/rakyll/hey) ⭐ 20,260 | 🐛 189 | 🌐 Go | 📅 2026-01-10 :` Hey`是一个微型程序,用于向`web` 应用发送负载
* [Packer](https://github.com/mitchellh/packer) ⭐ 15,781 | 🐛 321 | 🌐 Go | 📅 2026-09-11 :` Packer`通过单一的配置文件,为不同的平台创建独立镜像
* [webhook](https://github.com/adnanh/webhook) ⭐ 12,126 | 🐛 127 | 🌐 Go | 📅 2026-09-04 :  允许用户创建`HTTP`钩子,并在服务器上执行命令
...
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 5,003 | 🐛 153 | 🌐 Go | 📅 2026-09-11 :  `Pomerium`是一个身份感知的访问代理。
...
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) ⭐ 997 | 🐛 284 | 🌐 Go | 📅 2026-09-11 :  通过命令行来管理 裸金属服务器 (和使用`Docker`一样容易)。
...
* [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) ⭐ 485 | 🐛 19 | 🌐 Go | 📅 2026-09-11 : `S3`代理,具有`GET、PUT`和`DELETE`方法和认证（`OpenID Connect`和`Basic Auth`）。
...
* [croc](https://github.com/schollz/croc) ⭐ 40,302 | 🐛 2 | 🌐 Go | 📅 2026-09-10 :    轻松安全地将文件或文件夹从一台计算机发送到另一台计算机。
* [restic](https://github.com/restic/restic) ⭐ 35,979 | 🐛 596 | 🌐 Go | 📅 2026-09-01 :  解耦备份程序
* [Gor](https://github.com/buger/gor) ⭐ 19,318 | 🐛 341 | 🌐 Go | 📅 2026-01-27 :  Http 流量复制工具,用于将生产环境的流量在开发环境进行重放
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12,332 | 🐛 105 | 🌐 Go | 📅 2026-09-01 :  用于自动化测试中模拟网络和系统状态的代理服务。
* [Comcast](https://github.com/tylertreat/Comcast) ⭐ 10,513 | 🐛 26 | 🌐 Go | 📅 2025-03-20 :   模拟网络波动情况下的网络数据连接
* [scc](https://github.com/boyter/scc) ⭐ 8,733 | 🐛 26 | 🌐 Go | 📅 2026-09-11 :   一个非常快速准确的代码计数器,具有复杂度计算和`COCOMO`估计功能。
...
* [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5,675 | 🐛 336 | 🌐 Go | 📅 2026-08-06 :  跨平台网络和云备份工具
...
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) ⭐ 38 | 🐛 1 | 🌐 Go | 📅 2026-09-11 :  快速、简单、可扩展的分布式文件系统,具有`O(1)`的磁盘查找效率
